...
if __name__ == "__main__":
    main()
`,hn="/assets/joraw-BAR7UfD7.js",cn="/assets/joraw-mu1HaEC3.wasm";const ct=512,pn=an["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let Be=null,Ve=null;function un(i){if(i.byteLength<8)return null;const e=i.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function Dt(i,e,t){const n=Math.min(i.length,e+t);let r="";for(let a=e;a<n;a++){const s=i[a];if(s===0)break;r+=String.fromCharCode(s)}return r.trim()}function T(i,e,t,n,r){const a=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!a)return[];const s=a*n,o=s<=4?r:i.getUint32(r,e);if(o<0||o+s>i.byteLength)return[];const l=[];for(let c=0;c<n;c++){const h=o+c*a;t===1||t===2||t===7?l.push(i.getUint8(h)):t===3?l.push(i.getUint16(h,e)):t===8?l.push(i.getInt16(h,e)):t===4?l.push(i.getUint32(h,e)):t===9&&l.push(i.getInt32(h,e))}return l}function pt(i,e,t,n,r,a){if(n!==2||r<=0)return"";const s=r<=4?a:e.getUint32(a,t);return s<0||s>=i.length?"":Dt(i,s,r)}function Rt(i){const e=new Uint8Array(i),t=new DataView(i),n=un(t);if(n===null||t.getUint16(2,n)!==42)return null;const a=p=>t.getUint16(p,n),s=p=>t.getUint32(p,n),o=[s(4)],l=new Set;let c="",h="";for(;o.length;){const p=o.pop();if(l.has(p)||p<=0||p+2>t.byteLength)continue;l.add(p);const g=a(p);if(p+2+g*12+4>t.byteLength)continue;const d=new Map;for(let P=0;P<g;P++){const I=p+2+P*12,f=a(I),S=a(I+2),Re=s(I+4),O=I+8;d.set(f,{type:S,count:Re,valueOffset:O})}const _=d.get(271),k=d.get(272);_&&!c&&(c=pt(e,t,n,_.type,_.count,_.valueOffset)),k&&!h&&(h=pt(e,t,n,k.type,k.count,k.valueOffset));const v=d.get(330);if(v){const P=T(t,n,v.type,v.count,v.valueOffset);for(const I of P)o.push(I)}const R=d.get(259),W=d.get(262);if(R&&W){const P=T(t,n,R.type,R.count,R.valueOffset)[0],I=T(t,n,W.type,W.count,W.valueOffset)[0];if(P===32766&&I===32803){const f=T(t,n,d.get(256).type,d.get(256).count,d.get(256).valueOffset)[0],S=T(t,n,d.get(257).type,d.get(257).count,d.get(257).valueOffset)[0],Re=T(t,n,d.get(258).type,d.get(258).count,d.get(258).valueOffset)[0],O=T(t,n,d.get(273).type,d.get(273).count,d.get(273).valueOffset)[0],Oe=T(t,n,d.get(279).type,d.get(279).count,d.get(279).valueOffset)[0],Xt=d.get(33422)?T(t,n,d.get(33422).type,d.get(33422).count,d.get(33422).valueOffset):[0,1,1,2];d.get(29456)&&T(t,n,d.get(29456).type,d.get(29456).count,d.get(29456).valueOffset);const qt=d.get(50717)?T(t,n,d.get(50717).type,d.get(50717).count,d.get(50717).valueOffset)[0]:16383,Me=d.get(50719)?T(t,n,d.get(50719).type,d.get(50719).count,d.get(50719).valueOffset):[],Ee=d.get(50720)?T(t,n,d.get(50720).type,d.get(50720).count,d.get(50720).valueOffset):[];if(O+ct+16>e.length||O+Oe>e.length)return null;const F=O+ct,ot=Dt(e,F,4),fe=e[F+8]<<8|e[F+9],Yt=e[F+10]<<8|e[F+11],Jt=e[F+12]<<8|e[F+13],lt=e[F+14]<<8|e[F+15],$t=Jt>>4&63,Qt=lt>>13,Zt=lt>>10&3,ge=Yt*2,K=Oe>=4?(e[O]|e[O+1]<<8|e[O+2]<<16|e[O+3]<<24)>>>0:0,en=fe===f&&ge===S;let dt=!1;if(K>=1&&K<=16&&Oe>=8+K*24){const X=new Map,Fe=new Map;let oe=!0;for(let le=0;le<K;le++){const N=O+8+le*24,q=t.getUint32(N+8,!0),Y=t.getUint32(N+12,!0),Ue=t.getUint32(N+16,!0),_e=t.getUint32(N+20,!0);if(!Ue||!_e||q+Ue>f||Y+_e>S){oe=!1;break}const ht=X.get(Y);if(ht!==void 0&&ht!==_e){oe=!1;break}X.set(Y,_e),Fe.set(Y,(Fe.get(Y)||0)+Ue)}if(oe){const le=Array.from(X.keys()).sort((q,Y)=>q-Y);let N=0;for(const q of le){if(q!==N||Fe.get(q)!==f){oe=!1;break}N+=X.get(q)}dt=oe&&N===S}}const tn=K>=1&&K<=16&&fe>0&&ge>0&&f%fe===0&&S%ge===0&&K===f/fe*(S/ge);if(ot!=="A000"&&ot!=="0000"||!en&&!tn&&!dt||$t!==16||Qt!==3||Zt!==3)return null;const nn=[1024,1024,1024,1024],rn=Xt.slice(0,4).map(X=>X===0?"R":X===2?"B":"G").join("")||"RGGB";return{width:f,height:S,bitsPerSample:Re,compression:P,photometric:I,blackLevel:nn,whiteLevel:Number(qt||16383),cfaPattern:rn,defaultCropOrigin:Me.length>=2?[Number(Me[0]),Number(Me[1])]:void 0,defaultCropSize:Ee.length>=2?[Number(Ee[0]),Number(Ee[1])]:void 0,make:c||"SONY",model:h||"ILCE-7M5"}}}const ue=s(p+2+g*12);ue&&o.push(ue)}return null}async function fn(i){return Be||(Be=(async()=>{const e=await sn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",on),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",ln),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",dn),await e.runPythonAsync(`
import sys
