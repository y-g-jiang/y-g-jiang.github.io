var en=Object.defineProperty;var tn=(r,e,t)=>e in r?en(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var D=(r,e,t)=>tn(r,typeof e!="symbol"?e+"":e,t);class Pe{constructor(e){D(this,"size");D(this,"isPowerOfTwo");D(this,"_real");D(this,"_imag");D(this,"_scratch",null);D(this,"_rev",null);D(this,"_m",0);D(this,"_internalFFT",null);D(this,"_chirpReal",null);D(this,"_chirpImag",null);D(this,"_bReal",null);D(this,"_bImag",null);D(this,"_hanning",null);D(this,"_windowSumSq",0);this.size=e,this.isPowerOfTwo=(e&e-1)===0&&e>0,this._real=new Float32Array(e),this._imag=new Float32Array(e),this.isPowerOfTwo?this.initRadix2():this.initBluestein()}initRadix2(){const e=this.size,t=Math.log2(e);this._rev=new Uint32Array(e);for(let n=0;n<e;n++){let i=0,s=n;for(let a=0;a<t;a++)i=i<<1|s&1,s>>>=1;this._rev[n]=i}}initBluestein(){const e=this.size;this._m=Math.pow(2,Math.ceil(Math.log2(2*e-1))),this._internalFFT=new Pe(this._m),this._chirpReal=new Float32Array(e),this._chirpImag=new Float32Array(e);for(let i=0;i<e;i++){const s=-Math.PI*(i*i)/e;this._chirpReal[i]=Math.cos(s),this._chirpImag[i]=Math.sin(s)}const t=new Float32Array(this._m),n=new Float32Array(this._m);for(let i=0;i<e;i++)t[i]=this._chirpReal[i],n[i]=-this._chirpImag[i];for(let i=1;i<e;i++)t[this._m-i]=t[i],n[this._m-i]=n[i];this._internalFFT.transform(t,n),this._bReal=new Float32Array(this._internalFFT._real),this._bImag=new Float32Array(this._internalFFT._imag)}initHanning(){if(this._hanning)return;const e=this.size;this._hanning=new Float32Array(e);let t=0;for(let n=0;n<e;n++){const i=.5*(1-Math.cos(2*Math.PI*n/(e-1)));this._hanning[n]=i,t+=i*i}this._windowSumSq=t}transform(e,t){this.isPowerOfTwo?this.transformRadix2(e,t):this.transformBluestein(e,t)}transformRadix2(e,t){const n=this.size,i=this._rev,s=this._real,a=this._imag;if(e===s)for(let o=0;o<n;o++){const d=i[o];if(o<d){const u=s[o],h=a[o];s[o]=s[d],a[o]=a[d],s[d]=u,a[d]=h}}else for(let o=0;o<n;o++){const d=i[o];s[o]=e[d],a[o]=t?t[d]:0}for(let o=2;o<=n;o*=2){const d=o/2,u=-2*Math.PI/o,h=Math.cos(u),l=Math.sin(u);for(let p=0;p<n;p+=o){let c=1,f=0;for(let y=0;y<d;y++){const w=p+y,b=p+y+d,k=c*s[b]-f*a[b],O=c*a[b]+f*s[b],x=s[w],S=a[w];s[w]=x+k,a[w]=S+O,s[b]=x-k,a[b]=S-O;const _=c*h-f*l,A=c*l+f*h;c=_,f=A}}}}transformBluestein(e,t){const n=this.size,i=this._m,s=this._internalFFT,a=s._real,o=s._imag;a.fill(0),o.fill(0);for(let l=0;l<n;l++){const p=e[l],c=t?t[l]:0,f=this._chirpReal[l],y=this._chirpImag[l];a[l]=p*f-c*y,o[l]=p*y+c*f}s.transformRadix2(a,o);for(let l=0;l<i;l++){const p=s._real[l],c=s._imag[l],f=this._bReal[l],y=this._bImag[l];s._real[l]=p*f-c*y,s._imag[l]=p*y+c*f}const d=s._real,u=s._imag;for(let l=0;l<i;l++)u[l]=-u[l];s.transformRadix2(d,u);const h=1/i;for(let l=0;l<n;l++){const p=s._real[l]*h,c=-s._imag[l]*h,f=this._chirpReal[l],y=this._chirpImag[l];this._real[l]=p*f-c*y,this._imag[l]=p*y+c*f}}calculateSpectrum(e,t,n=!1){const i=this.size;let s=0;for(let h=0;h<i;h++)s+=e[h];const a=s/i;this._scratch||(this._scratch=new Float32Array(i));const o=this._scratch;if(n){this.initHanning();const h=this._hanning;for(let l=0;l<i;l++)o[l]=(e[l]-a)*h[l]}else for(let h=0;h<i;h++)o[h]=e[h]-a;this.transform(o);const d=t.length;let u=1/i;n&&this._windowSumSq>0&&(u=1/this._windowSumSq);for(let h=0;h<d;h++){const l=this._real[h],p=this._imag[h];t[h]+=(l*l+p*p)*u}}calculateSpectrumWindow(e,t,n,i=!1){const s=this.size;let a=0;for(let l=0;l<s;l++)a+=e[t+l];const o=a/s;this._scratch||(this._scratch=new Float32Array(s));const d=this._scratch;if(i){this.initHanning();const l=this._hanning;for(let p=0;p<s;p++)d[p]=(e[t+p]-o)*l[p]}else for(let l=0;l<s;l++)d[l]=e[t+l]-o;this.transform(d);const u=n.length;let h=1/s;i&&this._windowSumSq>0&&(h=1/this._windowSumSq);for(let l=0;l<u;l++){const p=this._real[l],c=this._imag[l];n[l]+=(p*p+c*c)*h}}}const nn={"Sony ILCE-7RM5":"0.82 -0.2976 -0.0719 -0.4296 1.2053 0.2532 -0.0429 0.1282 0.5774"};let ze=null;async function rn(r){return ze||(ze=(async()=>{if(typeof window.loadPyodide!="function")throw new Error("Pyodide missing: window.loadPyodide not found.");const e=await window.loadPyodide();return await e.loadPackage("numpy"),e})()),ze}var sn=`#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
`;const dt=512,ln=nn["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let Ve=null;function dn(r){if(r.byteLength<8)return null;const e=r.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function Lt(r,e,t){const n=Math.min(r.length,e+t);let i="";for(let s=e;s<n;s++){const a=r[s];if(a===0)break;i+=String.fromCharCode(a)}return i.trim()}function U(r,e,t,n,i){const s=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!s)return[];const a=s*n,o=a<=4?i:r.getUint32(i,e);if(o<0||o+a>r.byteLength)return[];const d=[];for(let u=0;u<n;u++){const h=o+u*s;t===1||t===2||t===7?d.push(r.getUint8(h)):t===3?d.push(r.getUint16(h,e)):t===8?d.push(r.getInt16(h,e)):t===4?d.push(r.getUint32(h,e)):t===9&&d.push(r.getInt32(h,e))}return d}function ht(r,e,t,n,i,s){if(n!==2||i<=0)return"";const a=i<=4?s:e.getUint32(s,t);return a<0||a>=r.length?"":Lt(r,a,i)}function Ot(r){const e=new Uint8Array(r),t=new DataView(r),n=dn(t);if(n===null||t.getUint16(2,n)!==42)return null;const s=l=>t.getUint16(l,n),a=l=>t.getUint32(l,n),o=[a(4)],d=new Set;let u="",h="";for(;o.length;){const l=o.pop();if(d.has(l)||l<=0||l+2>t.byteLength)continue;d.add(l);const p=s(l);if(l+2+p*12+4>t.byteLength)continue;const c=new Map;for(let x=0;x<p;x++){const S=l+2+x*12,_=s(S),A=s(S+2),pe=a(S+4),F=S+8;c.set(_,{type:A,count:pe,valueOffset:F})}const f=c.get(271),y=c.get(272);f&&!u&&(u=ht(e,t,n,f.type,f.count,f.valueOffset)),y&&!h&&(h=ht(e,t,n,y.type,y.count,y.valueOffset));const w=c.get(330);if(w){const x=U(t,n,w.type,w.count,w.valueOffset);for(const S of x)o.push(S)}const b=c.get(259),k=c.get(262);if(b&&k){const x=U(t,n,b.type,b.count,b.valueOffset)[0],S=U(t,n,k.type,k.count,k.valueOffset)[0];if(x===32766&&S===32803){const _=U(t,n,c.get(256).type,c.get(256).count,c.get(256).valueOffset)[0],A=U(t,n,c.get(257).type,c.get(257).count,c.get(257).valueOffset)[0],pe=U(t,n,c.get(258).type,c.get(258).count,c.get(258).valueOffset)[0],F=U(t,n,c.get(273).type,c.get(273).count,c.get(273).valueOffset)[0],Z=U(t,n,c.get(279).type,c.get(279).count,c.get(279).valueOffset)[0],le=c.get(33422)?U(t,n,c.get(33422).type,c.get(33422).count,c.get(33422).valueOffset):[0,1,1,2],B=c.get(29456)?U(t,n,c.get(29456).type,c.get(29456).count,c.get(29456).valueOffset):[],ye=c.get(50717)?U(t,n,c.get(50717).type,c.get(50717).count,c.get(50717).valueOffset)[0]:16383,de=c.get(50719)?U(t,n,c.get(50719).type,c.get(50719).count,c.get(50719).valueOffset):[],m=c.get(50720)?U(t,n,c.get(50720).type,c.get(50720).count,c.get(50720).valueOffset):[];if(F+dt+16>e.length||F+Z>e.length)return null;const N=F+dt,X=Lt(e,N,4),T=e[N+8]<<8|e[N+9],R=e[N+10]<<8|e[N+11],j=e[N+12]<<8|e[N+13],be=e[N+14]<<8|e[N+15],Kt=j>>4&63,qt=be>>13,Yt=be>>10&3,we=R*2,Be=Z>=4?(e[F]|e[F+1]<<8|e[F+2]<<16|e[F+3]<<24)>>>0:0,Jt=T===_&&we===A,$t=Be>=1&&Be<=16&&T>0&&we>0&&_%T===0&&A%we===0&&Be===_/T*(A/we);if(X!=="A000"&&X!=="0000"||!Jt&&!$t||Kt!==16||qt!==3||Yt!==3)return null;const Qt=[Number(B[0]??512),Number(B[1]??B[0]??512),Number(B[2]??B[0]??512),Number(B[3]??B[0]??512)],Zt=le.slice(0,4).map(lt=>lt===0?"R":lt===2?"B":"G").join("")||"RGGB";return{width:_,height:A,bitsPerSample:pe,compression:x,photometric:S,blackLevel:Qt,whiteLevel:Number(ye||16383),cfaPattern:Zt,defaultCropOrigin:de.length>=2?[Number(de[0]),Number(de[1])]:void 0,defaultCropSize:m.length>=2?[Number(m[0]),Number(m[1])]:void 0,make:u||"SONY",model:h||"ILCE-7M5"}}}const O=a(l+2+p*12);O&&o.push(O)}return null}async function hn(r){return Ve||(Ve=(async()=>{const e=await rn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",sn),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",an),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",on),await e.runPythonAsync(`
import sys
...
`),e.__jtrSonyCrawHqDecoderReady=!0),e})()),Ve}function cn(r){return Ot(r)}async function un(r,e){const t=typeof performance<"u"?performance.now():Date.now(),n=Ot(r);if(!n)return null;const i=await hn(),s=typeof performance<"u"?performance.now():Date.now(),a=new Uint8Array(r),o=await fetch(new URL("/assets/sony_llvc3_static_lut4096_padded_u16-FsVBk-IV.bin",import.meta.url));if(!o.ok)throw new Error(`Failed to load Sony LLVC3 sample LUT: HTTP ${o.status}`);const d=new Uint8Array(await o.arrayBuffer()),u=typeof performance<"u"?performance.now():Date.now();i.globals.set("jtr_sony_arw_bytes",a),i.globals.set("jtr_sony_lut_bytes",d);const h=await i.runPythonAsync("jtr_decode_sony_craw_hq(jtr_sony_arw_bytes.to_py(), jtr_sony_lut_bytes.to_py())"),l=typeof performance<"u"?performance.now():Date.now(),p=h.toJs();typeof h.destroy=="function"&&h.destroy(),i.globals.delete("jtr_sony_arw_bytes"),i.globals.delete("jtr_sony_lut_bytes");const c=new Uint8Array(p.byteLength);c.set(p);const f=new Uint16Array(c.buffer),y=typeof performance<"u"?performance.now():Date.now();if(f.length!==n.width*n.height)throw new Error(`Sony cRAW HQ decoded size mismatch: got ${f.length}, expected ${n.width*n.height}`);const w=n.model||"ILCE-7M5",b=w.startsWith("Sony ")?w:`Sony ${w}`,k=w==="ILCE-7M5"?ln:null,O={make:n.make||"SONY",model:w,camera_make:n.make||"SONY",camera_model:w,UniqueCameraModel:b,sourceFormat:"Sony cRAW HQ / LLVC3",sonyCrawHq:n,color_desc:n.cfaPattern,black_level_per_channel:n.blackLevel,white_level:n.whiteLevel,color_matrix:k&&k.length===9?k:void 0,idata:{filters:2492765332,colors:3},color_data:{cblack_rawpy_style:n.blackLevel,dng_levels:{dng_cblack:n.blackLevel,dng_whitelevel:n.whiteLevel}}},x=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] decode timings",{width:n.width,height:n.height,pyodideReadyMs:Math.round(s-t),lutLoadMs:Math.round(u-s),llvc3DecodeMs:Math.round(l-u),copyMs:Math.round(y-l),totalMs:Math.round(x-t)}),{rawImageData:{data:f,width:n.width,height:n.height,bayerPattern:n.cfaPattern,blackLevels:n.blackLevel,whiteLevel:n.whiteLevel,metadata:O,isThreePlane:!1,isXTrans:!1},info:n}}async function pn(r,e){return un(r)}var De=typeof self<"u"?self:global;const me=typeof navigator<"u",fn=me&&typeof HTMLImageElement>"u",Ie=!(typeof global>"u"||typeof process>"u"||!process.versions||!process.versions.node),Me=De.Buffer,xe=De.BigInt,Fe=!!Me,gn=r=>r;function Ae(r,e=gn){if(Ie)try{return typeof require=="function"?Promise.resolve(e(require(r))):import(r).then(e)}catch{console.warn(`Couldn't load ${r}`)}}let et=De.fetch;const _n=r=>et=r;if(!De.fetch){const r=Ae("http",n=>n),e=Ae("https",n=>n),t=(n,{headers:i}={})=>new Promise(async(s,a)=>{let{port:o,hostname:d,pathname:u,protocol:h,search:l}=new URL(n);const p={method:"GET",hostname:d,path:encodeURI(u)+l,headers:i};o!==""&&(p.port=Number(o));const c=(h==="https:"?await e:await r).request(p,f=>{if(f.statusCode===301||f.statusCode===302){let y=new URL(f.headers.location,n).toString();return t(y,{headers:i}).then(s).catch(a)}s({status:f.statusCode,arrayBuffer:()=>new Promise(y=>{let w=[];f.on("data",b=>w.push(b)),f.on("end",()=>y(Buffer.concat(w)))})})});c.on("error",a),c.end()});_n(t)}function g(r,e,t){return e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}const Te=r=>Dt(r)?void 0:r,mn=r=>r!==void 0;function Dt(r){return r===void 0||(r instanceof Map?r.size===0:Object.values(r).filter(mn).length===0)}function I(r){let e=new Error(r);throw delete e.stack,e}function ee(r){return(r=function(e){for(;e.endsWith("\0");)e=e.slice(0,-1);return e}(r).trim())===""?void 0:r}function Ye(r){let e=function(t){let n=0;return t.ifd0.enabled&&(n+=1024),t.exif.enabled&&(n+=2048),t.makerNote&&(n+=2048),t.userComment&&(n+=1024),t.gps.enabled&&(n+=512),t.interop.enabled&&(n+=100),t.ifd1.enabled&&(n+=1024),n+2048}(r);return r.jfif.enabled&&(e+=50),r.xmp.enabled&&(e+=2e4),r.iptc.enabled&&(e+=14e3),r.icc.enabled&&(e+=6e3),e}const Je=r=>String.fromCharCode.apply(null,r),ct=typeof TextDecoder<"u"?new TextDecoder("utf-8"):void 0;function Mt(r){return ct?ct.decode(r):Fe?Buffer.from(r).toString("utf8"):decodeURIComponent(escape(Je(r)))}class E{static from(e,t){return e instanceof this&&e.le===t?e:new E(e,void 0,void 0,t)}constructor(e,t=0,n,i){if(typeof i=="boolean"&&(this.le=i),Array.isArray(e)&&(e=new Uint8Array(e)),e===0)this.byteOffset=0,this.byteLength=0;else if(e instanceof ArrayBuffer){n===void 0&&(n=e.byteLength-t);let s=new DataView(e,t,n);this._swapDataView(s)}else if(e instanceof Uint8Array||e instanceof DataView||e instanceof E){n===void 0&&(n=e.byteLength-t),(t+=e.byteOffset)+n>e.byteOffset+e.byteLength&&I("Creating view outside of available memory in ArrayBuffer");let s=new DataView(e.buffer,t,n);this._swapDataView(s)}else if(typeof e=="number"){let s=new DataView(new ArrayBuffer(e));this._swapDataView(s)}else I("Invalid input argument for BufferView: "+e)}_swapArrayBuffer(e){this._swapDataView(new DataView(e))}_swapBuffer(e){this._swapDataView(new DataView(e.buffer,e.byteOffset,e.byteLength))}_swapDataView(e){this.dataView=e,this.buffer=e.buffer,this.byteOffset=e.byteOffset,this.byteLength=e.byteLength}_lengthToEnd(e){return this.byteLength-e}set(e,t,n=E){return e instanceof DataView||e instanceof E?e=new Uint8Array(e.buffer,e.byteOffset,e.byteLength):e instanceof ArrayBuffer&&(e=new Uint8Array(e)),e instanceof Uint8Array||I("BufferView.set(): Invalid data argument."),this.toUint8().set(e,t),new n(this,t,e.byteLength)}subarray(e,t){return t=t||this._lengthToEnd(e),new E(this,e,t)}toUint8(){return new Uint8Array(this.buffer,this.byteOffset,this.byteLength)}getUint8Array(e,t){return new Uint8Array(this.buffer,this.byteOffset+e,t)}getString(e=0,t=this.byteLength){return Mt(this.getUint8Array(e,t))}getLatin1String(e=0,t=this.byteLength){let n=this.getUint8Array(e,t);return Je(n)}getUnicodeString(e=0,t=this.byteLength){const n=[];for(let i=0;i<t&&e+i<this.byteLength;i+=2)n.push(this.getUint16(e+i));return Je(n)}getInt8(e){return this.dataView.getInt8(e)}getUint8(e){return this.dataView.getUint8(e)}getInt16(e,t=this.le){return this.dataView.getInt16(e,t)}getInt32(e,t=this.le){return this.dataView.getInt32(e,t)}getUint16(e,t=this.le){return this.dataView.getUint16(e,t)}getUint32(e,t=this.le){return this.dataView.getUint32(e,t)}getFloat32(e,t=this.le){return this.dataView.getFloat32(e,t)}getFloat64(e,t=this.le){return this.dataView.getFloat64(e,t)}getFloat(e,t=this.le){return this.dataView.getFloat32(e,t)}getDouble(e,t=this.le){return this.dataView.getFloat64(e,t)}getUintBytes(e,t,n){switch(t){case 1:return this.getUint8(e,n);case 2:return this.getUint16(e,n);case 4:return this.getUint32(e,n);case 8:return this.getUint64&&this.getUint64(e,n)}}getUint(e,t,n){switch(t){case 8:return this.getUint8(e,n);case 16:return this.getUint16(e,n);case 32:return this.getUint32(e,n);case 64:return this.getUint64&&this.getUint64(e,n)}}toString(e){return this.dataView.toString(e,this.constructor.name)}ensureChunk(){}}function $e(r,e){I(`${r} '${e}' was not loaded, try using full build of exifr.`)}class tt extends Map{constructor(e){super(),this.kind=e}get(e,t){return this.has(e)||$e(this.kind,e),t&&(e in t||function(n,i){I(`Unknown ${n} '${i}'.`)}(this.kind,e),t[e].enabled||$e(this.kind,e)),super.get(e)}keyList(){return Array.from(this.keys())}}var G=new tt("file parser"),P=new tt("segment parser"),H=new tt("file reader");function yn(r,e){return typeof r=="string"?ut(r,e):me&&!fn&&r instanceof HTMLImageElement?ut(r.src,e):r instanceof Uint8Array||r instanceof ArrayBuffer||r instanceof DataView?new E(r):me&&r instanceof Blob?Qe(r,e,"blob",re):void I("Invalid input argument")}function ut(r,e){return(t=r).startsWith("data:")||t.length>1e4?Ze(r,e,"base64"):Ie&&r.includes("://")?Qe(r,e,"url",ie):Ie?Ze(r,e,"fs"):me?Qe(r,e,"url",ie):void I("Invalid input argument");var t}async function Qe(r,e,t,n){return H.has(t)?Ze(r,e,t):n?async function(i,s){let a=await s(i);return new E(a)}(r,n):void I(`Parser ${t} is not loaded`)}async function Ze(r,e,t){let n=new(H.get(t))(r,e);return await n.read(),n}const ie=r=>et(r).then(e=>e.arrayBuffer()),re=r=>new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result||new ArrayBuffer),n.onerror=t,n.readAsArrayBuffer(r)});class bn extends Map{get tagKeys(){return this.allKeys||(this.allKeys=Array.from(this.keys())),this.allKeys}get tagValues(){return this.allValues||(this.allValues=Array.from(this.values())),this.allValues}}function C(r,e,t){let n=new bn;for(let[i,s]of t)n.set(i,s);if(Array.isArray(e))for(let i of e)r.set(i,n);else r.set(e,n);return n}function se(r,e,t){let n,i=r.get(e);for(n of t)i.set(n[0],n[1])}const L=new Map,V=new Map,$=new Map,K=["chunked","firstChunkSize","firstChunkSizeNode","firstChunkSizeBrowser","chunkSize","chunkLimit"],ce=["jfif","xmp","icc","iptc","ihdr"],ae=["tiff",...ce],v=["ifd0","ifd1","exif","gps","interop"],q=[...ae,...v],Y=["makerNote","userComment"],ue=["translateKeys","translateValues","reviveValues","multiSegment"],J=[...ue,"sanitize","mergeOutput","silentErrors"];class Ft{get translate(){return this.translateKeys||this.translateValues||this.reviveValues}}class fe extends Ft{get needed(){return this.enabled||this.deps.size>0}constructor(e,t,n,i){if(super(),g(this,"enabled",!1),g(this,"skip",new Set),g(this,"pick",new Set),g(this,"deps",new Set),g(this,"translateKeys",!1),g(this,"translateValues",!1),g(this,"reviveValues",!1),this.key=e,this.enabled=t,this.parse=this.enabled,this.applyInheritables(i),this.canBeFiltered=v.includes(e),this.canBeFiltered&&(this.dict=L.get(e)),n!==void 0)if(Array.isArray(n))this.parse=this.enabled=!0,this.canBeFiltered&&n.length>0&&this.translateTagSet(n,this.pick);else if(typeof n=="object"){if(this.enabled=!0,this.parse=n.parse!==!1,this.canBeFiltered){let{pick:s,skip:a}=n;s&&s.length>0&&this.translateTagSet(s,this.pick),a&&a.length>0&&this.translateTagSet(a,this.skip)}this.applyInheritables(n)}else n===!0||n===!1?this.parse=this.enabled=n:I(`Invalid options argument: ${n}`)}applyInheritables(e){let t,n;for(t of ue)n=e[t],n!==void 0&&(this[t]=n)}translateTagSet(e,t){if(this.dict){let n,i,{tagKeys:s,tagValues:a}=this.dict;for(n of e)typeof n=="string"?(i=a.indexOf(n),i===-1&&(i=s.indexOf(Number(n))),i!==-1&&t.add(Number(s[i]))):t.add(n)}else for(let n of e)t.add(n)}finalizeFilters(){!this.enabled&&this.deps.size>0?(this.enabled=!0,Re(this.pick,this.deps)):this.enabled&&this.pick.size>0&&Re(this.pick,this.deps)}}var M={jfif:!1,tiff:!0,xmp:!1,icc:!1,iptc:!1,ifd0:!0,ifd1:!1,exif:!0,gps:!0,interop:!1,ihdr:void 0,makerNote:!1,userComment:!1,multiSegment:!1,skip:[],pick:[],translateKeys:!0,translateValues:!0,reviveValues:!0,sanitize:!0,mergeOutput:!0,silentErrors:!0,chunked:!0,firstChunkSize:void 0,firstChunkSizeNode:512,firstChunkSizeBrowser:65536,chunkSize:65536,chunkLimit:5},pt=new Map;class oe extends Ft{static useCached(e){let t=pt.get(e);return t!==void 0||(t=new this(e),pt.set(e,t)),t}constructor(e){super(),e===!0?this.setupFromTrue():e===void 0?this.setupFromUndefined():Array.isArray(e)?this.setupFromArray(e):typeof e=="object"?this.setupFromObject(e):I(`Invalid options argument ${e}`),this.firstChunkSize===void 0&&(this.firstChunkSize=me?this.firstChunkSizeBrowser:this.firstChunkSizeNode),this.mergeOutput&&(this.ifd1.enabled=!1),this.filterNestedSegmentTags(),this.traverseTiffDependencyTree(),this.checkLoadedPlugins()}setupFromUndefined(){let e;for(e of K)this[e]=M[e];for(e of J)this[e]=M[e];for(e of Y)this[e]=M[e];for(e of q)this[e]=new fe(e,M[e],void 0,this)}setupFromTrue(){let e;for(e of K)this[e]=M[e];for(e of J)this[e]=M[e];for(e of Y)this[e]=!0;for(e of q)this[e]=new fe(e,!0,void 0,this)}setupFromArray(e){let t;for(t of K)this[t]=M[t];for(t of J)this[t]=M[t];for(t of Y)this[t]=M[t];for(t of q)this[t]=new fe(t,!1,void 0,this);this.setupGlobalFilters(e,void 0,v)}setupFromObject(e){let t;for(t of(v.ifd0=v.ifd0||v.image,v.ifd1=v.ifd1||v.thumbnail,Object.assign(this,e),K))this[t]=Ge(e[t],M[t]);for(t of J)this[t]=Ge(e[t],M[t]);for(t of Y)this[t]=Ge(e[t],M[t]);for(t of ae)this[t]=new fe(t,M[t],e[t],this);for(t of v)this[t]=new fe(t,M[t],e[t],this.tiff);this.setupGlobalFilters(e.pick,e.skip,v,q),e.tiff===!0?this.batchEnableWithBool(v,!0):e.tiff===!1?this.batchEnableWithUserValue(v,e):Array.isArray(e.tiff)?this.setupGlobalFilters(e.tiff,void 0,v):typeof e.tiff=="object"&&this.setupGlobalFilters(e.tiff.pick,e.tiff.skip,v)}batchEnableWithBool(e,t){for(let n of e)this[n].enabled=t}batchEnableWithUserValue(e,t){for(let n of e){let i=t[n];this[n].enabled=i!==!1&&i!==void 0}}setupGlobalFilters(e,t,n,i=n){if(e&&e.length){for(let a of i)this[a].enabled=!1;let s=ft(e,n);for(let[a,o]of s)Re(this[a].pick,o),this[a].enabled=!0}else if(t&&t.length){let s=ft(t,n);for(let[a,o]of s)Re(this[a].skip,o)}}filterNestedSegmentTags(){let{ifd0:e,exif:t,xmp:n,iptc:i,icc:s}=this;this.makerNote?t.deps.add(37500):t.skip.add(37500),this.userComment?t.deps.add(37510):t.skip.add(37510),n.enabled||e.skip.add(700),i.enabled||e.skip.add(33723),s.enabled||e.skip.add(34675)}traverseTiffDependencyTree(){let{ifd0:e,exif:t,gps:n,interop:i}=this;i.needed&&(t.deps.add(40965),e.deps.add(40965)),t.needed&&e.deps.add(34665),n.needed&&e.deps.add(34853),this.tiff.enabled=v.some(s=>this[s].enabled===!0)||this.makerNote||this.userComment;for(let s of v)this[s].finalizeFilters()}get onlyTiff(){return!ce.map(e=>this[e].enabled).some(e=>e===!0)&&this.tiff.enabled}checkLoadedPlugins(){for(let e of ae)this[e].enabled&&!P.has(e)&&$e("segment parser",e)}}function ft(r,e){let t,n,i,s,a=[];for(i of e){for(s of(t=L.get(i),n=[],t))(r.includes(s[0])||r.includes(s[1]))&&n.push(s[0]);n.length&&a.push([i,n])}return a}function Ge(r,e){return r!==void 0?r:e!==void 0?e:void 0}function Re(r,e){for(let t of e)r.add(t)}g(oe,"default",M);class Q{constructor(e){g(this,"parsers",{}),g(this,"output",{}),g(this,"errors",[]),g(this,"pushToErrors",t=>this.errors.push(t)),this.options=oe.useCached(e)}async read(e){this.file=await yn(e,this.options)}setup(){if(this.fileParser)return;let{file:e}=this,t=e.getUint16(0);for(let[n,i]of G)if(i.canHandle(e,t))return this.fileParser=new i(this.options,this.file,this.parsers),e[n]=!0;this.file.close&&this.file.close(),I("Unknown file format")}async parse(){let{output:e,errors:t}=this;return this.setup(),this.options.silentErrors?(await this.executeParsers().catch(this.pushToErrors),t.push(...this.fileParser.errors)):await this.executeParsers(),this.file.close&&this.file.close(),this.options.silentErrors&&t.length>0&&(e.errors=t),Te(e)}async executeParsers(){let{output:e}=this;await this.fileParser.parse();let t=Object.values(this.parsers).map(async n=>{let i=await n.parse();n.assignToOutput(e,i)});this.options.silentErrors&&(t=t.map(n=>n.catch(this.pushToErrors))),await Promise.all(t)}async extractThumbnail(){this.setup();let{options:e,file:t}=this,n=P.get("tiff",e);var i;if(t.tiff?i={start:0,type:"tiff"}:t.jpeg&&(i=await this.fileParser.getOrFindSegment("tiff")),i===void 0)return;let s=await this.fileParser.ensureSegmentChunk(i),a=this.parsers.tiff=new n(s,e,t),o=await a.extractThumbnail();return t.close&&t.close(),o}}async function Ee(r,e){let t=new Q(e);return await t.read(r),t.parse()}var wn=Object.freeze({__proto__:null,parse:Ee,Exifr:Q,fileParsers:G,segmentParsers:P,fileReaders:H,tagKeys:L,tagValues:V,tagRevivers:$,createDictionary:C,extendDictionary:se,fetchUrlAsArrayBuffer:ie,readBlobAsArrayBuffer:re,chunkedProps:K,otherSegments:ce,segments:ae,tiffBlocks:v,segmentsAndBlocks:q,tiffExtractables:Y,inheritables:ue,allFormatters:J,Options:oe});class Ne{constructor(e,t,n){g(this,"errors",[]),g(this,"ensureSegmentChunk",async i=>{let s=i.start,a=i.size||65536;if(this.file.chunked)if(this.file.available(s,a))i.chunk=this.file.subarray(s,a);else try{i.chunk=await this.file.readChunk(s,a)}catch(o){I(`Couldn't read segment: ${JSON.stringify(i)}. ${o.message}`)}else this.file.byteLength>s+a?i.chunk=this.file.subarray(s,a):i.size===void 0?i.chunk=this.file.subarray(s):I("Segment unreachable: "+JSON.stringify(i));return i.chunk}),this.extendOptions&&this.extendOptions(e),this.options=e,this.file=t,this.parsers=n}injectSegment(e,t){this.options[e].enabled&&this.createParser(e,t)}createParser(e,t){let n=new(P.get(e))(t,this.options,this.file);return this.parsers[e]=n}createParsers(e){for(let t of e){let{type:n,chunk:i}=t,s=this.options[n];if(s&&s.enabled){let a=this.parsers[n];a&&a.append||a||this.createParser(n,i)}}}async readSegments(e){let t=e.map(this.ensureSegmentChunk);await Promise.all(t)}}class z{static findPosition(e,t){let n=e.getUint16(t+2)+2,i=typeof this.headerLength=="function"?this.headerLength(e,t,n):this.headerLength,s=t+i,a=n-i;return{offset:t,length:n,headerLength:i,start:s,size:a,end:s+a}}static parse(e,t={}){return new this(e,new oe({[this.type]:t}),e).parse()}normalizeInput(e){return e instanceof E?e:new E(e)}constructor(e,t={},n){g(this,"errors",[]),g(this,"raw",new Map),g(this,"handleError",i=>{if(!this.options.silentErrors)throw i;this.errors.push(i.message)}),this.chunk=this.normalizeInput(e),this.file=n,this.type=this.constructor.type,this.globalOptions=this.options=t,this.localOptions=t[this.type],this.canTranslate=this.localOptions&&this.localOptions.translate}translate(){this.canTranslate&&(this.translated=this.translateBlock(this.raw,this.type))}get output(){return this.translated?this.translated:this.raw?Object.fromEntries(this.raw):void 0}translateBlock(e,t){let n=$.get(t),i=V.get(t),s=L.get(t),a=this.options[t],o=a.reviveValues&&!!n,d=a.translateValues&&!!i,u=a.translateKeys&&!!s,h={};for(let[l,p]of e)o&&n.has(l)?p=n.get(l)(p):d&&i.has(l)&&(p=this.translateValue(p,i.get(l))),u&&s.has(l)&&(l=s.get(l)||l),h[l]=p;return h}translateValue(e,t){return t[e]||t.DEFAULT||e}assignToOutput(e,t){this.assignObjectToOutput(e,this.constructor.type,t)}assignObjectToOutput(e,t,n){if(this.globalOptions.mergeOutput)return Object.assign(e,n);e[t]?Object.assign(e[t],n):e[t]=n}}g(z,"headerLength",4),g(z,"type",void 0),g(z,"multiSegment",!1),g(z,"canHandle",()=>!1);function xn(r){return r===192||r===194||r===196||r===219||r===221||r===218||r===254}function Sn(r){return r>=224&&r<=239}function kn(r,e,t){for(let[n,i]of P)if(i.canHandle(r,e,t))return n}class gt extends Ne{constructor(...e){super(...e),g(this,"appSegments",[]),g(this,"jpegSegments",[]),g(this,"unknownSegments",[])}static canHandle(e,t){return t===65496}async parse(){await this.findAppSegments(),await this.readSegments(this.appSegments),this.mergeMultiSegments(),this.createParsers(this.mergedAppSegments||this.appSegments)}setupSegmentFinderArgs(e){e===!0?(this.findAll=!0,this.wanted=new Set(P.keyList())):(e=e===void 0?P.keyList().filter(t=>this.options[t].enabled):e.filter(t=>this.options[t].enabled&&P.has(t)),this.findAll=!1,this.remaining=new Set(e),this.wanted=new Set(e)),this.unfinishedMultiSegment=!1}async findAppSegments(e=0,t){this.setupSegmentFinderArgs(t);let{file:n,findAll:i,wanted:s,remaining:a}=this;if(!i&&this.file.chunked&&(i=Array.from(s).some(o=>{let d=P.get(o),u=this.options[o];return d.multiSegment&&u.multiSegment}),i&&await this.file.readWhole()),e=this.findAppSegmentsInRange(e,n.byteLength),!this.options.onlyTiff&&n.chunked){let o=!1;for(;a.size>0&&!o&&(n.canReadNextChunk||this.unfinishedMultiSegment);){let{nextChunkOffset:d}=n,u=this.appSegments.some(h=>!this.file.available(h.offset||h.start,h.length||h.size));if(o=e>d&&!u?!await n.readNextChunk(e):!await n.readNextChunk(d),(e=this.findAppSegmentsInRange(e,n.byteLength))===void 0)return}}}findAppSegmentsInRange(e,t){t-=2;let n,i,s,a,o,d,{file:u,findAll:h,wanted:l,remaining:p,options:c}=this;for(;e<t;e++)if(u.getUint8(e)===255){if(n=u.getUint8(e+1),Sn(n)){if(i=u.getUint16(e+2),s=kn(u,e,i),s&&l.has(s)&&(a=P.get(s),o=a.findPosition(u,e),d=c[s],o.type=s,this.appSegments.push(o),!h&&(a.multiSegment&&d.multiSegment?(this.unfinishedMultiSegment=o.chunkNumber<o.chunkCount,this.unfinishedMultiSegment||p.delete(s)):p.delete(s),p.size===0)))break;c.recordUnknownSegments&&(o=z.findPosition(u,e),o.marker=n,this.unknownSegments.push(o)),e+=i+1}else if(xn(n)){if(i=u.getUint16(e+2),n===218&&c.stopAfterSos!==!1)return;c.recordJpegSegments&&this.jpegSegments.push({offset:e,length:i,marker:n}),e+=i+1}}return e}mergeMultiSegments(){if(!this.appSegments.some(t=>t.multiSegment))return;let e=function(t,n){let i,s,a,o=new Map;for(let d=0;d<t.length;d++)i=t[d],s=i[n],o.has(s)?a=o.get(s):o.set(s,a=[]),a.push(i);return Array.from(o)}(this.appSegments,"type");this.mergedAppSegments=e.map(([t,n])=>{let i=P.get(t,this.options);return i.handleMultiSegments?{type:t,chunk:i.handleMultiSegments(n)}:n[0]})}getSegment(e){return this.appSegments.find(t=>t.type===e)}async getOrFindSegment(e){let t=this.getSegment(e);return t===void 0&&(await this.findAppSegments(0,[e]),t=this.getSegment(e)),t}}g(gt,"type","jpeg"),G.set("jpeg",gt);const vn=[void 0,1,1,2,4,8,1,1,2,4,8,4,8,4];class Cn extends z{parseHeader(){var e=this.chunk.getUint16();e===18761?this.le=!0:e===19789&&(this.le=!1),this.chunk.le=this.le,this.headerParsed=!0}parseTags(e,t,n=new Map){let{pick:i,skip:s}=this.options[t];i=new Set(i);let a=i.size>0,o=s.size===0,d=this.chunk.getUint16(e);e+=2;for(let u=0;u<d;u++){let h=this.chunk.getUint16(e);if(a){if(i.has(h)&&(n.set(h,this.parseTag(e,h,t)),i.delete(h),i.size===0))break}else!o&&s.has(h)||n.set(h,this.parseTag(e,h,t));e+=12}return n}parseTag(e,t,n){let{chunk:i}=this,s=i.getUint16(e+2),a=i.getUint32(e+4),o=vn[s];if(o*a<=4?e+=8:e=i.getUint32(e+8),(s<1||s>13)&&I(`Invalid TIFF value type. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e}`),e>i.byteLength&&I(`Invalid TIFF value offset. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${i.byteLength}`),s===1)return i.getUint8Array(e,a);if(s===2)return ee(i.getString(e,a));if(s===7)return i.getUint8Array(e,a);if(a===1)return this.parseTagValue(s,e);{let d=new(function(h){switch(h){case 1:return Uint8Array;case 3:return Uint16Array;case 4:return Uint32Array;case 5:return Array;case 6:return Int8Array;case 8:return Int16Array;case 9:return Int32Array;case 10:return Array;case 11:return Float32Array;case 12:return Float64Array;default:return Array}}(s))(a),u=o;for(let h=0;h<a;h++)d[h]=this.parseTagValue(s,e),e+=u;return d}}parseTagValue(e,t){let{chunk:n}=this;switch(e){case 1:return n.getUint8(t);case 3:return n.getUint16(t);case 4:return n.getUint32(t);case 5:return n.getUint32(t)/n.getUint32(t+4);case 6:return n.getInt8(t);case 8:return n.getInt16(t);case 9:return n.getInt32(t);case 10:return n.getInt32(t)/n.getInt32(t+4);case 11:return n.getFloat(t);case 12:return n.getDouble(t);case 13:return n.getUint32(t);default:I(`Invalid tiff type ${e}`)}}}class He extends Cn{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1165519206&&e.getUint16(t+8)===0}async parse(){this.parseHeader();let{options:e}=this;return e.ifd0.enabled&&await this.parseIfd0Block(),e.exif.enabled&&await this.safeParse("parseExifBlock"),e.gps.enabled&&await this.safeParse("parseGpsBlock"),e.interop.enabled&&await this.safeParse("parseInteropBlock"),e.ifd1.enabled&&await this.safeParse("parseThumbnailBlock"),this.createOutput()}safeParse(e){let t=this[e]();return t.catch!==void 0&&(t=t.catch(this.handleError)),t}findIfd0Offset(){this.ifd0Offset===void 0&&(this.ifd0Offset=this.chunk.getUint32(4))}findIfd1Offset(){if(this.ifd1Offset===void 0){this.findIfd0Offset();let e=this.chunk.getUint16(this.ifd0Offset),t=this.ifd0Offset+2+12*e;this.ifd1Offset=this.chunk.getUint32(t)}}parseBlock(e,t){let n=new Map;return this[t]=n,this.parseTags(e,t,n),n}async parseIfd0Block(){if(this.ifd0)return;let{file:e}=this;this.findIfd0Offset(),this.ifd0Offset<8&&I("Malformed EXIF data"),!e.chunked&&this.ifd0Offset>e.byteLength&&I(`IFD0 offset points to outside of file.
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`),e.tiff&&await e.ensureChunk(this.ifd0Offset,Ye(this.options));let t=this.parseBlock(this.ifd0Offset,"ifd0");return t.size!==0?(this.exifOffset=t.get(34665),this.interopOffset=t.get(40965),this.gpsOffset=t.get(34853),this.xmp=t.get(700),this.iptc=t.get(33723),this.icc=t.get(34675),this.options.sanitize&&(t.delete(34665),t.delete(40965),t.delete(34853),t.delete(700),t.delete(33723),t.delete(34675)),t):void 0}async parseExifBlock(){if(this.exif||(this.ifd0||await this.parseIfd0Block(),this.exifOffset===void 0))return;this.file.tiff&&await this.file.ensureChunk(this.exifOffset,Ye(this.options));let e=this.parseBlock(this.exifOffset,"exif");return this.interopOffset||(this.interopOffset=e.get(40965)),this.makerNote=e.get(37500),this.userComment=e.get(37510),this.options.sanitize&&(e.delete(40965),e.delete(37500),e.delete(37510)),this.unpack(e,41728),this.unpack(e,41729),e}unpack(e,t){let n=e.get(t);n&&n.length===1&&e.set(t,n[0])}async parseGpsBlock(){if(this.gps||(this.ifd0||await this.parseIfd0Block(),this.gpsOffset===void 0))return;let e=this.parseBlock(this.gpsOffset,"gps");return e&&e.has(2)&&e.has(4)&&(e.set("latitude",_t(...e.get(2),e.get(1))),e.set("longitude",_t(...e.get(4),e.get(3)))),e}async parseInteropBlock(){if(!this.interop&&(this.ifd0||await this.parseIfd0Block(),this.interopOffset!==void 0||this.exif||await this.parseExifBlock(),this.interopOffset!==void 0))return this.parseBlock(this.interopOffset,"interop")}async parseThumbnailBlock(e=!1){if(!this.ifd1&&!this.ifd1Parsed&&(!this.options.mergeOutput||e))return this.findIfd1Offset(),this.ifd1Offset>0&&(this.parseBlock(this.ifd1Offset,"ifd1"),this.ifd1Parsed=!0),this.ifd1}async extractThumbnail(){if(this.headerParsed||this.parseHeader(),this.ifd1Parsed||await this.parseThumbnailBlock(!0),this.ifd1===void 0)return;let e=this.ifd1.get(513),t=this.ifd1.get(514);return this.chunk.getUint8Array(e,t)}get image(){return this.ifd0}get thumbnail(){return this.ifd1}createOutput(){let e,t,n,i={};for(t of v)if(e=this[t],!Dt(e))if(n=this.canTranslate?this.translateBlock(e,t):Object.fromEntries(e),this.options.mergeOutput){if(t==="ifd1")continue;Object.assign(i,n)}else i[t]=n;return this.makerNote&&(i.makerNote=this.makerNote),this.userComment&&(i.userComment=this.userComment),i}assignToOutput(e,t){if(this.globalOptions.mergeOutput)Object.assign(e,t);else for(let[n,i]of Object.entries(t))this.assignObjectToOutput(e,n,i)}}function _t(r,e,t,n){var i=r+e/60+t/3600;return n!=="S"&&n!=="W"||(i*=-1),i}g(He,"type","tiff"),g(He,"headerLength",10),P.set("tiff",He);var Pn=Object.freeze({__proto__:null,default:wn,Exifr:Q,fileParsers:G,segmentParsers:P,fileReaders:H,tagKeys:L,tagValues:V,tagRevivers:$,createDictionary:C,extendDictionary:se,fetchUrlAsArrayBuffer:ie,readBlobAsArrayBuffer:re,chunkedProps:K,otherSegments:ce,segments:ae,tiffBlocks:v,segmentsAndBlocks:q,tiffExtractables:Y,inheritables:ue,allFormatters:J,Options:oe,parse:Ee});const nt={ifd0:!1,ifd1:!1,exif:!1,gps:!1,interop:!1,sanitize:!1,reviveValues:!0,translateKeys:!1,translateValues:!1,mergeOutput:!1},it=Object.assign({},nt,{firstChunkSize:4e4,gps:[1,2,3,4]});async function Et(r){let e=new Q(it);await e.read(r);let t=await e.parse();if(t&&t.gps){let{latitude:n,longitude:i}=t.gps;return{latitude:n,longitude:i}}}const rt=Object.assign({},nt,{tiff:!1,ifd1:!0,mergeOutput:!1});async function Nt(r){let e=new Q(rt);await e.read(r);let t=await e.extractThumbnail();return t&&Fe?Me.from(t):t}async function Ut(r){let e=await this.thumbnail(r);if(e!==void 0){let t=new Blob([e]);return URL.createObjectURL(t)}}const st=Object.assign({},nt,{firstChunkSize:4e4,ifd0:[274]});async function at(r){let e=new Q(st);await e.read(r);let t=await e.parse();if(t&&t.ifd0)return t.ifd0[274]}const ot=Object.freeze({1:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:0,rad:0},2:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:0,rad:0},3:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:180,rad:180*Math.PI/180},4:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:180,rad:180*Math.PI/180},5:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:90,rad:90*Math.PI/180},6:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:90,rad:90*Math.PI/180},7:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:270,rad:270*Math.PI/180},8:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:270,rad:270*Math.PI/180}});let te=!0,ne=!0;if(typeof navigator=="object"){let r=navigator.userAgent;if(r.includes("iPad")||r.includes("iPhone")){let e=r.match(/OS (\d+)_(\d+)/);if(e){let[,t,n]=e;te=Number(t)+.1*Number(n)<13.4,ne=!1}}else if(r.includes("OS X 10")){let[,e]=r.match(/OS X 10[_.](\d+)/);te=ne=Number(e)<15}if(r.includes("Chrome/")){let[,e]=r.match(/Chrome\/(\d+)/);te=ne=Number(e)<81}else if(r.includes("Firefox/")){let[,e]=r.match(/Firefox\/(\d+)/);te=ne=Number(e)<77}}async function Bt(r){let e=await at(r);return Object.assign({canvas:te,css:ne},ot[e])}class In extends E{constructor(...e){super(...e),g(this,"ranges",new An),this.byteLength!==0&&this.ranges.add(0,this.byteLength)}_tryExtend(e,t,n){if(e===0&&this.byteLength===0&&n){let i=new DataView(n.buffer||n,n.byteOffset,n.byteLength);this._swapDataView(i)}else{let i=e+t;if(i>this.byteLength){let{dataView:s}=this._extend(i);this._swapDataView(s)}}}_extend(e){let t;t=Fe?Me.allocUnsafe(e):new Uint8Array(e);let n=new DataView(t.buffer,t.byteOffset,t.byteLength);return t.set(new Uint8Array(this.buffer,this.byteOffset,this.byteLength),0),{uintView:t,dataView:n}}subarray(e,t,n=!1){return t=t||this._lengthToEnd(e),n&&this._tryExtend(e,t),this.ranges.add(e,t),super.subarray(e,t)}set(e,t,n=!1){n&&this._tryExtend(t,e.byteLength,e);let i=super.set(e,t);return this.ranges.add(t,i.byteLength),i}async ensureChunk(e,t){this.chunked&&(this.ranges.available(e,t)||await this.readChunk(e,t))}available(e,t){return this.ranges.available(e,t)}}class An{constructor(){g(this,"list",[])}get length(){return this.list.length}add(e,t,n=0){let i=e+t,s=this.list.filter(a=>mt(e,a.offset,i)||mt(e,a.end,i));if(s.length>0){e=Math.min(e,...s.map(o=>o.offset)),i=Math.max(i,...s.map(o=>o.end)),t=i-e;let a=s.shift();a.offset=e,a.length=t,a.end=i,this.list=this.list.filter(o=>!s.includes(o))}else this.list.push({offset:e,length:t,end:i})}available(e,t){let n=e+t;return this.list.some(i=>i.offset<=e&&n<=i.end)}}function mt(r,e,t){return r<=e&&e<=t}class Ue extends In{constructor(e,t){super(0),g(this,"chunksRead",0),this.input=e,this.options=t}async readWhole(){this.chunked=!1,await this.readChunk(this.nextChunkOffset)}async readChunked(){this.chunked=!0,await this.readChunk(0,this.options.firstChunkSize)}async readNextChunk(e=this.nextChunkOffset){if(this.fullyRead)return this.chunksRead++,!1;let t=this.options.chunkSize,n=await this.readChunk(e,t);return!!n&&n.byteLength===t}async readChunk(e,t){if(this.chunksRead++,(t=this.safeWrapAddress(e,t))!==0)return this._readChunk(e,t)}safeWrapAddress(e,t){return this.size!==void 0&&e+t>this.size?Math.max(0,this.size-e):t}get nextChunkOffset(){if(this.ranges.list.length!==0)return this.ranges.list[0].length}get canReadNextChunk(){return this.chunksRead<this.options.chunkLimit}get fullyRead(){return this.size!==void 0&&this.nextChunkOffset===this.size}read(){return this.options.chunked?this.readChunked():this.readWhole()}close(){}}H.set("blob",class extends Ue{async readWhole(){this.chunked=!1;let r=await re(this.input);this._swapArrayBuffer(r)}readChunked(){return this.chunked=!0,this.size=this.input.size,super.readChunked()}async _readChunk(r,e){let t=e?r+e:void 0,n=this.input.slice(r,t),i=await re(n);return this.set(i,r,!0)}});var Tn=Object.freeze({__proto__:null,default:Pn,Exifr:Q,fileParsers:G,segmentParsers:P,fileReaders:H,tagKeys:L,tagValues:V,tagRevivers:$,createDictionary:C,extendDictionary:se,fetchUrlAsArrayBuffer:ie,readBlobAsArrayBuffer:re,chunkedProps:K,otherSegments:ce,segments:ae,tiffBlocks:v,segmentsAndBlocks:q,tiffExtractables:Y,inheritables:ue,allFormatters:J,Options:oe,parse:Ee,gpsOnlyOptions:it,gps:Et,thumbnailOnlyOptions:rt,thumbnail:Nt,thumbnailUrl:Ut,orientationOnlyOptions:st,orientation:at,rotations:ot,get rotateCanvas(){return te},get rotateCss(){return ne},rotation:Bt});H.set("url",class extends Ue{async readWhole(){this.chunked=!1;let r=await ie(this.input);r instanceof ArrayBuffer?this._swapArrayBuffer(r):r instanceof Uint8Array&&this._swapBuffer(r)}async _readChunk(r,e){let t=e?r+e-1:void 0,n=this.options.httpHeaders||{};(r||t)&&(n.range=`bytes=${[r,t].join("-")}`);let i=await et(this.input,{headers:n}),s=await i.arrayBuffer(),a=s.byteLength;if(i.status!==416)return a!==e&&(this.size=r+a),this.set(s,r,!0)}});E.prototype.getUint64=function(r){let e=this.getUint32(r),t=this.getUint32(r+4);return e<1048575?e<<32|t:typeof xe!==void 0?(console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."),xe(e)<<xe(32)|xe(t)):void I("Trying to read 64b value but JS can only handle 53b numbers.")};class Rn extends Ne{parseBoxes(e=0){let t=[];for(;e<this.file.byteLength-4;){let n=this.parseBoxHead(e);if(t.push(n),n.length===0)break;e+=n.length}return t}parseSubBoxes(e){e.boxes=this.parseBoxes(e.start)}findBox(e,t){return e.boxes===void 0&&this.parseSubBoxes(e),e.boxes.find(n=>n.kind===t)}parseBoxHead(e){let t=this.file.getUint32(e),n=this.file.getString(e+4,4),i=e+8;return t===1&&(t=this.file.getUint64(e+8),i+=8),{offset:e,length:t,kind:n,start:i}}parseBoxFullHead(e){if(e.version!==void 0)return;let t=this.file.getUint32(e.start);e.version=t>>24,e.start+=4}}class zt extends Rn{static canHandle(e,t){if(t!==0)return!1;let n=e.getUint16(2);if(n>50)return!1;let i=16,s=[];for(;i<n;)s.push(e.getString(i,4)),i+=4;return s.includes(this.type)}async parse(){let e=this.file.getUint32(0),t=this.parseBoxHead(e);for(;t.kind!=="meta";)e+=t.length,await this.file.ensureChunk(e,16),t=this.parseBoxHead(e);await this.file.ensureChunk(t.offset,t.length),this.parseBoxFullHead(t),this.parseSubBoxes(t),this.options.icc.enabled&&await this.findIcc(t),this.options.tiff.enabled&&await this.findExif(t)}async registerSegment(e,t,n){await this.file.ensureChunk(t,n);let i=this.file.subarray(t,n);this.createParser(e,i)}async findIcc(e){let t=this.findBox(e,"iprp");if(t===void 0)return;let n=this.findBox(t,"ipco");if(n===void 0)return;let i=this.findBox(n,"colr");i!==void 0&&await this.registerSegment("icc",i.offset+12,i.length)}async findExif(e){let t=this.findBox(e,"iinf");if(t===void 0)return;let n=this.findBox(e,"iloc");if(n===void 0)return;let i=this.findExifLocIdInIinf(t),s=this.findExtentInIloc(n,i);if(s===void 0)return;let[a,o]=s;await this.file.ensureChunk(a,o);let d=4+this.file.getUint32(a);a+=d,o-=d,await this.registerSegment("tiff",a,o)}findExifLocIdInIinf(e){this.parseBoxFullHead(e);let t,n,i,s,a=e.start,o=this.file.getUint16(a);for(a+=2;o--;){if(t=this.parseBoxHead(a),this.parseBoxFullHead(t),n=t.start,t.version>=2&&(i=t.version===3?4:2,s=this.file.getString(n+i+2,4),s==="Exif"))return this.file.getUintBytes(n,i);a+=t.length}}get8bits(e){let t=this.file.getUint8(e);return[t>>4,15&t]}findExtentInIloc(e,t){this.parseBoxFullHead(e);let n=e.start,[i,s]=this.get8bits(n++),[a,o]=this.get8bits(n++),d=e.version===2?4:2,u=e.version===1||e.version===2?2:0,h=o+i+s,l=e.version===2?4:2,p=this.file.getUintBytes(n,l);for(n+=l;p--;){let c=this.file.getUintBytes(n,d);n+=d+u+2+a;let f=this.file.getUint16(n);if(n+=2,c===t)return f>1&&console.warn(`ILOC box has more than one extent but we're only processing one
Please create an issue at https://github.com/MikeKovarik/exifr with this file`),[this.file.getUintBytes(n+o,i),this.file.getUintBytes(n+o+i,s)];n+=f*h}}}class Vt extends zt{}g(Vt,"type","heic");class yt extends zt{}g(yt,"type","avif"),G.set("heic",Vt),G.set("avif",yt),C(L,["ifd0","ifd1"],[[256,"ImageWidth"],[257,"ImageHeight"],[258,"BitsPerSample"],[259,"Compression"],[262,"PhotometricInterpretation"],[270,"ImageDescription"],[271,"Make"],[272,"Model"],[273,"StripOffsets"],[274,"Orientation"],[277,"SamplesPerPixel"],[278,"RowsPerStrip"],[279,"StripByteCounts"],[282,"XResolution"],[283,"YResolution"],[284,"PlanarConfiguration"],[296,"ResolutionUnit"],[301,"TransferFunction"],[305,"Software"],[306,"ModifyDate"],[315,"Artist"],[316,"HostComputer"],[317,"Predictor"],[318,"WhitePoint"],[319,"PrimaryChromaticities"],[513,"ThumbnailOffset"],[514,"ThumbnailLength"],[529,"YCbCrCoefficients"],[530,"YCbCrSubSampling"],[531,"YCbCrPositioning"],[532,"ReferenceBlackWhite"],[700,"ApplicationNotes"],[33432,"Copyright"],[33723,"IPTC"],[34665,"ExifIFD"],[34675,"ICC"],[34853,"GpsIFD"],[330,"SubIFD"],[40965,"InteropIFD"],[40091,"XPTitle"],[40092,"XPComment"],[40093,"XPAuthor"],[40094,"XPKeywords"],[40095,"XPSubject"]]),C(L,"exif",[[33434,"ExposureTime"],[33437,"FNumber"],[34850,"ExposureProgram"],[34852,"SpectralSensitivity"],[34855,"ISO"],[34858,"TimeZoneOffset"],[34859,"SelfTimerMode"],[34864,"SensitivityType"],[34865,"StandardOutputSensitivity"],[34866,"RecommendedExposureIndex"],[34867,"ISOSpeed"],[34868,"ISOSpeedLatitudeyyy"],[34869,"ISOSpeedLatitudezzz"],[36864,"ExifVersion"],[36867,"DateTimeOriginal"],[36868,"CreateDate"],[36873,"GooglePlusUploadCode"],[36880,"OffsetTime"],[36881,"OffsetTimeOriginal"],[36882,"OffsetTimeDigitized"],[37121,"ComponentsConfiguration"],[37122,"CompressedBitsPerPixel"],[37377,"ShutterSpeedValue"],[37378,"ApertureValue"],[37379,"BrightnessValue"],[37380,"ExposureCompensation"],[37381,"MaxApertureValue"],[37382,"SubjectDistance"],[37383,"MeteringMode"],[37384,"LightSource"],[37385,"Flash"],[37386,"FocalLength"],[37393,"ImageNumber"],[37394,"SecurityClassification"],[37395,"ImageHistory"],[37396,"SubjectArea"],[37500,"MakerNote"],[37510,"UserComment"],[37520,"SubSecTime"],[37521,"SubSecTimeOriginal"],[37522,"SubSecTimeDigitized"],[37888,"AmbientTemperature"],[37889,"Humidity"],[37890,"Pressure"],[37891,"WaterDepth"],[37892,"Acceleration"],[37893,"CameraElevationAngle"],[40960,"FlashpixVersion"],[40961,"ColorSpace"],[40962,"ExifImageWidth"],[40963,"ExifImageHeight"],[40964,"RelatedSoundFile"],[41483,"FlashEnergy"],[41486,"FocalPlaneXResolution"],[41487,"FocalPlaneYResolution"],[41488,"FocalPlaneResolutionUnit"],[41492,"SubjectLocation"],[41493,"ExposureIndex"],[41495,"SensingMethod"],[41728,"FileSource"],[41729,"SceneType"],[41730,"CFAPattern"],[41985,"CustomRendered"],[41986,"ExposureMode"],[41987,"WhiteBalance"],[41988,"DigitalZoomRatio"],[41989,"FocalLengthIn35mmFormat"],[41990,"SceneCaptureType"],[41991,"GainControl"],[41992,"Contrast"],[41993,"Saturation"],[41994,"Sharpness"],[41996,"SubjectDistanceRange"],[42016,"ImageUniqueID"],[42032,"OwnerName"],[42033,"SerialNumber"],[42034,"LensInfo"],[42035,"LensMake"],[42036,"LensModel"],[42037,"LensSerialNumber"],[42080,"CompositeImage"],[42081,"CompositeImageCount"],[42082,"CompositeImageExposureTimes"],[42240,"Gamma"],[59932,"Padding"],[59933,"OffsetSchema"],[65e3,"OwnerName"],[65001,"SerialNumber"],[65002,"Lens"],[65100,"RawFile"],[65101,"Converter"],[65102,"WhiteBalance"],[65105,"Exposure"],[65106,"Shadows"],[65107,"Brightness"],[65108,"Contrast"],[65109,"Saturation"],[65110,"Sharpness"],[65111,"Smoothness"],[65112,"MoireFilter"],[40965,"InteropIFD"]]),C(L,"gps",[[0,"GPSVersionID"],[1,"GPSLatitudeRef"],[2,"GPSLatitude"],[3,"GPSLongitudeRef"],[4,"GPSLongitude"],[5,"GPSAltitudeRef"],[6,"GPSAltitude"],[7,"GPSTimeStamp"],[8,"GPSSatellites"],[9,"GPSStatus"],[10,"GPSMeasureMode"],[11,"GPSDOP"],[12,"GPSSpeedRef"],[13,"GPSSpeed"],[14,"GPSTrackRef"],[15,"GPSTrack"],[16,"GPSImgDirectionRef"],[17,"GPSImgDirection"],[18,"GPSMapDatum"],[19,"GPSDestLatitudeRef"],[20,"GPSDestLatitude"],[21,"GPSDestLongitudeRef"],[22,"GPSDestLongitude"],[23,"GPSDestBearingRef"],[24,"GPSDestBearing"],[25,"GPSDestDistanceRef"],[26,"GPSDestDistance"],[27,"GPSProcessingMethod"],[28,"GPSAreaInformation"],[29,"GPSDateStamp"],[30,"GPSDifferential"],[31,"GPSHPositioningError"]]),C(V,["ifd0","ifd1"],[[274,{1:"Horizontal (normal)",2:"Mirror horizontal",3:"Rotate 180",4:"Mirror vertical",5:"Mirror horizontal and rotate 270 CW",6:"Rotate 90 CW",7:"Mirror horizontal and rotate 90 CW",8:"Rotate 270 CW"}],[296,{1:"None",2:"inches",3:"cm"}]]);let _e=C(V,"exif",[[34850,{0:"Not defined",1:"Manual",2:"Normal program",3:"Aperture priority",4:"Shutter priority",5:"Creative program",6:"Action program",7:"Portrait mode",8:"Landscape mode"}],[37121,{0:"-",1:"Y",2:"Cb",3:"Cr",4:"R",5:"G",6:"B"}],[37383,{0:"Unknown",1:"Average",2:"CenterWeightedAverage",3:"Spot",4:"MultiSpot",5:"Pattern",6:"Partial",255:"Other"}],[37384,{0:"Unknown",1:"Daylight",2:"Fluorescent",3:"Tungsten (incandescent light)",4:"Flash",9:"Fine weather",10:"Cloudy weather",11:"Shade",12:"Daylight fluorescent (D 5700 - 7100K)",13:"Day white fluorescent (N 4600 - 5400K)",14:"Cool white fluorescent (W 3900 - 4500K)",15:"White fluorescent (WW 3200 - 3700K)",17:"Standard light A",18:"Standard light B",19:"Standard light C",20:"D55",21:"D65",22:"D75",23:"D50",24:"ISO studio tungsten",255:"Other"}],[37385,{0:"Flash did not fire",1:"Flash fired",5:"Strobe return light not detected",7:"Strobe return light detected",9:"Flash fired, compulsory flash mode",13:"Flash fired, compulsory flash mode, return light not detected",15:"Flash fired, compulsory flash mode, return light detected",16:"Flash did not fire, compulsory flash mode",24:"Flash did not fire, auto mode",25:"Flash fired, auto mode",29:"Flash fired, auto mode, return light not detected",31:"Flash fired, auto mode, return light detected",32:"No flash function",65:"Flash fired, red-eye reduction mode",69:"Flash fired, red-eye reduction mode, return light not detected",71:"Flash fired, red-eye reduction mode, return light detected",73:"Flash fired, compulsory flash mode, red-eye reduction mode",77:"Flash fired, compulsory flash mode, red-eye reduction mode, return light not detected",79:"Flash fired, compulsory flash mode, red-eye reduction mode, return light detected",89:"Flash fired, auto mode, red-eye reduction mode",93:"Flash fired, auto mode, return light not detected, red-eye reduction mode",95:"Flash fired, auto mode, return light detected, red-eye reduction mode"}],[41495,{1:"Not defined",2:"One-chip color area sensor",3:"Two-chip color area sensor",4:"Three-chip color area sensor",5:"Color sequential area sensor",7:"Trilinear sensor",8:"Color sequential linear sensor"}],[41728,{1:"Film Scanner",2:"Reflection Print Scanner",3:"Digital Camera"}],[41729,{1:"Directly photographed"}],[41985,{0:"Normal",1:"Custom",2:"HDR (no original saved)",3:"HDR (original saved)",4:"Original (for HDR)",6:"Panorama",7:"Portrait HDR",8:"Portrait"}],[41986,{0:"Auto",1:"Manual",2:"Auto bracket"}],[41987,{0:"Auto",1:"Manual"}],[41990,{0:"Standard",1:"Landscape",2:"Portrait",3:"Night",4:"Other"}],[41991,{0:"None",1:"Low gain up",2:"High gain up",3:"Low gain down",4:"High gain down"}],[41996,{0:"Unknown",1:"Macro",2:"Close",3:"Distant"}],[42080,{0:"Unknown",1:"Not a Composite Image",2:"General Composite Image",3:"Composite Image Captured While Shooting"}]]);const bt={1:"No absolute unit of measurement",2:"Inch",3:"Centimeter"};_e.set(37392,bt),_e.set(41488,bt);const je={0:"Normal",1:"Low",2:"High"};function wt(r){return typeof r=="object"&&r.length!==void 0?r[0]:r}function xt(r){let e=Array.from(r).slice(1);return e[1]>15&&(e=e.map(t=>String.fromCharCode(t))),e[2]!=="0"&&e[2]!==0||e.pop(),e.join(".")}function We(r){if(typeof r=="string"){var[e,t,n,i,s,a]=r.trim().split(/[-: ]/g).map(Number),o=new Date(e,t-1,n);return Number.isNaN(i)||Number.isNaN(s)||Number.isNaN(a)||(o.setHours(i),o.setMinutes(s),o.setSeconds(a)),Number.isNaN(+o)?r:o}}function ge(r){if(typeof r=="string")return r;let e=[];if(r[1]===0&&r[r.length-1]===0)for(let t=0;t<r.length;t+=2)e.push(St(r[t+1],r[t]));else for(let t=0;t<r.length;t+=2)e.push(St(r[t],r[t+1]));return ee(String.fromCodePoint(...e))}function St(r,e){return r<<8|e}_e.set(41992,je),_e.set(41993,je),_e.set(41994,je),C($,["ifd0","ifd1"],[[50827,function(r){return typeof r!="string"?Mt(r):r}],[306,We],[40091,ge],[40092,ge],[40093,ge],[40094,ge],[40095,ge]]),C($,"exif",[[40960,xt],[36864,xt],[36867,We],[36868,We],[40962,wt],[40963,wt]]),C($,"gps",[[0,r=>Array.from(r).join(".")],[7,r=>Array.from(r).join(":")]]);class Xe extends z{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1752462448&&e.getString(t+4,20)==="http://ns.adobe.com/"}static headerLength(e,t){return e.getString(t+4,34)==="http://ns.adobe.com/xmp/extension/"?79:33}static findPosition(e,t){let n=super.findPosition(e,t);return n.multiSegment=n.extended=n.headerLength===79,n.multiSegment?(n.chunkCount=e.getUint8(t+72),n.chunkNumber=e.getUint8(t+76),e.getUint8(t+77)!==0&&n.chunkNumber++):(n.chunkCount=1/0,n.chunkNumber=-1),n}static handleMultiSegments(e){return e.map(t=>t.chunk.getString()).join("")}normalizeInput(e){return typeof e=="string"?e:E.from(e).getString()}parse(e=this.chunk){if(!this.localOptions.parse)return e;e=function(s){let a={},o={};for(let d of Wt)a[d]=[],o[d]=0;return s.replace(Mn,(d,u,h)=>{if(u==="<"){let l=++o[h];return a[h].push(l),`${d}#${l}`}return`${d}#${a[h].pop()}`})}(e);let t=he.findAll(e,"rdf","Description");t.length===0&&t.push(new he("rdf","Description",void 0,e));let n,i={};for(let s of t)for(let a of s.properties)n=Dn(a.ns,i),Gt(a,n);return function(s){let a;for(let o in s)a=s[o]=Te(s[o]),a===void 0&&delete s[o];return Te(s)}(i)}assignToOutput(e,t){if(this.localOptions.parse)for(let[n,i]of Object.entries(t))switch(n){case"tiff":this.assignObjectToOutput(e,"ifd0",i);break;case"exif":this.assignObjectToOutput(e,"exif",i);break;case"xmlns":break;default:this.assignObjectToOutput(e,n,i)}else e.xmp=t}}g(Xe,"type","xmp"),g(Xe,"multiSegment",!0),P.set("xmp",Xe);class Le{static findAll(e){return Ht(e,/([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(Le.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],i=e[3].slice(1,-1);return i=jt(i),new Le(t,n,i)}constructor(e,t,n){this.ns=e,this.name=t,this.value=n}serialize(){return this.value}}class he{static findAll(e,t,n){if(t!==void 0||n!==void 0){t=t||"[\\w\\d-]+",n=n||"[\\w\\d-]+";var i=new RegExp(`<(${t}):(${n})(#\\d+)?((\\s+?[\\w\\d-:]+=("[^"]*"|'[^']*'))*\\s*)(\\/>|>([\\s\\S]*?)<\\/\\1:\\2\\3>)`,"gm")}else i=/<([\w\d-]+):([\w\d-]+)(#\d+)?((\s+?[\w\d-:]+=("[^"]*"|'[^']*'))*\s*)(\/>|>([\s\S]*?)<\/\1:\2\3>)/gm;return Ht(e,i).map(he.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],i=e[4],s=e[8];return new he(t,n,i,s)}constructor(e,t,n,i){this.ns=e,this.name=t,this.attrString=n,this.innerXml=i,this.attrs=Le.findAll(n),this.children=he.findAll(i),this.value=this.children.length===0?jt(i):void 0,this.properties=[...this.attrs,...this.children]}get isPrimitive(){return this.value!==void 0&&this.attrs.length===0&&this.children.length===0}get isListContainer(){return this.children.length===1&&this.children[0].isList}get isList(){let{ns:e,name:t}=this;return e==="rdf"&&(t==="Seq"||t==="Bag"||t==="Alt")}get isListItem(){return this.ns==="rdf"&&this.name==="li"}serialize(){if(this.properties.length===0&&this.value===void 0)return;if(this.isPrimitive)return this.value;if(this.isListContainer)return this.children[0].serialize();if(this.isList)return On(this.children.map(Ln));if(this.isListItem&&this.children.length===1&&this.attrs.length===0)return this.children[0].serialize();let e={};for(let t of this.properties)Gt(t,e);return this.value!==void 0&&(e.value=this.value),Te(e)}}function Gt(r,e){let t=r.serialize();t!==void 0&&(e[r.name]=t)}var Ln=r=>r.serialize(),On=r=>r.length===1?r[0]:r,Dn=(r,e)=>e[r]?e[r]:e[r]={};function Ht(r,e){let t,n=[];if(!r)return n;for(;(t=e.exec(r))!==null;)n.push(t);return n}function jt(r){if(function(n){return n==null||n==="null"||n==="undefined"||n===""||n.trim()===""}(r))return;let e=Number(r);if(!Number.isNaN(e))return e;let t=r.toLowerCase();return t==="true"||t!=="false"&&r.trim()}const Wt=["rdf:li","rdf:Seq","rdf:Bag","rdf:Alt","rdf:Description"],Mn=new RegExp(`(<|\\/)(${Wt.join("|")})`,"g");var Fn=Object.freeze({__proto__:null,default:Tn,Exifr:Q,fileParsers:G,segmentParsers:P,fileReaders:H,tagKeys:L,tagValues:V,tagRevivers:$,createDictionary:C,extendDictionary:se,fetchUrlAsArrayBuffer:ie,readBlobAsArrayBuffer:re,chunkedProps:K,otherSegments:ce,segments:ae,tiffBlocks:v,segmentsAndBlocks:q,tiffExtractables:Y,inheritables:ue,allFormatters:J,Options:oe,parse:Ee,gpsOnlyOptions:it,gps:Et,thumbnailOnlyOptions:rt,thumbnail:Nt,thumbnailUrl:Ut,orientationOnlyOptions:st,orientation:at,rotations:ot,get rotateCanvas(){return te},get rotateCss(){return ne},rotation:Bt});let kt=Ae("fs",r=>r.promises);H.set("fs",class extends Ue{async readWhole(){this.chunked=!1,this.fs=await kt;let r=await this.fs.readFile(this.input);this._swapBuffer(r)}async readChunked(){this.chunked=!0,this.fs=await kt,await this.open(),await this.readChunk(0,this.options.firstChunkSize)}async open(){this.fh===void 0&&(this.fh=await this.fs.open(this.input,"r"),this.size=(await this.fh.stat(this.input)).size)}async _readChunk(r,e){this.fh===void 0&&await this.open(),r+e>this.size&&(e=this.size-r);var t=this.subarray(r,e,!0);return await this.fh.read(t.dataView,0,e,r),t}async close(){if(this.fh){let r=this.fh;this.fh=void 0,await r.close()}}});H.set("base64",class extends Ue{constructor(...r){super(...r),this.input=this.input.replace(/^data:([^;]+);base64,/gim,""),this.size=this.input.length/4*3,this.input.endsWith("==")?this.size-=2:this.input.endsWith("=")&&(this.size-=1)}async _readChunk(r,e){let t,n,i=this.input;r===void 0?(r=0,t=0,n=0):(t=4*Math.floor(r/3),n=r-t/4*3),e===void 0&&(e=this.size);let s=r+e,a=t+4*Math.ceil(s/3);i=i.slice(t,a);let o=Math.min(e,this.size-r);if(Fe){let d=Me.from(i,"base64").slice(n,n+o);return this.set(d,r,!0)}{let d=this.subarray(r,o,!0),u=atob(i),h=d.toUint8();for(let l=0;l<o;l++)h[l]=u.charCodeAt(n+l);return d}}});class vt extends Ne{static canHandle(e,t){return t===18761||t===19789}extendOptions(e){let{ifd0:t,xmp:n,iptc:i,icc:s}=e;n.enabled&&t.deps.add(700),i.enabled&&t.deps.add(33723),s.enabled&&t.deps.add(34675),t.finalizeFilters()}async parse(){let{tiff:e,xmp:t,iptc:n,icc:i}=this.options;if(e.enabled||t.enabled||n.enabled||i.enabled){let s=Math.max(Ye(this.options),this.options.chunkSize);await this.file.ensureChunk(0,s),this.createParser("tiff",this.file),this.parsers.tiff.parseHeader(),await this.parsers.tiff.parseIfd0Block(),this.adaptTiffPropAsSegment("xmp"),this.adaptTiffPropAsSegment("iptc"),this.adaptTiffPropAsSegment("icc")}}adaptTiffPropAsSegment(e){if(this.parsers.tiff[e]){let t=this.parsers.tiff[e];this.injectSegment(e,t)}}}g(vt,"type","tiff"),G.set("tiff",vt);let En=Ae("zlib");const Nn=["ihdr","iccp","text","itxt","exif"];class Ct extends Ne{constructor(...e){super(...e),g(this,"catchError",t=>this.errors.push(t)),g(this,"metaChunks",[]),g(this,"unknownChunks",[])}static canHandle(e,t){return t===35152&&e.getUint32(0)===2303741511&&e.getUint32(4)===218765834}async parse(){let{file:e}=this;await this.findPngChunksInRange(8,e.byteLength),await this.readSegments(this.metaChunks),this.findIhdr(),this.parseTextChunks(),await this.findExif().catch(this.catchError),await this.findXmp().catch(this.catchError),await this.findIcc().catch(this.catchError)}async findPngChunksInRange(e,t){let{file:n}=this;for(;e<t;){let i=n.getUint32(e),s=n.getUint32(e+4),a=n.getString(e+4,4).toLowerCase(),o=i+4+4+4,d={type:a,offset:e,length:o,start:e+4+4,size:i,marker:s};Nn.includes(a)?this.metaChunks.push(d):this.unknownChunks.push(d),e+=o}}parseTextChunks(){let e=this.metaChunks.filter(t=>t.type==="text");for(let t of e){let[n,i]=this.file.getString(t.start,t.size).split("\0");this.injectKeyValToIhdr(n,i)}}injectKeyValToIhdr(e,t){let n=this.parsers.ihdr;n&&n.raw.set(e,t)}findIhdr(){let e=this.metaChunks.find(t=>t.type==="ihdr");e&&this.options.ihdr.enabled!==!1&&this.createParser("ihdr",e.chunk)}async findExif(){let e=this.metaChunks.find(t=>t.type==="exif");e&&this.injectSegment("tiff",e.chunk)}async findXmp(){let e=this.metaChunks.filter(t=>t.type==="itxt");for(let t of e)t.chunk.getString(0,17)==="XML:com.adobe.xmp"&&this.injectSegment("xmp",t.chunk)}async findIcc(){let e=this.metaChunks.find(o=>o.type==="iccp");if(!e)return;let{chunk:t}=e,n=t.getUint8Array(0,81),i=0;for(;i<80&&n[i]!==0;)i++;let s=i+2,a=t.getString(0,i);if(this.injectKeyValToIhdr("ProfileName",a),Ie){let o=await En,d=t.getUint8Array(s);d=o.inflateSync(d),this.injectSegment("icc",d)}}}g(Ct,"type","png"),G.set("png",Ct),C(L,"interop",[[1,"InteropIndex"],[2,"InteropVersion"],[4096,"RelatedImageFileFormat"],[4097,"RelatedImageWidth"],[4098,"RelatedImageHeight"]]),se(L,"ifd0",[[11,"ProcessingSoftware"],[254,"SubfileType"],[255,"OldSubfileType"],[263,"Thresholding"],[264,"CellWidth"],[265,"CellLength"],[266,"FillOrder"],[269,"DocumentName"],[280,"MinSampleValue"],[281,"MaxSampleValue"],[285,"PageName"],[286,"XPosition"],[287,"YPosition"],[290,"GrayResponseUnit"],[297,"PageNumber"],[321,"HalftoneHints"],[322,"TileWidth"],[323,"TileLength"],[332,"InkSet"],[337,"TargetPrinter"],[18246,"Rating"],[18249,"RatingPercent"],[33550,"PixelScale"],[34264,"ModelTransform"],[34377,"PhotoshopSettings"],[50706,"DNGVersion"],[50707,"DNGBackwardVersion"],[50708,"UniqueCameraModel"],[50709,"LocalizedCameraModel"],[50736,"DNGLensInfo"],[50739,"ShadowScale"],[50740,"DNGPrivateData"],[33920,"IntergraphMatrix"],[33922,"ModelTiePoint"],[34118,"SEMInfo"],[34735,"GeoTiffDirectory"],[34736,"GeoTiffDoubleParams"],[34737,"GeoTiffAsciiParams"],[50341,"PrintIM"],[50721,"ColorMatrix1"],[50722,"ColorMatrix2"],[50723,"CameraCalibration1"],[50724,"CameraCalibration2"],[50725,"ReductionMatrix1"],[50726,"ReductionMatrix2"],[50727,"AnalogBalance"],[50728,"AsShotNeutral"],[50729,"AsShotWhiteXY"],[50730,"BaselineExposure"],[50731,"BaselineNoise"],[50732,"BaselineSharpness"],[50734,"LinearResponseLimit"],[50735,"CameraSerialNumber"],[50741,"MakerNoteSafety"],[50778,"CalibrationIlluminant1"],[50779,"CalibrationIlluminant2"],[50781,"RawDataUniqueID"],[50827,"OriginalRawFileName"],[50828,"OriginalRawFileData"],[50831,"AsShotICCProfile"],[50832,"AsShotPreProfileMatrix"],[50833,"CurrentICCProfile"],[50834,"CurrentPreProfileMatrix"],[50879,"ColorimetricReference"],[50885,"SRawType"],[50898,"PanasonicTitle"],[50899,"PanasonicTitle2"],[50931,"CameraCalibrationSig"],[50932,"ProfileCalibrationSig"],[50933,"ProfileIFD"],[50934,"AsShotProfileName"],[50936,"ProfileName"],[50937,"ProfileHueSatMapDims"],[50938,"ProfileHueSatMapData1"],[50939,"ProfileHueSatMapData2"],[50940,"ProfileToneCurve"],[50941,"ProfileEmbedPolicy"],[50942,"ProfileCopyright"],[50964,"ForwardMatrix1"],[50965,"ForwardMatrix2"],[50966,"PreviewApplicationName"],[50967,"PreviewApplicationVersion"],[50968,"PreviewSettingsName"],[50969,"PreviewSettingsDigest"],[50970,"PreviewColorSpace"],[50971,"PreviewDateTime"],[50972,"RawImageDigest"],[50973,"OriginalRawFileDigest"],[50981,"ProfileLookTableDims"],[50982,"ProfileLookTableData"],[51043,"TimeCodes"],[51044,"FrameRate"],[51058,"TStop"],[51081,"ReelName"],[51089,"OriginalDefaultFinalSize"],[51090,"OriginalBestQualitySize"],[51091,"OriginalDefaultCropSize"],[51105,"CameraLabel"],[51107,"ProfileHueSatMapEncoding"],[51108,"ProfileLookTableEncoding"],[51109,"BaselineExposureOffset"],[51110,"DefaultBlackRender"],[51111,"NewRawImageDigest"],[51112,"RawToPreviewGain"]]);let Pt=[[273,"StripOffsets"],[279,"StripByteCounts"],[288,"FreeOffsets"],[289,"FreeByteCounts"],[291,"GrayResponseCurve"],[292,"T4Options"],[293,"T6Options"],[300,"ColorResponseUnit"],[320,"ColorMap"],[324,"TileOffsets"],[325,"TileByteCounts"],[326,"BadFaxLines"],[327,"CleanFaxData"],[328,"ConsecutiveBadFaxLines"],[330,"SubIFD"],[333,"InkNames"],[334,"NumberofInks"],[336,"DotRange"],[338,"ExtraSamples"],[339,"SampleFormat"],[340,"SMinSampleValue"],[341,"SMaxSampleValue"],[342,"TransferRange"],[343,"ClipPath"],[344,"XClipPathUnits"],[345,"YClipPathUnits"],[346,"Indexed"],[347,"JPEGTables"],[351,"OPIProxy"],[400,"GlobalParametersIFD"],[401,"ProfileType"],[402,"FaxProfile"],[403,"CodingMethods"],[404,"VersionYear"],[405,"ModeNumber"],[433,"Decode"],[434,"DefaultImageColor"],[435,"T82Options"],[437,"JPEGTables"],[512,"JPEGProc"],[515,"JPEGRestartInterval"],[517,"JPEGLosslessPredictors"],[518,"JPEGPointTransforms"],[519,"JPEGQTables"],[520,"JPEGDCTables"],[521,"JPEGACTables"],[559,"StripRowCounts"],[999,"USPTOMiscellaneous"],[18247,"XP_DIP_XML"],[18248,"StitchInfo"],[28672,"SonyRawFileType"],[28688,"SonyToneCurve"],[28721,"VignettingCorrection"],[28722,"VignettingCorrParams"],[28724,"ChromaticAberrationCorrection"],[28725,"ChromaticAberrationCorrParams"],[28726,"DistortionCorrection"],[28727,"DistortionCorrParams"],[29895,"SonyCropTopLeft"],[29896,"SonyCropSize"],[32781,"ImageID"],[32931,"WangTag1"],[32932,"WangAnnotation"],[32933,"WangTag3"],[32934,"WangTag4"],[32953,"ImageReferencePoints"],[32954,"RegionXformTackPoint"],[32955,"WarpQuadrilateral"],[32956,"AffineTransformMat"],[32995,"Matteing"],[32996,"DataType"],[32997,"ImageDepth"],[32998,"TileDepth"],[33300,"ImageFullWidth"],[33301,"ImageFullHeight"],[33302,"TextureFormat"],[33303,"WrapModes"],[33304,"FovCot"],[33305,"MatrixWorldToScreen"],[33306,"MatrixWorldToCamera"],[33405,"Model2"],[33421,"CFARepeatPatternDim"],[33422,"CFAPattern2"],[33423,"BatteryLevel"],[33424,"KodakIFD"],[33445,"MDFileTag"],[33446,"MDScalePixel"],[33447,"MDColorTable"],[33448,"MDLabName"],[33449,"MDSampleInfo"],[33450,"MDPrepDate"],[33451,"MDPrepTime"],[33452,"MDFileUnits"],[33589,"AdventScale"],[33590,"AdventRevision"],[33628,"UIC1Tag"],[33629,"UIC2Tag"],[33630,"UIC3Tag"],[33631,"UIC4Tag"],[33918,"IntergraphPacketData"],[33919,"IntergraphFlagRegisters"],[33921,"INGRReserved"],[34016,"Site"],[34017,"ColorSequence"],[34018,"IT8Header"],[34019,"RasterPadding"],[34020,"BitsPerRunLength"],[34021,"BitsPerExtendedRunLength"],[34022,"ColorTable"],[34023,"ImageColorIndicator"],[34024,"BackgroundColorIndicator"],[34025,"ImageColorValue"],[34026,"BackgroundColorValue"],[34027,"PixelIntensityRange"],[34028,"TransparencyIndicator"],[34029,"ColorCharacterization"],[34030,"HCUsage"],[34031,"TrapIndicator"],[34032,"CMYKEquivalent"],[34152,"AFCP_IPTC"],[34232,"PixelMagicJBIGOptions"],[34263,"JPLCartoIFD"],[34306,"WB_GRGBLevels"],[34310,"LeafData"],[34687,"TIFF_FXExtensions"],[34688,"MultiProfiles"],[34689,"SharedData"],[34690,"T88Options"],[34732,"ImageLayer"],[34750,"JBIGOptions"],[34856,"Opto-ElectricConvFactor"],[34857,"Interlace"],[34908,"FaxRecvParams"],[34909,"FaxSubAddress"],[34910,"FaxRecvTime"],[34929,"FedexEDR"],[34954,"LeafSubIFD"],[37387,"FlashEnergy"],[37388,"SpatialFrequencyResponse"],[37389,"Noise"],[37390,"FocalPlaneXResolution"],[37391,"FocalPlaneYResolution"],[37392,"FocalPlaneResolutionUnit"],[37397,"ExposureIndex"],[37398,"TIFF-EPStandardID"],[37399,"SensingMethod"],[37434,"CIP3DataFile"],[37435,"CIP3Sheet"],[37436,"CIP3Side"],[37439,"StoNits"],[37679,"MSDocumentText"],[37680,"MSPropertySetStorage"],[37681,"MSDocumentTextPosition"],[37724,"ImageSourceData"],[40965,"InteropIFD"],[40976,"SamsungRawPointersOffset"],[40977,"SamsungRawPointersLength"],[41217,"SamsungRawByteOrder"],[41218,"SamsungRawUnknown"],[41484,"SpatialFrequencyResponse"],[41485,"Noise"],[41489,"ImageNumber"],[41490,"SecurityClassification"],[41491,"ImageHistory"],[41494,"TIFF-EPStandardID"],[41995,"DeviceSettingDescription"],[42112,"GDALMetadata"],[42113,"GDALNoData"],[44992,"ExpandSoftware"],[44993,"ExpandLens"],[44994,"ExpandFilm"],[44995,"ExpandFilterLens"],[44996,"ExpandScanner"],[44997,"ExpandFlashLamp"],[46275,"HasselbladRawImage"],[48129,"PixelFormat"],[48130,"Transformation"],[48131,"Uncompressed"],[48132,"ImageType"],[48256,"ImageWidth"],[48257,"ImageHeight"],[48258,"WidthResolution"],[48259,"HeightResolution"],[48320,"ImageOffset"],[48321,"ImageByteCount"],[48322,"AlphaOffset"],[48323,"AlphaByteCount"],[48324,"ImageDataDiscard"],[48325,"AlphaDataDiscard"],[50215,"OceScanjobDesc"],[50216,"OceApplicationSelector"],[50217,"OceIDNumber"],[50218,"OceImageLogic"],[50255,"Annotations"],[50459,"HasselbladExif"],[50547,"OriginalFileName"],[50560,"USPTOOriginalContentType"],[50656,"CR2CFAPattern"],[50710,"CFAPlaneColor"],[50711,"CFALayout"],[50712,"LinearizationTable"],[50713,"BlackLevelRepeatDim"],[50714,"BlackLevel"],[50715,"BlackLevelDeltaH"],[50716,"BlackLevelDeltaV"],[50717,"WhiteLevel"],[50718,"DefaultScale"],[50719,"DefaultCropOrigin"],[50720,"DefaultCropSize"],[50733,"BayerGreenSplit"],[50737,"ChromaBlurRadius"],[50738,"AntiAliasStrength"],[50752,"RawImageSegmentation"],[50780,"BestQualityScale"],[50784,"AliasLayerMetadata"],[50829,"ActiveArea"],[50830,"MaskedAreas"],[50935,"NoiseReductionApplied"],[50974,"SubTileBlockSize"],[50975,"RowInterleaveFactor"],[51008,"OpcodeList1"],[51009,"OpcodeList2"],[51022,"OpcodeList3"],[51041,"NoiseProfile"],[51114,"CacheVersion"],[51125,"DefaultUserCrop"],[51157,"NikonNEFInfo"],[65024,"KdcIFD"]];se(L,"ifd0",Pt),se(L,"exif",Pt),C(V,"gps",[[23,{M:"Magnetic North",T:"True North"}],[25,{K:"Kilometers",M:"Miles",N:"Nautical Miles"}]]);class Ke extends z{static canHandle(e,t){return e.getUint8(t+1)===224&&e.getUint32(t+4)===1246120262&&e.getUint8(t+8)===0}parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint16(0)],[2,this.chunk.getUint8(2)],[3,this.chunk.getUint16(3)],[5,this.chunk.getUint16(5)],[7,this.chunk.getUint8(7)],[8,this.chunk.getUint8(8)]])}}g(Ke,"type","jfif"),g(Ke,"headerLength",9),P.set("jfif",Ke),C(L,"jfif",[[0,"JFIFVersion"],[2,"ResolutionUnit"],[3,"XResolution"],[5,"YResolution"],[7,"ThumbnailWidth"],[8,"ThumbnailHeight"]]);class It extends z{parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint32(0)],[4,this.chunk.getUint32(4)],[8,this.chunk.getUint8(8)],[9,this.chunk.getUint8(9)],[10,this.chunk.getUint8(10)],[11,this.chunk.getUint8(11)],[12,this.chunk.getUint8(12)],...Array.from(this.raw)])}}g(It,"type","ihdr"),P.set("ihdr",It),C(L,"ihdr",[[0,"ImageWidth"],[4,"ImageHeight"],[8,"BitDepth"],[9,"ColorType"],[10,"Compression"],[11,"Filter"],[12,"Interlace"]]),C(V,"ihdr",[[9,{0:"Grayscale",2:"RGB",3:"Palette",4:"Grayscale with Alpha",6:"RGB with Alpha",DEFAULT:"Unknown"}],[10,{0:"Deflate/Inflate",DEFAULT:"Unknown"}],[11,{0:"Adaptive",DEFAULT:"Unknown"}],[12,{0:"Noninterlaced",1:"Adam7 Interlace",DEFAULT:"Unknown"}]]);class ve extends z{static canHandle(e,t){return e.getUint8(t+1)===226&&e.getUint32(t+4)===1229144927}static findPosition(e,t){let n=super.findPosition(e,t);return n.chunkNumber=e.getUint8(t+16),n.chunkCount=e.getUint8(t+17),n.multiSegment=n.chunkCount>1,n}static handleMultiSegments(e){return function(t){let n=function(i){let s=i[0].constructor,a=0;for(let u of i)a+=u.length;let o=new s(a),d=0;for(let u of i)o.set(u,d),d+=u.length;return o}(t.map(i=>i.chunk.toUint8()));return new E(n)}(e)}parse(){return this.raw=new Map,this.parseHeader(),this.parseTags(),this.translate(),this.output}parseHeader(){let{raw:e}=this;this.chunk.byteLength<84&&I("ICC header is too short");for(let[t,n]of Object.entries(Un)){t=parseInt(t,10);let i=n(this.chunk,t);i!=="\0\0\0\0"&&e.set(t,i)}}parseTags(){let e,t,n,i,s,{raw:a}=this,o=this.chunk.getUint32(128),d=132,u=this.chunk.byteLength;for(;o--;){if(e=this.chunk.getString(d,4),t=this.chunk.getUint32(d+4),n=this.chunk.getUint32(d+8),i=this.chunk.getString(t,4),t+n>u)return void console.warn("reached the end of the first ICC chunk. Enable options.tiff.multiSegment to read all ICC segments.");s=this.parseTag(i,t,n),s!==void 0&&s!=="\0\0\0\0"&&a.set(e,s),d+=12}}parseTag(e,t,n){switch(e){case"desc":return this.parseDesc(t);case"mluc":return this.parseMluc(t);case"text":return this.parseText(t,n);case"sig ":return this.parseSig(t)}if(!(t+n>this.chunk.byteLength))return this.chunk.getUint8Array(t,n)}parseDesc(e){let t=this.chunk.getUint32(e+8)-1;return ee(this.chunk.getString(e+12,t))}parseText(e,t){return ee(this.chunk.getString(e+8,t-8))}parseSig(e){return ee(this.chunk.getString(e+8,4))}parseMluc(e){let{chunk:t}=this,n=t.getUint32(e+8),i=t.getUint32(e+12),s=e+16,a=[];for(let o=0;o<n;o++){let d=t.getString(s+0,2),u=t.getString(s+2,2),h=t.getUint32(s+4),l=t.getUint32(s+8)+e,p=ee(t.getUnicodeString(l,h));a.push({lang:d,country:u,text:p}),s+=i}return n===1?a[0].text:a}translateValue(e,t){return typeof e=="string"?t[e]||t[e.toLowerCase()]||e:t[e]||e}}g(ve,"type","icc"),g(ve,"multiSegment",!0),g(ve,"headerLength",18);const Un={4:W,8:function(r,e){return[r.getUint8(e),r.getUint8(e+1)>>4,r.getUint8(e+1)%16].map(t=>t.toString(10)).join(".")},12:W,16:W,20:W,24:function(r,e){const t=r.getUint16(e),n=r.getUint16(e+2)-1,i=r.getUint16(e+4),s=r.getUint16(e+6),a=r.getUint16(e+8),o=r.getUint16(e+10);return new Date(Date.UTC(t,n,i,s,a,o))},36:W,40:W,48:W,52:W,64:(r,e)=>r.getUint32(e),80:W};function W(r,e){return ee(r.getString(e,4))}P.set("icc",ve),C(L,"icc",[[4,"ProfileCMMType"],[8,"ProfileVersion"],[12,"ProfileClass"],[16,"ColorSpaceData"],[20,"ProfileConnectionSpace"],[24,"ProfileDateTime"],[36,"ProfileFileSignature"],[40,"PrimaryPlatform"],[44,"CMMFlags"],[48,"DeviceManufacturer"],[52,"DeviceModel"],[56,"DeviceAttributes"],[64,"RenderingIntent"],[68,"ConnectionSpaceIlluminant"],[80,"ProfileCreator"],[84,"ProfileID"],["Header","ProfileHeader"],["MS00","WCSProfiles"],["bTRC","BlueTRC"],["bXYZ","BlueMatrixColumn"],["bfd","UCRBG"],["bkpt","MediaBlackPoint"],["calt","CalibrationDateTime"],["chad","ChromaticAdaptation"],["chrm","Chromaticity"],["ciis","ColorimetricIntentImageState"],["clot","ColorantTableOut"],["clro","ColorantOrder"],["clrt","ColorantTable"],["cprt","ProfileCopyright"],["crdi","CRDInfo"],["desc","ProfileDescription"],["devs","DeviceSettings"],["dmdd","DeviceModelDesc"],["dmnd","DeviceMfgDesc"],["dscm","ProfileDescriptionML"],["fpce","FocalPlaneColorimetryEstimates"],["gTRC","GreenTRC"],["gXYZ","GreenMatrixColumn"],["gamt","Gamut"],["kTRC","GrayTRC"],["lumi","Luminance"],["meas","Measurement"],["meta","Metadata"],["mmod","MakeAndModel"],["ncl2","NamedColor2"],["ncol","NamedColor"],["ndin","NativeDisplayInfo"],["pre0","Preview0"],["pre1","Preview1"],["pre2","Preview2"],["ps2i","PS2RenderingIntent"],["ps2s","PostScript2CSA"],["psd0","PostScript2CRD0"],["psd1","PostScript2CRD1"],["psd2","PostScript2CRD2"],["psd3","PostScript2CRD3"],["pseq","ProfileSequenceDesc"],["psid","ProfileSequenceIdentifier"],["psvm","PS2CRDVMSize"],["rTRC","RedTRC"],["rXYZ","RedMatrixColumn"],["resp","OutputResponse"],["rhoc","ReflectionHardcopyOrigColorimetry"],["rig0","PerceptualRenderingIntentGamut"],["rig2","SaturationRenderingIntentGamut"],["rpoc","ReflectionPrintOutputColorimetry"],["sape","SceneAppearanceEstimates"],["scoe","SceneColorimetryEstimates"],["scrd","ScreeningDesc"],["scrn","Screening"],["targ","CharTarget"],["tech","Technology"],["vcgt","VideoCardGamma"],["view","ViewingConditions"],["vued","ViewingCondDesc"],["wtpt","MediaWhitePoint"]]);const Se={"4d2p":"Erdt Systems",AAMA:"Aamazing Technologies",ACER:"Acer",ACLT:"Acolyte Color Research",ACTI:"Actix Sytems",ADAR:"Adara Technology",ADBE:"Adobe",ADI:"ADI Systems",AGFA:"Agfa Graphics",ALMD:"Alps Electric",ALPS:"Alps Electric",ALWN:"Alwan Color Expertise",AMTI:"Amiable Technologies",AOC:"AOC International",APAG:"Apago",APPL:"Apple Computer",AST:"AST","AT&T":"AT&T",BAEL:"BARBIERI electronic",BRCO:"Barco NV",BRKP:"Breakpoint",BROT:"Brother",BULL:"Bull",BUS:"Bus Computer Systems","C-IT":"C-Itoh",CAMR:"Intel",CANO:"Canon",CARR:"Carroll Touch",CASI:"Casio",CBUS:"Colorbus PL",CEL:"Crossfield",CELx:"Crossfield",CGS:"CGS Publishing Technologies International",CHM:"Rochester Robotics",CIGL:"Colour Imaging Group, London",CITI:"Citizen",CL00:"Candela",CLIQ:"Color IQ",CMCO:"Chromaco",CMiX:"CHROMiX",COLO:"Colorgraphic Communications",COMP:"Compaq",COMp:"Compeq/Focus Technology",CONR:"Conrac Display Products",CORD:"Cordata Technologies",CPQ:"Compaq",CPRO:"ColorPro",CRN:"Cornerstone",CTX:"CTX International",CVIS:"ColorVision",CWC:"Fujitsu Laboratories",DARI:"Darius Technology",DATA:"Dataproducts",DCP:"Dry Creek Photo",DCRC:"Digital Contents Resource Center, Chung-Ang University",DELL:"Dell Computer",DIC:"Dainippon Ink and Chemicals",DICO:"Diconix",DIGI:"Digital","DL&C":"Digital Light & Color",DPLG:"Doppelganger",DS:"Dainippon Screen",DSOL:"DOOSOL",DUPN:"DuPont",EPSO:"Epson",ESKO:"Esko-Graphics",ETRI:"Electronics and Telecommunications Research Institute",EVER:"Everex Systems",EXAC:"ExactCODE",Eizo:"Eizo",FALC:"Falco Data Products",FF:"Fuji Photo Film",FFEI:"FujiFilm Electronic Imaging",FNRD:"Fnord Software",FORA:"Fora",FORE:"Forefront Technology",FP:"Fujitsu",FPA:"WayTech Development",FUJI:"Fujitsu",FX:"Fuji Xerox",GCC:"GCC Technologies",GGSL:"Global Graphics Software",GMB:"Gretagmacbeth",GMG:"GMG",GOLD:"GoldStar Technology",GOOG:"Google",GPRT:"Giantprint",GTMB:"Gretagmacbeth",GVC:"WayTech Development",GW2K:"Sony",HCI:"HCI",HDM:"Heidelberger Druckmaschinen",HERM:"Hermes",HITA:"Hitachi America",HP:"Hewlett-Packard",HTC:"Hitachi",HiTi:"HiTi Digital",IBM:"IBM",IDNT:"Scitex",IEC:"Hewlett-Packard",IIYA:"Iiyama North America",IKEG:"Ikegami Electronics",IMAG:"Image Systems",IMI:"Ingram Micro",INTC:"Intel",INTL:"N/A (INTL)",INTR:"Intra Electronics",IOCO:"Iocomm International Technology",IPS:"InfoPrint Solutions Company",IRIS:"Scitex",ISL:"Ichikawa Soft Laboratory",ITNL:"N/A (ITNL)",IVM:"IVM",IWAT:"Iwatsu Electric",Idnt:"Scitex",Inca:"Inca Digital Printers",Iris:"Scitex",JPEG:"Joint Photographic Experts Group",JSFT:"Jetsoft Development",JVC:"JVC Information Products",KART:"Scitex",KFC:"KFC Computek Components",KLH:"KLH Computers",KMHD:"Konica Minolta",KNCA:"Konica",KODA:"Kodak",KYOC:"Kyocera",Kart:"Scitex",LCAG:"Leica",LCCD:"Leeds Colour",LDAK:"Left Dakota",LEAD:"Leading Technology",LEXM:"Lexmark International",LINK:"Link Computer",LINO:"Linotronic",LITE:"Lite-On",Leaf:"Leaf",Lino:"Linotronic",MAGC:"Mag Computronic",MAGI:"MAG Innovision",MANN:"Mannesmann",MICN:"Micron Technology",MICR:"Microtek",MICV:"Microvitec",MINO:"Minolta",MITS:"Mitsubishi Electronics America",MITs:"Mitsuba",MNLT:"Minolta",MODG:"Modgraph",MONI:"Monitronix",MONS:"Monaco Systems",MORS:"Morse Technology",MOTI:"Motive Systems",MSFT:"Microsoft",MUTO:"MUTOH INDUSTRIES",Mits:"Mitsubishi Electric",NANA:"NANAO",NEC:"NEC",NEXP:"NexPress Solutions",NISS:"Nissei Sangyo America",NKON:"Nikon",NONE:"none",OCE:"Oce Technologies",OCEC:"OceColor",OKI:"Oki",OKID:"Okidata",OKIP:"Okidata",OLIV:"Olivetti",OLYM:"Olympus",ONYX:"Onyx Graphics",OPTI:"Optiquest",PACK:"Packard Bell",PANA:"Matsushita Electric Industrial",PANT:"Pantone",PBN:"Packard Bell",PFU:"PFU",PHIL:"Philips Consumer Electronics",PNTX:"HOYA",POne:"Phase One A/S",PREM:"Premier Computer Innovations",PRIN:"Princeton Graphic Systems",PRIP:"Princeton Publishing Labs",QLUX:"Hong Kong",QMS:"QMS",QPCD:"QPcard AB",QUAD:"QuadLaser",QUME:"Qume",RADI:"Radius",RDDx:"Integrated Color Solutions",RDG:"Roland DG",REDM:"REDMS Group",RELI:"Relisys",RGMS:"Rolf Gierling Multitools",RICO:"Ricoh",RNLD:"Edmund Ronald",ROYA:"Royal",RPC:"Ricoh Printing Systems",RTL:"Royal Information Electronics",SAMP:"Sampo",SAMS:"Samsung",SANT:"Jaime Santana Pomares",SCIT:"Scitex",SCRN:"Dainippon Screen",SDP:"Scitex",SEC:"Samsung",SEIK:"Seiko Instruments",SEIk:"Seikosha",SGUY:"ScanGuy.com",SHAR:"Sharp Laboratories",SICC:"International Color Consortium",SONY:"Sony",SPCL:"SpectraCal",STAR:"Star",STC:"Sampo Technology",Scit:"Scitex",Sdp:"Scitex",Sony:"Sony",TALO:"Talon Technology",TAND:"Tandy",TATU:"Tatung",TAXA:"TAXAN America",TDS:"Tokyo Denshi Sekei",TECO:"TECO Information Systems",TEGR:"Tegra",TEKT:"Tektronix",TI:"Texas Instruments",TMKR:"TypeMaker",TOSB:"Toshiba",TOSH:"Toshiba",TOTK:"TOTOKU ELECTRIC",TRIU:"Triumph",TSBT:"Toshiba",TTX:"TTX Computer Products",TVM:"TVM Professional Monitor",TW:"TW Casper",ULSX:"Ulead Systems",UNIS:"Unisys",UTZF:"Utz Fehlau & Sohn",VARI:"Varityper",VIEW:"Viewsonic",VISL:"Visual communication",VIVO:"Vivo Mobile Communication",WANG:"Wang",WLBR:"Wilbur Imaging",WTG2:"Ware To Go",WYSE:"WYSE Technology",XERX:"Xerox",XRIT:"X-Rite",ZRAN:"Zoran",Zebr:"Zebra Technologies",appl:"Apple Computer",bICC:"basICColor",berg:"bergdesign",ceyd:"Integrated Color Solutions",clsp:"MacDermid ColorSpan",ds:"Dainippon Screen",dupn:"DuPont",ffei:"FujiFilm Electronic Imaging",flux:"FluxData",iris:"Scitex",kart:"Scitex",lcms:"Little CMS",lino:"Linotronic",none:"none",ob4d:"Erdt Systems",obic:"Medigraph",quby:"Qubyx Sarl",scit:"Scitex",scrn:"Dainippon Screen",sdp:"Scitex",siwi:"SIWI GRAFIKA",yxym:"YxyMaster"},At={scnr:"Scanner",mntr:"Monitor",prtr:"Printer",link:"Device Link",abst:"Abstract",spac:"Color Space Conversion Profile",nmcl:"Named Color",cenc:"ColorEncodingSpace profile",mid:"MultiplexIdentification profile",mlnk:"MultiplexLink profile",mvis:"MultiplexVisualization profile",nkpf:"Nikon Input Device Profile (NON-STANDARD!)"};C(V,"icc",[[4,Se],[12,At],[40,Object.assign({},Se,At)],[48,Se],[80,Se],[64,{0:"Perceptual",1:"Relative Colorimetric",2:"Saturation",3:"Absolute Colorimetric"}],["tech",{amd:"Active Matrix Display",crt:"Cathode Ray Tube Display",kpcd:"Photo CD",pmd:"Passive Matrix Display",dcam:"Digital Camera",dcpj:"Digital Cinema Projector",dmpc:"Digital Motion Picture Camera",dsub:"Dye Sublimation Printer",epho:"Electrophotographic Printer",esta:"Electrostatic Printer",flex:"Flexography",fprn:"Film Writer",fscn:"Film Scanner",grav:"Gravure",ijet:"Ink Jet Printer",imgs:"Photo Image Setter",mpfr:"Motion Picture Film Recorder",mpfs:"Motion Picture Film Scanner",offs:"Offset Lithography",pjtv:"Projection Television",rpho:"Photographic Paper Printer",rscn:"Reflective Scanner",silk:"Silkscreen",twax:"Thermal Wax Printer",vidc:"Video Camera",vidm:"Video Monitor"}]]);class ke extends z{static canHandle(e,t,n){return e.getUint8(t+1)===237&&e.getString(t+4,9)==="Photoshop"&&this.containsIptc8bim(e,t,n)!==void 0}static headerLength(e,t,n){let i,s=this.containsIptc8bim(e,t,n);if(s!==void 0)return i=e.getUint8(t+s+7),i%2!=0&&(i+=1),i===0&&(i=4),s+8+i}static containsIptc8bim(e,t,n){for(let i=0;i<n;i++)if(this.isIptcSegmentHead(e,t+i))return i}static isIptcSegmentHead(e,t){return e.getUint8(t)===56&&e.getUint32(t)===943868237&&e.getUint16(t+4)===1028}parse(){let{raw:e}=this,t=this.chunk.byteLength-1,n=!1;for(let i=0;i<t;i++)if(this.chunk.getUint8(i)===28&&this.chunk.getUint8(i+1)===2){n=!0;let s=this.chunk.getUint16(i+3),a=this.chunk.getUint8(i+2),o=this.chunk.getLatin1String(i+5,s);e.set(a,this.pluralizeValue(e.get(a),o)),i+=4+s}else if(n)break;return this.translate(),this.output}pluralizeValue(e,t){return e!==void 0?e instanceof Array?(e.push(t),e):[e,t]:t}}g(ke,"type","iptc"),g(ke,"translateValues",!1),g(ke,"reviveValues",!1),P.set("iptc",ke),C(L,"iptc",[[0,"ApplicationRecordVersion"],[3,"ObjectTypeReference"],[4,"ObjectAttributeReference"],[5,"ObjectName"],[7,"EditStatus"],[8,"EditorialUpdate"],[10,"Urgency"],[12,"SubjectReference"],[15,"Category"],[20,"SupplementalCategories"],[22,"FixtureIdentifier"],[25,"Keywords"],[26,"ContentLocationCode"],[27,"ContentLocationName"],[30,"ReleaseDate"],[35,"ReleaseTime"],[37,"ExpirationDate"],[38,"ExpirationTime"],[40,"SpecialInstructions"],[42,"ActionAdvised"],[45,"ReferenceService"],[47,"ReferenceDate"],[50,"ReferenceNumber"],[55,"DateCreated"],[60,"TimeCreated"],[62,"DigitalCreationDate"],[63,"DigitalCreationTime"],[65,"OriginatingProgram"],[70,"ProgramVersion"],[75,"ObjectCycle"],[80,"Byline"],[85,"BylineTitle"],[90,"City"],[92,"Sublocation"],[95,"State"],[100,"CountryCode"],[101,"Country"],[103,"OriginalTransmissionReference"],[105,"Headline"],[110,"Credit"],[115,"Source"],[116,"CopyrightNotice"],[118,"Contact"],[120,"Caption"],[121,"LocalCaption"],[122,"Writer"],[125,"RasterizedCaption"],[130,"ImageType"],[131,"ImageOrientation"],[135,"LanguageIdentifier"],[150,"AudioType"],[151,"AudioSamplingRate"],[152,"AudioSamplingResolution"],[153,"AudioDuration"],[154,"AudioOutcue"],[184,"JobID"],[185,"MasterDocumentID"],[186,"ShortDocumentID"],[187,"UniqueDocumentID"],[188,"OwnerID"],[200,"ObjectPreviewFileFormat"],[201,"ObjectPreviewFileVersion"],[202,"ObjectPreviewData"],[221,"Prefs"],[225,"ClassifyState"],[228,"SimilarityIndex"],[230,"DocumentNotes"],[231,"DocumentHistory"],[232,"ExifCameraInfo"],[255,"CatalogSets"]]),C(V,"iptc",[[10,{0:"0 (reserved)",1:"1 (most urgent)",2:"2",3:"3",4:"4",5:"5 (normal urgency)",6:"6",7:"7",8:"8 (least urgent)",9:"9 (user-defined priority)"}],[75,{a:"Morning",b:"Both Morning and Evening",p:"Evening"}],[131,{L:"Landscape",P:"Portrait",S:"Square"}]]);let qe=null;async function Bn(){if(!qe)try{const n=(await import("./joraw-1Lq5hXK7.js")).default;if(typeof n!="function")throw new Error("JoRaw WASM import failed");const i=new URL("/assets/joraw-DraTMNgX.wasm",import.meta.url).href;qe=n({locateFile:(s,a)=>s.endsWith("joraw.wasm")?i:a+s})}catch(t){throw console.error("Failed to load joraw.js:",t),t}const r=await qe,e=r.LibRaw||r.JoRaw;if(!e)throw new Error("JoRaw class not found");return e}const zn=async r=>{var n,i,s,a,o,d,u,h,l;const e=await Bn(),t=new e;try{if(await t.open(r,{}),typeof t.getRawImage!="function")throw new Error("WASM mismatch");const p=t.getRawImage();let c=new Uint16Array(p.data);const f=await t.metadata(!0);let y={...f};try{const _=await Fn.parse(r.buffer);_&&(y={...y,..._})}catch(_){console.warn("exifr parsing failed for RAW buffer",_)}const w=((n=f.idata)==null?void 0:n.filters)||0,b=((i=f.idata)==null?void 0:i.colors)||0,k=w===0&&b===3,O=w===9;let x=[0,0,0,0],S=!1;if(t.getBlackLevels)try{const _=t.getBlackLevels();_.dng_cblack&&_.dng_cblack.length===4&&Array.from(_.dng_cblack).some(A=>A>0)?(x=Array.from(_.dng_cblack).map(Number),S=!0):_.cblack&&_.cblack.length===4&&Array.from(_.cblack).some(A=>A>0)?(x=Array.from(_.cblack).map(Number),S=!0):typeof _.black=="number"&&_.black>0&&(x=[_.black,_.black,_.black,_.black],S=!0)}catch(_){console.warn("getBlackLevels binding failed",_)}if(!S){let _=[];if((s=f.color_data)!=null&&s.cblack_rawpy_style)_=f.color_data.cblack_rawpy_style;else if((o=(a=f.color_data)==null?void 0:a.dng_levels)!=null&&o.dng_cblack)_=f.color_data.dng_levels.dng_cblack;else if(((d=f.black_level_per_channel)==null?void 0:d.length)>=4)_=f.black_level_per_channel;else if(((u=f.cblack)==null?void 0:u.length)>=4)_=f.cblack;else if(((l=(h=f.color)==null?void 0:h.cblack)==null?void 0:l.length)>=4)_=f.color.cblack;else{const A=f.black_level||f.color_data&&f.color_data.black||0;_=[A,A,A,A]}x=[Number(_[0])||0,Number(_[1])||0,Number(_[2])||0,Number(_[3])||0]}return{data:c,width:p.width,height:p.height,bayerPattern:f.color_desc||"RGGB",blackLevels:x,whiteLevel:f.white_level||16383,metadata:y,isThreePlane:k,threePlaneTransfer:k?"linear":void 0,isXTrans:O}}finally{t.delete?t.delete():t.close()}};async function Vn(r){if(cn(r)){const n=await pn(r);if(!n)throw new Error("Sony cRAW HQ decoder did not return image data.");return n.rawImageData}const t=new Uint8Array(r);return zn(t)}function Gn(r,e,t,n,i,s=!1,a=!1,o={rows:!1,rowGroup:0,cols:!1,colGroup:0},d=!0,u=1,h=!1){const l=Math.max(0,Math.floor(n.x)),p=Math.max(0,Math.floor(n.y)),c=Math.min(e,Math.ceil(n.x+n.w)),f=Math.min(t,Math.ceil(n.y+n.h)),y=c-l,w=f-p;if(y<=1||w<=1)return null;const b=h&&r.length>=e*t*3;if(b){if(i<0||i>2)return null}else if(i<0||i>3)return null;let k=0,O=0;if(b)k=c-l,O=f-p;else{for(let m=l;m<c;m++)m%2===(i&1)&&k++;for(let m=p;m<f;m++)m%2===i>>1&&O++}if(k<4||O<4)return null;const x=Math.max(1,u),S=Math.floor(2*k/(x+1)),_=Math.floor(2*O/(x+1));if(S<4||_<4)return null;const A=new Pe(S),pe=new Pe(_),F=new Float32Array(Math.floor(S/2)+1),Z=new Float32Array(Math.floor(_/2)+1);let le=0,B=0;const ye=new Float32Array(k),de=new Float32Array(O);for(let m=p;m<f;m++){const N=m%2;if(!b&&i>>1!==N||o.rows&&(b?m&1:m>>1&1)!==o.rowGroup)continue;const X=m*e;let T=0;for(let R=l;R<c;R++){if(!b&&R%2!==(i&1)||T>=k)continue;const j=b?r[(X+R)*3+i]:r[X+R],be=Number.isFinite(j)?j:0;ye[T++]=be}for(let R=0;R<x;R++){const j=Math.floor(R*S/2);if(j+S>k)break;A.calculateSpectrumWindow(ye,j,F,a),le++}if(!d)break}for(let m=l;m<c;m++){const N=m%2;if(!b&&(i&1)!==N||o.cols&&(b?m&1:m>>1&1)!==o.colGroup)continue;let X=0;for(let T=p;T<f;T++){if(!b&&T%2!==i>>1||X>=O)continue;const R=b?r[(T*e+m)*3+i]:r[T*e+m],j=Number.isFinite(R)?R:0;de[X++]=j}for(let T=0;T<x;T++){const R=Math.floor(T*_/2);if(R+_>O)break;pe.calculateSpectrumWindow(de,R,Z,a),B++}if(!d)break}if(le>0)for(let m=0;m<F.length;m++)F[m]/=le;if(B>0)for(let m=0;m<Z.length;m++)Z[m]/=B;return{avgHoriz:Array.from(F),avgVert:Array.from(Z),sampleCount:{h:le,v:B}}}const Tt=192*1024*1024,Oe=new Map;let Ce=0,Rt=Promise.resolve();const Hn=r=>{r.lastAccess=Date.now()},jn=(r=new Set)=>{if(Ce<=Tt)return;const e=Array.from(Oe.entries()).filter(([t])=>!r.has(t)).sort((t,n)=>t[1].lastAccess-n[1].lastAccess);for(const[t,n]of e){if(Ce<=Tt)break;Ce-=n.sizeBytes,Oe.delete(t)}},Wn=r=>{var e;return r.data.byteLength+(((e=r.floatData)==null?void 0:e.byteLength)||0)},Xt=async r=>{const e=Oe.get(r.key);if(e)return Hn(e),e.raw;if(!r.file)throw new Error(`Worker cache miss for ${r.key}`);const t=await r.file.arrayBuffer(),n=await Vn(t),i={raw:n,sizeBytes:Wn(n),lastAccess:Date.now()};return Oe.set(r.key,i),Ce+=i.sizeBytes,jn(new Set([r.key])),n},Xn=async r=>{for(const e of r.files)await Xt(e);self.postMessage({id:r.id,type:"result",success:!0})},Kn=async r=>{const e=new Map;for(const i of r.files){const s=await Xt(i);for(const a of r.channelIndices){const o=Gn(s.data,s.width,s.height,r.roi,a,!1,r.useHanning,r.interlace,r.doAverage,r.nSegments,!!s.isThreePlane);if(!o)continue;let d=e.get(a);if(!d)d={sumH:new Float32Array(o.avgHoriz.length),sumV:new Float32Array(o.avgVert.length),sampleCount:o.sampleCount,contributingFrames:0},e.set(a,d);else if(d.sumH.length!==o.avgHoriz.length||d.sumV.length!==o.avgVert.length)throw new Error("Stack FFT requires matching frame dimensions and channel layout.");for(let u=0;u<o.avgHoriz.length;u++)d.sumH[u]+=o.avgHoriz[u];for(let u=0;u<o.avgVert.length;u++)d.sumV[u]+=o.avgVert[u];d.sampleCount=o.sampleCount,d.contributingFrames+=1}self.postMessage({id:r.id,type:"progress",completed:1})}const t=Array.from(e.entries()).map(([i,s])=>({ch:i,sumH:s.sumH,sumV:s.sumV,sampleCount:s.sampleCount,contributingFrames:s.contributingFrames})),n=[];for(const i of t)n.push(i.sumH.buffer,i.sumV.buffer);self.postMessage({id:r.id,type:"result",success:!0,processedFrames:r.files.length,results:t},n)};self.onmessage=r=>{const e=r.data;Rt=Rt.then(async()=>{try{e.type==="preload"?await Xn(e):await Kn(e)}catch(t){self.postMessage({id:e.id,type:"result",success:!1,error:(t==null?void 0:t.message)||"Power spectrum worker failed"})}})};
