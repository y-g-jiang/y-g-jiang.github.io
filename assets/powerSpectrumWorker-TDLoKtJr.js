var wn=Object.defineProperty;var bn=(r,e,t)=>e in r?wn(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var V=(r,e,t)=>bn(r,typeof e!="symbol"?e+"":e,t);class ze{constructor(e){V(this,"size");V(this,"isPowerOfTwo");V(this,"_real");V(this,"_imag");V(this,"_scratch",null);V(this,"_rev",null);V(this,"_m",0);V(this,"_internalFFT",null);V(this,"_chirpReal",null);V(this,"_chirpImag",null);V(this,"_bReal",null);V(this,"_bImag",null);V(this,"_hanning",null);V(this,"_windowSumSq",0);this.size=e,this.isPowerOfTwo=(e&e-1)===0&&e>0,this._real=new Float32Array(e),this._imag=new Float32Array(e),this.isPowerOfTwo?this.initRadix2():this.initBluestein()}initRadix2(){const e=this.size,t=Math.log2(e);this._rev=new Uint32Array(e);for(let n=0;n<e;n++){let i=0,s=n;for(let a=0;a<t;a++)i=i<<1|s&1,s>>>=1;this._rev[n]=i}}initBluestein(){const e=this.size;this._m=Math.pow(2,Math.ceil(Math.log2(2*e-1))),this._internalFFT=new ze(this._m),this._chirpReal=new Float32Array(e),this._chirpImag=new Float32Array(e);for(let i=0;i<e;i++){const s=-Math.PI*(i*i)/e;this._chirpReal[i]=Math.cos(s),this._chirpImag[i]=Math.sin(s)}const t=new Float32Array(this._m),n=new Float32Array(this._m);for(let i=0;i<e;i++)t[i]=this._chirpReal[i],n[i]=-this._chirpImag[i];for(let i=1;i<e;i++)t[this._m-i]=t[i],n[this._m-i]=n[i];this._internalFFT.transform(t,n),this._bReal=new Float32Array(this._internalFFT._real),this._bImag=new Float32Array(this._internalFFT._imag)}initHanning(){if(this._hanning)return;const e=this.size;this._hanning=new Float32Array(e);let t=0;for(let n=0;n<e;n++){const i=.5*(1-Math.cos(2*Math.PI*n/(e-1)));this._hanning[n]=i,t+=i*i}this._windowSumSq=t}transform(e,t){this.isPowerOfTwo?this.transformRadix2(e,t):this.transformBluestein(e,t)}transformRadix2(e,t){const n=this.size,i=this._rev,s=this._real,a=this._imag;if(e===s)for(let o=0;o<n;o++){const l=i[o];if(o<l){const h=s[o],c=a[o];s[o]=s[l],a[o]=a[l],s[l]=h,a[l]=c}}else for(let o=0;o<n;o++){const l=i[o];s[o]=e[l],a[o]=t?t[l]:0}for(let o=2;o<=n;o*=2){const l=o/2,h=-2*Math.PI/o,c=Math.cos(h),d=Math.sin(h);for(let p=0;p<n;p+=o){let u=1,_=0;for(let w=0;w<l;w++){const P=p+w,b=p+w+l,y=u*s[b]-_*a[b],x=u*a[b]+_*s[b],I=s[P],C=a[P];s[P]=I+y,a[P]=C+x,s[b]=I-y,a[b]=C-x;const T=u*c-_*d,U=u*d+_*c;u=T,_=U}}}}transformBluestein(e,t){const n=this.size,i=this._m,s=this._internalFFT,a=s._real,o=s._imag;a.fill(0),o.fill(0);for(let d=0;d<n;d++){const p=e[d],u=t?t[d]:0,_=this._chirpReal[d],w=this._chirpImag[d];a[d]=p*_-u*w,o[d]=p*w+u*_}s.transformRadix2(a,o);for(let d=0;d<i;d++){const p=s._real[d],u=s._imag[d],_=this._bReal[d],w=this._bImag[d];s._real[d]=p*_-u*w,s._imag[d]=p*w+u*_}const l=s._real,h=s._imag;for(let d=0;d<i;d++)h[d]=-h[d];s.transformRadix2(l,h);const c=1/i;for(let d=0;d<n;d++){const p=s._real[d]*c,u=-s._imag[d]*c,_=this._chirpReal[d],w=this._chirpImag[d];this._real[d]=p*_-u*w,this._imag[d]=p*w+u*_}}calculateSpectrum(e,t,n=!1){const i=this.size;let s=0;for(let c=0;c<i;c++)s+=e[c];const a=s/i;this._scratch||(this._scratch=new Float32Array(i));const o=this._scratch;if(n){this.initHanning();const c=this._hanning;for(let d=0;d<i;d++)o[d]=(e[d]-a)*c[d]}else for(let c=0;c<i;c++)o[c]=e[c]-a;this.transform(o);const l=t.length;let h=1/i;n&&this._windowSumSq>0&&(h=1/this._windowSumSq);for(let c=0;c<l;c++){const d=this._real[c],p=this._imag[c];t[c]+=(d*d+p*p)*h}}calculateSpectrumWindow(e,t,n,i=!1){const s=this.size;let a=0;for(let d=0;d<s;d++)a+=e[t+d];const o=a/s;this._scratch||(this._scratch=new Float32Array(s));const l=this._scratch;if(i){this.initHanning();const d=this._hanning;for(let p=0;p<s;p++)l[p]=(e[t+p]-o)*d[p]}else for(let d=0;d<s;d++)l[d]=e[t+d]-o;this.transform(l);const h=n.length;let c=1/s;i&&this._windowSumSq>0&&(c=1/this._windowSumSq);for(let d=0;d<h;d++){const p=this._real[d],u=this._imag[d];n[d]+=(p*p+u*u)*c}}}const xn={"Sony ILCE-7RM5":"0.82 -0.2976 -0.0719 -0.4296 1.2053 0.2532 -0.0429 0.1282 0.5774"};let it=null;async function Sn(r){return it||(it=(async()=>{if(typeof window.loadPyodide!="function")throw new Error("Pyodide missing: window.loadPyodide not found.");const e=await window.loadPyodide();return await e.loadPackage("numpy"),e})()),it}let st=null,It=!1;async function yt(){var t;st||(st=(async()=>{const n=await import("./joraw2-D--5OGIS.js");if(typeof n.default!="function")throw new Error("JoRaw2 WASM import failed");const i=new URL("/assets/joraw2-_rmijLlm.wasm",import.meta.url).href;return n.default({locateFile(s,a){return s.endsWith("joraw2.wasm")?i:a+s}})})());const e=(await st).LibRaw;if(!e)throw new Error("JoRaw2 class not found");if(!It){const n=new e;try{if(typeof n.runtimeInfo!="function")throw new Error("JoRaw2 runtime identity is missing");const i=n.runtimeInfo();if((i==null?void 0:i.wrapper)!=="joraw2"||!String((i==null?void 0:i.librawVersion)||"").startsWith("0.22.2")||!(i!=null&&i.nikonHe)||!(i!=null&&i.nikonHeStar))throw new Error(`Unexpected JoRaw2 runtime: ${JSON.stringify(i)}`);It=!0}finally{(t=n.delete)==null||t.call(n)}}return e}var kn=`#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
`;const Tt=512,Pn=xn["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let at=null;function An(r){if(r.byteLength<8)return null;const e=r.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function Zt(r,e,t){const n=Math.min(r.length,e+t);let i="";for(let s=e;s<n;s++){const a=r[s];if(a===0)break;i+=String.fromCharCode(a)}return i.trim()}function W(r,e,t,n,i){const s=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!s)return[];const a=s*n,o=a<=4?i:r.getUint32(i,e);if(o<0||o+a>r.byteLength)return[];const l=[];for(let h=0;h<n;h++){const c=o+h*s;t===1||t===2||t===7?l.push(r.getUint8(c)):t===3?l.push(r.getUint16(c,e)):t===8?l.push(r.getInt16(c,e)):t===4?l.push(r.getUint32(c,e)):t===9&&l.push(r.getInt32(c,e))}return l}function Rt(r,e,t,n,i,s){if(n!==2||i<=0)return"";const a=i<=4?s:e.getUint32(s,t);return a<0||a>=r.length?"":Zt(r,a,i)}function en(r){const e=new Uint8Array(r),t=new DataView(r),n=An(t);if(n===null||t.getUint16(2,n)!==42)return null;const s=d=>t.getUint16(d,n),a=d=>t.getUint32(d,n),o=[a(4)],l=new Set;let h="",c="";for(;o.length;){const d=o.pop();if(l.has(d)||d<=0||d+2>t.byteLength)continue;l.add(d);const p=s(d);if(d+2+p*12+4>t.byteLength)continue;const u=new Map;for(let I=0;I<p;I++){const C=d+2+I*12,T=s(C),U=s(C+2),$=a(C+4),O=C+8;u.set(T,{type:U,count:$,valueOffset:O})}const _=u.get(271),w=u.get(272);_&&!h&&(h=Rt(e,t,n,_.type,_.count,_.valueOffset)),w&&!c&&(c=Rt(e,t,n,w.type,w.count,w.valueOffset));const P=u.get(330);if(P){const I=W(t,n,P.type,P.count,P.valueOffset);for(const C of I)o.push(C)}const b=u.get(259),y=u.get(262);if(b&&y){const I=W(t,n,b.type,b.count,b.valueOffset)[0],C=W(t,n,y.type,y.count,y.valueOffset)[0];if(I===32766&&C===32803){const T=W(t,n,u.get(256).type,u.get(256).count,u.get(256).valueOffset)[0],U=W(t,n,u.get(257).type,u.get(257).count,u.get(257).valueOffset)[0],$=W(t,n,u.get(258).type,u.get(258).count,u.get(258).valueOffset)[0],O=W(t,n,u.get(273).type,u.get(273).count,u.get(273).valueOffset)[0],E=W(t,n,u.get(279).type,u.get(279).count,u.get(279).valueOffset)[0],N=u.get(33422)?W(t,n,u.get(33422).type,u.get(33422).count,u.get(33422).valueOffset):[0,1,1,2];u.get(29456)&&W(t,n,u.get(29456).type,u.get(29456).count,u.get(29456).valueOffset);const G=u.get(50717)?W(t,n,u.get(50717).type,u.get(50717).count,u.get(50717).valueOffset)[0]:16383,X=u.get(50719)?W(t,n,u.get(50719).type,u.get(50719).count,u.get(50719).valueOffset):[],K=u.get(50720)?W(t,n,u.get(50720).type,u.get(50720).count,u.get(50720).valueOffset):[];if(O+Tt+16>e.length||O+E>e.length)return null;const g=O+Tt,f=Zt(e,g,4),k=e[g+8]<<8|e[g+9],v=e[g+10]<<8|e[g+11],S=e[g+12]<<8|e[g+13],R=e[g+14]<<8|e[g+15],J=S>>4&63,ue=R>>13,te=R>>10&3,Q=v*2,B=E>=4?(e[O]|e[O+1]<<8|e[O+2]<<16|e[O+3]<<24)>>>0:0,et=k===T&&Q===U;let ke=!1;if(B>=1&&B<=16&&E>=8+B*24){const ne=new Map,ie=new Map;let Ae=!0;for(let Ie=0;Ie<B;Ie++){const se=O+8+Ie*24,pe=t.getUint32(se+8,!0),fe=t.getUint32(se+12,!0),rt=t.getUint32(se+16,!0),Fe=t.getUint32(se+20,!0);if(!rt||!Fe||pe+rt>T||fe+Fe>U){Ae=!1;break}const At=ne.get(fe);if(At!==void 0&&At!==Fe){Ae=!1;break}ne.set(fe,Fe),ie.set(fe,(ie.get(fe)||0)+rt)}if(Ae){const Ie=Array.from(ne.keys()).sort((pe,fe)=>pe-fe);let se=0;for(const pe of Ie){if(pe!==se||ie.get(pe)!==T){Ae=!1;break}se+=ne.get(pe)}ke=Ae&&se===U}}const De=B>=1&&B<=16&&k>0&&Q>0&&T%k===0&&U%Q===0&&B===T/k*(U/Q);if(f!=="A000"&&f!=="0000"||!et&&!De&&!ke||J!==16||ue!==3||te!==3)return null;const tt=[1024,1024,1024,1024],nt=N.length>=4?N.slice(0,4).map(ne=>ne===0?"R":ne===2?"B":ne===1?"G":"?").join(""):"";return{width:T,height:U,bitsPerSample:$,compression:I,photometric:C,blackLevel:tt,whiteLevel:Number(G||16383),cfaPattern:nt,defaultCropOrigin:X.length>=2?[Number(X[0]),Number(X[1])]:void 0,defaultCropSize:K.length>=2?[Number(K[0]),Number(K[1])]:void 0,make:h||"SONY",model:c||"ILCE-7M5"}}}const x=a(d+2+p*12);x&&o.push(x)}return null}async function In(r){return at||(at=(async()=>{const e=await Sn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",kn),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",Cn),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",vn),await e.runPythonAsync(`
import sys
...
`),e.__jtrSonyCrawHqDecoderReady=!0),e})()),at}function Tn(r){return en(r)}function Rn(r){return r==="ILCE-7M5"?Pn:null}function tn(r,e,t,n){var l;if(r.length!==e.width*e.height)throw new Error(`Sony cRAW HQ decoded size mismatch: got ${r.length}, expected ${e.width*e.height}`);const i=e.model||"ILCE-7M5",s=i.startsWith("Sony ")?i:`Sony ${i}`,a=Rn(i),o={...n||{},make:e.make||(n==null?void 0:n.camera_make)||"SONY",model:i,camera_make:e.make||(n==null?void 0:n.camera_make)||"SONY",camera_model:i,UniqueCameraModel:s,sourceFormat:t==="joraw2-wasm"?"Sony cRAW HQ / LLVC3 (JoRaw2 WASM)":"Sony cRAW HQ / LLVC3",sonyCrawHq:{...e,decodeBackend:t},color_desc:e.cfaPattern,black_level_per_channel:e.blackLevel,white_level:e.whiteLevel,color_matrix:a&&a.length===9?a:void 0,idata:{filters:2492765332,colors:3},color_data:{...(n==null?void 0:n.color_data)||{},black:1024,cblack_rawpy_style:e.blackLevel,dng_levels:{...((l=n==null?void 0:n.color_data)==null?void 0:l.dng_levels)||{},dng_cblack:e.blackLevel,dng_whitelevel:e.whiteLevel}}};return{data:r,width:e.width,height:e.height,bayerPattern:e.cfaPattern,blackLevels:e.blackLevel,whiteLevel:e.whiteLevel,metadata:o,isThreePlane:!1,isXTrans:!1}}async function Ln(r,e,t){const n=typeof performance<"u"?performance.now():Date.now(),i=await yt(),s=typeof performance<"u"?performance.now():Date.now(),a=new i;try{const o=new Uint8Array(r);await a.open(o,{});const l=typeof performance<"u"?performance.now():Date.now();let h=null;try{h=await a.metadata(!0)}catch(P){console.warn("[Sony cRAW HQ] fast WASM metadata read failed",P)}const c=typeof performance<"u"?performance.now():Date.now(),d=a.getRawImage(),p=typeof performance<"u"?performance.now():Date.now();if(!d||!d.data)throw new Error("Sony cRAW HQ LibRaw WASM returned no raw image");const u=d.data instanceof Uint16Array?d.data:new Uint16Array(d.data.buffer,d.data.byteOffset||0,d.data.byteLength/2),_=typeof performance<"u"?performance.now():Date.now();if(d.width!==e.width||d.height!==e.height)throw new Error(`Sony cRAW HQ LibRaw WASM dimensions mismatch: got ${d.width}x${d.height}, expected ${e.width}x${e.height}`);const w=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] fast decode timings",{width:e.width,height:e.height,backend:"joraw2-wasm",wasmReadyMs:Math.round(s-n),openMs:Math.round(l-s),metadataMs:Math.round(c-l),unpackMs:Math.round(p-c),copyMs:Math.round(_-p),totalMs:Math.round(w-n)}),{rawImageData:tn(u,e,"joraw2-wasm",h),info:e}}finally{typeof a.delete=="function"?a.delete():typeof a.close=="function"&&a.close()}}async function On(r,e,t){const n=typeof performance<"u"?performance.now():Date.now(),i=await In(),s=typeof performance<"u"?performance.now():Date.now(),a=new Uint8Array(r),o=await fetch(new URL("/assets/sony_llvc3_static_lut4096_padded_u16-FsVBk-IV.bin",import.meta.url));if(!o.ok)throw new Error(`Failed to load Sony LLVC3 sample LUT: HTTP ${o.status}`);const l=new Uint8Array(await o.arrayBuffer()),h=typeof performance<"u"?performance.now():Date.now();i.globals.set("jtr_sony_arw_bytes",a),i.globals.set("jtr_sony_lut_bytes",l);const c=await i.runPythonAsync("jtr_decode_sony_craw_hq(jtr_sony_arw_bytes.to_py(), jtr_sony_lut_bytes.to_py())"),d=typeof performance<"u"?performance.now():Date.now(),p=c.toJs();typeof c.destroy=="function"&&c.destroy(),i.globals.delete("jtr_sony_arw_bytes"),i.globals.delete("jtr_sony_lut_bytes");const u=new Uint8Array(p.byteLength);u.set(p);const _=new Uint16Array(u.buffer),w=typeof performance<"u"?performance.now():Date.now(),P=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] decode timings",{width:e.width,height:e.height,backend:"pyodide",pyodideReadyMs:Math.round(s-n),lutLoadMs:Math.round(h-s),llvc3DecodeMs:Math.round(d-h),copyMs:Math.round(w-d),totalMs:Math.round(P-n)}),{rawImageData:tn(_,e,"pyodide"),info:e}}async function Dn(r,e){const t=en(r);if(!t)return null;try{return await Ln(r,t,e)}catch(n){return console.warn("[Sony cRAW HQ] fast WASM decode failed; falling back to Pyodide",n),On(r,t)}}async function Fn(r,e){return Dn(r,e)}const Mn=["RGGB","BGGR","GRBG","GBRG"],En=new Set(Mn);function Un(r){if(!r||typeof r!="object"||Array.isArray(r)||ArrayBuffer.isView(r))return r;const e=r;return e.value??e.values??e.description??r}function Me(r){const e=Un(r);let t="";if(typeof e=="string")t=e.toUpperCase().replace(/[^RGB012]/g,"");else if(typeof e=="number")t=String(e);else if(Array.isArray(e)||ArrayBuffer.isView(e))t=Array.from(e).map(String).join("");else return null;return/^[012]{4}$/.test(t)&&(t=t.replace(/0/g,"R").replace(/1/g,"G").replace(/2/g,"B")),En.has(t)?t:null}function Lt(r){var e;return r?[r.cfa_pattern,r.cfaPattern,r.BayerPattern,r.CFAPattern2,r.CFAPattern,(e=r.idata)==null?void 0:e.cfa_pattern]:[]}function Nn(r,e,t){const n=Me(r.bayerPattern),i=r.bayerPatternSource==="manual";if(n&&!i)return{pattern:n,source:r.bayerPatternSource||"decoder"};if(!i)for(const a of Lt(r.metadata)){const o=Me(a);if(o)return{pattern:o,source:"libraw-metadata"}}for(const a of Lt(e)){const o=Me(a);if(o)return{pattern:o,source:"metadata"}}const s=Me(t)||(i?n:null);return s?{pattern:s,source:"manual"}:{pattern:null,source:null}}function Bn(r,e){return r.bayerPattern=e.pattern||"",r.bayerPatternSource=e.source||void 0,e.pattern&&e.source!=="manual"&&(r.metadata={...r.metadata||{},cfa_pattern:e.pattern,cfaPattern:e.pattern}),e}var qe=typeof self<"u"?self:global;const Oe=typeof navigator<"u",Vn=Oe&&typeof HTMLImageElement>"u",Ge=!(typeof global>"u"||typeof process>"u"||!process.versions||!process.versions.node),Ye=qe.Buffer,Ee=qe.BigInt,$e=!!Ye,zn=r=>r;function He(r,e=zn){if(Ge)try{return typeof require=="function"?Promise.resolve(e(require(r))):import(r).then(e)}catch{console.warn(`Couldn't load ${r}`)}}let wt=qe.fetch;const Gn=r=>wt=r;if(!qe.fetch){const r=He("http",n=>n),e=He("https",n=>n),t=(n,{headers:i}={})=>new Promise(async(s,a)=>{let{port:o,hostname:l,pathname:h,protocol:c,search:d}=new URL(n);const p={method:"GET",hostname:l,path:encodeURI(h)+d,headers:i};o!==""&&(p.port=Number(o));const u=(c==="https:"?await e:await r).request(p,_=>{if(_.statusCode===301||_.statusCode===302){let w=new URL(_.headers.location,n).toString();return t(w,{headers:i}).then(s).catch(a)}s({status:_.statusCode,arrayBuffer:()=>new Promise(w=>{let P=[];_.on("data",b=>P.push(b)),_.on("end",()=>w(Buffer.concat(P)))})})});u.on("error",a),u.end()});Gn(t)}function m(r,e,t){return e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}const je=r=>nn(r)?void 0:r,Hn=r=>r!==void 0;function nn(r){return r===void 0||(r instanceof Map?r.size===0:Object.values(r).filter(Hn).length===0)}function F(r){let e=new Error(r);throw delete e.stack,e}function ge(r){return(r=function(e){for(;e.endsWith("\0");)e=e.slice(0,-1);return e}(r).trim())===""?void 0:r}function pt(r){let e=function(t){let n=0;return t.ifd0.enabled&&(n+=1024),t.exif.enabled&&(n+=2048),t.makerNote&&(n+=2048),t.userComment&&(n+=1024),t.gps.enabled&&(n+=512),t.interop.enabled&&(n+=100),t.ifd1.enabled&&(n+=1024),n+2048}(r);return r.jfif.enabled&&(e+=50),r.xmp.enabled&&(e+=2e4),r.iptc.enabled&&(e+=14e3),r.icc.enabled&&(e+=6e3),e}const ft=r=>String.fromCharCode.apply(null,r),Ot=typeof TextDecoder<"u"?new TextDecoder("utf-8"):void 0;function rn(r){return Ot?Ot.decode(r):$e?Buffer.from(r).toString("utf8"):decodeURIComponent(escape(ft(r)))}class j{static from(e,t){return e instanceof this&&e.le===t?e:new j(e,void 0,void 0,t)}constructor(e,t=0,n,i){if(typeof i=="boolean"&&(this.le=i),Array.isArray(e)&&(e=new Uint8Array(e)),e===0)this.byteOffset=0,this.byteLength=0;else if(e instanceof ArrayBuffer){n===void 0&&(n=e.byteLength-t);let s=new DataView(e,t,n);this._swapDataView(s)}else if(e instanceof Uint8Array||e instanceof DataView||e instanceof j){n===void 0&&(n=e.byteLength-t),(t+=e.byteOffset)+n>e.byteOffset+e.byteLength&&F("Creating view outside of available memory in ArrayBuffer");let s=new DataView(e.buffer,t,n);this._swapDataView(s)}else if(typeof e=="number"){let s=new DataView(new ArrayBuffer(e));this._swapDataView(s)}else F("Invalid input argument for BufferView: "+e)}_swapArrayBuffer(e){this._swapDataView(new DataView(e))}_swapBuffer(e){this._swapDataView(new DataView(e.buffer,e.byteOffset,e.byteLength))}_swapDataView(e){this.dataView=e,this.buffer=e.buffer,this.byteOffset=e.byteOffset,this.byteLength=e.byteLength}_lengthToEnd(e){return this.byteLength-e}set(e,t,n=j){return e instanceof DataView||e instanceof j?e=new Uint8Array(e.buffer,e.byteOffset,e.byteLength):e instanceof ArrayBuffer&&(e=new Uint8Array(e)),e instanceof Uint8Array||F("BufferView.set(): Invalid data argument."),this.toUint8().set(e,t),new n(this,t,e.byteLength)}subarray(e,t){return t=t||this._lengthToEnd(e),new j(this,e,t)}toUint8(){return new Uint8Array(this.buffer,this.byteOffset,this.byteLength)}getUint8Array(e,t){return new Uint8Array(this.buffer,this.byteOffset+e,t)}getString(e=0,t=this.byteLength){return rn(this.getUint8Array(e,t))}getLatin1String(e=0,t=this.byteLength){let n=this.getUint8Array(e,t);return ft(n)}getUnicodeString(e=0,t=this.byteLength){const n=[];for(let i=0;i<t&&e+i<this.byteLength;i+=2)n.push(this.getUint16(e+i));return ft(n)}getInt8(e){return this.dataView.getInt8(e)}getUint8(e){return this.dataView.getUint8(e)}getInt16(e,t=this.le){return this.dataView.getInt16(e,t)}getInt32(e,t=this.le){return this.dataView.getInt32(e,t)}getUint16(e,t=this.le){return this.dataView.getUint16(e,t)}getUint32(e,t=this.le){return this.dataView.getUint32(e,t)}getFloat32(e,t=this.le){return this.dataView.getFloat32(e,t)}getFloat64(e,t=this.le){return this.dataView.getFloat64(e,t)}getFloat(e,t=this.le){return this.dataView.getFloat32(e,t)}getDouble(e,t=this.le){return this.dataView.getFloat64(e,t)}getUintBytes(e,t,n){switch(t){case 1:return this.getUint8(e,n);case 2:return this.getUint16(e,n);case 4:return this.getUint32(e,n);case 8:return this.getUint64&&this.getUint64(e,n)}}getUint(e,t,n){switch(t){case 8:return this.getUint8(e,n);case 16:return this.getUint16(e,n);case 32:return this.getUint32(e,n);case 64:return this.getUint64&&this.getUint64(e,n)}}toString(e){return this.dataView.toString(e,this.constructor.name)}ensureChunk(){}}function gt(r,e){F(`${r} '${e}' was not loaded, try using full build of exifr.`)}class bt extends Map{constructor(e){super(),this.kind=e}get(e,t){return this.has(e)||gt(this.kind,e),t&&(e in t||function(n,i){F(`Unknown ${n} '${i}'.`)}(this.kind,e),t[e].enabled||gt(this.kind,e)),super.get(e)}keyList(){return Array.from(this.keys())}}var Z=new bt("file parser"),D=new bt("segment parser"),ee=new bt("file reader");function jn(r,e){return typeof r=="string"?Dt(r,e):Oe&&!Vn&&r instanceof HTMLImageElement?Dt(r.src,e):r instanceof Uint8Array||r instanceof ArrayBuffer||r instanceof DataView?new j(r):Oe&&r instanceof Blob?mt(r,e,"blob",we):void F("Invalid input argument")}function Dt(r,e){return(t=r).startsWith("data:")||t.length>1e4?_t(r,e,"base64"):Ge&&r.includes("://")?mt(r,e,"url",ye):Ge?_t(r,e,"fs"):Oe?mt(r,e,"url",ye):void F("Invalid input argument");var t}async function mt(r,e,t,n){return ee.has(t)?_t(r,e,t):n?async function(i,s){let a=await s(i);return new j(a)}(r,n):void F(`Parser ${t} is not loaded`)}async function _t(r,e,t){let n=new(ee.get(t))(r,e);return await n.read(),n}const ye=r=>wt(r).then(e=>e.arrayBuffer()),we=r=>new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result||new ArrayBuffer),n.onerror=t,n.readAsArrayBuffer(r)});class Wn extends Map{get tagKeys(){return this.allKeys||(this.allKeys=Array.from(this.keys())),this.allKeys}get tagValues(){return this.allValues||(this.allValues=Array.from(this.values())),this.allValues}}function L(r,e,t){let n=new Wn;for(let[i,s]of t)n.set(i,s);if(Array.isArray(e))for(let i of e)r.set(i,n);else r.set(e,n);return n}function be(r,e,t){let n,i=r.get(e);for(n of t)i.set(n[0],n[1])}const M=new Map,Y=new Map,ce=new Map,ae=["chunked","firstChunkSize","firstChunkSizeNode","firstChunkSizeBrowser","chunkSize","chunkLimit"],ve=["jfif","xmp","icc","iptc","ihdr"],xe=["tiff",...ve],A=["ifd0","ifd1","exif","gps","interop"],oe=[...xe,...A],le=["makerNote","userComment"],Pe=["translateKeys","translateValues","reviveValues","multiSegment"],de=[...Pe,"sanitize","mergeOutput","silentErrors"];class sn{get translate(){return this.translateKeys||this.translateValues||this.reviveValues}}class Te extends sn{get needed(){return this.enabled||this.deps.size>0}constructor(e,t,n,i){if(super(),m(this,"enabled",!1),m(this,"skip",new Set),m(this,"pick",new Set),m(this,"deps",new Set),m(this,"translateKeys",!1),m(this,"translateValues",!1),m(this,"reviveValues",!1),this.key=e,this.enabled=t,this.parse=this.enabled,this.applyInheritables(i),this.canBeFiltered=A.includes(e),this.canBeFiltered&&(this.dict=M.get(e)),n!==void 0)if(Array.isArray(n))this.parse=this.enabled=!0,this.canBeFiltered&&n.length>0&&this.translateTagSet(n,this.pick);else if(typeof n=="object"){if(this.enabled=!0,this.parse=n.parse!==!1,this.canBeFiltered){let{pick:s,skip:a}=n;s&&s.length>0&&this.translateTagSet(s,this.pick),a&&a.length>0&&this.translateTagSet(a,this.skip)}this.applyInheritables(n)}else n===!0||n===!1?this.parse=this.enabled=n:F(`Invalid options argument: ${n}`)}applyInheritables(e){let t,n;for(t of Pe)n=e[t],n!==void 0&&(this[t]=n)}translateTagSet(e,t){if(this.dict){let n,i,{tagKeys:s,tagValues:a}=this.dict;for(n of e)typeof n=="string"?(i=a.indexOf(n),i===-1&&(i=s.indexOf(Number(n))),i!==-1&&t.add(Number(s[i]))):t.add(n)}else for(let n of e)t.add(n)}finalizeFilters(){!this.enabled&&this.deps.size>0?(this.enabled=!0,We(this.pick,this.deps)):this.enabled&&this.pick.size>0&&We(this.pick,this.deps)}}var z={jfif:!1,tiff:!0,xmp:!1,icc:!1,iptc:!1,ifd0:!0,ifd1:!1,exif:!0,gps:!0,interop:!1,ihdr:void 0,makerNote:!1,userComment:!1,multiSegment:!1,skip:[],pick:[],translateKeys:!0,translateValues:!0,reviveValues:!0,sanitize:!0,mergeOutput:!0,silentErrors:!0,chunked:!0,firstChunkSize:void 0,firstChunkSizeNode:512,firstChunkSizeBrowser:65536,chunkSize:65536,chunkLimit:5},Ft=new Map;class Se extends sn{static useCached(e){let t=Ft.get(e);return t!==void 0||(t=new this(e),Ft.set(e,t)),t}constructor(e){super(),e===!0?this.setupFromTrue():e===void 0?this.setupFromUndefined():Array.isArray(e)?this.setupFromArray(e):typeof e=="object"?this.setupFromObject(e):F(`Invalid options argument ${e}`),this.firstChunkSize===void 0&&(this.firstChunkSize=Oe?this.firstChunkSizeBrowser:this.firstChunkSizeNode),this.mergeOutput&&(this.ifd1.enabled=!1),this.filterNestedSegmentTags(),this.traverseTiffDependencyTree(),this.checkLoadedPlugins()}setupFromUndefined(){let e;for(e of ae)this[e]=z[e];for(e of de)this[e]=z[e];for(e of le)this[e]=z[e];for(e of oe)this[e]=new Te(e,z[e],void 0,this)}setupFromTrue(){let e;for(e of ae)this[e]=z[e];for(e of de)this[e]=z[e];for(e of le)this[e]=!0;for(e of oe)this[e]=new Te(e,!0,void 0,this)}setupFromArray(e){let t;for(t of ae)this[t]=z[t];for(t of de)this[t]=z[t];for(t of le)this[t]=z[t];for(t of oe)this[t]=new Te(t,!1,void 0,this);this.setupGlobalFilters(e,void 0,A)}setupFromObject(e){let t;for(t of(A.ifd0=A.ifd0||A.image,A.ifd1=A.ifd1||A.thumbnail,Object.assign(this,e),ae))this[t]=ot(e[t],z[t]);for(t of de)this[t]=ot(e[t],z[t]);for(t of le)this[t]=ot(e[t],z[t]);for(t of xe)this[t]=new Te(t,z[t],e[t],this);for(t of A)this[t]=new Te(t,z[t],e[t],this.tiff);this.setupGlobalFilters(e.pick,e.skip,A,oe),e.tiff===!0?this.batchEnableWithBool(A,!0):e.tiff===!1?this.batchEnableWithUserValue(A,e):Array.isArray(e.tiff)?this.setupGlobalFilters(e.tiff,void 0,A):typeof e.tiff=="object"&&this.setupGlobalFilters(e.tiff.pick,e.tiff.skip,A)}batchEnableWithBool(e,t){for(let n of e)this[n].enabled=t}batchEnableWithUserValue(e,t){for(let n of e){let i=t[n];this[n].enabled=i!==!1&&i!==void 0}}setupGlobalFilters(e,t,n,i=n){if(e&&e.length){for(let a of i)this[a].enabled=!1;let s=Mt(e,n);for(let[a,o]of s)We(this[a].pick,o),this[a].enabled=!0}else if(t&&t.length){let s=Mt(t,n);for(let[a,o]of s)We(this[a].skip,o)}}filterNestedSegmentTags(){let{ifd0:e,exif:t,xmp:n,iptc:i,icc:s}=this;this.makerNote?t.deps.add(37500):t.skip.add(37500),this.userComment?t.deps.add(37510):t.skip.add(37510),n.enabled||e.skip.add(700),i.enabled||e.skip.add(33723),s.enabled||e.skip.add(34675)}traverseTiffDependencyTree(){let{ifd0:e,exif:t,gps:n,interop:i}=this;i.needed&&(t.deps.add(40965),e.deps.add(40965)),t.needed&&e.deps.add(34665),n.needed&&e.deps.add(34853),this.tiff.enabled=A.some(s=>this[s].enabled===!0)||this.makerNote||this.userComment;for(let s of A)this[s].finalizeFilters()}get onlyTiff(){return!ve.map(e=>this[e].enabled).some(e=>e===!0)&&this.tiff.enabled}checkLoadedPlugins(){for(let e of xe)this[e].enabled&&!D.has(e)&&gt("segment parser",e)}}function Mt(r,e){let t,n,i,s,a=[];for(i of e){for(s of(t=M.get(i),n=[],t))(r.includes(s[0])||r.includes(s[1]))&&n.push(s[0]);n.length&&a.push([i,n])}return a}function ot(r,e){return r!==void 0?r:e!==void 0?e:void 0}function We(r,e){for(let t of e)r.add(t)}m(Se,"default",z);class he{constructor(e){m(this,"parsers",{}),m(this,"output",{}),m(this,"errors",[]),m(this,"pushToErrors",t=>this.errors.push(t)),this.options=Se.useCached(e)}async read(e){this.file=await jn(e,this.options)}setup(){if(this.fileParser)return;let{file:e}=this,t=e.getUint16(0);for(let[n,i]of Z)if(i.canHandle(e,t))return this.fileParser=new i(this.options,this.file,this.parsers),e[n]=!0;this.file.close&&this.file.close(),F("Unknown file format")}async parse(){let{output:e,errors:t}=this;return this.setup(),this.options.silentErrors?(await this.executeParsers().catch(this.pushToErrors),t.push(...this.fileParser.errors)):await this.executeParsers(),this.file.close&&this.file.close(),this.options.silentErrors&&t.length>0&&(e.errors=t),je(e)}async executeParsers(){let{output:e}=this;await this.fileParser.parse();let t=Object.values(this.parsers).map(async n=>{let i=await n.parse();n.assignToOutput(e,i)});this.options.silentErrors&&(t=t.map(n=>n.catch(this.pushToErrors))),await Promise.all(t)}async extractThumbnail(){this.setup();let{options:e,file:t}=this,n=D.get("tiff",e);var i;if(t.tiff?i={start:0,type:"tiff"}:t.jpeg&&(i=await this.fileParser.getOrFindSegment("tiff")),i===void 0)return;let s=await this.fileParser.ensureSegmentChunk(i),a=this.parsers.tiff=new n(s,e,t),o=await a.extractThumbnail();return t.close&&t.close(),o}}async function Je(r,e){let t=new he(e);return await t.read(r),t.parse()}var Xn=Object.freeze({__proto__:null,parse:Je,Exifr:he,fileParsers:Z,segmentParsers:D,fileReaders:ee,tagKeys:M,tagValues:Y,tagRevivers:ce,createDictionary:L,extendDictionary:be,fetchUrlAsArrayBuffer:ye,readBlobAsArrayBuffer:we,chunkedProps:ae,otherSegments:ve,segments:xe,tiffBlocks:A,segmentsAndBlocks:oe,tiffExtractables:le,inheritables:Pe,allFormatters:de,Options:Se});class Qe{constructor(e,t,n){m(this,"errors",[]),m(this,"ensureSegmentChunk",async i=>{let s=i.start,a=i.size||65536;if(this.file.chunked)if(this.file.available(s,a))i.chunk=this.file.subarray(s,a);else try{i.chunk=await this.file.readChunk(s,a)}catch(o){F(`Couldn't read segment: ${JSON.stringify(i)}. ${o.message}`)}else this.file.byteLength>s+a?i.chunk=this.file.subarray(s,a):i.size===void 0?i.chunk=this.file.subarray(s):F("Segment unreachable: "+JSON.stringify(i));return i.chunk}),this.extendOptions&&this.extendOptions(e),this.options=e,this.file=t,this.parsers=n}injectSegment(e,t){this.options[e].enabled&&this.createParser(e,t)}createParser(e,t){let n=new(D.get(e))(t,this.options,this.file);return this.parsers[e]=n}createParsers(e){for(let t of e){let{type:n,chunk:i}=t,s=this.options[n];if(s&&s.enabled){let a=this.parsers[n];a&&a.append||a||this.createParser(n,i)}}}async readSegments(e){let t=e.map(this.ensureSegmentChunk);await Promise.all(t)}}class q{static findPosition(e,t){let n=e.getUint16(t+2)+2,i=typeof this.headerLength=="function"?this.headerLength(e,t,n):this.headerLength,s=t+i,a=n-i;return{offset:t,length:n,headerLength:i,start:s,size:a,end:s+a}}static parse(e,t={}){return new this(e,new Se({[this.type]:t}),e).parse()}normalizeInput(e){return e instanceof j?e:new j(e)}constructor(e,t={},n){m(this,"errors",[]),m(this,"raw",new Map),m(this,"handleError",i=>{if(!this.options.silentErrors)throw i;this.errors.push(i.message)}),this.chunk=this.normalizeInput(e),this.file=n,this.type=this.constructor.type,this.globalOptions=this.options=t,this.localOptions=t[this.type],this.canTranslate=this.localOptions&&this.localOptions.translate}translate(){this.canTranslate&&(this.translated=this.translateBlock(this.raw,this.type))}get output(){return this.translated?this.translated:this.raw?Object.fromEntries(this.raw):void 0}translateBlock(e,t){let n=ce.get(t),i=Y.get(t),s=M.get(t),a=this.options[t],o=a.reviveValues&&!!n,l=a.translateValues&&!!i,h=a.translateKeys&&!!s,c={};for(let[d,p]of e)o&&n.has(d)?p=n.get(d)(p):l&&i.has(d)&&(p=this.translateValue(p,i.get(d))),h&&s.has(d)&&(d=s.get(d)||d),c[d]=p;return c}translateValue(e,t){return t[e]||t.DEFAULT||e}assignToOutput(e,t){this.assignObjectToOutput(e,this.constructor.type,t)}assignObjectToOutput(e,t,n){if(this.globalOptions.mergeOutput)return Object.assign(e,n);e[t]?Object.assign(e[t],n):e[t]=n}}m(q,"headerLength",4),m(q,"type",void 0),m(q,"multiSegment",!1),m(q,"canHandle",()=>!1);function Kn(r){return r===192||r===194||r===196||r===219||r===221||r===218||r===254}function qn(r){return r>=224&&r<=239}function Yn(r,e,t){for(let[n,i]of D)if(i.canHandle(r,e,t))return n}class Et extends Qe{constructor(...e){super(...e),m(this,"appSegments",[]),m(this,"jpegSegments",[]),m(this,"unknownSegments",[])}static canHandle(e,t){return t===65496}async parse(){await this.findAppSegments(),await this.readSegments(this.appSegments),this.mergeMultiSegments(),this.createParsers(this.mergedAppSegments||this.appSegments)}setupSegmentFinderArgs(e){e===!0?(this.findAll=!0,this.wanted=new Set(D.keyList())):(e=e===void 0?D.keyList().filter(t=>this.options[t].enabled):e.filter(t=>this.options[t].enabled&&D.has(t)),this.findAll=!1,this.remaining=new Set(e),this.wanted=new Set(e)),this.unfinishedMultiSegment=!1}async findAppSegments(e=0,t){this.setupSegmentFinderArgs(t);let{file:n,findAll:i,wanted:s,remaining:a}=this;if(!i&&this.file.chunked&&(i=Array.from(s).some(o=>{let l=D.get(o),h=this.options[o];return l.multiSegment&&h.multiSegment}),i&&await this.file.readWhole()),e=this.findAppSegmentsInRange(e,n.byteLength),!this.options.onlyTiff&&n.chunked){let o=!1;for(;a.size>0&&!o&&(n.canReadNextChunk||this.unfinishedMultiSegment);){let{nextChunkOffset:l}=n,h=this.appSegments.some(c=>!this.file.available(c.offset||c.start,c.length||c.size));if(o=e>l&&!h?!await n.readNextChunk(e):!await n.readNextChunk(l),(e=this.findAppSegmentsInRange(e,n.byteLength))===void 0)return}}}findAppSegmentsInRange(e,t){t-=2;let n,i,s,a,o,l,{file:h,findAll:c,wanted:d,remaining:p,options:u}=this;for(;e<t;e++)if(h.getUint8(e)===255){if(n=h.getUint8(e+1),qn(n)){if(i=h.getUint16(e+2),s=Yn(h,e,i),s&&d.has(s)&&(a=D.get(s),o=a.findPosition(h,e),l=u[s],o.type=s,this.appSegments.push(o),!c&&(a.multiSegment&&l.multiSegment?(this.unfinishedMultiSegment=o.chunkNumber<o.chunkCount,this.unfinishedMultiSegment||p.delete(s)):p.delete(s),p.size===0)))break;u.recordUnknownSegments&&(o=q.findPosition(h,e),o.marker=n,this.unknownSegments.push(o)),e+=i+1}else if(Kn(n)){if(i=h.getUint16(e+2),n===218&&u.stopAfterSos!==!1)return;u.recordJpegSegments&&this.jpegSegments.push({offset:e,length:i,marker:n}),e+=i+1}}return e}mergeMultiSegments(){if(!this.appSegments.some(t=>t.multiSegment))return;let e=function(t,n){let i,s,a,o=new Map;for(let l=0;l<t.length;l++)i=t[l],s=i[n],o.has(s)?a=o.get(s):o.set(s,a=[]),a.push(i);return Array.from(o)}(this.appSegments,"type");this.mergedAppSegments=e.map(([t,n])=>{let i=D.get(t,this.options);return i.handleMultiSegments?{type:t,chunk:i.handleMultiSegments(n)}:n[0]})}getSegment(e){return this.appSegments.find(t=>t.type===e)}async getOrFindSegment(e){let t=this.getSegment(e);return t===void 0&&(await this.findAppSegments(0,[e]),t=this.getSegment(e)),t}}m(Et,"type","jpeg"),Z.set("jpeg",Et);const $n=[void 0,1,1,2,4,8,1,1,2,4,8,4,8,4];class Jn extends q{parseHeader(){var e=this.chunk.getUint16();e===18761?this.le=!0:e===19789&&(this.le=!1),this.chunk.le=this.le,this.headerParsed=!0}parseTags(e,t,n=new Map){let{pick:i,skip:s}=this.options[t];i=new Set(i);let a=i.size>0,o=s.size===0,l=this.chunk.getUint16(e);e+=2;for(let h=0;h<l;h++){let c=this.chunk.getUint16(e);if(a){if(i.has(c)&&(n.set(c,this.parseTag(e,c,t)),i.delete(c),i.size===0))break}else!o&&s.has(c)||n.set(c,this.parseTag(e,c,t));e+=12}return n}parseTag(e,t,n){let{chunk:i}=this,s=i.getUint16(e+2),a=i.getUint32(e+4),o=$n[s];if(o*a<=4?e+=8:e=i.getUint32(e+8),(s<1||s>13)&&F(`Invalid TIFF value type. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e}`),e>i.byteLength&&F(`Invalid TIFF value offset. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${i.byteLength}`),s===1)return i.getUint8Array(e,a);if(s===2)return ge(i.getString(e,a));if(s===7)return i.getUint8Array(e,a);if(a===1)return this.parseTagValue(s,e);{let l=new(function(c){switch(c){case 1:return Uint8Array;case 3:return Uint16Array;case 4:return Uint32Array;case 5:return Array;case 6:return Int8Array;case 8:return Int16Array;case 9:return Int32Array;case 10:return Array;case 11:return Float32Array;case 12:return Float64Array;default:return Array}}(s))(a),h=o;for(let c=0;c<a;c++)l[c]=this.parseTagValue(s,e),e+=h;return l}}parseTagValue(e,t){let{chunk:n}=this;switch(e){case 1:return n.getUint8(t);case 3:return n.getUint16(t);case 4:return n.getUint32(t);case 5:return n.getUint32(t)/n.getUint32(t+4);case 6:return n.getInt8(t);case 8:return n.getInt16(t);case 9:return n.getInt32(t);case 10:return n.getInt32(t)/n.getInt32(t+4);case 11:return n.getFloat(t);case 12:return n.getDouble(t);case 13:return n.getUint32(t);default:F(`Invalid tiff type ${e}`)}}}class lt extends Jn{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1165519206&&e.getUint16(t+8)===0}async parse(){this.parseHeader();let{options:e}=this;return e.ifd0.enabled&&await this.parseIfd0Block(),e.exif.enabled&&await this.safeParse("parseExifBlock"),e.gps.enabled&&await this.safeParse("parseGpsBlock"),e.interop.enabled&&await this.safeParse("parseInteropBlock"),e.ifd1.enabled&&await this.safeParse("parseThumbnailBlock"),this.createOutput()}safeParse(e){let t=this[e]();return t.catch!==void 0&&(t=t.catch(this.handleError)),t}findIfd0Offset(){this.ifd0Offset===void 0&&(this.ifd0Offset=this.chunk.getUint32(4))}findIfd1Offset(){if(this.ifd1Offset===void 0){this.findIfd0Offset();let e=this.chunk.getUint16(this.ifd0Offset),t=this.ifd0Offset+2+12*e;this.ifd1Offset=this.chunk.getUint32(t)}}parseBlock(e,t){let n=new Map;return this[t]=n,this.parseTags(e,t,n),n}async parseIfd0Block(){if(this.ifd0)return;let{file:e}=this;this.findIfd0Offset(),this.ifd0Offset<8&&F("Malformed EXIF data"),!e.chunked&&this.ifd0Offset>e.byteLength&&F(`IFD0 offset points to outside of file.
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`),e.tiff&&await e.ensureChunk(this.ifd0Offset,pt(this.options));let t=this.parseBlock(this.ifd0Offset,"ifd0");return t.size!==0?(this.exifOffset=t.get(34665),this.interopOffset=t.get(40965),this.gpsOffset=t.get(34853),this.xmp=t.get(700),this.iptc=t.get(33723),this.icc=t.get(34675),this.options.sanitize&&(t.delete(34665),t.delete(40965),t.delete(34853),t.delete(700),t.delete(33723),t.delete(34675)),t):void 0}async parseExifBlock(){if(this.exif||(this.ifd0||await this.parseIfd0Block(),this.exifOffset===void 0))return;this.file.tiff&&await this.file.ensureChunk(this.exifOffset,pt(this.options));let e=this.parseBlock(this.exifOffset,"exif");return this.interopOffset||(this.interopOffset=e.get(40965)),this.makerNote=e.get(37500),this.userComment=e.get(37510),this.options.sanitize&&(e.delete(40965),e.delete(37500),e.delete(37510)),this.unpack(e,41728),this.unpack(e,41729),e}unpack(e,t){let n=e.get(t);n&&n.length===1&&e.set(t,n[0])}async parseGpsBlock(){if(this.gps||(this.ifd0||await this.parseIfd0Block(),this.gpsOffset===void 0))return;let e=this.parseBlock(this.gpsOffset,"gps");return e&&e.has(2)&&e.has(4)&&(e.set("latitude",Ut(...e.get(2),e.get(1))),e.set("longitude",Ut(...e.get(4),e.get(3)))),e}async parseInteropBlock(){if(!this.interop&&(this.ifd0||await this.parseIfd0Block(),this.interopOffset!==void 0||this.exif||await this.parseExifBlock(),this.interopOffset!==void 0))return this.parseBlock(this.interopOffset,"interop")}async parseThumbnailBlock(e=!1){if(!this.ifd1&&!this.ifd1Parsed&&(!this.options.mergeOutput||e))return this.findIfd1Offset(),this.ifd1Offset>0&&(this.parseBlock(this.ifd1Offset,"ifd1"),this.ifd1Parsed=!0),this.ifd1}async extractThumbnail(){if(this.headerParsed||this.parseHeader(),this.ifd1Parsed||await this.parseThumbnailBlock(!0),this.ifd1===void 0)return;let e=this.ifd1.get(513),t=this.ifd1.get(514);return this.chunk.getUint8Array(e,t)}get image(){return this.ifd0}get thumbnail(){return this.ifd1}createOutput(){let e,t,n,i={};for(t of A)if(e=this[t],!nn(e))if(n=this.canTranslate?this.translateBlock(e,t):Object.fromEntries(e),this.options.mergeOutput){if(t==="ifd1")continue;Object.assign(i,n)}else i[t]=n;return this.makerNote&&(i.makerNote=this.makerNote),this.userComment&&(i.userComment=this.userComment),i}assignToOutput(e,t){if(this.globalOptions.mergeOutput)Object.assign(e,t);else for(let[n,i]of Object.entries(t))this.assignObjectToOutput(e,n,i)}}function Ut(r,e,t,n){var i=r+e/60+t/3600;return n!=="S"&&n!=="W"||(i*=-1),i}m(lt,"type","tiff"),m(lt,"headerLength",10),D.set("tiff",lt);var Qn=Object.freeze({__proto__:null,default:Xn,Exifr:he,fileParsers:Z,segmentParsers:D,fileReaders:ee,tagKeys:M,tagValues:Y,tagRevivers:ce,createDictionary:L,extendDictionary:be,fetchUrlAsArrayBuffer:ye,readBlobAsArrayBuffer:we,chunkedProps:ae,otherSegments:ve,segments:xe,tiffBlocks:A,segmentsAndBlocks:oe,tiffExtractables:le,inheritables:Pe,allFormatters:de,Options:Se,parse:Je});const xt={ifd0:!1,ifd1:!1,exif:!1,gps:!1,interop:!1,sanitize:!1,reviveValues:!0,translateKeys:!1,translateValues:!1,mergeOutput:!1},St=Object.assign({},xt,{firstChunkSize:4e4,gps:[1,2,3,4]});async function an(r){let e=new he(St);await e.read(r);let t=await e.parse();if(t&&t.gps){let{latitude:n,longitude:i}=t.gps;return{latitude:n,longitude:i}}}const kt=Object.assign({},xt,{tiff:!1,ifd1:!0,mergeOutput:!1});async function on(r){let e=new he(kt);await e.read(r);let t=await e.extractThumbnail();return t&&$e?Ye.from(t):t}async function ln(r){let e=await this.thumbnail(r);if(e!==void 0){let t=new Blob([e]);return URL.createObjectURL(t)}}const Ct=Object.assign({},xt,{firstChunkSize:4e4,ifd0:[274]});async function vt(r){let e=new he(Ct);await e.read(r);let t=await e.parse();if(t&&t.ifd0)return t.ifd0[274]}const Pt=Object.freeze({1:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:0,rad:0},2:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:0,rad:0},3:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:180,rad:180*Math.PI/180},4:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:180,rad:180*Math.PI/180},5:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:90,rad:90*Math.PI/180},6:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:90,rad:90*Math.PI/180},7:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:270,rad:270*Math.PI/180},8:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:270,rad:270*Math.PI/180}});let me=!0,_e=!0;if(typeof navigator=="object"){let r=navigator.userAgent;if(r.includes("iPad")||r.includes("iPhone")){let e=r.match(/OS (\d+)_(\d+)/);if(e){let[,t,n]=e;me=Number(t)+.1*Number(n)<13.4,_e=!1}}else if(r.includes("OS X 10")){let[,e]=r.match(/OS X 10[_.](\d+)/);me=_e=Number(e)<15}if(r.includes("Chrome/")){let[,e]=r.match(/Chrome\/(\d+)/);me=_e=Number(e)<81}else if(r.includes("Firefox/")){let[,e]=r.match(/Firefox\/(\d+)/);me=_e=Number(e)<77}}async function dn(r){let e=await vt(r);return Object.assign({canvas:me,css:_e},Pt[e])}class Zn extends j{constructor(...e){super(...e),m(this,"ranges",new er),this.byteLength!==0&&this.ranges.add(0,this.byteLength)}_tryExtend(e,t,n){if(e===0&&this.byteLength===0&&n){let i=new DataView(n.buffer||n,n.byteOffset,n.byteLength);this._swapDataView(i)}else{let i=e+t;if(i>this.byteLength){let{dataView:s}=this._extend(i);this._swapDataView(s)}}}_extend(e){let t;t=$e?Ye.allocUnsafe(e):new Uint8Array(e);let n=new DataView(t.buffer,t.byteOffset,t.byteLength);return t.set(new Uint8Array(this.buffer,this.byteOffset,this.byteLength),0),{uintView:t,dataView:n}}subarray(e,t,n=!1){return t=t||this._lengthToEnd(e),n&&this._tryExtend(e,t),this.ranges.add(e,t),super.subarray(e,t)}set(e,t,n=!1){n&&this._tryExtend(t,e.byteLength,e);let i=super.set(e,t);return this.ranges.add(t,i.byteLength),i}async ensureChunk(e,t){this.chunked&&(this.ranges.available(e,t)||await this.readChunk(e,t))}available(e,t){return this.ranges.available(e,t)}}class er{constructor(){m(this,"list",[])}get length(){return this.list.length}add(e,t,n=0){let i=e+t,s=this.list.filter(a=>Nt(e,a.offset,i)||Nt(e,a.end,i));if(s.length>0){e=Math.min(e,...s.map(o=>o.offset)),i=Math.max(i,...s.map(o=>o.end)),t=i-e;let a=s.shift();a.offset=e,a.length=t,a.end=i,this.list=this.list.filter(o=>!s.includes(o))}else this.list.push({offset:e,length:t,end:i})}available(e,t){let n=e+t;return this.list.some(i=>i.offset<=e&&n<=i.end)}}function Nt(r,e,t){return r<=e&&e<=t}class Ze extends Zn{constructor(e,t){super(0),m(this,"chunksRead",0),this.input=e,this.options=t}async readWhole(){this.chunked=!1,await this.readChunk(this.nextChunkOffset)}async readChunked(){this.chunked=!0,await this.readChunk(0,this.options.firstChunkSize)}async readNextChunk(e=this.nextChunkOffset){if(this.fullyRead)return this.chunksRead++,!1;let t=this.options.chunkSize,n=await this.readChunk(e,t);return!!n&&n.byteLength===t}async readChunk(e,t){if(this.chunksRead++,(t=this.safeWrapAddress(e,t))!==0)return this._readChunk(e,t)}safeWrapAddress(e,t){return this.size!==void 0&&e+t>this.size?Math.max(0,this.size-e):t}get nextChunkOffset(){if(this.ranges.list.length!==0)return this.ranges.list[0].length}get canReadNextChunk(){return this.chunksRead<this.options.chunkLimit}get fullyRead(){return this.size!==void 0&&this.nextChunkOffset===this.size}read(){return this.options.chunked?this.readChunked():this.readWhole()}close(){}}ee.set("blob",class extends Ze{async readWhole(){this.chunked=!1;let r=await we(this.input);this._swapArrayBuffer(r)}readChunked(){return this.chunked=!0,this.size=this.input.size,super.readChunked()}async _readChunk(r,e){let t=e?r+e:void 0,n=this.input.slice(r,t),i=await we(n);return this.set(i,r,!0)}});var tr=Object.freeze({__proto__:null,default:Qn,Exifr:he,fileParsers:Z,segmentParsers:D,fileReaders:ee,tagKeys:M,tagValues:Y,tagRevivers:ce,createDictionary:L,extendDictionary:be,fetchUrlAsArrayBuffer:ye,readBlobAsArrayBuffer:we,chunkedProps:ae,otherSegments:ve,segments:xe,tiffBlocks:A,segmentsAndBlocks:oe,tiffExtractables:le,inheritables:Pe,allFormatters:de,Options:Se,parse:Je,gpsOnlyOptions:St,gps:an,thumbnailOnlyOptions:kt,thumbnail:on,thumbnailUrl:ln,orientationOnlyOptions:Ct,orientation:vt,rotations:Pt,get rotateCanvas(){return me},get rotateCss(){return _e},rotation:dn});ee.set("url",class extends Ze{async readWhole(){this.chunked=!1;let r=await ye(this.input);r instanceof ArrayBuffer?this._swapArrayBuffer(r):r instanceof Uint8Array&&this._swapBuffer(r)}async _readChunk(r,e){let t=e?r+e-1:void 0,n=this.options.httpHeaders||{};(r||t)&&(n.range=`bytes=${[r,t].join("-")}`);let i=await wt(this.input,{headers:n}),s=await i.arrayBuffer(),a=s.byteLength;if(i.status!==416)return a!==e&&(this.size=r+a),this.set(s,r,!0)}});j.prototype.getUint64=function(r){let e=this.getUint32(r),t=this.getUint32(r+4);return e<1048575?e<<32|t:typeof Ee!==void 0?(console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."),Ee(e)<<Ee(32)|Ee(t)):void F("Trying to read 64b value but JS can only handle 53b numbers.")};class nr extends Qe{parseBoxes(e=0){let t=[];for(;e<this.file.byteLength-4;){let n=this.parseBoxHead(e);if(t.push(n),n.length===0)break;e+=n.length}return t}parseSubBoxes(e){e.boxes=this.parseBoxes(e.start)}findBox(e,t){return e.boxes===void 0&&this.parseSubBoxes(e),e.boxes.find(n=>n.kind===t)}parseBoxHead(e){let t=this.file.getUint32(e),n=this.file.getString(e+4,4),i=e+8;return t===1&&(t=this.file.getUint64(e+8),i+=8),{offset:e,length:t,kind:n,start:i}}parseBoxFullHead(e){if(e.version!==void 0)return;let t=this.file.getUint32(e.start);e.version=t>>24,e.start+=4}}class cn extends nr{static canHandle(e,t){if(t!==0)return!1;let n=e.getUint16(2);if(n>50)return!1;let i=16,s=[];for(;i<n;)s.push(e.getString(i,4)),i+=4;return s.includes(this.type)}async parse(){let e=this.file.getUint32(0),t=this.parseBoxHead(e);for(;t.kind!=="meta";)e+=t.length,await this.file.ensureChunk(e,16),t=this.parseBoxHead(e);await this.file.ensureChunk(t.offset,t.length),this.parseBoxFullHead(t),this.parseSubBoxes(t),this.options.icc.enabled&&await this.findIcc(t),this.options.tiff.enabled&&await this.findExif(t)}async registerSegment(e,t,n){await this.file.ensureChunk(t,n);let i=this.file.subarray(t,n);this.createParser(e,i)}async findIcc(e){let t=this.findBox(e,"iprp");if(t===void 0)return;let n=this.findBox(t,"ipco");if(n===void 0)return;let i=this.findBox(n,"colr");i!==void 0&&await this.registerSegment("icc",i.offset+12,i.length)}async findExif(e){let t=this.findBox(e,"iinf");if(t===void 0)return;let n=this.findBox(e,"iloc");if(n===void 0)return;let i=this.findExifLocIdInIinf(t),s=this.findExtentInIloc(n,i);if(s===void 0)return;let[a,o]=s;await this.file.ensureChunk(a,o);let l=4+this.file.getUint32(a);a+=l,o-=l,await this.registerSegment("tiff",a,o)}findExifLocIdInIinf(e){this.parseBoxFullHead(e);let t,n,i,s,a=e.start,o=this.file.getUint16(a);for(a+=2;o--;){if(t=this.parseBoxHead(a),this.parseBoxFullHead(t),n=t.start,t.version>=2&&(i=t.version===3?4:2,s=this.file.getString(n+i+2,4),s==="Exif"))return this.file.getUintBytes(n,i);a+=t.length}}get8bits(e){let t=this.file.getUint8(e);return[t>>4,15&t]}findExtentInIloc(e,t){this.parseBoxFullHead(e);let n=e.start,[i,s]=this.get8bits(n++),[a,o]=this.get8bits(n++),l=e.version===2?4:2,h=e.version===1||e.version===2?2:0,c=o+i+s,d=e.version===2?4:2,p=this.file.getUintBytes(n,d);for(n+=d;p--;){let u=this.file.getUintBytes(n,l);n+=l+h+2+a;let _=this.file.getUint16(n);if(n+=2,u===t)return _>1&&console.warn(`ILOC box has more than one extent but we're only processing one
Please create an issue at https://github.com/MikeKovarik/exifr with this file`),[this.file.getUintBytes(n+o,i),this.file.getUintBytes(n+o+i,s)];n+=_*c}}}class hn extends cn{}m(hn,"type","heic");class Bt extends cn{}m(Bt,"type","avif"),Z.set("heic",hn),Z.set("avif",Bt),L(M,["ifd0","ifd1"],[[256,"ImageWidth"],[257,"ImageHeight"],[258,"BitsPerSample"],[259,"Compression"],[262,"PhotometricInterpretation"],[270,"ImageDescription"],[271,"Make"],[272,"Model"],[273,"StripOffsets"],[274,"Orientation"],[277,"SamplesPerPixel"],[278,"RowsPerStrip"],[279,"StripByteCounts"],[282,"XResolution"],[283,"YResolution"],[284,"PlanarConfiguration"],[296,"ResolutionUnit"],[301,"TransferFunction"],[305,"Software"],[306,"ModifyDate"],[315,"Artist"],[316,"HostComputer"],[317,"Predictor"],[318,"WhitePoint"],[319,"PrimaryChromaticities"],[513,"ThumbnailOffset"],[514,"ThumbnailLength"],[529,"YCbCrCoefficients"],[530,"YCbCrSubSampling"],[531,"YCbCrPositioning"],[532,"ReferenceBlackWhite"],[700,"ApplicationNotes"],[33432,"Copyright"],[33723,"IPTC"],[34665,"ExifIFD"],[34675,"ICC"],[34853,"GpsIFD"],[330,"SubIFD"],[40965,"InteropIFD"],[40091,"XPTitle"],[40092,"XPComment"],[40093,"XPAuthor"],[40094,"XPKeywords"],[40095,"XPSubject"]]),L(M,"exif",[[33434,"ExposureTime"],[33437,"FNumber"],[34850,"ExposureProgram"],[34852,"SpectralSensitivity"],[34855,"ISO"],[34858,"TimeZoneOffset"],[34859,"SelfTimerMode"],[34864,"SensitivityType"],[34865,"StandardOutputSensitivity"],[34866,"RecommendedExposureIndex"],[34867,"ISOSpeed"],[34868,"ISOSpeedLatitudeyyy"],[34869,"ISOSpeedLatitudezzz"],[36864,"ExifVersion"],[36867,"DateTimeOriginal"],[36868,"CreateDate"],[36873,"GooglePlusUploadCode"],[36880,"OffsetTime"],[36881,"OffsetTimeOriginal"],[36882,"OffsetTimeDigitized"],[37121,"ComponentsConfiguration"],[37122,"CompressedBitsPerPixel"],[37377,"ShutterSpeedValue"],[37378,"ApertureValue"],[37379,"BrightnessValue"],[37380,"ExposureCompensation"],[37381,"MaxApertureValue"],[37382,"SubjectDistance"],[37383,"MeteringMode"],[37384,"LightSource"],[37385,"Flash"],[37386,"FocalLength"],[37393,"ImageNumber"],[37394,"SecurityClassification"],[37395,"ImageHistory"],[37396,"SubjectArea"],[37500,"MakerNote"],[37510,"UserComment"],[37520,"SubSecTime"],[37521,"SubSecTimeOriginal"],[37522,"SubSecTimeDigitized"],[37888,"AmbientTemperature"],[37889,"Humidity"],[37890,"Pressure"],[37891,"WaterDepth"],[37892,"Acceleration"],[37893,"CameraElevationAngle"],[40960,"FlashpixVersion"],[40961,"ColorSpace"],[40962,"ExifImageWidth"],[40963,"ExifImageHeight"],[40964,"RelatedSoundFile"],[41483,"FlashEnergy"],[41486,"FocalPlaneXResolution"],[41487,"FocalPlaneYResolution"],[41488,"FocalPlaneResolutionUnit"],[41492,"SubjectLocation"],[41493,"ExposureIndex"],[41495,"SensingMethod"],[41728,"FileSource"],[41729,"SceneType"],[41730,"CFAPattern"],[41985,"CustomRendered"],[41986,"ExposureMode"],[41987,"WhiteBalance"],[41988,"DigitalZoomRatio"],[41989,"FocalLengthIn35mmFormat"],[41990,"SceneCaptureType"],[41991,"GainControl"],[41992,"Contrast"],[41993,"Saturation"],[41994,"Sharpness"],[41996,"SubjectDistanceRange"],[42016,"ImageUniqueID"],[42032,"OwnerName"],[42033,"SerialNumber"],[42034,"LensInfo"],[42035,"LensMake"],[42036,"LensModel"],[42037,"LensSerialNumber"],[42080,"CompositeImage"],[42081,"CompositeImageCount"],[42082,"CompositeImageExposureTimes"],[42240,"Gamma"],[59932,"Padding"],[59933,"OffsetSchema"],[65e3,"OwnerName"],[65001,"SerialNumber"],[65002,"Lens"],[65100,"RawFile"],[65101,"Converter"],[65102,"WhiteBalance"],[65105,"Exposure"],[65106,"Shadows"],[65107,"Brightness"],[65108,"Contrast"],[65109,"Saturation"],[65110,"Sharpness"],[65111,"Smoothness"],[65112,"MoireFilter"],[40965,"InteropIFD"]]),L(M,"gps",[[0,"GPSVersionID"],[1,"GPSLatitudeRef"],[2,"GPSLatitude"],[3,"GPSLongitudeRef"],[4,"GPSLongitude"],[5,"GPSAltitudeRef"],[6,"GPSAltitude"],[7,"GPSTimeStamp"],[8,"GPSSatellites"],[9,"GPSStatus"],[10,"GPSMeasureMode"],[11,"GPSDOP"],[12,"GPSSpeedRef"],[13,"GPSSpeed"],[14,"GPSTrackRef"],[15,"GPSTrack"],[16,"GPSImgDirectionRef"],[17,"GPSImgDirection"],[18,"GPSMapDatum"],[19,"GPSDestLatitudeRef"],[20,"GPSDestLatitude"],[21,"GPSDestLongitudeRef"],[22,"GPSDestLongitude"],[23,"GPSDestBearingRef"],[24,"GPSDestBearing"],[25,"GPSDestDistanceRef"],[26,"GPSDestDistance"],[27,"GPSProcessingMethod"],[28,"GPSAreaInformation"],[29,"GPSDateStamp"],[30,"GPSDifferential"],[31,"GPSHPositioningError"]]),L(Y,["ifd0","ifd1"],[[274,{1:"Horizontal (normal)",2:"Mirror horizontal",3:"Rotate 180",4:"Mirror vertical",5:"Mirror horizontal and rotate 270 CW",6:"Rotate 90 CW",7:"Mirror horizontal and rotate 90 CW",8:"Rotate 270 CW"}],[296,{1:"None",2:"inches",3:"cm"}]]);let Le=L(Y,"exif",[[34850,{0:"Not defined",1:"Manual",2:"Normal program",3:"Aperture priority",4:"Shutter priority",5:"Creative program",6:"Action program",7:"Portrait mode",8:"Landscape mode"}],[37121,{0:"-",1:"Y",2:"Cb",3:"Cr",4:"R",5:"G",6:"B"}],[37383,{0:"Unknown",1:"Average",2:"CenterWeightedAverage",3:"Spot",4:"MultiSpot",5:"Pattern",6:"Partial",255:"Other"}],[37384,{0:"Unknown",1:"Daylight",2:"Fluorescent",3:"Tungsten (incandescent light)",4:"Flash",9:"Fine weather",10:"Cloudy weather",11:"Shade",12:"Daylight fluorescent (D 5700 - 7100K)",13:"Day white fluorescent (N 4600 - 5400K)",14:"Cool white fluorescent (W 3900 - 4500K)",15:"White fluorescent (WW 3200 - 3700K)",17:"Standard light A",18:"Standard light B",19:"Standard light C",20:"D55",21:"D65",22:"D75",23:"D50",24:"ISO studio tungsten",255:"Other"}],[37385,{0:"Flash did not fire",1:"Flash fired",5:"Strobe return light not detected",7:"Strobe return light detected",9:"Flash fired, compulsory flash mode",13:"Flash fired, compulsory flash mode, return light not detected",15:"Flash fired, compulsory flash mode, return light detected",16:"Flash did not fire, compulsory flash mode",24:"Flash did not fire, auto mode",25:"Flash fired, auto mode",29:"Flash fired, auto mode, return light not detected",31:"Flash fired, auto mode, return light detected",32:"No flash function",65:"Flash fired, red-eye reduction mode",69:"Flash fired, red-eye reduction mode, return light not detected",71:"Flash fired, red-eye reduction mode, return light detected",73:"Flash fired, compulsory flash mode, red-eye reduction mode",77:"Flash fired, compulsory flash mode, red-eye reduction mode, return light not detected",79:"Flash fired, compulsory flash mode, red-eye reduction mode, return light detected",89:"Flash fired, auto mode, red-eye reduction mode",93:"Flash fired, auto mode, return light not detected, red-eye reduction mode",95:"Flash fired, auto mode, return light detected, red-eye reduction mode"}],[41495,{1:"Not defined",2:"One-chip color area sensor",3:"Two-chip color area sensor",4:"Three-chip color area sensor",5:"Color sequential area sensor",7:"Trilinear sensor",8:"Color sequential linear sensor"}],[41728,{1:"Film Scanner",2:"Reflection Print Scanner",3:"Digital Camera"}],[41729,{1:"Directly photographed"}],[41985,{0:"Normal",1:"Custom",2:"HDR (no original saved)",3:"HDR (original saved)",4:"Original (for HDR)",6:"Panorama",7:"Portrait HDR",8:"Portrait"}],[41986,{0:"Auto",1:"Manual",2:"Auto bracket"}],[41987,{0:"Auto",1:"Manual"}],[41990,{0:"Standard",1:"Landscape",2:"Portrait",3:"Night",4:"Other"}],[41991,{0:"None",1:"Low gain up",2:"High gain up",3:"Low gain down",4:"High gain down"}],[41996,{0:"Unknown",1:"Macro",2:"Close",3:"Distant"}],[42080,{0:"Unknown",1:"Not a Composite Image",2:"General Composite Image",3:"Composite Image Captured While Shooting"}]]);const Vt={1:"No absolute unit of measurement",2:"Inch",3:"Centimeter"};Le.set(37392,Vt),Le.set(41488,Vt);const dt={0:"Normal",1:"Low",2:"High"};function zt(r){return typeof r=="object"&&r.length!==void 0?r[0]:r}function Gt(r){let e=Array.from(r).slice(1);return e[1]>15&&(e=e.map(t=>String.fromCharCode(t))),e[2]!=="0"&&e[2]!==0||e.pop(),e.join(".")}function ct(r){if(typeof r=="string"){var[e,t,n,i,s,a]=r.trim().split(/[-: ]/g).map(Number),o=new Date(e,t-1,n);return Number.isNaN(i)||Number.isNaN(s)||Number.isNaN(a)||(o.setHours(i),o.setMinutes(s),o.setSeconds(a)),Number.isNaN(+o)?r:o}}function Re(r){if(typeof r=="string")return r;let e=[];if(r[1]===0&&r[r.length-1]===0)for(let t=0;t<r.length;t+=2)e.push(Ht(r[t+1],r[t]));else for(let t=0;t<r.length;t+=2)e.push(Ht(r[t],r[t+1]));return ge(String.fromCodePoint(...e))}function Ht(r,e){return r<<8|e}Le.set(41992,dt),Le.set(41993,dt),Le.set(41994,dt),L(ce,["ifd0","ifd1"],[[50827,function(r){return typeof r!="string"?rn(r):r}],[306,ct],[40091,Re],[40092,Re],[40093,Re],[40094,Re],[40095,Re]]),L(ce,"exif",[[40960,Gt],[36864,Gt],[36867,ct],[36868,ct],[40962,zt],[40963,zt]]),L(ce,"gps",[[0,r=>Array.from(r).join(".")],[7,r=>Array.from(r).join(":")]]);class ht extends q{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1752462448&&e.getString(t+4,20)==="http://ns.adobe.com/"}static headerLength(e,t){return e.getString(t+4,34)==="http://ns.adobe.com/xmp/extension/"?79:33}static findPosition(e,t){let n=super.findPosition(e,t);return n.multiSegment=n.extended=n.headerLength===79,n.multiSegment?(n.chunkCount=e.getUint8(t+72),n.chunkNumber=e.getUint8(t+76),e.getUint8(t+77)!==0&&n.chunkNumber++):(n.chunkCount=1/0,n.chunkNumber=-1),n}static handleMultiSegments(e){return e.map(t=>t.chunk.getString()).join("")}normalizeInput(e){return typeof e=="string"?e:j.from(e).getString()}parse(e=this.chunk){if(!this.localOptions.parse)return e;e=function(s){let a={},o={};for(let l of gn)a[l]=[],o[l]=0;return s.replace(ar,(l,h,c)=>{if(h==="<"){let d=++o[c];return a[c].push(d),`${l}#${d}`}return`${l}#${a[c].pop()}`})}(e);let t=Ce.findAll(e,"rdf","Description");t.length===0&&t.push(new Ce("rdf","Description",void 0,e));let n,i={};for(let s of t)for(let a of s.properties)n=sr(a.ns,i),un(a,n);return function(s){let a;for(let o in s)a=s[o]=je(s[o]),a===void 0&&delete s[o];return je(s)}(i)}assignToOutput(e,t){if(this.localOptions.parse)for(let[n,i]of Object.entries(t))switch(n){case"tiff":this.assignObjectToOutput(e,"ifd0",i);break;case"exif":this.assignObjectToOutput(e,"exif",i);break;case"xmlns":break;default:this.assignObjectToOutput(e,n,i)}else e.xmp=t}}m(ht,"type","xmp"),m(ht,"multiSegment",!0),D.set("xmp",ht);class Xe{static findAll(e){return pn(e,/([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(Xe.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],i=e[3].slice(1,-1);return i=fn(i),new Xe(t,n,i)}constructor(e,t,n){this.ns=e,this.name=t,this.value=n}serialize(){return this.value}}class Ce{static findAll(e,t,n){if(t!==void 0||n!==void 0){t=t||"[\\w\\d-]+",n=n||"[\\w\\d-]+";var i=new RegExp(`<(${t}):(${n})(#\\d+)?((\\s+?[\\w\\d-:]+=("[^"]*"|'[^']*'))*\\s*)(\\/>|>([\\s\\S]*?)<\\/\\1:\\2\\3>)`,"gm")}else i=/<([\w\d-]+):([\w\d-]+)(#\d+)?((\s+?[\w\d-:]+=("[^"]*"|'[^']*'))*\s*)(\/>|>([\s\S]*?)<\/\1:\2\3>)/gm;return pn(e,i).map(Ce.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],i=e[4],s=e[8];return new Ce(t,n,i,s)}constructor(e,t,n,i){this.ns=e,this.name=t,this.attrString=n,this.innerXml=i,this.attrs=Xe.findAll(n),this.children=Ce.findAll(i),this.value=this.children.length===0?fn(i):void 0,this.properties=[...this.attrs,...this.children]}get isPrimitive(){return this.value!==void 0&&this.attrs.length===0&&this.children.length===0}get isListContainer(){return this.children.length===1&&this.children[0].isList}get isList(){let{ns:e,name:t}=this;return e==="rdf"&&(t==="Seq"||t==="Bag"||t==="Alt")}get isListItem(){return this.ns==="rdf"&&this.name==="li"}serialize(){if(this.properties.length===0&&this.value===void 0)return;if(this.isPrimitive)return this.value;if(this.isListContainer)return this.children[0].serialize();if(this.isList)return ir(this.children.map(rr));if(this.isListItem&&this.children.length===1&&this.attrs.length===0)return this.children[0].serialize();let e={};for(let t of this.properties)un(t,e);return this.value!==void 0&&(e.value=this.value),je(e)}}function un(r,e){let t=r.serialize();t!==void 0&&(e[r.name]=t)}var rr=r=>r.serialize(),ir=r=>r.length===1?r[0]:r,sr=(r,e)=>e[r]?e[r]:e[r]={};function pn(r,e){let t,n=[];if(!r)return n;for(;(t=e.exec(r))!==null;)n.push(t);return n}function fn(r){if(function(n){return n==null||n==="null"||n==="undefined"||n===""||n.trim()===""}(r))return;let e=Number(r);if(!Number.isNaN(e))return e;let t=r.toLowerCase();return t==="true"||t!=="false"&&r.trim()}const gn=["rdf:li","rdf:Seq","rdf:Bag","rdf:Alt","rdf:Description"],ar=new RegExp(`(<|\\/)(${gn.join("|")})`,"g");var mn=Object.freeze({__proto__:null,default:tr,Exifr:he,fileParsers:Z,segmentParsers:D,fileReaders:ee,tagKeys:M,tagValues:Y,tagRevivers:ce,createDictionary:L,extendDictionary:be,fetchUrlAsArrayBuffer:ye,readBlobAsArrayBuffer:we,chunkedProps:ae,otherSegments:ve,segments:xe,tiffBlocks:A,segmentsAndBlocks:oe,tiffExtractables:le,inheritables:Pe,allFormatters:de,Options:Se,parse:Je,gpsOnlyOptions:St,gps:an,thumbnailOnlyOptions:kt,thumbnail:on,thumbnailUrl:ln,orientationOnlyOptions:Ct,orientation:vt,rotations:Pt,get rotateCanvas(){return me},get rotateCss(){return _e},rotation:dn});let jt=He("fs",r=>r.promises);ee.set("fs",class extends Ze{async readWhole(){this.chunked=!1,this.fs=await jt;let r=await this.fs.readFile(this.input);this._swapBuffer(r)}async readChunked(){this.chunked=!0,this.fs=await jt,await this.open(),await this.readChunk(0,this.options.firstChunkSize)}async open(){this.fh===void 0&&(this.fh=await this.fs.open(this.input,"r"),this.size=(await this.fh.stat(this.input)).size)}async _readChunk(r,e){this.fh===void 0&&await this.open(),r+e>this.size&&(e=this.size-r);var t=this.subarray(r,e,!0);return await this.fh.read(t.dataView,0,e,r),t}async close(){if(this.fh){let r=this.fh;this.fh=void 0,await r.close()}}});ee.set("base64",class extends Ze{constructor(...r){super(...r),this.input=this.input.replace(/^data:([^;]+);base64,/gim,""),this.size=this.input.length/4*3,this.input.endsWith("==")?this.size-=2:this.input.endsWith("=")&&(this.size-=1)}async _readChunk(r,e){let t,n,i=this.input;r===void 0?(r=0,t=0,n=0):(t=4*Math.floor(r/3),n=r-t/4*3),e===void 0&&(e=this.size);let s=r+e,a=t+4*Math.ceil(s/3);i=i.slice(t,a);let o=Math.min(e,this.size-r);if($e){let l=Ye.from(i,"base64").slice(n,n+o);return this.set(l,r,!0)}{let l=this.subarray(r,o,!0),h=atob(i),c=l.toUint8();for(let d=0;d<o;d++)c[d]=h.charCodeAt(n+d);return l}}});class Wt extends Qe{static canHandle(e,t){return t===18761||t===19789}extendOptions(e){let{ifd0:t,xmp:n,iptc:i,icc:s}=e;n.enabled&&t.deps.add(700),i.enabled&&t.deps.add(33723),s.enabled&&t.deps.add(34675),t.finalizeFilters()}async parse(){let{tiff:e,xmp:t,iptc:n,icc:i}=this.options;if(e.enabled||t.enabled||n.enabled||i.enabled){let s=Math.max(pt(this.options),this.options.chunkSize);await this.file.ensureChunk(0,s),this.createParser("tiff",this.file),this.parsers.tiff.parseHeader(),await this.parsers.tiff.parseIfd0Block(),this.adaptTiffPropAsSegment("xmp"),this.adaptTiffPropAsSegment("iptc"),this.adaptTiffPropAsSegment("icc")}}adaptTiffPropAsSegment(e){if(this.parsers.tiff[e]){let t=this.parsers.tiff[e];this.injectSegment(e,t)}}}m(Wt,"type","tiff"),Z.set("tiff",Wt);let or=He("zlib");const lr=["ihdr","iccp","text","itxt","exif"];class Xt extends Qe{constructor(...e){super(...e),m(this,"catchError",t=>this.errors.push(t)),m(this,"metaChunks",[]),m(this,"unknownChunks",[])}static canHandle(e,t){return t===35152&&e.getUint32(0)===2303741511&&e.getUint32(4)===218765834}async parse(){let{file:e}=this;await this.findPngChunksInRange(8,e.byteLength),await this.readSegments(this.metaChunks),this.findIhdr(),this.parseTextChunks(),await this.findExif().catch(this.catchError),await this.findXmp().catch(this.catchError),await this.findIcc().catch(this.catchError)}async findPngChunksInRange(e,t){let{file:n}=this;for(;e<t;){let i=n.getUint32(e),s=n.getUint32(e+4),a=n.getString(e+4,4).toLowerCase(),o=i+4+4+4,l={type:a,offset:e,length:o,start:e+4+4,size:i,marker:s};lr.includes(a)?this.metaChunks.push(l):this.unknownChunks.push(l),e+=o}}parseTextChunks(){let e=this.metaChunks.filter(t=>t.type==="text");for(let t of e){let[n,i]=this.file.getString(t.start,t.size).split("\0");this.injectKeyValToIhdr(n,i)}}injectKeyValToIhdr(e,t){let n=this.parsers.ihdr;n&&n.raw.set(e,t)}findIhdr(){let e=this.metaChunks.find(t=>t.type==="ihdr");e&&this.options.ihdr.enabled!==!1&&this.createParser("ihdr",e.chunk)}async findExif(){let e=this.metaChunks.find(t=>t.type==="exif");e&&this.injectSegment("tiff",e.chunk)}async findXmp(){let e=this.metaChunks.filter(t=>t.type==="itxt");for(let t of e)t.chunk.getString(0,17)==="XML:com.adobe.xmp"&&this.injectSegment("xmp",t.chunk)}async findIcc(){let e=this.metaChunks.find(o=>o.type==="iccp");if(!e)return;let{chunk:t}=e,n=t.getUint8Array(0,81),i=0;for(;i<80&&n[i]!==0;)i++;let s=i+2,a=t.getString(0,i);if(this.injectKeyValToIhdr("ProfileName",a),Ge){let o=await or,l=t.getUint8Array(s);l=o.inflateSync(l),this.injectSegment("icc",l)}}}m(Xt,"type","png"),Z.set("png",Xt),L(M,"interop",[[1,"InteropIndex"],[2,"InteropVersion"],[4096,"RelatedImageFileFormat"],[4097,"RelatedImageWidth"],[4098,"RelatedImageHeight"]]),be(M,"ifd0",[[11,"ProcessingSoftware"],[254,"SubfileType"],[255,"OldSubfileType"],[263,"Thresholding"],[264,"CellWidth"],[265,"CellLength"],[266,"FillOrder"],[269,"DocumentName"],[280,"MinSampleValue"],[281,"MaxSampleValue"],[285,"PageName"],[286,"XPosition"],[287,"YPosition"],[290,"GrayResponseUnit"],[297,"PageNumber"],[321,"HalftoneHints"],[322,"TileWidth"],[323,"TileLength"],[332,"InkSet"],[337,"TargetPrinter"],[18246,"Rating"],[18249,"RatingPercent"],[33550,"PixelScale"],[34264,"ModelTransform"],[34377,"PhotoshopSettings"],[50706,"DNGVersion"],[50707,"DNGBackwardVersion"],[50708,"UniqueCameraModel"],[50709,"LocalizedCameraModel"],[50736,"DNGLensInfo"],[50739,"ShadowScale"],[50740,"DNGPrivateData"],[33920,"IntergraphMatrix"],[33922,"ModelTiePoint"],[34118,"SEMInfo"],[34735,"GeoTiffDirectory"],[34736,"GeoTiffDoubleParams"],[34737,"GeoTiffAsciiParams"],[50341,"PrintIM"],[50721,"ColorMatrix1"],[50722,"ColorMatrix2"],[50723,"CameraCalibration1"],[50724,"CameraCalibration2"],[50725,"ReductionMatrix1"],[50726,"ReductionMatrix2"],[50727,"AnalogBalance"],[50728,"AsShotNeutral"],[50729,"AsShotWhiteXY"],[50730,"BaselineExposure"],[50731,"BaselineNoise"],[50732,"BaselineSharpness"],[50734,"LinearResponseLimit"],[50735,"CameraSerialNumber"],[50741,"MakerNoteSafety"],[50778,"CalibrationIlluminant1"],[50779,"CalibrationIlluminant2"],[50781,"RawDataUniqueID"],[50827,"OriginalRawFileName"],[50828,"OriginalRawFileData"],[50831,"AsShotICCProfile"],[50832,"AsShotPreProfileMatrix"],[50833,"CurrentICCProfile"],[50834,"CurrentPreProfileMatrix"],[50879,"ColorimetricReference"],[50885,"SRawType"],[50898,"PanasonicTitle"],[50899,"PanasonicTitle2"],[50931,"CameraCalibrationSig"],[50932,"ProfileCalibrationSig"],[50933,"ProfileIFD"],[50934,"AsShotProfileName"],[50936,"ProfileName"],[50937,"ProfileHueSatMapDims"],[50938,"ProfileHueSatMapData1"],[50939,"ProfileHueSatMapData2"],[50940,"ProfileToneCurve"],[50941,"ProfileEmbedPolicy"],[50942,"ProfileCopyright"],[50964,"ForwardMatrix1"],[50965,"ForwardMatrix2"],[50966,"PreviewApplicationName"],[50967,"PreviewApplicationVersion"],[50968,"PreviewSettingsName"],[50969,"PreviewSettingsDigest"],[50970,"PreviewColorSpace"],[50971,"PreviewDateTime"],[50972,"RawImageDigest"],[50973,"OriginalRawFileDigest"],[50981,"ProfileLookTableDims"],[50982,"ProfileLookTableData"],[51043,"TimeCodes"],[51044,"FrameRate"],[51058,"TStop"],[51081,"ReelName"],[51089,"OriginalDefaultFinalSize"],[51090,"OriginalBestQualitySize"],[51091,"OriginalDefaultCropSize"],[51105,"CameraLabel"],[51107,"ProfileHueSatMapEncoding"],[51108,"ProfileLookTableEncoding"],[51109,"BaselineExposureOffset"],[51110,"DefaultBlackRender"],[51111,"NewRawImageDigest"],[51112,"RawToPreviewGain"]]);let Kt=[[273,"StripOffsets"],[279,"StripByteCounts"],[288,"FreeOffsets"],[289,"FreeByteCounts"],[291,"GrayResponseCurve"],[292,"T4Options"],[293,"T6Options"],[300,"ColorResponseUnit"],[320,"ColorMap"],[324,"TileOffsets"],[325,"TileByteCounts"],[326,"BadFaxLines"],[327,"CleanFaxData"],[328,"ConsecutiveBadFaxLines"],[330,"SubIFD"],[333,"InkNames"],[334,"NumberofInks"],[336,"DotRange"],[338,"ExtraSamples"],[339,"SampleFormat"],[340,"SMinSampleValue"],[341,"SMaxSampleValue"],[342,"TransferRange"],[343,"ClipPath"],[344,"XClipPathUnits"],[345,"YClipPathUnits"],[346,"Indexed"],[347,"JPEGTables"],[351,"OPIProxy"],[400,"GlobalParametersIFD"],[401,"ProfileType"],[402,"FaxProfile"],[403,"CodingMethods"],[404,"VersionYear"],[405,"ModeNumber"],[433,"Decode"],[434,"DefaultImageColor"],[435,"T82Options"],[437,"JPEGTables"],[512,"JPEGProc"],[515,"JPEGRestartInterval"],[517,"JPEGLosslessPredictors"],[518,"JPEGPointTransforms"],[519,"JPEGQTables"],[520,"JPEGDCTables"],[521,"JPEGACTables"],[559,"StripRowCounts"],[999,"USPTOMiscellaneous"],[18247,"XP_DIP_XML"],[18248,"StitchInfo"],[28672,"SonyRawFileType"],[28688,"SonyToneCurve"],[28721,"VignettingCorrection"],[28722,"VignettingCorrParams"],[28724,"ChromaticAberrationCorrection"],[28725,"ChromaticAberrationCorrParams"],[28726,"DistortionCorrection"],[28727,"DistortionCorrParams"],[29895,"SonyCropTopLeft"],[29896,"SonyCropSize"],[32781,"ImageID"],[32931,"WangTag1"],[32932,"WangAnnotation"],[32933,"WangTag3"],[32934,"WangTag4"],[32953,"ImageReferencePoints"],[32954,"RegionXformTackPoint"],[32955,"WarpQuadrilateral"],[32956,"AffineTransformMat"],[32995,"Matteing"],[32996,"DataType"],[32997,"ImageDepth"],[32998,"TileDepth"],[33300,"ImageFullWidth"],[33301,"ImageFullHeight"],[33302,"TextureFormat"],[33303,"WrapModes"],[33304,"FovCot"],[33305,"MatrixWorldToScreen"],[33306,"MatrixWorldToCamera"],[33405,"Model2"],[33421,"CFARepeatPatternDim"],[33422,"CFAPattern2"],[33423,"BatteryLevel"],[33424,"KodakIFD"],[33445,"MDFileTag"],[33446,"MDScalePixel"],[33447,"MDColorTable"],[33448,"MDLabName"],[33449,"MDSampleInfo"],[33450,"MDPrepDate"],[33451,"MDPrepTime"],[33452,"MDFileUnits"],[33589,"AdventScale"],[33590,"AdventRevision"],[33628,"UIC1Tag"],[33629,"UIC2Tag"],[33630,"UIC3Tag"],[33631,"UIC4Tag"],[33918,"IntergraphPacketData"],[33919,"IntergraphFlagRegisters"],[33921,"INGRReserved"],[34016,"Site"],[34017,"ColorSequence"],[34018,"IT8Header"],[34019,"RasterPadding"],[34020,"BitsPerRunLength"],[34021,"BitsPerExtendedRunLength"],[34022,"ColorTable"],[34023,"ImageColorIndicator"],[34024,"BackgroundColorIndicator"],[34025,"ImageColorValue"],[34026,"BackgroundColorValue"],[34027,"PixelIntensityRange"],[34028,"TransparencyIndicator"],[34029,"ColorCharacterization"],[34030,"HCUsage"],[34031,"TrapIndicator"],[34032,"CMYKEquivalent"],[34152,"AFCP_IPTC"],[34232,"PixelMagicJBIGOptions"],[34263,"JPLCartoIFD"],[34306,"WB_GRGBLevels"],[34310,"LeafData"],[34687,"TIFF_FXExtensions"],[34688,"MultiProfiles"],[34689,"SharedData"],[34690,"T88Options"],[34732,"ImageLayer"],[34750,"JBIGOptions"],[34856,"Opto-ElectricConvFactor"],[34857,"Interlace"],[34908,"FaxRecvParams"],[34909,"FaxSubAddress"],[34910,"FaxRecvTime"],[34929,"FedexEDR"],[34954,"LeafSubIFD"],[37387,"FlashEnergy"],[37388,"SpatialFrequencyResponse"],[37389,"Noise"],[37390,"FocalPlaneXResolution"],[37391,"FocalPlaneYResolution"],[37392,"FocalPlaneResolutionUnit"],[37397,"ExposureIndex"],[37398,"TIFF-EPStandardID"],[37399,"SensingMethod"],[37434,"CIP3DataFile"],[37435,"CIP3Sheet"],[37436,"CIP3Side"],[37439,"StoNits"],[37679,"MSDocumentText"],[37680,"MSPropertySetStorage"],[37681,"MSDocumentTextPosition"],[37724,"ImageSourceData"],[40965,"InteropIFD"],[40976,"SamsungRawPointersOffset"],[40977,"SamsungRawPointersLength"],[41217,"SamsungRawByteOrder"],[41218,"SamsungRawUnknown"],[41484,"SpatialFrequencyResponse"],[41485,"Noise"],[41489,"ImageNumber"],[41490,"SecurityClassification"],[41491,"ImageHistory"],[41494,"TIFF-EPStandardID"],[41995,"DeviceSettingDescription"],[42112,"GDALMetadata"],[42113,"GDALNoData"],[44992,"ExpandSoftware"],[44993,"ExpandLens"],[44994,"ExpandFilm"],[44995,"ExpandFilterLens"],[44996,"ExpandScanner"],[44997,"ExpandFlashLamp"],[46275,"HasselbladRawImage"],[48129,"PixelFormat"],[48130,"Transformation"],[48131,"Uncompressed"],[48132,"ImageType"],[48256,"ImageWidth"],[48257,"ImageHeight"],[48258,"WidthResolution"],[48259,"HeightResolution"],[48320,"ImageOffset"],[48321,"ImageByteCount"],[48322,"AlphaOffset"],[48323,"AlphaByteCount"],[48324,"ImageDataDiscard"],[48325,"AlphaDataDiscard"],[50215,"OceScanjobDesc"],[50216,"OceApplicationSelector"],[50217,"OceIDNumber"],[50218,"OceImageLogic"],[50255,"Annotations"],[50459,"HasselbladExif"],[50547,"OriginalFileName"],[50560,"USPTOOriginalContentType"],[50656,"CR2CFAPattern"],[50710,"CFAPlaneColor"],[50711,"CFALayout"],[50712,"LinearizationTable"],[50713,"BlackLevelRepeatDim"],[50714,"BlackLevel"],[50715,"BlackLevelDeltaH"],[50716,"BlackLevelDeltaV"],[50717,"WhiteLevel"],[50718,"DefaultScale"],[50719,"DefaultCropOrigin"],[50720,"DefaultCropSize"],[50733,"BayerGreenSplit"],[50737,"ChromaBlurRadius"],[50738,"AntiAliasStrength"],[50752,"RawImageSegmentation"],[50780,"BestQualityScale"],[50784,"AliasLayerMetadata"],[50829,"ActiveArea"],[50830,"MaskedAreas"],[50935,"NoiseReductionApplied"],[50974,"SubTileBlockSize"],[50975,"RowInterleaveFactor"],[51008,"OpcodeList1"],[51009,"OpcodeList2"],[51022,"OpcodeList3"],[51041,"NoiseProfile"],[51114,"CacheVersion"],[51125,"DefaultUserCrop"],[51157,"NikonNEFInfo"],[65024,"KdcIFD"]];be(M,"ifd0",Kt),be(M,"exif",Kt),L(Y,"gps",[[23,{M:"Magnetic North",T:"True North"}],[25,{K:"Kilometers",M:"Miles",N:"Nautical Miles"}]]);class ut extends q{static canHandle(e,t){return e.getUint8(t+1)===224&&e.getUint32(t+4)===1246120262&&e.getUint8(t+8)===0}parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint16(0)],[2,this.chunk.getUint8(2)],[3,this.chunk.getUint16(3)],[5,this.chunk.getUint16(5)],[7,this.chunk.getUint8(7)],[8,this.chunk.getUint8(8)]])}}m(ut,"type","jfif"),m(ut,"headerLength",9),D.set("jfif",ut),L(M,"jfif",[[0,"JFIFVersion"],[2,"ResolutionUnit"],[3,"XResolution"],[5,"YResolution"],[7,"ThumbnailWidth"],[8,"ThumbnailHeight"]]);class qt extends q{parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint32(0)],[4,this.chunk.getUint32(4)],[8,this.chunk.getUint8(8)],[9,this.chunk.getUint8(9)],[10,this.chunk.getUint8(10)],[11,this.chunk.getUint8(11)],[12,this.chunk.getUint8(12)],...Array.from(this.raw)])}}m(qt,"type","ihdr"),D.set("ihdr",qt),L(M,"ihdr",[[0,"ImageWidth"],[4,"ImageHeight"],[8,"BitDepth"],[9,"ColorType"],[10,"Compression"],[11,"Filter"],[12,"Interlace"]]),L(Y,"ihdr",[[9,{0:"Grayscale",2:"RGB",3:"Palette",4:"Grayscale with Alpha",6:"RGB with Alpha",DEFAULT:"Unknown"}],[10,{0:"Deflate/Inflate",DEFAULT:"Unknown"}],[11,{0:"Adaptive",DEFAULT:"Unknown"}],[12,{0:"Noninterlaced",1:"Adam7 Interlace",DEFAULT:"Unknown"}]]);class Be extends q{static canHandle(e,t){return e.getUint8(t+1)===226&&e.getUint32(t+4)===1229144927}static findPosition(e,t){let n=super.findPosition(e,t);return n.chunkNumber=e.getUint8(t+16),n.chunkCount=e.getUint8(t+17),n.multiSegment=n.chunkCount>1,n}static handleMultiSegments(e){return function(t){let n=function(i){let s=i[0].constructor,a=0;for(let h of i)a+=h.length;let o=new s(a),l=0;for(let h of i)o.set(h,l),l+=h.length;return o}(t.map(i=>i.chunk.toUint8()));return new j(n)}(e)}parse(){return this.raw=new Map,this.parseHeader(),this.parseTags(),this.translate(),this.output}parseHeader(){let{raw:e}=this;this.chunk.byteLength<84&&F("ICC header is too short");for(let[t,n]of Object.entries(dr)){t=parseInt(t,10);let i=n(this.chunk,t);i!=="\0\0\0\0"&&e.set(t,i)}}parseTags(){let e,t,n,i,s,{raw:a}=this,o=this.chunk.getUint32(128),l=132,h=this.chunk.byteLength;for(;o--;){if(e=this.chunk.getString(l,4),t=this.chunk.getUint32(l+4),n=this.chunk.getUint32(l+8),i=this.chunk.getString(t,4),t+n>h)return void console.warn("reached the end of the first ICC chunk. Enable options.tiff.multiSegment to read all ICC segments.");s=this.parseTag(i,t,n),s!==void 0&&s!=="\0\0\0\0"&&a.set(e,s),l+=12}}parseTag(e,t,n){switch(e){case"desc":return this.parseDesc(t);case"mluc":return this.parseMluc(t);case"text":return this.parseText(t,n);case"sig ":return this.parseSig(t)}if(!(t+n>this.chunk.byteLength))return this.chunk.getUint8Array(t,n)}parseDesc(e){let t=this.chunk.getUint32(e+8)-1;return ge(this.chunk.getString(e+12,t))}parseText(e,t){return ge(this.chunk.getString(e+8,t-8))}parseSig(e){return ge(this.chunk.getString(e+8,4))}parseMluc(e){let{chunk:t}=this,n=t.getUint32(e+8),i=t.getUint32(e+12),s=e+16,a=[];for(let o=0;o<n;o++){let l=t.getString(s+0,2),h=t.getString(s+2,2),c=t.getUint32(s+4),d=t.getUint32(s+8)+e,p=ge(t.getUnicodeString(d,c));a.push({lang:l,country:h,text:p}),s+=i}return n===1?a[0].text:a}translateValue(e,t){return typeof e=="string"?t[e]||t[e.toLowerCase()]||e:t[e]||e}}m(Be,"type","icc"),m(Be,"multiSegment",!0),m(Be,"headerLength",18);const dr={4:re,8:function(r,e){return[r.getUint8(e),r.getUint8(e+1)>>4,r.getUint8(e+1)%16].map(t=>t.toString(10)).join(".")},12:re,16:re,20:re,24:function(r,e){const t=r.getUint16(e),n=r.getUint16(e+2)-1,i=r.getUint16(e+4),s=r.getUint16(e+6),a=r.getUint16(e+8),o=r.getUint16(e+10);return new Date(Date.UTC(t,n,i,s,a,o))},36:re,40:re,48:re,52:re,64:(r,e)=>r.getUint32(e),80:re};function re(r,e){return ge(r.getString(e,4))}D.set("icc",Be),L(M,"icc",[[4,"ProfileCMMType"],[8,"ProfileVersion"],[12,"ProfileClass"],[16,"ColorSpaceData"],[20,"ProfileConnectionSpace"],[24,"ProfileDateTime"],[36,"ProfileFileSignature"],[40,"PrimaryPlatform"],[44,"CMMFlags"],[48,"DeviceManufacturer"],[52,"DeviceModel"],[56,"DeviceAttributes"],[64,"RenderingIntent"],[68,"ConnectionSpaceIlluminant"],[80,"ProfileCreator"],[84,"ProfileID"],["Header","ProfileHeader"],["MS00","WCSProfiles"],["bTRC","BlueTRC"],["bXYZ","BlueMatrixColumn"],["bfd","UCRBG"],["bkpt","MediaBlackPoint"],["calt","CalibrationDateTime"],["chad","ChromaticAdaptation"],["chrm","Chromaticity"],["ciis","ColorimetricIntentImageState"],["clot","ColorantTableOut"],["clro","ColorantOrder"],["clrt","ColorantTable"],["cprt","ProfileCopyright"],["crdi","CRDInfo"],["desc","ProfileDescription"],["devs","DeviceSettings"],["dmdd","DeviceModelDesc"],["dmnd","DeviceMfgDesc"],["dscm","ProfileDescriptionML"],["fpce","FocalPlaneColorimetryEstimates"],["gTRC","GreenTRC"],["gXYZ","GreenMatrixColumn"],["gamt","Gamut"],["kTRC","GrayTRC"],["lumi","Luminance"],["meas","Measurement"],["meta","Metadata"],["mmod","MakeAndModel"],["ncl2","NamedColor2"],["ncol","NamedColor"],["ndin","NativeDisplayInfo"],["pre0","Preview0"],["pre1","Preview1"],["pre2","Preview2"],["ps2i","PS2RenderingIntent"],["ps2s","PostScript2CSA"],["psd0","PostScript2CRD0"],["psd1","PostScript2CRD1"],["psd2","PostScript2CRD2"],["psd3","PostScript2CRD3"],["pseq","ProfileSequenceDesc"],["psid","ProfileSequenceIdentifier"],["psvm","PS2CRDVMSize"],["rTRC","RedTRC"],["rXYZ","RedMatrixColumn"],["resp","OutputResponse"],["rhoc","ReflectionHardcopyOrigColorimetry"],["rig0","PerceptualRenderingIntentGamut"],["rig2","SaturationRenderingIntentGamut"],["rpoc","ReflectionPrintOutputColorimetry"],["sape","SceneAppearanceEstimates"],["scoe","SceneColorimetryEstimates"],["scrd","ScreeningDesc"],["scrn","Screening"],["targ","CharTarget"],["tech","Technology"],["vcgt","VideoCardGamma"],["view","ViewingConditions"],["vued","ViewingCondDesc"],["wtpt","MediaWhitePoint"]]);const Ue={"4d2p":"Erdt Systems",AAMA:"Aamazing Technologies",ACER:"Acer",ACLT:"Acolyte Color Research",ACTI:"Actix Sytems",ADAR:"Adara Technology",ADBE:"Adobe",ADI:"ADI Systems",AGFA:"Agfa Graphics",ALMD:"Alps Electric",ALPS:"Alps Electric",ALWN:"Alwan Color Expertise",AMTI:"Amiable Technologies",AOC:"AOC International",APAG:"Apago",APPL:"Apple Computer",AST:"AST","AT&T":"AT&T",BAEL:"BARBIERI electronic",BRCO:"Barco NV",BRKP:"Breakpoint",BROT:"Brother",BULL:"Bull",BUS:"Bus Computer Systems","C-IT":"C-Itoh",CAMR:"Intel",CANO:"Canon",CARR:"Carroll Touch",CASI:"Casio",CBUS:"Colorbus PL",CEL:"Crossfield",CELx:"Crossfield",CGS:"CGS Publishing Technologies International",CHM:"Rochester Robotics",CIGL:"Colour Imaging Group, London",CITI:"Citizen",CL00:"Candela",CLIQ:"Color IQ",CMCO:"Chromaco",CMiX:"CHROMiX",COLO:"Colorgraphic Communications",COMP:"Compaq",COMp:"Compeq/Focus Technology",CONR:"Conrac Display Products",CORD:"Cordata Technologies",CPQ:"Compaq",CPRO:"ColorPro",CRN:"Cornerstone",CTX:"CTX International",CVIS:"ColorVision",CWC:"Fujitsu Laboratories",DARI:"Darius Technology",DATA:"Dataproducts",DCP:"Dry Creek Photo",DCRC:"Digital Contents Resource Center, Chung-Ang University",DELL:"Dell Computer",DIC:"Dainippon Ink and Chemicals",DICO:"Diconix",DIGI:"Digital","DL&C":"Digital Light & Color",DPLG:"Doppelganger",DS:"Dainippon Screen",DSOL:"DOOSOL",DUPN:"DuPont",EPSO:"Epson",ESKO:"Esko-Graphics",ETRI:"Electronics and Telecommunications Research Institute",EVER:"Everex Systems",EXAC:"ExactCODE",Eizo:"Eizo",FALC:"Falco Data Products",FF:"Fuji Photo Film",FFEI:"FujiFilm Electronic Imaging",FNRD:"Fnord Software",FORA:"Fora",FORE:"Forefront Technology",FP:"Fujitsu",FPA:"WayTech Development",FUJI:"Fujitsu",FX:"Fuji Xerox",GCC:"GCC Technologies",GGSL:"Global Graphics Software",GMB:"Gretagmacbeth",GMG:"GMG",GOLD:"GoldStar Technology",GOOG:"Google",GPRT:"Giantprint",GTMB:"Gretagmacbeth",GVC:"WayTech Development",GW2K:"Sony",HCI:"HCI",HDM:"Heidelberger Druckmaschinen",HERM:"Hermes",HITA:"Hitachi America",HP:"Hewlett-Packard",HTC:"Hitachi",HiTi:"HiTi Digital",IBM:"IBM",IDNT:"Scitex",IEC:"Hewlett-Packard",IIYA:"Iiyama North America",IKEG:"Ikegami Electronics",IMAG:"Image Systems",IMI:"Ingram Micro",INTC:"Intel",INTL:"N/A (INTL)",INTR:"Intra Electronics",IOCO:"Iocomm International Technology",IPS:"InfoPrint Solutions Company",IRIS:"Scitex",ISL:"Ichikawa Soft Laboratory",ITNL:"N/A (ITNL)",IVM:"IVM",IWAT:"Iwatsu Electric",Idnt:"Scitex",Inca:"Inca Digital Printers",Iris:"Scitex",JPEG:"Joint Photographic Experts Group",JSFT:"Jetsoft Development",JVC:"JVC Information Products",KART:"Scitex",KFC:"KFC Computek Components",KLH:"KLH Computers",KMHD:"Konica Minolta",KNCA:"Konica",KODA:"Kodak",KYOC:"Kyocera",Kart:"Scitex",LCAG:"Leica",LCCD:"Leeds Colour",LDAK:"Left Dakota",LEAD:"Leading Technology",LEXM:"Lexmark International",LINK:"Link Computer",LINO:"Linotronic",LITE:"Lite-On",Leaf:"Leaf",Lino:"Linotronic",MAGC:"Mag Computronic",MAGI:"MAG Innovision",MANN:"Mannesmann",MICN:"Micron Technology",MICR:"Microtek",MICV:"Microvitec",MINO:"Minolta",MITS:"Mitsubishi Electronics America",MITs:"Mitsuba",MNLT:"Minolta",MODG:"Modgraph",MONI:"Monitronix",MONS:"Monaco Systems",MORS:"Morse Technology",MOTI:"Motive Systems",MSFT:"Microsoft",MUTO:"MUTOH INDUSTRIES",Mits:"Mitsubishi Electric",NANA:"NANAO",NEC:"NEC",NEXP:"NexPress Solutions",NISS:"Nissei Sangyo America",NKON:"Nikon",NONE:"none",OCE:"Oce Technologies",OCEC:"OceColor",OKI:"Oki",OKID:"Okidata",OKIP:"Okidata",OLIV:"Olivetti",OLYM:"Olympus",ONYX:"Onyx Graphics",OPTI:"Optiquest",PACK:"Packard Bell",PANA:"Matsushita Electric Industrial",PANT:"Pantone",PBN:"Packard Bell",PFU:"PFU",PHIL:"Philips Consumer Electronics",PNTX:"HOYA",POne:"Phase One A/S",PREM:"Premier Computer Innovations",PRIN:"Princeton Graphic Systems",PRIP:"Princeton Publishing Labs",QLUX:"Hong Kong",QMS:"QMS",QPCD:"QPcard AB",QUAD:"QuadLaser",QUME:"Qume",RADI:"Radius",RDDx:"Integrated Color Solutions",RDG:"Roland DG",REDM:"REDMS Group",RELI:"Relisys",RGMS:"Rolf Gierling Multitools",RICO:"Ricoh",RNLD:"Edmund Ronald",ROYA:"Royal",RPC:"Ricoh Printing Systems",RTL:"Royal Information Electronics",SAMP:"Sampo",SAMS:"Samsung",SANT:"Jaime Santana Pomares",SCIT:"Scitex",SCRN:"Dainippon Screen",SDP:"Scitex",SEC:"Samsung",SEIK:"Seiko Instruments",SEIk:"Seikosha",SGUY:"ScanGuy.com",SHAR:"Sharp Laboratories",SICC:"International Color Consortium",SONY:"Sony",SPCL:"SpectraCal",STAR:"Star",STC:"Sampo Technology",Scit:"Scitex",Sdp:"Scitex",Sony:"Sony",TALO:"Talon Technology",TAND:"Tandy",TATU:"Tatung",TAXA:"TAXAN America",TDS:"Tokyo Denshi Sekei",TECO:"TECO Information Systems",TEGR:"Tegra",TEKT:"Tektronix",TI:"Texas Instruments",TMKR:"TypeMaker",TOSB:"Toshiba",TOSH:"Toshiba",TOTK:"TOTOKU ELECTRIC",TRIU:"Triumph",TSBT:"Toshiba",TTX:"TTX Computer Products",TVM:"TVM Professional Monitor",TW:"TW Casper",ULSX:"Ulead Systems",UNIS:"Unisys",UTZF:"Utz Fehlau & Sohn",VARI:"Varityper",VIEW:"Viewsonic",VISL:"Visual communication",VIVO:"Vivo Mobile Communication",WANG:"Wang",WLBR:"Wilbur Imaging",WTG2:"Ware To Go",WYSE:"WYSE Technology",XERX:"Xerox",XRIT:"X-Rite",ZRAN:"Zoran",Zebr:"Zebra Technologies",appl:"Apple Computer",bICC:"basICColor",berg:"bergdesign",ceyd:"Integrated Color Solutions",clsp:"MacDermid ColorSpan",ds:"Dainippon Screen",dupn:"DuPont",ffei:"FujiFilm Electronic Imaging",flux:"FluxData",iris:"Scitex",kart:"Scitex",lcms:"Little CMS",lino:"Linotronic",none:"none",ob4d:"Erdt Systems",obic:"Medigraph",quby:"Qubyx Sarl",scit:"Scitex",scrn:"Dainippon Screen",sdp:"Scitex",siwi:"SIWI GRAFIKA",yxym:"YxyMaster"},Yt={scnr:"Scanner",mntr:"Monitor",prtr:"Printer",link:"Device Link",abst:"Abstract",spac:"Color Space Conversion Profile",nmcl:"Named Color",cenc:"ColorEncodingSpace profile",mid:"MultiplexIdentification profile",mlnk:"MultiplexLink profile",mvis:"MultiplexVisualization profile",nkpf:"Nikon Input Device Profile (NON-STANDARD!)"};L(Y,"icc",[[4,Ue],[12,Yt],[40,Object.assign({},Ue,Yt)],[48,Ue],[80,Ue],[64,{0:"Perceptual",1:"Relative Colorimetric",2:"Saturation",3:"Absolute Colorimetric"}],["tech",{amd:"Active Matrix Display",crt:"Cathode Ray Tube Display",kpcd:"Photo CD",pmd:"Passive Matrix Display",dcam:"Digital Camera",dcpj:"Digital Cinema Projector",dmpc:"Digital Motion Picture Camera",dsub:"Dye Sublimation Printer",epho:"Electrophotographic Printer",esta:"Electrostatic Printer",flex:"Flexography",fprn:"Film Writer",fscn:"Film Scanner",grav:"Gravure",ijet:"Ink Jet Printer",imgs:"Photo Image Setter",mpfr:"Motion Picture Film Recorder",mpfs:"Motion Picture Film Scanner",offs:"Offset Lithography",pjtv:"Projection Television",rpho:"Photographic Paper Printer",rscn:"Reflective Scanner",silk:"Silkscreen",twax:"Thermal Wax Printer",vidc:"Video Camera",vidm:"Video Monitor"}]]);class Ne extends q{static canHandle(e,t,n){return e.getUint8(t+1)===237&&e.getString(t+4,9)==="Photoshop"&&this.containsIptc8bim(e,t,n)!==void 0}static headerLength(e,t,n){let i,s=this.containsIptc8bim(e,t,n);if(s!==void 0)return i=e.getUint8(t+s+7),i%2!=0&&(i+=1),i===0&&(i=4),s+8+i}static containsIptc8bim(e,t,n){for(let i=0;i<n;i++)if(this.isIptcSegmentHead(e,t+i))return i}static isIptcSegmentHead(e,t){return e.getUint8(t)===56&&e.getUint32(t)===943868237&&e.getUint16(t+4)===1028}parse(){let{raw:e}=this,t=this.chunk.byteLength-1,n=!1;for(let i=0;i<t;i++)if(this.chunk.getUint8(i)===28&&this.chunk.getUint8(i+1)===2){n=!0;let s=this.chunk.getUint16(i+3),a=this.chunk.getUint8(i+2),o=this.chunk.getLatin1String(i+5,s);e.set(a,this.pluralizeValue(e.get(a),o)),i+=4+s}else if(n)break;return this.translate(),this.output}pluralizeValue(e,t){return e!==void 0?e instanceof Array?(e.push(t),e):[e,t]:t}}m(Ne,"type","iptc"),m(Ne,"translateValues",!1),m(Ne,"reviveValues",!1),D.set("iptc",Ne),L(M,"iptc",[[0,"ApplicationRecordVersion"],[3,"ObjectTypeReference"],[4,"ObjectAttributeReference"],[5,"ObjectName"],[7,"EditStatus"],[8,"EditorialUpdate"],[10,"Urgency"],[12,"SubjectReference"],[15,"Category"],[20,"SupplementalCategories"],[22,"FixtureIdentifier"],[25,"Keywords"],[26,"ContentLocationCode"],[27,"ContentLocationName"],[30,"ReleaseDate"],[35,"ReleaseTime"],[37,"ExpirationDate"],[38,"ExpirationTime"],[40,"SpecialInstructions"],[42,"ActionAdvised"],[45,"ReferenceService"],[47,"ReferenceDate"],[50,"ReferenceNumber"],[55,"DateCreated"],[60,"TimeCreated"],[62,"DigitalCreationDate"],[63,"DigitalCreationTime"],[65,"OriginatingProgram"],[70,"ProgramVersion"],[75,"ObjectCycle"],[80,"Byline"],[85,"BylineTitle"],[90,"City"],[92,"Sublocation"],[95,"State"],[100,"CountryCode"],[101,"Country"],[103,"OriginalTransmissionReference"],[105,"Headline"],[110,"Credit"],[115,"Source"],[116,"CopyrightNotice"],[118,"Contact"],[120,"Caption"],[121,"LocalCaption"],[122,"Writer"],[125,"RasterizedCaption"],[130,"ImageType"],[131,"ImageOrientation"],[135,"LanguageIdentifier"],[150,"AudioType"],[151,"AudioSamplingRate"],[152,"AudioSamplingResolution"],[153,"AudioDuration"],[154,"AudioOutcue"],[184,"JobID"],[185,"MasterDocumentID"],[186,"ShortDocumentID"],[187,"UniqueDocumentID"],[188,"OwnerID"],[200,"ObjectPreviewFileFormat"],[201,"ObjectPreviewFileVersion"],[202,"ObjectPreviewData"],[221,"Prefs"],[225,"ClassifyState"],[228,"SimilarityIndex"],[230,"DocumentNotes"],[231,"DocumentHistory"],[232,"ExifCameraInfo"],[255,"CatalogSets"]]),L(Y,"iptc",[[10,{0:"0 (reserved)",1:"1 (most urgent)",2:"2",3:"3",4:"4",5:"5 (normal urgency)",6:"6",7:"7",8:"8 (least urgent)",9:"9 (user-defined priority)"}],[75,{a:"Morning",b:"Both Morning and Evening",p:"Evening"}],[131,{L:"Landscape",P:"Portrait",S:"Square"}]]);function cr(r,e,t){const n=t.type===1||t.type===2||t.type===7?1:t.type===3?2:t.type===4||t.type===9||t.type===11||t.type===13?4:t.type===5||t.type===10||t.type===12?8:0;if(n===0)throw new Error(`Unsupported TIFF field type: ${t.type}`);const s=t.count*n<=4?t.valueFieldOffset:r.getUint32(t.valueFieldOffset,e),a=[];for(let o=0;o<t.count;o++){const l=s+o*n;if(l<0||l+n>r.byteLength)throw new Error("Invalid TIFF field offset");if(t.type===1)a.push(r.getUint8(l));else if(t.type===2||t.type===7)a.push(r.getUint8(l));else if(t.type===3)a.push(r.getUint16(l,e));else if(t.type===5){const h=r.getUint32(l+4,e);a.push(h?r.getUint32(l,e)/h:0)}else if(t.type===13)a.push(r.getUint32(l,e));else if(t.type===9)a.push(r.getInt32(l,e));else if(t.type===10){const h=r.getInt32(l+4,e);a.push(h?r.getInt32(l,e)/h:0)}else t.type===11?a.push(r.getFloat32(l,e)):t.type===12?a.push(r.getFloat64(l,e)):a.push(r.getUint32(l,e))}return a}function $t(r,e,t){if(!Number.isFinite(t)||t<=0||t+2>r.byteLength)throw new Error("Invalid TIFF IFD offset");const n=r.getUint16(t,e);if(t+2+n*12+4>r.byteLength)throw new Error("Corrupt TIFF IFD");const s=new Map;for(let a=0;a<n;a++){const o=t+2+a*12,l=r.getUint16(o,e),h=r.getUint16(o+2,e),c=r.getUint32(o+4,e);s.set(l,{type:h,count:c,valueFieldOffset:o+8})}return s}function H(r,e,t,n){const i=t.get(n);return i?cr(r,e,i):[]}const _n=(...r)=>{for(const e of r){if(Array.isArray(e)||ArrayBuffer.isView(e)){const n=Array.from(e).map(Number).filter(i=>Number.isFinite(i)&&i>0);if(n.length)return Math.max(...n);continue}const t=Number(e);if(Number.isFinite(t)&&t>0)return t}return null},hr=r=>{const t=(Array.isArray(r)||ArrayBuffer.isView(r)?Array.from(r).map(Number):[Number(r)]).map(n=>Number.isFinite(n)?n:0);return t.length>=3?[t[0]||0,t[1]||0,t[1]||0,t[2]||0]:t.length===1?[t[0]||0,t[0]||0,t[0]||0,t[0]||0]:[0,0,0,0]};function ur(r,e={}){var O,E,N,G,X,K;if(r.byteLength<8)return null;const t=new DataView(r.buffer,r.byteOffset,r.byteLength),n=t.getUint16(0,!1),i=n===18761;if(!i&&n!==19789||t.getUint16(2,i)!==42)return null;const s=t.getUint32(4,i);let a;try{a=$t(t,i,s)}catch{return null}const o=new Set([s]);for(const g of H(t,i,a,330))g>0&&o.add(g);let l=null;for(const g of o)try{const f=g===s?a:$t(t,i,g),k=H(t,i,f,256)[0]||0,v=H(t,i,f,257)[0]||0,S=H(t,i,f,258),R=H(t,i,f,277)[0]||S.length||1,J=S.length===1?new Array(R).fill(S[0]):S,ue=H(t,i,f,259)[0]||1,te=H(t,i,f,262)[0]||0,Q=H(t,i,f,284)[0]||1,B=H(t,i,f,339),et=B.length===0?new Array(R).fill(1):B.length===1?new Array(R).fill(B[0]):B,ke=H(t,i,f,273),De=H(t,i,f,279),tt=H(t,i,f,278)[0]||v,nt=et.slice(0,R).every(ie=>ie===0||ie===1);if(!(te===34892&&ue===1&&Q===1&&k>0&&v>0&&R>=3&&J.length>=R&&J.slice(0,R).every(ie=>ie===16)&&nt&&ke.length>0&&ke.length===De.length))continue;(!l||k*v>l.width*l.height)&&(l={entries:f,width:k,height:v,samplesPerPixel:R,rowsPerStrip:tt,stripOffsets:ke,stripByteCounts:De,bitsPerSample:J,photometric:te})}catch{continue}if(!l)return null;const{entries:h,width:c,height:d,samplesPerPixel:p,rowsPerStrip:u,stripOffsets:_,stripByteCounts:w,bitsPerSample:P,photometric:b}=l,y=c*d;if(!Number.isSafeInteger(y)||y<=0)return null;const x=new Uint16Array(y*3);for(let g=0;g<_.length;g++){const f=g*u;if(f>=d)break;const k=Math.min(u,d-f),v=k*c*p*2,S=_[g],R=w[g];if(S<0||R<v||S+v>r.byteLength)throw new Error("Invalid LinearRaw DNG strip bounds");const J=f*c*3;if(p===3&&i&&!(r.byteOffset+S&1)){x.set(new Uint16Array(r.buffer,r.byteOffset+S,k*c*3),J);continue}const ue=new DataView(r.buffer,r.byteOffset+S,v);let te=0,Q=J;for(let B=0;B<k*c;B++)x[Q++]=ue.getUint16(te,i),x[Q++]=ue.getUint16(te+2,i),x[Q++]=ue.getUint16(te+4,i),te+=p*2}const I=H(t,i,h,50714),C=((E=(O=e==null?void 0:e.color_data)==null?void 0:O.dng_levels)==null?void 0:E.dng_cblack)||((N=e==null?void 0:e.color_data)==null?void 0:N.cblack_rawpy_style)||(e==null?void 0:e.black_level_per_channel)||(e==null?void 0:e.cblack),T=hr(I.length?I:C),U=H(t,i,h,50717),$=_n(U,(X=(G=e==null?void 0:e.color_data)==null?void 0:G.dng_levels)==null?void 0:X.dng_whitelevel,(K=e==null?void 0:e.color_data)==null?void 0:K.maximum,e==null?void 0:e.white_level)||65535;return{data:x,width:c,height:d,bayerPattern:"",blackLevels:T,whiteLevel:$,metadata:{...e,format:"DNG_LINEAR_RAW_RGB",description:"Uncompressed DNG LinearRaw RGB",linearRawDngDecoder:!0,bitsPerSample:P.slice(0,p),samplesPerPixel:p,photometric:b},isThreePlane:!0,threePlaneTransfer:"linear"}}async function pr(r){const e=ur(r);if(!e)return null;let t={};const n=await yt(),i=new n;try{await i.open(r,{}),t=await i.metadata(!0)}catch(s){console.warn("LinearRaw DNG metadata enrichment failed",s)}finally{try{i.delete?i.delete():i.close()}catch{}}try{const s=await mn.parse(r.buffer);s&&(t={...t,...s})}catch(s){console.warn("exifr parsing failed for LinearRaw DNG",s)}return e.metadata={...t,...e.metadata},e}const fr=async r=>{var i,s,a,o,l,h,c,d,p,u,_,w,P,b;const e=await pr(r);if(e)return e;const t=await yt(),n=new t;try{if(await n.open(r,{}),typeof n.getRawImage!="function")throw new Error("WASM mismatch");let y={};try{y=await n.metadata(!0)}catch(f){console.warn("Metadata error before raw extraction",f)}const x=n.getRawImage(),I=x.data instanceof Uint16Array?x.data:new Uint16Array(x.data);let C={...y};try{const f=await mn.parse(r.buffer);f&&(C={...C,...f})}catch(f){console.warn("exifr parsing failed for RAW buffer",f)}const T=y.filters||((i=y.idata)==null?void 0:i.filters)||0,U=y.colors||((s=y.idata)==null?void 0:s.colors)||0,$=T===0&&U===3,O=T===9;let E=[0,0,0,0],N=!1,G=null;if(n.getBlackLevels)try{const f=n.getBlackLevels();G=f,f.dng_cblack&&f.dng_cblack.length===4&&Array.from(f.dng_cblack).some(k=>k>0)?(E=Array.from(f.dng_cblack).map(Number),N=!0):f.cblack&&f.cblack.length===4&&Array.from(f.cblack).some(k=>k>0)?(E=Array.from(f.cblack).map(Number),N=!0):typeof f.black=="number"&&f.black>0&&(E=[f.black,f.black,f.black,f.black],N=!0)}catch(f){console.warn("getBlackLevels binding failed",f)}if(!N){let f=[];if((a=y.color_data)!=null&&a.cblack_rawpy_style)f=y.color_data.cblack_rawpy_style;else if((l=(o=y.color_data)==null?void 0:o.dng_levels)!=null&&l.dng_cblack)f=y.color_data.dng_levels.dng_cblack;else if(((h=y.black_level_per_channel)==null?void 0:h.length)>=4)f=y.black_level_per_channel;else if(((c=y.cblack)==null?void 0:c.length)>=4)f=y.cblack;else if(((p=(d=y.color)==null?void 0:d.cblack)==null?void 0:p.length)>=4)f=y.color.cblack;else{const k=y.black_level||y.color_data&&y.color_data.black||0;f=[k,k,k,k]}E=[Number(f[0])||0,Number(f[1])||0,Number(f[2])||0,Number(f[3])||0]}const X=Number.isFinite(Number(x.bits))&&Number(x.bits)>0?Math.pow(2,Number(x.bits))-1:null,K=_n(y.white_level,(_=(u=y.color_data)==null?void 0:u.dng_levels)==null?void 0:_.dng_whitelevel,(w=y.color_data)==null?void 0:w.maximum,G==null?void 0:G.maximum,(P=y.color_data)==null?void 0:P.fmaximum,(b=y.color_data)==null?void 0:b.data_maximum,X)||16383,g={data:I,width:x.width,height:x.height,bayerPattern:x.bayerPattern||"",blackLevels:E,whiteLevel:K,metadata:C,isThreePlane:$,threePlaneTransfer:$?"linear":void 0,isXTrans:O};return Bn(g,Nn(g,C)),g}finally{n.delete?n.delete():n.close()}};async function gr(r){if(Tn(r)){const n=await Fn(r);if(!n)throw new Error("Sony cRAW HQ decoder did not return image data.");return n.rawImageData}const t=new Uint8Array(r);return fr(t)}function mr(r,e,t,n,i,s=!1,a=!1,o={rows:!1,rowGroup:0,cols:!1,colGroup:0},l=!0,h=1,c=!1){const d=Math.max(0,Math.floor(n.x)),p=Math.max(0,Math.floor(n.y)),u=Math.min(e,Math.ceil(n.x+n.w)),_=Math.min(t,Math.ceil(n.y+n.h)),w=u-d,P=_-p;if(w<=1||P<=1)return null;const b=c&&r.length>=e*t*3;if(b){if(i<0||i>2)return null}else if(i<0||i>3)return null;let y=0,x=0;if(b)y=u-d,x=_-p;else{for(let g=d;g<u;g++)g%2===(i&1)&&y++;for(let g=p;g<_;g++)g%2===i>>1&&x++}if(y<4||x<4)return null;const I=Math.max(1,h),C=Math.floor(2*y/(I+1)),T=Math.floor(2*x/(I+1));if(C<4||T<4)return null;const U=new ze(C),$=new ze(T),O=new Float32Array(Math.floor(C/2)+1),E=new Float32Array(Math.floor(T/2)+1);let N=0,G=0;const X=new Float32Array(y),K=new Float32Array(x);for(let g=p;g<_;g++){const f=g%2;if(!b&&i>>1!==f||o.rows&&(b?g&1:g>>1&1)!==o.rowGroup)continue;const k=g*e;let v=0;for(let S=d;S<u;S++){if(!b&&S%2!==(i&1)||v>=y)continue;const R=b?r[(k+S)*3+i]:r[k+S],J=Number.isFinite(R)?R:0;X[v++]=J}for(let S=0;S<I;S++){const R=Math.floor(S*C/2);if(R+C>y)break;U.calculateSpectrumWindow(X,R,O,a),N++}if(!l)break}for(let g=d;g<u;g++){const f=g%2;if(!b&&(i&1)!==f||o.cols&&(b?g&1:g>>1&1)!==o.colGroup)continue;let k=0;for(let v=p;v<_;v++){if(!b&&v%2!==i>>1||k>=x)continue;const S=b?r[(v*e+g)*3+i]:r[v*e+g],R=Number.isFinite(S)?S:0;K[k++]=R}for(let v=0;v<I;v++){const S=Math.floor(v*T/2);if(S+T>x)break;$.calculateSpectrumWindow(K,S,E,a),G++}if(!l)break}if(N>0)for(let g=0;g<O.length;g++)O[g]/=N;if(G>0)for(let g=0;g<E.length;g++)E[g]/=G;return{avgHoriz:Array.from(O),avgVert:Array.from(E),sampleCount:{h:N,v:G}}}const Jt=192*1024*1024,Ke=new Map;let Ve=0,Qt=Promise.resolve();const _r=r=>{r.lastAccess=Date.now()},yr=(r=new Set)=>{if(Ve<=Jt)return;const e=Array.from(Ke.entries()).filter(([t])=>!r.has(t)).sort((t,n)=>t[1].lastAccess-n[1].lastAccess);for(const[t,n]of e){if(Ve<=Jt)break;Ve-=n.sizeBytes,Ke.delete(t)}},wr=r=>{var e;return r.data.byteLength+(((e=r.floatData)==null?void 0:e.byteLength)||0)},yn=async r=>{const e=Ke.get(r.key);if(e)return _r(e),e.raw;if(!r.file)throw new Error(`Worker cache miss for ${r.key}`);const t=await r.file.arrayBuffer(),n=await gr(t),i={raw:n,sizeBytes:wr(n),lastAccess:Date.now()};return Ke.set(r.key,i),Ve+=i.sizeBytes,yr(new Set([r.key])),n},br=async r=>{for(const e of r.files)await yn(e);self.postMessage({id:r.id,type:"result",success:!0})},xr=async r=>{const e=new Map;for(const i of r.files){const s=await yn(i);for(const a of r.channelIndices){const o=mr(s.data,s.width,s.height,r.roi,a,!1,r.useHanning,r.interlace,r.doAverage,r.nSegments,!!s.isThreePlane);if(!o)continue;let l=e.get(a);if(!l)l={sumH:new Float32Array(o.avgHoriz.length),sumV:new Float32Array(o.avgVert.length),sampleCount:o.sampleCount,contributingFrames:0},e.set(a,l);else if(l.sumH.length!==o.avgHoriz.length||l.sumV.length!==o.avgVert.length)throw new Error("Stack FFT requires matching frame dimensions and channel layout.");for(let h=0;h<o.avgHoriz.length;h++)l.sumH[h]+=o.avgHoriz[h];for(let h=0;h<o.avgVert.length;h++)l.sumV[h]+=o.avgVert[h];l.sampleCount=o.sampleCount,l.contributingFrames+=1}self.postMessage({id:r.id,type:"progress",completed:1})}const t=Array.from(e.entries()).map(([i,s])=>({ch:i,sumH:s.sumH,sumV:s.sumV,sampleCount:s.sampleCount,contributingFrames:s.contributingFrames})),n=[];for(const i of t)n.push(i.sumH.buffer,i.sumV.buffer);self.postMessage({id:r.id,type:"result",success:!0,processedFrames:r.files.length,results:t},n)};self.onmessage=r=>{const e=r.data;Qt=Qt.then(async()=>{try{e.type==="preload"?await br(e):await xr(e)}catch(t){self.postMessage({id:e.id,type:"result",success:!1,error:(t==null?void 0:t.message)||"Power spectrum worker failed"})}})};
