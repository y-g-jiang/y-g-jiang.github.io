const un={"Sony ILCE-7RM5":"0.82 -0.2976 -0.0719 -0.4296 1.2053 0.2532 -0.0429 0.1282 0.5774"};let je=null;async function pn(i){return je||(je=(async()=>{if(typeof window.loadPyodide!="function")throw new Error("Pyodide missing: window.loadPyodide not found.");const e=await window.loadPyodide();return await e.loadPackage("numpy"),e})()),je}var fn=`#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
`,_n="/assets/joraw-BAR7UfD7.js",yn="/assets/joraw-CZg3hVRg.wasm";const bt=512,bn=un["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let Ke=null,Xe=null;function wn(i){if(i.byteLength<8)return null;const e=i.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function zt(i,e,t){const n=Math.min(i.length,e+t);let r="";for(let s=e;s<n;s++){const a=i[s];if(a===0)break;r+=String.fromCharCode(a)}return r.trim()}function E(i,e,t,n,r){const s=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!s)return[];const a=s*n,o=a<=4?r:i.getUint32(r,e);if(o<0||o+a>i.byteLength)return[];const l=[];for(let c=0;c<n;c++){const d=o+c*s;t===1||t===2||t===7?l.push(i.getUint8(d)):t===3?l.push(i.getUint16(d,e)):t===8?l.push(i.getInt16(d,e)):t===4?l.push(i.getUint32(d,e)):t===9&&l.push(i.getInt32(d,e))}return l}function wt(i,e,t,n,r,s){if(n!==2||r<=0)return"";const a=r<=4?s:e.getUint32(s,t);return a<0||a>=i.length?"":zt(i,a,r)}function Ht(i){const e=new Uint8Array(i),t=new DataView(i),n=wn(t);if(n===null||t.getUint16(2,n)!==42)return null;const s=u=>t.getUint16(u,n),a=u=>t.getUint32(u,n),o=[a(4)],l=new Set;let c="",d="";for(;o.length;){const u=o.pop();if(l.has(u)||u<=0||u+2>t.byteLength)continue;l.add(u);const p=s(u);if(u+2+p*12+4>t.byteLength)continue;const h=new Map;for(let A=0;A<p;A++){const R=u+2+A*12,D=s(R),M=s(R+2),H=a(R+4),v=R+8;h.set(D,{type:M,count:H,valueOffset:v})}const y=h.get(271),m=h.get(272);y&&!c&&(c=wt(e,t,n,y.type,y.count,y.valueOffset)),m&&!d&&(d=wt(e,t,n,m.type,m.count,m.valueOffset));const b=h.get(330);if(b){const A=E(t,n,b.type,b.count,b.valueOffset);for(const R of A)o.push(R)}const k=h.get(259),U=h.get(262);if(k&&U){const A=E(t,n,k.type,k.count,k.valueOffset)[0],R=E(t,n,U.type,U.count,U.valueOffset)[0];if(A===32766&&R===32803){const D=E(t,n,h.get(256).type,h.get(256).count,h.get(256).valueOffset)[0],M=E(t,n,h.get(257).type,h.get(257).count,h.get(257).valueOffset)[0],H=E(t,n,h.get(258).type,h.get(258).count,h.get(258).valueOffset)[0],v=E(t,n,h.get(273).type,h.get(273).count,h.get(273).valueOffset)[0],T=E(t,n,h.get(279).type,h.get(279).count,h.get(279).valueOffset)[0],G=h.get(33422)?E(t,n,h.get(33422).type,h.get(33422).count,h.get(33422).valueOffset):[0,1,1,2];h.get(29456)&&E(t,n,h.get(29456).type,h.get(29456).count,h.get(29456).valueOffset);const W=h.get(50717)?E(t,n,h.get(50717).type,h.get(50717).count,h.get(50717).valueOffset)[0]:16383,ee=h.get(50719)?E(t,n,h.get(50719).type,h.get(50719).count,h.get(50719).valueOffset):[],j=h.get(50720)?E(t,n,h.get(50720).type,h.get(50720).count,h.get(50720).valueOffset):[];if(v+bt+16>e.length||v+T>e.length)return null;const f=v+bt,I=zt(e,f,4),K=e[f+8]<<8|e[f+9],ye=e[f+10]<<8|e[f+11],ve=e[f+12]<<8|e[f+13],mt=e[f+14]<<8|e[f+15],sn=ve>>4&63,an=mt>>13,on=mt>>10&3,Pe=ye*2,te=T>=4?(e[v]|e[v+1]<<8|e[v+2]<<16|e[v+3]<<24)>>>0:0,ln=K===D&&Pe===M;let _t=!1;if(te>=1&&te<=16&&T>=8+te*24){const ne=new Map,Ge=new Map;let be=!0;for(let we=0;we<te;we++){const X=v+8+we*24,ie=t.getUint32(X+8,!0),re=t.getUint32(X+12,!0),We=t.getUint32(X+16,!0),Ie=t.getUint32(X+20,!0);if(!We||!Ie||ie+We>D||re+Ie>M){be=!1;break}const yt=ne.get(re);if(yt!==void 0&&yt!==Ie){be=!1;break}ne.set(re,Ie),Ge.set(re,(Ge.get(re)||0)+We)}if(be){const we=Array.from(ne.keys()).sort((ie,re)=>ie-re);let X=0;for(const ie of we){if(ie!==X||Ge.get(ie)!==D){be=!1;break}X+=ne.get(ie)}_t=be&&X===M}}const dn=te>=1&&te<=16&&K>0&&Pe>0&&D%K===0&&M%Pe===0&&te===D/K*(M/Pe);if(I!=="A000"&&I!=="0000"||!ln&&!dn&&!_t||sn!==16||an!==3||on!==3)return null;const hn=[1024,1024,1024,1024],cn=G.slice(0,4).map(ne=>ne===0?"R":ne===2?"B":"G").join("")||"RGGB";return{width:D,height:M,bitsPerSample:H,compression:A,photometric:R,blackLevel:hn,whiteLevel:Number(W||16383),cfaPattern:cn,defaultCropOrigin:ee.length>=2?[Number(ee[0]),Number(ee[1])]:void 0,defaultCropSize:j.length>=2?[Number(j[0]),Number(j[1])]:void 0,make:c||"SONY",model:d||"ILCE-7M5"}}}const _=a(u+2+p*12);_&&o.push(_)}return null}async function xn(i){return Ke||(Ke=(async()=>{const e=await pn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",fn),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",gn),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",mn),await e.runPythonAsync(`
import sys
...
`),e.__jtrSonyCrawHqDecoderReady=!0),e})()),Ke}function kn(i){return Ht(i)}async function Sn(){return Xe||(Xe=import(_n).then(i=>{const e=i.default;if(typeof e!="function")throw new Error("Sony cRAW HQ LibRaw WASM module is missing its initializer");return e({locateFile:(t,n)=>t.endsWith("joraw.wasm")?yn:n+t})})),Xe}function Cn(i){return i==="ILCE-7M5"?bn:null}function Gt(i,e,t,n){var l;if(i.length!==e.width*e.height)throw new Error(`Sony cRAW HQ decoded size mismatch: got ${i.length}, expected ${e.width*e.height}`);const r=e.model||"ILCE-7M5",s=r.startsWith("Sony ")?r:`Sony ${r}`,a=Cn(r),o={...n||{},make:e.make||(n==null?void 0:n.camera_make)||"SONY",model:r,camera_make:e.make||(n==null?void 0:n.camera_make)||"SONY",camera_model:r,UniqueCameraModel:s,sourceFormat:t==="libraw-wasm"?"Sony cRAW HQ / LLVC3 (LibRaw WASM)":"Sony cRAW HQ / LLVC3",sonyCrawHq:{...e,decodeBackend:t},color_desc:e.cfaPattern,black_level_per_channel:e.blackLevel,white_level:e.whiteLevel,color_matrix:a&&a.length===9?a:void 0,idata:{filters:2492765332,colors:3},color_data:{...(n==null?void 0:n.color_data)||{},black:1024,cblack_rawpy_style:e.blackLevel,dng_levels:{...((l=n==null?void 0:n.color_data)==null?void 0:l.dng_levels)||{},dng_cblack:e.blackLevel,dng_whitelevel:e.whiteLevel}}};return{data:i,width:e.width,height:e.height,bayerPattern:e.cfaPattern,blackLevels:e.blackLevel,whiteLevel:e.whiteLevel,metadata:o,isThreePlane:!1,isXTrans:!1}}async function vn(i,e,t){const n=typeof performance<"u"?performance.now():Date.now(),r=await Sn(),s=typeof performance<"u"?performance.now():Date.now(),a=r.LibRaw||r.JoRaw;if(!a)throw new Error("Sony cRAW HQ LibRaw WASM class not found");const o=new a;try{const l=new Uint8Array(i);o.open(l,{});const c=typeof performance<"u"?performance.now():Date.now();let d=null;try{d=o.metadata(!0)}catch(k){console.warn("[Sony cRAW HQ] fast WASM metadata read failed",k)}const u=typeof performance<"u"?performance.now():Date.now(),p=o.getRawImage(),h=typeof performance<"u"?performance.now():Date.now();if(!p||!p.data)throw new Error("Sony cRAW HQ LibRaw WASM returned no raw image");const y=p.data instanceof Uint16Array?p.data:new Uint16Array(p.data.buffer,p.data.byteOffset||0,p.data.byteLength/2),m=typeof performance<"u"?performance.now():Date.now();if(p.width!==e.width||p.height!==e.height)throw new Error(`Sony cRAW HQ LibRaw WASM dimensions mismatch: got ${p.width}x${p.height}, expected ${e.width}x${e.height}`);const b=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] fast decode timings",{width:e.width,height:e.height,backend:"libraw-wasm",wasmReadyMs:Math.round(s-n),openMs:Math.round(c-s),metadataMs:Math.round(u-c),unpackMs:Math.round(h-u),copyMs:Math.round(m-h),totalMs:Math.round(b-n)}),{rawImageData:Gt(y,e,"libraw-wasm",d),info:e}}finally{typeof o.delete=="function"?o.delete():typeof o.close=="function"&&o.close()}}async function Pn(i,e,t){const n=typeof performance<"u"?performance.now():Date.now(),r=await xn(),s=typeof performance<"u"?performance.now():Date.now(),a=new Uint8Array(i),o=await fetch(new URL("/assets/sony_llvc3_static_lut4096_padded_u16-FsVBk-IV.bin",import.meta.url));if(!o.ok)throw new Error(`Failed to load Sony LLVC3 sample LUT: HTTP ${o.status}`);const l=new Uint8Array(await o.arrayBuffer()),c=typeof performance<"u"?performance.now():Date.now();r.globals.set("jtr_sony_arw_bytes",a),r.globals.set("jtr_sony_lut_bytes",l);const d=await r.runPythonAsync("jtr_decode_sony_craw_hq(jtr_sony_arw_bytes.to_py(), jtr_sony_lut_bytes.to_py())"),u=typeof performance<"u"?performance.now():Date.now(),p=d.toJs();typeof d.destroy=="function"&&d.destroy(),r.globals.delete("jtr_sony_arw_bytes"),r.globals.delete("jtr_sony_lut_bytes");const h=new Uint8Array(p.byteLength);h.set(p);const y=new Uint16Array(h.buffer),m=typeof performance<"u"?performance.now():Date.now(),b=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] decode timings",{width:e.width,height:e.height,backend:"pyodide",pyodideReadyMs:Math.round(s-n),lutLoadMs:Math.round(c-s),llvc3DecodeMs:Math.round(u-c),copyMs:Math.round(m-u),totalMs:Math.round(b-n)}),{rawImageData:Gt(y,e,"pyodide"),info:e}}async function In(i,e){const t=Ht(i);if(!t)return null;try{return await vn(i,t,e)}catch(n){return console.warn("[Sony cRAW HQ] fast WASM decode failed; falling back to Pyodide",n),Pn(i,t)}}async function An(i,e){return In(i,e)}const Tn={1:1,2:1,3:2,4:4,5:8,7:1,9:4,10:8,11:4,12:8},Ln=34713,nt=155;let qe=null;function xt(i,e,t){return fe(i,e,t,Math.min(t.count,256)).map(r=>r&255).filter(r=>r!==0).map(r=>String.fromCharCode(r)).join("").trim()}function fe(i,e,t,n=Number.MAX_SAFE_INTEGER){const r=Tn[t.type]||0;if(!r)return[];const a=t.count*r<=4?t.valueOffset:i.getUint32(t.valueOffset,e),o=Math.min(t.count,n),l=[];for(let c=0;c<o;c++){const d=a+c*r;if(d<0||d+r>i.byteLength)break;switch(t.type){case 1:case 2:case 7:l.push(i.getUint8(d));break;case 3:l.push(i.getUint16(d,e));break;case 4:l.push(i.getUint32(d,e));break;case 9:l.push(i.getInt32(d,e));break;case 5:{const u=i.getUint32(d,e),p=i.getUint32(d+4,e);l.push(p?u/p:0);break}case 10:{const u=i.getInt32(d,e),p=i.getInt32(d+4,e);l.push(p?u/p:0);break}}}return l}function kt(i,e,t){if(t<=0||t+2>i.byteLength)return null;const n=i.getUint16(t,e),r=2+n*12+4;if(n>4096||t+r>i.byteLength)return null;const s=new Map;for(let a=0;a<n;a++){const o=t+2+a*12,l=i.getUint16(o,e);s.set(l,{tag:l,type:i.getUint16(o+2,e),count:i.getUint32(o+4,e),valueOffset:o+8})}return s}function Rn(i,e,t){if(t<=0||t+2>i.byteLength)return 0;const n=i.getUint16(t,e),r=t+2+n*12;return r+4>i.byteLength?0:i.getUint32(r,e)}function On(i){const e=["R","G","B","C","M","Y","W"];return i.length<4?"RGGB":i.slice(0,4).map(t=>e[t]||"G").join("")}function se(i,e,t,n){const r=i.get(n);if(!r)return null;const s=fe(e,t,r,1);return s.length?s[0]:null}function Wt(i){if(i.byteLength<16)return null;const e=new DataView(i),t=e.getUint16(0,!1),n=t===18761;if(!n&&t!==19789||e.getUint16(2,n)!==42)return null;const r=e.getUint32(4,n),s=kt(e,n,r);if(!s)return null;const a=s.get(271),o=s.get(272),l=a?xt(e,n,a):"",c=o?xt(e,n,o):"";if(!/NIKON/i.test(l+" "+c))return null;const d=se(s,e,n,274)||1,u=s.get(330);if(!u)return null;const p=fe(e,n,u,16);for(const y of p){const m=kt(e,n,y);if(!m)continue;const b=se(m,e,n,259)||0,k=se(m,e,n,273)||0,U=se(m,e,n,279)||0,_=se(m,e,n,256)||0,A=se(m,e,n,257)||0;if(b!==Ln||!k||!U||_<=0||A<=0||k+U>i.byteLength)continue;const R=se(m,e,n,258)||14,D=m.get(33422),M=D?On(fe(e,n,D,4)):"RGGB",H=m.get(50714),v=m.get(50717),T=H?fe(e,n,H,4):[],G=v?fe(e,n,v,1):[],W=T.length&&Number(T[0])||0,ee=[Number(T[0])||W,Number(T[1])||W,Number(T[2])||W,Number(T[3])||W],j=k+nt,f=j+3<i.byteLength?e.getUint8(j+3):0;return{make:l,model:c,width:_,height:A,stripOffset:k,stripByteCount:U,bayerPattern:M,blackLevels:ee,whiteLevel:Math.max(1,Number(G[0])||(1<<Math.min(R,15))-1||16383),orientation:d,compression:b,firstBp:f,isHeStar:f>=1&&f<=2}}return Rn(e,n,r)>0,null}function Dn(){return{wasi_snapshot_preview1:{fd_close:()=>0,fd_seek:(i,e,t,n,r)=>0,fd_write:()=>0,proc_exit:i=>{throw new Error(`Nikon HE WASM exited with code ${i}`)}}}}async function Mn(){return qe||(qe=(async()=>{const i=new URL("/assets/nikon-he-decoder-DUHNoGN2.wasm",import.meta.url),e=await fetch(i);if(!e.ok)throw new Error(`Failed to load Nikon HE WASM: ${e.status}`);const t=await e.arrayBuffer(),r=(await WebAssembly.instantiate(t,Dn())).instance.exports;if(!r.memory||!r.nikon_he_decode||!r.nikon_he_malloc||!r.nikon_he_free)throw new Error("Nikon HE WASM exports are incomplete.");return r})()),qe}function En(i){return Wt(i)}async function Fn(i){const e=Wt(i);if(!e)return null;const t=e.stripOffset+nt,n=e.stripByteCount-nt;if(n<=12||t+n>i.byteLength)throw new Error("Invalid Nikon HE precinct bounds.");const r=await Mn(),s=e.width*e.height*2,a=r.nikon_he_malloc(n),o=r.nikon_he_malloc(s);try{new Uint8Array(r.memory.buffer).set(new Uint8Array(i,t,n),a);const c=r.nikon_he_decode(a,n,e.width,e.height,o);if(c<0)throw new Error(`Nikon HE decoder failed with code ${c}.`);const d=new Uint16Array(r.memory.buffer,o,e.width*e.height),u=new Uint16Array(d);let p=65535,h=0;const y=Math.max(1,Math.floor(u.length/2e5));for(let m=0;m<u.length;m+=y){const b=u[m];b<p&&(p=b),b>h&&(h=b)}if(p===h)throw new Error("Nikon HE decoder returned a constant image; this HE variant is not supported by the current WASM core.");return{data:u,width:e.width,height:e.height,bayerPattern:e.bayerPattern,blackLevels:e.blackLevels,whiteLevel:e.whiteLevel,metadata:{description:`Nikon ${e.isHeStar?"HE*":"HE"} RAW decoded by standalone WASM`,camera_make:e.make,camera_model:e.model,make:e.make,model:e.model,orientation:e.orientation,compression:e.compression,raw_width:e.width,raw_height:e.height,width:e.width,height:e.height,color_desc:e.bayerPattern,white_level:e.whiteLevel,black_level_per_channel:e.blackLevels,nikon_he:{isHeStar:e.isHeStar,firstBp:e.firstBp,stripOffset:e.stripOffset,stripByteCount:e.stripByteCount,precinctOffset:t,precinctSize:n}},isThreePlane:!1}}finally{r.nikon_he_free(o),r.nikon_he_free(a)}}var Ne=typeof self<"u"?self:global;const Ce=typeof navigator<"u",Nn=Ce&&typeof HTMLImageElement>"u",Oe=!(typeof global>"u"||typeof process>"u"||!process.versions||!process.versions.node),Ue=Ne.Buffer,Ae=Ne.BigInt,Be=!!Ue,Un=i=>i;function De(i,e=Un){if(Oe)try{return typeof require=="function"?Promise.resolve(e(require(i))):import(i).then(e)}catch{console.warn(`Couldn't load ${i}`)}}let lt=Ne.fetch;const Bn=i=>lt=i;if(!Ne.fetch){const i=De("http",n=>n),e=De("https",n=>n),t=(n,{headers:r}={})=>new Promise(async(s,a)=>{let{port:o,hostname:l,pathname:c,protocol:d,search:u}=new URL(n);const p={method:"GET",hostname:l,path:encodeURI(c)+u,headers:r};o!==""&&(p.port=Number(o));const h=(d==="https:"?await e:await i).request(p,y=>{if(y.statusCode===301||y.statusCode===302){let m=new URL(y.headers.location,n).toString();return t(m,{headers:r}).then(s).catch(a)}s({status:y.statusCode,arrayBuffer:()=>new Promise(m=>{let b=[];y.on("data",k=>b.push(k)),y.on("end",()=>m(Buffer.concat(b)))})})});h.on("error",a),h.end()});Bn(t)}function g(i,e,t){return e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}const Me=i=>jt(i)?void 0:i,Vn=i=>i!==void 0;function jt(i){return i===void 0||(i instanceof Map?i.size===0:Object.values(i).filter(Vn).length===0)}function C(i){let e=new Error(i);throw delete e.stack,e}function ae(i){return(i=function(e){for(;e.endsWith("\0");)e=e.slice(0,-1);return e}(i).trim())===""?void 0:i}function it(i){let e=function(t){let n=0;return t.ifd0.enabled&&(n+=1024),t.exif.enabled&&(n+=2048),t.makerNote&&(n+=2048),t.userComment&&(n+=1024),t.gps.enabled&&(n+=512),t.interop.enabled&&(n+=100),t.ifd1.enabled&&(n+=1024),n+2048}(i);return i.jfif.enabled&&(e+=50),i.xmp.enabled&&(e+=2e4),i.iptc.enabled&&(e+=14e3),i.icc.enabled&&(e+=6e3),e}const rt=i=>String.fromCharCode.apply(null,i),St=typeof TextDecoder<"u"?new TextDecoder("utf-8"):void 0;function Kt(i){return St?St.decode(i):Be?Buffer.from(i).toString("utf8"):decodeURIComponent(escape(rt(i)))}class O{static from(e,t){return e instanceof this&&e.le===t?e:new O(e,void 0,void 0,t)}constructor(e,t=0,n,r){if(typeof r=="boolean"&&(this.le=r),Array.isArray(e)&&(e=new Uint8Array(e)),e===0)this.byteOffset=0,this.byteLength=0;else if(e instanceof ArrayBuffer){n===void 0&&(n=e.byteLength-t);let s=new DataView(e,t,n);this._swapDataView(s)}else if(e instanceof Uint8Array||e instanceof DataView||e instanceof O){n===void 0&&(n=e.byteLength-t),(t+=e.byteOffset)+n>e.byteOffset+e.byteLength&&C("Creating view outside of available memory in ArrayBuffer");let s=new DataView(e.buffer,t,n);this._swapDataView(s)}else if(typeof e=="number"){let s=new DataView(new ArrayBuffer(e));this._swapDataView(s)}else C("Invalid input argument for BufferView: "+e)}_swapArrayBuffer(e){this._swapDataView(new DataView(e))}_swapBuffer(e){this._swapDataView(new DataView(e.buffer,e.byteOffset,e.byteLength))}_swapDataView(e){this.dataView=e,this.buffer=e.buffer,this.byteOffset=e.byteOffset,this.byteLength=e.byteLength}_lengthToEnd(e){return this.byteLength-e}set(e,t,n=O){return e instanceof DataView||e instanceof O?e=new Uint8Array(e.buffer,e.byteOffset,e.byteLength):e instanceof ArrayBuffer&&(e=new Uint8Array(e)),e instanceof Uint8Array||C("BufferView.set(): Invalid data argument."),this.toUint8().set(e,t),new n(this,t,e.byteLength)}subarray(e,t){return t=t||this._lengthToEnd(e),new O(this,e,t)}toUint8(){return new Uint8Array(this.buffer,this.byteOffset,this.byteLength)}getUint8Array(e,t){return new Uint8Array(this.buffer,this.byteOffset+e,t)}getString(e=0,t=this.byteLength){return Kt(this.getUint8Array(e,t))}getLatin1String(e=0,t=this.byteLength){let n=this.getUint8Array(e,t);return rt(n)}getUnicodeString(e=0,t=this.byteLength){const n=[];for(let r=0;r<t&&e+r<this.byteLength;r+=2)n.push(this.getUint16(e+r));return rt(n)}getInt8(e){return this.dataView.getInt8(e)}getUint8(e){return this.dataView.getUint8(e)}getInt16(e,t=this.le){return this.dataView.getInt16(e,t)}getInt32(e,t=this.le){return this.dataView.getInt32(e,t)}getUint16(e,t=this.le){return this.dataView.getUint16(e,t)}getUint32(e,t=this.le){return this.dataView.getUint32(e,t)}getFloat32(e,t=this.le){return this.dataView.getFloat32(e,t)}getFloat64(e,t=this.le){return this.dataView.getFloat64(e,t)}getFloat(e,t=this.le){return this.dataView.getFloat32(e,t)}getDouble(e,t=this.le){return this.dataView.getFloat64(e,t)}getUintBytes(e,t,n){switch(t){case 1:return this.getUint8(e,n);case 2:return this.getUint16(e,n);case 4:return this.getUint32(e,n);case 8:return this.getUint64&&this.getUint64(e,n)}}getUint(e,t,n){switch(t){case 8:return this.getUint8(e,n);case 16:return this.getUint16(e,n);case 32:return this.getUint32(e,n);case 64:return this.getUint64&&this.getUint64(e,n)}}toString(e){return this.dataView.toString(e,this.constructor.name)}ensureChunk(){}}function st(i,e){C(`${i} '${e}' was not loaded, try using full build of exifr.`)}class dt extends Map{constructor(e){super(),this.kind=e}get(e,t){return this.has(e)||st(this.kind,e),t&&(e in t||function(n,r){C(`Unknown ${n} '${r}'.`)}(this.kind,e),t[e].enabled||st(this.kind,e)),super.get(e)}keyList(){return Array.from(this.keys())}}var B=new dt("file parser"),S=new dt("segment parser"),V=new dt("file reader");function zn(i,e){return typeof i=="string"?Ct(i,e):Ce&&!Nn&&i instanceof HTMLImageElement?Ct(i.src,e):i instanceof Uint8Array||i instanceof ArrayBuffer||i instanceof DataView?new O(i):Ce&&i instanceof Blob?at(i,e,"blob",he):void C("Invalid input argument")}function Ct(i,e){return(t=i).startsWith("data:")||t.length>1e4?ot(i,e,"base64"):Oe&&i.includes("://")?at(i,e,"url",de):Oe?ot(i,e,"fs"):Ce?at(i,e,"url",de):void C("Invalid input argument");var t}async function at(i,e,t,n){return V.has(t)?ot(i,e,t):n?async function(r,s){let a=await s(r);return new O(a)}(i,n):void C(`Parser ${t} is not loaded`)}async function ot(i,e,t){let n=new(V.get(t))(i,e);return await n.read(),n}const de=i=>lt(i).then(e=>e.arrayBuffer()),he=i=>new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result||new ArrayBuffer),n.onerror=t,n.readAsArrayBuffer(i)});class Hn extends Map{get tagKeys(){return this.allKeys||(this.allKeys=Array.from(this.keys())),this.allKeys}get tagValues(){return this.allValues||(this.allValues=Array.from(this.values())),this.allValues}}function x(i,e,t){let n=new Hn;for(let[r,s]of t)n.set(r,s);if(Array.isArray(e))for(let r of e)i.set(r,n);else i.set(e,n);return n}function ce(i,e,t){let n,r=i.get(e);for(n of t)r.set(n[0],n[1])}const P=new Map,N=new Map,Q=new Map,q=["chunked","firstChunkSize","firstChunkSizeNode","firstChunkSizeBrowser","chunkSize","chunkLimit"],me=["jfif","xmp","icc","iptc","ihdr"],ue=["tiff",...me],w=["ifd0","ifd1","exif","gps","interop"],$=[...ue,...w],Y=["makerNote","userComment"],_e=["translateKeys","translateValues","reviveValues","multiSegment"],J=[..._e,"sanitize","mergeOutput","silentErrors"];class Xt{get translate(){return this.translateKeys||this.translateValues||this.reviveValues}}class xe extends Xt{get needed(){return this.enabled||this.deps.size>0}constructor(e,t,n,r){if(super(),g(this,"enabled",!1),g(this,"skip",new Set),g(this,"pick",new Set),g(this,"deps",new Set),g(this,"translateKeys",!1),g(this,"translateValues",!1),g(this,"reviveValues",!1),this.key=e,this.enabled=t,this.parse=this.enabled,this.applyInheritables(r),this.canBeFiltered=w.includes(e),this.canBeFiltered&&(this.dict=P.get(e)),n!==void 0)if(Array.isArray(n))this.parse=this.enabled=!0,this.canBeFiltered&&n.length>0&&this.translateTagSet(n,this.pick);else if(typeof n=="object"){if(this.enabled=!0,this.parse=n.parse!==!1,this.canBeFiltered){let{pick:s,skip:a}=n;s&&s.length>0&&this.translateTagSet(s,this.pick),a&&a.length>0&&this.translateTagSet(a,this.skip)}this.applyInheritables(n)}else n===!0||n===!1?this.parse=this.enabled=n:C(`Invalid options argument: ${n}`)}applyInheritables(e){let t,n;for(t of _e)n=e[t],n!==void 0&&(this[t]=n)}translateTagSet(e,t){if(this.dict){let n,r,{tagKeys:s,tagValues:a}=this.dict;for(n of e)typeof n=="string"?(r=a.indexOf(n),r===-1&&(r=s.indexOf(Number(n))),r!==-1&&t.add(Number(s[r]))):t.add(n)}else for(let n of e)t.add(n)}finalizeFilters(){!this.enabled&&this.deps.size>0?(this.enabled=!0,Ee(this.pick,this.deps)):this.enabled&&this.pick.size>0&&Ee(this.pick,this.deps)}}var L={jfif:!1,tiff:!0,xmp:!1,icc:!1,iptc:!1,ifd0:!0,ifd1:!1,exif:!0,gps:!0,interop:!1,ihdr:void 0,makerNote:!1,userComment:!1,multiSegment:!1,skip:[],pick:[],translateKeys:!0,translateValues:!0,reviveValues:!0,sanitize:!0,mergeOutput:!0,silentErrors:!0,chunked:!0,firstChunkSize:void 0,firstChunkSizeNode:512,firstChunkSizeBrowser:65536,chunkSize:65536,chunkLimit:5},vt=new Map;class pe extends Xt{static useCached(e){let t=vt.get(e);return t!==void 0||(t=new this(e),vt.set(e,t)),t}constructor(e){super(),e===!0?this.setupFromTrue():e===void 0?this.setupFromUndefined():Array.isArray(e)?this.setupFromArray(e):typeof e=="object"?this.setupFromObject(e):C(`Invalid options argument ${e}`),this.firstChunkSize===void 0&&(this.firstChunkSize=Ce?this.firstChunkSizeBrowser:this.firstChunkSizeNode),this.mergeOutput&&(this.ifd1.enabled=!1),this.filterNestedSegmentTags(),this.traverseTiffDependencyTree(),this.checkLoadedPlugins()}setupFromUndefined(){let e;for(e of q)this[e]=L[e];for(e of J)this[e]=L[e];for(e of Y)this[e]=L[e];for(e of $)this[e]=new xe(e,L[e],void 0,this)}setupFromTrue(){let e;for(e of q)this[e]=L[e];for(e of J)this[e]=L[e];for(e of Y)this[e]=!0;for(e of $)this[e]=new xe(e,!0,void 0,this)}setupFromArray(e){let t;for(t of q)this[t]=L[t];for(t of J)this[t]=L[t];for(t of Y)this[t]=L[t];for(t of $)this[t]=new xe(t,!1,void 0,this);this.setupGlobalFilters(e,void 0,w)}setupFromObject(e){let t;for(t of(w.ifd0=w.ifd0||w.image,w.ifd1=w.ifd1||w.thumbnail,Object.assign(this,e),q))this[t]=$e(e[t],L[t]);for(t of J)this[t]=$e(e[t],L[t]);for(t of Y)this[t]=$e(e[t],L[t]);for(t of ue)this[t]=new xe(t,L[t],e[t],this);for(t of w)this[t]=new xe(t,L[t],e[t],this.tiff);this.setupGlobalFilters(e.pick,e.skip,w,$),e.tiff===!0?this.batchEnableWithBool(w,!0):e.tiff===!1?this.batchEnableWithUserValue(w,e):Array.isArray(e.tiff)?this.setupGlobalFilters(e.tiff,void 0,w):typeof e.tiff=="object"&&this.setupGlobalFilters(e.tiff.pick,e.tiff.skip,w)}batchEnableWithBool(e,t){for(let n of e)this[n].enabled=t}batchEnableWithUserValue(e,t){for(let n of e){let r=t[n];this[n].enabled=r!==!1&&r!==void 0}}setupGlobalFilters(e,t,n,r=n){if(e&&e.length){for(let a of r)this[a].enabled=!1;let s=Pt(e,n);for(let[a,o]of s)Ee(this[a].pick,o),this[a].enabled=!0}else if(t&&t.length){let s=Pt(t,n);for(let[a,o]of s)Ee(this[a].skip,o)}}filterNestedSegmentTags(){let{ifd0:e,exif:t,xmp:n,iptc:r,icc:s}=this;this.makerNote?t.deps.add(37500):t.skip.add(37500),this.userComment?t.deps.add(37510):t.skip.add(37510),n.enabled||e.skip.add(700),r.enabled||e.skip.add(33723),s.enabled||e.skip.add(34675)}traverseTiffDependencyTree(){let{ifd0:e,exif:t,gps:n,interop:r}=this;r.needed&&(t.deps.add(40965),e.deps.add(40965)),t.needed&&e.deps.add(34665),n.needed&&e.deps.add(34853),this.tiff.enabled=w.some(s=>this[s].enabled===!0)||this.makerNote||this.userComment;for(let s of w)this[s].finalizeFilters()}get onlyTiff(){return!me.map(e=>this[e].enabled).some(e=>e===!0)&&this.tiff.enabled}checkLoadedPlugins(){for(let e of ue)this[e].enabled&&!S.has(e)&&st("segment parser",e)}}function Pt(i,e){let t,n,r,s,a=[];for(r of e){for(s of(t=P.get(r),n=[],t))(i.includes(s[0])||i.includes(s[1]))&&n.push(s[0]);n.length&&a.push([r,n])}return a}function $e(i,e){return i!==void 0?i:e!==void 0?e:void 0}function Ee(i,e){for(let t of e)i.add(t)}g(pe,"default",L);class Z{constructor(e){g(this,"parsers",{}),g(this,"output",{}),g(this,"errors",[]),g(this,"pushToErrors",t=>this.errors.push(t)),this.options=pe.useCached(e)}async read(e){this.file=await zn(e,this.options)}setup(){if(this.fileParser)return;let{file:e}=this,t=e.getUint16(0);for(let[n,r]of B)if(r.canHandle(e,t))return this.fileParser=new r(this.options,this.file,this.parsers),e[n]=!0;this.file.close&&this.file.close(),C("Unknown file format")}async parse(){let{output:e,errors:t}=this;return this.setup(),this.options.silentErrors?(await this.executeParsers().catch(this.pushToErrors),t.push(...this.fileParser.errors)):await this.executeParsers(),this.file.close&&this.file.close(),this.options.silentErrors&&t.length>0&&(e.errors=t),Me(e)}async executeParsers(){let{output:e}=this;await this.fileParser.parse();let t=Object.values(this.parsers).map(async n=>{let r=await n.parse();n.assignToOutput(e,r)});this.options.silentErrors&&(t=t.map(n=>n.catch(this.pushToErrors))),await Promise.all(t)}async extractThumbnail(){this.setup();let{options:e,file:t}=this,n=S.get("tiff",e);var r;if(t.tiff?r={start:0,type:"tiff"}:t.jpeg&&(r=await this.fileParser.getOrFindSegment("tiff")),r===void 0)return;let s=await this.fileParser.ensureSegmentChunk(r),a=this.parsers.tiff=new n(s,e,t),o=await a.extractThumbnail();return t.close&&t.close(),o}}async function Ve(i,e){let t=new Z(e);return await t.read(i),t.parse()}var Gn=Object.freeze({__proto__:null,parse:Ve,Exifr:Z,fileParsers:B,segmentParsers:S,fileReaders:V,tagKeys:P,tagValues:N,tagRevivers:Q,createDictionary:x,extendDictionary:ce,fetchUrlAsArrayBuffer:de,readBlobAsArrayBuffer:he,chunkedProps:q,otherSegments:me,segments:ue,tiffBlocks:w,segmentsAndBlocks:$,tiffExtractables:Y,inheritables:_e,allFormatters:J,Options:pe});class ze{constructor(e,t,n){g(this,"errors",[]),g(this,"ensureSegmentChunk",async r=>{let s=r.start,a=r.size||65536;if(this.file.chunked)if(this.file.available(s,a))r.chunk=this.file.subarray(s,a);else try{r.chunk=await this.file.readChunk(s,a)}catch(o){C(`Couldn't read segment: ${JSON.stringify(r)}. ${o.message}`)}else this.file.byteLength>s+a?r.chunk=this.file.subarray(s,a):r.size===void 0?r.chunk=this.file.subarray(s):C("Segment unreachable: "+JSON.stringify(r));return r.chunk}),this.extendOptions&&this.extendOptions(e),this.options=e,this.file=t,this.parsers=n}injectSegment(e,t){this.options[e].enabled&&this.createParser(e,t)}createParser(e,t){let n=new(S.get(e))(t,this.options,this.file);return this.parsers[e]=n}createParsers(e){for(let t of e){let{type:n,chunk:r}=t,s=this.options[n];if(s&&s.enabled){let a=this.parsers[n];a&&a.append||a||this.createParser(n,r)}}}async readSegments(e){let t=e.map(this.ensureSegmentChunk);await Promise.all(t)}}class F{static findPosition(e,t){let n=e.getUint16(t+2)+2,r=typeof this.headerLength=="function"?this.headerLength(e,t,n):this.headerLength,s=t+r,a=n-r;return{offset:t,length:n,headerLength:r,start:s,size:a,end:s+a}}static parse(e,t={}){return new this(e,new pe({[this.type]:t}),e).parse()}normalizeInput(e){return e instanceof O?e:new O(e)}constructor(e,t={},n){g(this,"errors",[]),g(this,"raw",new Map),g(this,"handleError",r=>{if(!this.options.silentErrors)throw r;this.errors.push(r.message)}),this.chunk=this.normalizeInput(e),this.file=n,this.type=this.constructor.type,this.globalOptions=this.options=t,this.localOptions=t[this.type],this.canTranslate=this.localOptions&&this.localOptions.translate}translate(){this.canTranslate&&(this.translated=this.translateBlock(this.raw,this.type))}get output(){return this.translated?this.translated:this.raw?Object.fromEntries(this.raw):void 0}translateBlock(e,t){let n=Q.get(t),r=N.get(t),s=P.get(t),a=this.options[t],o=a.reviveValues&&!!n,l=a.translateValues&&!!r,c=a.translateKeys&&!!s,d={};for(let[u,p]of e)o&&n.has(u)?p=n.get(u)(p):l&&r.has(u)&&(p=this.translateValue(p,r.get(u))),c&&s.has(u)&&(u=s.get(u)||u),d[u]=p;return d}translateValue(e,t){return t[e]||t.DEFAULT||e}assignToOutput(e,t){this.assignObjectToOutput(e,this.constructor.type,t)}assignObjectToOutput(e,t,n){if(this.globalOptions.mergeOutput)return Object.assign(e,n);e[t]?Object.assign(e[t],n):e[t]=n}}g(F,"headerLength",4),g(F,"type",void 0),g(F,"multiSegment",!1),g(F,"canHandle",()=>!1);function Wn(i){return i===192||i===194||i===196||i===219||i===221||i===218||i===254}function jn(i){return i>=224&&i<=239}function Kn(i,e,t){for(let[n,r]of S)if(r.canHandle(i,e,t))return n}class It extends ze{constructor(...e){super(...e),g(this,"appSegments",[]),g(this,"jpegSegments",[]),g(this,"unknownSegments",[])}static canHandle(e,t){return t===65496}async parse(){await this.findAppSegments(),await this.readSegments(this.appSegments),this.mergeMultiSegments(),this.createParsers(this.mergedAppSegments||this.appSegments)}setupSegmentFinderArgs(e){e===!0?(this.findAll=!0,this.wanted=new Set(S.keyList())):(e=e===void 0?S.keyList().filter(t=>this.options[t].enabled):e.filter(t=>this.options[t].enabled&&S.has(t)),this.findAll=!1,this.remaining=new Set(e),this.wanted=new Set(e)),this.unfinishedMultiSegment=!1}async findAppSegments(e=0,t){this.setupSegmentFinderArgs(t);let{file:n,findAll:r,wanted:s,remaining:a}=this;if(!r&&this.file.chunked&&(r=Array.from(s).some(o=>{let l=S.get(o),c=this.options[o];return l.multiSegment&&c.multiSegment}),r&&await this.file.readWhole()),e=this.findAppSegmentsInRange(e,n.byteLength),!this.options.onlyTiff&&n.chunked){let o=!1;for(;a.size>0&&!o&&(n.canReadNextChunk||this.unfinishedMultiSegment);){let{nextChunkOffset:l}=n,c=this.appSegments.some(d=>!this.file.available(d.offset||d.start,d.length||d.size));if(o=e>l&&!c?!await n.readNextChunk(e):!await n.readNextChunk(l),(e=this.findAppSegmentsInRange(e,n.byteLength))===void 0)return}}}findAppSegmentsInRange(e,t){t-=2;let n,r,s,a,o,l,{file:c,findAll:d,wanted:u,remaining:p,options:h}=this;for(;e<t;e++)if(c.getUint8(e)===255){if(n=c.getUint8(e+1),jn(n)){if(r=c.getUint16(e+2),s=Kn(c,e,r),s&&u.has(s)&&(a=S.get(s),o=a.findPosition(c,e),l=h[s],o.type=s,this.appSegments.push(o),!d&&(a.multiSegment&&l.multiSegment?(this.unfinishedMultiSegment=o.chunkNumber<o.chunkCount,this.unfinishedMultiSegment||p.delete(s)):p.delete(s),p.size===0)))break;h.recordUnknownSegments&&(o=F.findPosition(c,e),o.marker=n,this.unknownSegments.push(o)),e+=r+1}else if(Wn(n)){if(r=c.getUint16(e+2),n===218&&h.stopAfterSos!==!1)return;h.recordJpegSegments&&this.jpegSegments.push({offset:e,length:r,marker:n}),e+=r+1}}return e}mergeMultiSegments(){if(!this.appSegments.some(t=>t.multiSegment))return;let e=function(t,n){let r,s,a,o=new Map;for(let l=0;l<t.length;l++)r=t[l],s=r[n],o.has(s)?a=o.get(s):o.set(s,a=[]),a.push(r);return Array.from(o)}(this.appSegments,"type");this.mergedAppSegments=e.map(([t,n])=>{let r=S.get(t,this.options);return r.handleMultiSegments?{type:t,chunk:r.handleMultiSegments(n)}:n[0]})}getSegment(e){return this.appSegments.find(t=>t.type===e)}async getOrFindSegment(e){let t=this.getSegment(e);return t===void 0&&(await this.findAppSegments(0,[e]),t=this.getSegment(e)),t}}g(It,"type","jpeg"),B.set("jpeg",It);const Xn=[void 0,1,1,2,4,8,1,1,2,4,8,4,8,4];class qn extends F{parseHeader(){var e=this.chunk.getUint16();e===18761?this.le=!0:e===19789&&(this.le=!1),this.chunk.le=this.le,this.headerParsed=!0}parseTags(e,t,n=new Map){let{pick:r,skip:s}=this.options[t];r=new Set(r);let a=r.size>0,o=s.size===0,l=this.chunk.getUint16(e);e+=2;for(let c=0;c<l;c++){let d=this.chunk.getUint16(e);if(a){if(r.has(d)&&(n.set(d,this.parseTag(e,d,t)),r.delete(d),r.size===0))break}else!o&&s.has(d)||n.set(d,this.parseTag(e,d,t));e+=12}return n}parseTag(e,t,n){let{chunk:r}=this,s=r.getUint16(e+2),a=r.getUint32(e+4),o=Xn[s];if(o*a<=4?e+=8:e=r.getUint32(e+8),(s<1||s>13)&&C(`Invalid TIFF value type. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e}`),e>r.byteLength&&C(`Invalid TIFF value offset. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${r.byteLength}`),s===1)return r.getUint8Array(e,a);if(s===2)return ae(r.getString(e,a));if(s===7)return r.getUint8Array(e,a);if(a===1)return this.parseTagValue(s,e);{let l=new(function(d){switch(d){case 1:return Uint8Array;case 3:return Uint16Array;case 4:return Uint32Array;case 5:return Array;case 6:return Int8Array;case 8:return Int16Array;case 9:return Int32Array;case 10:return Array;case 11:return Float32Array;case 12:return Float64Array;default:return Array}}(s))(a),c=o;for(let d=0;d<a;d++)l[d]=this.parseTagValue(s,e),e+=c;return l}}parseTagValue(e,t){let{chunk:n}=this;switch(e){case 1:return n.getUint8(t);case 3:return n.getUint16(t);case 4:return n.getUint32(t);case 5:return n.getUint32(t)/n.getUint32(t+4);case 6:return n.getInt8(t);case 8:return n.getInt16(t);case 9:return n.getInt32(t);case 10:return n.getInt32(t)/n.getInt32(t+4);case 11:return n.getFloat(t);case 12:return n.getDouble(t);case 13:return n.getUint32(t);default:C(`Invalid tiff type ${e}`)}}}class Ye extends qn{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1165519206&&e.getUint16(t+8)===0}async parse(){this.parseHeader();let{options:e}=this;return e.ifd0.enabled&&await this.parseIfd0Block(),e.exif.enabled&&await this.safeParse("parseExifBlock"),e.gps.enabled&&await this.safeParse("parseGpsBlock"),e.interop.enabled&&await this.safeParse("parseInteropBlock"),e.ifd1.enabled&&await this.safeParse("parseThumbnailBlock"),this.createOutput()}safeParse(e){let t=this[e]();return t.catch!==void 0&&(t=t.catch(this.handleError)),t}findIfd0Offset(){this.ifd0Offset===void 0&&(this.ifd0Offset=this.chunk.getUint32(4))}findIfd1Offset(){if(this.ifd1Offset===void 0){this.findIfd0Offset();let e=this.chunk.getUint16(this.ifd0Offset),t=this.ifd0Offset+2+12*e;this.ifd1Offset=this.chunk.getUint32(t)}}parseBlock(e,t){let n=new Map;return this[t]=n,this.parseTags(e,t,n),n}async parseIfd0Block(){if(this.ifd0)return;let{file:e}=this;this.findIfd0Offset(),this.ifd0Offset<8&&C("Malformed EXIF data"),!e.chunked&&this.ifd0Offset>e.byteLength&&C(`IFD0 offset points to outside of file.
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`),e.tiff&&await e.ensureChunk(this.ifd0Offset,it(this.options));let t=this.parseBlock(this.ifd0Offset,"ifd0");return t.size!==0?(this.exifOffset=t.get(34665),this.interopOffset=t.get(40965),this.gpsOffset=t.get(34853),this.xmp=t.get(700),this.iptc=t.get(33723),this.icc=t.get(34675),this.options.sanitize&&(t.delete(34665),t.delete(40965),t.delete(34853),t.delete(700),t.delete(33723),t.delete(34675)),t):void 0}async parseExifBlock(){if(this.exif||(this.ifd0||await this.parseIfd0Block(),this.exifOffset===void 0))return;this.file.tiff&&await this.file.ensureChunk(this.exifOffset,it(this.options));let e=this.parseBlock(this.exifOffset,"exif");return this.interopOffset||(this.interopOffset=e.get(40965)),this.makerNote=e.get(37500),this.userComment=e.get(37510),this.options.sanitize&&(e.delete(40965),e.delete(37500),e.delete(37510)),this.unpack(e,41728),this.unpack(e,41729),e}unpack(e,t){let n=e.get(t);n&&n.length===1&&e.set(t,n[0])}async parseGpsBlock(){if(this.gps||(this.ifd0||await this.parseIfd0Block(),this.gpsOffset===void 0))return;let e=this.parseBlock(this.gpsOffset,"gps");return e&&e.has(2)&&e.has(4)&&(e.set("latitude",At(...e.get(2),e.get(1))),e.set("longitude",At(...e.get(4),e.get(3)))),e}async parseInteropBlock(){if(!this.interop&&(this.ifd0||await this.parseIfd0Block(),this.interopOffset!==void 0||this.exif||await this.parseExifBlock(),this.interopOffset!==void 0))return this.parseBlock(this.interopOffset,"interop")}async parseThumbnailBlock(e=!1){if(!this.ifd1&&!this.ifd1Parsed&&(!this.options.mergeOutput||e))return this.findIfd1Offset(),this.ifd1Offset>0&&(this.parseBlock(this.ifd1Offset,"ifd1"),this.ifd1Parsed=!0),this.ifd1}async extractThumbnail(){if(this.headerParsed||this.parseHeader(),this.ifd1Parsed||await this.parseThumbnailBlock(!0),this.ifd1===void 0)return;let e=this.ifd1.get(513),t=this.ifd1.get(514);return this.chunk.getUint8Array(e,t)}get image(){return this.ifd0}get thumbnail(){return this.ifd1}createOutput(){let e,t,n,r={};for(t of w)if(e=this[t],!jt(e))if(n=this.canTranslate?this.translateBlock(e,t):Object.fromEntries(e),this.options.mergeOutput){if(t==="ifd1")continue;Object.assign(r,n)}else r[t]=n;return this.makerNote&&(r.makerNote=this.makerNote),this.userComment&&(r.userComment=this.userComment),r}assignToOutput(e,t){if(this.globalOptions.mergeOutput)Object.assign(e,t);else for(let[n,r]of Object.entries(t))this.assignObjectToOutput(e,n,r)}}function At(i,e,t,n){var r=i+e/60+t/3600;return n!=="S"&&n!=="W"||(r*=-1),r}g(Ye,"type","tiff"),g(Ye,"headerLength",10),S.set("tiff",Ye);var $n=Object.freeze({__proto__:null,default:Gn,Exifr:Z,fileParsers:B,segmentParsers:S,fileReaders:V,tagKeys:P,tagValues:N,tagRevivers:Q,createDictionary:x,extendDictionary:ce,fetchUrlAsArrayBuffer:de,readBlobAsArrayBuffer:he,chunkedProps:q,otherSegments:me,segments:ue,tiffBlocks:w,segmentsAndBlocks:$,tiffExtractables:Y,inheritables:_e,allFormatters:J,Options:pe,parse:Ve});const ht={ifd0:!1,ifd1:!1,exif:!1,gps:!1,interop:!1,sanitize:!1,reviveValues:!0,translateKeys:!1,translateValues:!1,mergeOutput:!1},ct=Object.assign({},ht,{firstChunkSize:4e4,gps:[1,2,3,4]});async function qt(i){let e=new Z(ct);await e.read(i);let t=await e.parse();if(t&&t.gps){let{latitude:n,longitude:r}=t.gps;return{latitude:n,longitude:r}}}const ut=Object.assign({},ht,{tiff:!1,ifd1:!0,mergeOutput:!1});async function $t(i){let e=new Z(ut);await e.read(i);let t=await e.extractThumbnail();return t&&Be?Ue.from(t):t}async function Yt(i){let e=await this.thumbnail(i);if(e!==void 0){let t=new Blob([e]);return URL.createObjectURL(t)}}const pt=Object.assign({},ht,{firstChunkSize:4e4,ifd0:[274]});async function ft(i){let e=new Z(pt);await e.read(i);let t=await e.parse();if(t&&t.ifd0)return t.ifd0[274]}const gt=Object.freeze({1:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:0,rad:0},2:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:0,rad:0},3:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:180,rad:180*Math.PI/180},4:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:180,rad:180*Math.PI/180},5:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:90,rad:90*Math.PI/180},6:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:90,rad:90*Math.PI/180},7:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:270,rad:270*Math.PI/180},8:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:270,rad:270*Math.PI/180}});let oe=!0,le=!0;if(typeof navigator=="object"){let i=navigator.userAgent;if(i.includes("iPad")||i.includes("iPhone")){let e=i.match(/OS (\d+)_(\d+)/);if(e){let[,t,n]=e;oe=Number(t)+.1*Number(n)<13.4,le=!1}}else if(i.includes("OS X 10")){let[,e]=i.match(/OS X 10[_.](\d+)/);oe=le=Number(e)<15}if(i.includes("Chrome/")){let[,e]=i.match(/Chrome\/(\d+)/);oe=le=Number(e)<81}else if(i.includes("Firefox/")){let[,e]=i.match(/Firefox\/(\d+)/);oe=le=Number(e)<77}}async function Jt(i){let e=await ft(i);return Object.assign({canvas:oe,css:le},gt[e])}class Yn extends O{constructor(...e){super(...e),g(this,"ranges",new Jn),this.byteLength!==0&&this.ranges.add(0,this.byteLength)}_tryExtend(e,t,n){if(e===0&&this.byteLength===0&&n){let r=new DataView(n.buffer||n,n.byteOffset,n.byteLength);this._swapDataView(r)}else{let r=e+t;if(r>this.byteLength){let{dataView:s}=this._extend(r);this._swapDataView(s)}}}_extend(e){let t;t=Be?Ue.allocUnsafe(e):new Uint8Array(e);let n=new DataView(t.buffer,t.byteOffset,t.byteLength);return t.set(new Uint8Array(this.buffer,this.byteOffset,this.byteLength),0),{uintView:t,dataView:n}}subarray(e,t,n=!1){return t=t||this._lengthToEnd(e),n&&this._tryExtend(e,t),this.ranges.add(e,t),super.subarray(e,t)}set(e,t,n=!1){n&&this._tryExtend(t,e.byteLength,e);let r=super.set(e,t);return this.ranges.add(t,r.byteLength),r}async ensureChunk(e,t){this.chunked&&(this.ranges.available(e,t)||await this.readChunk(e,t))}available(e,t){return this.ranges.available(e,t)}}class Jn{constructor(){g(this,"list",[])}get length(){return this.list.length}add(e,t,n=0){let r=e+t,s=this.list.filter(a=>Tt(e,a.offset,r)||Tt(e,a.end,r));if(s.length>0){e=Math.min(e,...s.map(o=>o.offset)),r=Math.max(r,...s.map(o=>o.end)),t=r-e;let a=s.shift();a.offset=e,a.length=t,a.end=r,this.list=this.list.filter(o=>!s.includes(o))}else this.list.push({offset:e,length:t,end:r})}available(e,t){let n=e+t;return this.list.some(r=>r.offset<=e&&n<=r.end)}}function Tt(i,e,t){return i<=e&&e<=t}class He extends Yn{constructor(e,t){super(0),g(this,"chunksRead",0),this.input=e,this.options=t}async readWhole(){this.chunked=!1,await this.readChunk(this.nextChunkOffset)}async readChunked(){this.chunked=!0,await this.readChunk(0,this.options.firstChunkSize)}async readNextChunk(e=this.nextChunkOffset){if(this.fullyRead)return this.chunksRead++,!1;let t=this.options.chunkSize,n=await this.readChunk(e,t);return!!n&&n.byteLength===t}async readChunk(e,t){if(this.chunksRead++,(t=this.safeWrapAddress(e,t))!==0)return this._readChunk(e,t)}safeWrapAddress(e,t){return this.size!==void 0&&e+t>this.size?Math.max(0,this.size-e):t}get nextChunkOffset(){if(this.ranges.list.length!==0)return this.ranges.list[0].length}get canReadNextChunk(){return this.chunksRead<this.options.chunkLimit}get fullyRead(){return this.size!==void 0&&this.nextChunkOffset===this.size}read(){return this.options.chunked?this.readChunked():this.readWhole()}close(){}}V.set("blob",class extends He{async readWhole(){this.chunked=!1;let i=await he(this.input);this._swapArrayBuffer(i)}readChunked(){return this.chunked=!0,this.size=this.input.size,super.readChunked()}async _readChunk(i,e){let t=e?i+e:void 0,n=this.input.slice(i,t),r=await he(n);return this.set(r,i,!0)}});var Qn=Object.freeze({__proto__:null,default:$n,Exifr:Z,fileParsers:B,segmentParsers:S,fileReaders:V,tagKeys:P,tagValues:N,tagRevivers:Q,createDictionary:x,extendDictionary:ce,fetchUrlAsArrayBuffer:de,readBlobAsArrayBuffer:he,chunkedProps:q,otherSegments:me,segments:ue,tiffBlocks:w,segmentsAndBlocks:$,tiffExtractables:Y,inheritables:_e,allFormatters:J,Options:pe,parse:Ve,gpsOnlyOptions:ct,gps:qt,thumbnailOnlyOptions:ut,thumbnail:$t,thumbnailUrl:Yt,orientationOnlyOptions:pt,orientation:ft,rotations:gt,get rotateCanvas(){return oe},get rotateCss(){return le},rotation:Jt});V.set("url",class extends He{async readWhole(){this.chunked=!1;let i=await de(this.input);i instanceof ArrayBuffer?this._swapArrayBuffer(i):i instanceof Uint8Array&&this._swapBuffer(i)}async _readChunk(i,e){let t=e?i+e-1:void 0,n=this.options.httpHeaders||{};(i||t)&&(n.range=`bytes=${[i,t].join("-")}`);let r=await lt(this.input,{headers:n}),s=await r.arrayBuffer(),a=s.byteLength;if(r.status!==416)return a!==e&&(this.size=i+a),this.set(s,i,!0)}});O.prototype.getUint64=function(i){let e=this.getUint32(i),t=this.getUint32(i+4);return e<1048575?e<<32|t:typeof Ae!==void 0?(console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."),Ae(e)<<Ae(32)|Ae(t)):void C("Trying to read 64b value but JS can only handle 53b numbers.")};class Zn extends ze{parseBoxes(e=0){let t=[];for(;e<this.file.byteLength-4;){let n=this.parseBoxHead(e);if(t.push(n),n.length===0)break;e+=n.length}return t}parseSubBoxes(e){e.boxes=this.parseBoxes(e.start)}findBox(e,t){return e.boxes===void 0&&this.parseSubBoxes(e),e.boxes.find(n=>n.kind===t)}parseBoxHead(e){let t=this.file.getUint32(e),n=this.file.getString(e+4,4),r=e+8;return t===1&&(t=this.file.getUint64(e+8),r+=8),{offset:e,length:t,kind:n,start:r}}parseBoxFullHead(e){if(e.version!==void 0)return;let t=this.file.getUint32(e.start);e.version=t>>24,e.start+=4}}class Qt extends Zn{static canHandle(e,t){if(t!==0)return!1;let n=e.getUint16(2);if(n>50)return!1;let r=16,s=[];for(;r<n;)s.push(e.getString(r,4)),r+=4;return s.includes(this.type)}async parse(){let e=this.file.getUint32(0),t=this.parseBoxHead(e);for(;t.kind!=="meta";)e+=t.length,await this.file.ensureChunk(e,16),t=this.parseBoxHead(e);await this.file.ensureChunk(t.offset,t.length),this.parseBoxFullHead(t),this.parseSubBoxes(t),this.options.icc.enabled&&await this.findIcc(t),this.options.tiff.enabled&&await this.findExif(t)}async registerSegment(e,t,n){await this.file.ensureChunk(t,n);let r=this.file.subarray(t,n);this.createParser(e,r)}async findIcc(e){let t=this.findBox(e,"iprp");if(t===void 0)return;let n=this.findBox(t,"ipco");if(n===void 0)return;let r=this.findBox(n,"colr");r!==void 0&&await this.registerSegment("icc",r.offset+12,r.length)}async findExif(e){let t=this.findBox(e,"iinf");if(t===void 0)return;let n=this.findBox(e,"iloc");if(n===void 0)return;let r=this.findExifLocIdInIinf(t),s=this.findExtentInIloc(n,r);if(s===void 0)return;let[a,o]=s;await this.file.ensureChunk(a,o);let l=4+this.file.getUint32(a);a+=l,o-=l,await this.registerSegment("tiff",a,o)}findExifLocIdInIinf(e){this.parseBoxFullHead(e);let t,n,r,s,a=e.start,o=this.file.getUint16(a);for(a+=2;o--;){if(t=this.parseBoxHead(a),this.parseBoxFullHead(t),n=t.start,t.version>=2&&(r=t.version===3?4:2,s=this.file.getString(n+r+2,4),s==="Exif"))return this.file.getUintBytes(n,r);a+=t.length}}get8bits(e){let t=this.file.getUint8(e);return[t>>4,15&t]}findExtentInIloc(e,t){this.parseBoxFullHead(e);let n=e.start,[r,s]=this.get8bits(n++),[a,o]=this.get8bits(n++),l=e.version===2?4:2,c=e.version===1||e.version===2?2:0,d=o+r+s,u=e.version===2?4:2,p=this.file.getUintBytes(n,u);for(n+=u;p--;){let h=this.file.getUintBytes(n,l);n+=l+c+2+a;let y=this.file.getUint16(n);if(n+=2,h===t)return y>1&&console.warn(`ILOC box has more than one extent but we're only processing one
Please create an issue at https://github.com/MikeKovarik/exifr with this file`),[this.file.getUintBytes(n+o,r),this.file.getUintBytes(n+o+r,s)];n+=y*d}}}class Zt extends Qt{}g(Zt,"type","heic");class Lt extends Qt{}g(Lt,"type","avif"),B.set("heic",Zt),B.set("avif",Lt),x(P,["ifd0","ifd1"],[[256,"ImageWidth"],[257,"ImageHeight"],[258,"BitsPerSample"],[259,"Compression"],[262,"PhotometricInterpretation"],[270,"ImageDescription"],[271,"Make"],[272,"Model"],[273,"StripOffsets"],[274,"Orientation"],[277,"SamplesPerPixel"],[278,"RowsPerStrip"],[279,"StripByteCounts"],[282,"XResolution"],[283,"YResolution"],[284,"PlanarConfiguration"],[296,"ResolutionUnit"],[301,"TransferFunction"],[305,"Software"],[306,"ModifyDate"],[315,"Artist"],[316,"HostComputer"],[317,"Predictor"],[318,"WhitePoint"],[319,"PrimaryChromaticities"],[513,"ThumbnailOffset"],[514,"ThumbnailLength"],[529,"YCbCrCoefficients"],[530,"YCbCrSubSampling"],[531,"YCbCrPositioning"],[532,"ReferenceBlackWhite"],[700,"ApplicationNotes"],[33432,"Copyright"],[33723,"IPTC"],[34665,"ExifIFD"],[34675,"ICC"],[34853,"GpsIFD"],[330,"SubIFD"],[40965,"InteropIFD"],[40091,"XPTitle"],[40092,"XPComment"],[40093,"XPAuthor"],[40094,"XPKeywords"],[40095,"XPSubject"]]),x(P,"exif",[[33434,"ExposureTime"],[33437,"FNumber"],[34850,"ExposureProgram"],[34852,"SpectralSensitivity"],[34855,"ISO"],[34858,"TimeZoneOffset"],[34859,"SelfTimerMode"],[34864,"SensitivityType"],[34865,"StandardOutputSensitivity"],[34866,"RecommendedExposureIndex"],[34867,"ISOSpeed"],[34868,"ISOSpeedLatitudeyyy"],[34869,"ISOSpeedLatitudezzz"],[36864,"ExifVersion"],[36867,"DateTimeOriginal"],[36868,"CreateDate"],[36873,"GooglePlusUploadCode"],[36880,"OffsetTime"],[36881,"OffsetTimeOriginal"],[36882,"OffsetTimeDigitized"],[37121,"ComponentsConfiguration"],[37122,"CompressedBitsPerPixel"],[37377,"ShutterSpeedValue"],[37378,"ApertureValue"],[37379,"BrightnessValue"],[37380,"ExposureCompensation"],[37381,"MaxApertureValue"],[37382,"SubjectDistance"],[37383,"MeteringMode"],[37384,"LightSource"],[37385,"Flash"],[37386,"FocalLength"],[37393,"ImageNumber"],[37394,"SecurityClassification"],[37395,"ImageHistory"],[37396,"SubjectArea"],[37500,"MakerNote"],[37510,"UserComment"],[37520,"SubSecTime"],[37521,"SubSecTimeOriginal"],[37522,"SubSecTimeDigitized"],[37888,"AmbientTemperature"],[37889,"Humidity"],[37890,"Pressure"],[37891,"WaterDepth"],[37892,"Acceleration"],[37893,"CameraElevationAngle"],[40960,"FlashpixVersion"],[40961,"ColorSpace"],[40962,"ExifImageWidth"],[40963,"ExifImageHeight"],[40964,"RelatedSoundFile"],[41483,"FlashEnergy"],[41486,"FocalPlaneXResolution"],[41487,"FocalPlaneYResolution"],[41488,"FocalPlaneResolutionUnit"],[41492,"SubjectLocation"],[41493,"ExposureIndex"],[41495,"SensingMethod"],[41728,"FileSource"],[41729,"SceneType"],[41730,"CFAPattern"],[41985,"CustomRendered"],[41986,"ExposureMode"],[41987,"WhiteBalance"],[41988,"DigitalZoomRatio"],[41989,"FocalLengthIn35mmFormat"],[41990,"SceneCaptureType"],[41991,"GainControl"],[41992,"Contrast"],[41993,"Saturation"],[41994,"Sharpness"],[41996,"SubjectDistanceRange"],[42016,"ImageUniqueID"],[42032,"OwnerName"],[42033,"SerialNumber"],[42034,"LensInfo"],[42035,"LensMake"],[42036,"LensModel"],[42037,"LensSerialNumber"],[42080,"CompositeImage"],[42081,"CompositeImageCount"],[42082,"CompositeImageExposureTimes"],[42240,"Gamma"],[59932,"Padding"],[59933,"OffsetSchema"],[65e3,"OwnerName"],[65001,"SerialNumber"],[65002,"Lens"],[65100,"RawFile"],[65101,"Converter"],[65102,"WhiteBalance"],[65105,"Exposure"],[65106,"Shadows"],[65107,"Brightness"],[65108,"Contrast"],[65109,"Saturation"],[65110,"Sharpness"],[65111,"Smoothness"],[65112,"MoireFilter"],[40965,"InteropIFD"]]),x(P,"gps",[[0,"GPSVersionID"],[1,"GPSLatitudeRef"],[2,"GPSLatitude"],[3,"GPSLongitudeRef"],[4,"GPSLongitude"],[5,"GPSAltitudeRef"],[6,"GPSAltitude"],[7,"GPSTimeStamp"],[8,"GPSSatellites"],[9,"GPSStatus"],[10,"GPSMeasureMode"],[11,"GPSDOP"],[12,"GPSSpeedRef"],[13,"GPSSpeed"],[14,"GPSTrackRef"],[15,"GPSTrack"],[16,"GPSImgDirectionRef"],[17,"GPSImgDirection"],[18,"GPSMapDatum"],[19,"GPSDestLatitudeRef"],[20,"GPSDestLatitude"],[21,"GPSDestLongitudeRef"],[22,"GPSDestLongitude"],[23,"GPSDestBearingRef"],[24,"GPSDestBearing"],[25,"GPSDestDistanceRef"],[26,"GPSDestDistance"],[27,"GPSProcessingMethod"],[28,"GPSAreaInformation"],[29,"GPSDateStamp"],[30,"GPSDifferential"],[31,"GPSHPositioningError"]]),x(N,["ifd0","ifd1"],[[274,{1:"Horizontal (normal)",2:"Mirror horizontal",3:"Rotate 180",4:"Mirror vertical",5:"Mirror horizontal and rotate 270 CW",6:"Rotate 90 CW",7:"Mirror horizontal and rotate 90 CW",8:"Rotate 270 CW"}],[296,{1:"None",2:"inches",3:"cm"}]]);let Se=x(N,"exif",[[34850,{0:"Not defined",1:"Manual",2:"Normal program",3:"Aperture priority",4:"Shutter priority",5:"Creative program",6:"Action program",7:"Portrait mode",8:"Landscape mode"}],[37121,{0:"-",1:"Y",2:"Cb",3:"Cr",4:"R",5:"G",6:"B"}],[37383,{0:"Unknown",1:"Average",2:"CenterWeightedAverage",3:"Spot",4:"MultiSpot",5:"Pattern",6:"Partial",255:"Other"}],[37384,{0:"Unknown",1:"Daylight",2:"Fluorescent",3:"Tungsten (incandescent light)",4:"Flash",9:"Fine weather",10:"Cloudy weather",11:"Shade",12:"Daylight fluorescent (D 5700 - 7100K)",13:"Day white fluorescent (N 4600 - 5400K)",14:"Cool white fluorescent (W 3900 - 4500K)",15:"White fluorescent (WW 3200 - 3700K)",17:"Standard light A",18:"Standard light B",19:"Standard light C",20:"D55",21:"D65",22:"D75",23:"D50",24:"ISO studio tungsten",255:"Other"}],[37385,{0:"Flash did not fire",1:"Flash fired",5:"Strobe return light not detected",7:"Strobe return light detected",9:"Flash fired, compulsory flash mode",13:"Flash fired, compulsory flash mode, return light not detected",15:"Flash fired, compulsory flash mode, return light detected",16:"Flash did not fire, compulsory flash mode",24:"Flash did not fire, auto mode",25:"Flash fired, auto mode",29:"Flash fired, auto mode, return light not detected",31:"Flash fired, auto mode, return light detected",32:"No flash function",65:"Flash fired, red-eye reduction mode",69:"Flash fired, red-eye reduction mode, return light not detected",71:"Flash fired, red-eye reduction mode, return light detected",73:"Flash fired, compulsory flash mode, red-eye reduction mode",77:"Flash fired, compulsory flash mode, red-eye reduction mode, return light not detected",79:"Flash fired, compulsory flash mode, red-eye reduction mode, return light detected",89:"Flash fired, auto mode, red-eye reduction mode",93:"Flash fired, auto mode, return light not detected, red-eye reduction mode",95:"Flash fired, auto mode, return light detected, red-eye reduction mode"}],[41495,{1:"Not defined",2:"One-chip color area sensor",3:"Two-chip color area sensor",4:"Three-chip color area sensor",5:"Color sequential area sensor",7:"Trilinear sensor",8:"Color sequential linear sensor"}],[41728,{1:"Film Scanner",2:"Reflection Print Scanner",3:"Digital Camera"}],[41729,{1:"Directly photographed"}],[41985,{0:"Normal",1:"Custom",2:"HDR (no original saved)",3:"HDR (original saved)",4:"Original (for HDR)",6:"Panorama",7:"Portrait HDR",8:"Portrait"}],[41986,{0:"Auto",1:"Manual",2:"Auto bracket"}],[41987,{0:"Auto",1:"Manual"}],[41990,{0:"Standard",1:"Landscape",2:"Portrait",3:"Night",4:"Other"}],[41991,{0:"None",1:"Low gain up",2:"High gain up",3:"Low gain down",4:"High gain down"}],[41996,{0:"Unknown",1:"Macro",2:"Close",3:"Distant"}],[42080,{0:"Unknown",1:"Not a Composite Image",2:"General Composite Image",3:"Composite Image Captured While Shooting"}]]);const Rt={1:"No absolute unit of measurement",2:"Inch",3:"Centimeter"};Se.set(37392,Rt),Se.set(41488,Rt);const Je={0:"Normal",1:"Low",2:"High"};function Ot(i){return typeof i=="object"&&i.length!==void 0?i[0]:i}function Dt(i){let e=Array.from(i).slice(1);return e[1]>15&&(e=e.map(t=>String.fromCharCode(t))),e[2]!=="0"&&e[2]!==0||e.pop(),e.join(".")}function Qe(i){if(typeof i=="string"){var[e,t,n,r,s,a]=i.trim().split(/[-: ]/g).map(Number),o=new Date(e,t-1,n);return Number.isNaN(r)||Number.isNaN(s)||Number.isNaN(a)||(o.setHours(r),o.setMinutes(s),o.setSeconds(a)),Number.isNaN(+o)?i:o}}function ke(i){if(typeof i=="string")return i;let e=[];if(i[1]===0&&i[i.length-1]===0)for(let t=0;t<i.length;t+=2)e.push(Mt(i[t+1],i[t]));else for(let t=0;t<i.length;t+=2)e.push(Mt(i[t],i[t+1]));return ae(String.fromCodePoint(...e))}function Mt(i,e){return i<<8|e}Se.set(41992,Je),Se.set(41993,Je),Se.set(41994,Je),x(Q,["ifd0","ifd1"],[[50827,function(i){return typeof i!="string"?Kt(i):i}],[306,Qe],[40091,ke],[40092,ke],[40093,ke],[40094,ke],[40095,ke]]),x(Q,"exif",[[40960,Dt],[36864,Dt],[36867,Qe],[36868,Qe],[40962,Ot],[40963,Ot]]),x(Q,"gps",[[0,i=>Array.from(i).join(".")],[7,i=>Array.from(i).join(":")]]);class Ze extends F{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1752462448&&e.getString(t+4,20)==="http://ns.adobe.com/"}static headerLength(e,t){return e.getString(t+4,34)==="http://ns.adobe.com/xmp/extension/"?79:33}static findPosition(e,t){let n=super.findPosition(e,t);return n.multiSegment=n.extended=n.headerLength===79,n.multiSegment?(n.chunkCount=e.getUint8(t+72),n.chunkNumber=e.getUint8(t+76),e.getUint8(t+77)!==0&&n.chunkNumber++):(n.chunkCount=1/0,n.chunkNumber=-1),n}static handleMultiSegments(e){return e.map(t=>t.chunk.getString()).join("")}normalizeInput(e){return typeof e=="string"?e:O.from(e).getString()}parse(e=this.chunk){if(!this.localOptions.parse)return e;e=function(s){let a={},o={};for(let l of rn)a[l]=[],o[l]=0;return s.replace(ii,(l,c,d)=>{if(c==="<"){let u=++o[d];return a[d].push(u),`${l}#${u}`}return`${l}#${a[d].pop()}`})}(e);let t=ge.findAll(e,"rdf","Description");t.length===0&&t.push(new ge("rdf","Description",void 0,e));let n,r={};for(let s of t)for(let a of s.properties)n=ni(a.ns,r),en(a,n);return function(s){let a;for(let o in s)a=s[o]=Me(s[o]),a===void 0&&delete s[o];return Me(s)}(r)}assignToOutput(e,t){if(this.localOptions.parse)for(let[n,r]of Object.entries(t))switch(n){case"tiff":this.assignObjectToOutput(e,"ifd0",r);break;case"exif":this.assignObjectToOutput(e,"exif",r);break;case"xmlns":break;default:this.assignObjectToOutput(e,n,r)}else e.xmp=t}}g(Ze,"type","xmp"),g(Ze,"multiSegment",!0),S.set("xmp",Ze);class Fe{static findAll(e){return tn(e,/([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(Fe.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],r=e[3].slice(1,-1);return r=nn(r),new Fe(t,n,r)}constructor(e,t,n){this.ns=e,this.name=t,this.value=n}serialize(){return this.value}}class ge{static findAll(e,t,n){if(t!==void 0||n!==void 0){t=t||"[\\w\\d-]+",n=n||"[\\w\\d-]+";var r=new RegExp(`<(${t}):(${n})(#\\d+)?((\\s+?[\\w\\d-:]+=("[^"]*"|'[^']*'))*\\s*)(\\/>|>([\\s\\S]*?)<\\/\\1:\\2\\3>)`,"gm")}else r=/<([\w\d-]+):([\w\d-]+)(#\d+)?((\s+?[\w\d-:]+=("[^"]*"|'[^']*'))*\s*)(\/>|>([\s\S]*?)<\/\1:\2\3>)/gm;return tn(e,r).map(ge.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],r=e[4],s=e[8];return new ge(t,n,r,s)}constructor(e,t,n,r){this.ns=e,this.name=t,this.attrString=n,this.innerXml=r,this.attrs=Fe.findAll(n),this.children=ge.findAll(r),this.value=this.children.length===0?nn(r):void 0,this.properties=[...this.attrs,...this.children]}get isPrimitive(){return this.value!==void 0&&this.attrs.length===0&&this.children.length===0}get isListContainer(){return this.children.length===1&&this.children[0].isList}get isList(){let{ns:e,name:t}=this;return e==="rdf"&&(t==="Seq"||t==="Bag"||t==="Alt")}get isListItem(){return this.ns==="rdf"&&this.name==="li"}serialize(){if(this.properties.length===0&&this.value===void 0)return;if(this.isPrimitive)return this.value;if(this.isListContainer)return this.children[0].serialize();if(this.isList)return ti(this.children.map(ei));if(this.isListItem&&this.children.length===1&&this.attrs.length===0)return this.children[0].serialize();let e={};for(let t of this.properties)en(t,e);return this.value!==void 0&&(e.value=this.value),Me(e)}}function en(i,e){let t=i.serialize();t!==void 0&&(e[i.name]=t)}var ei=i=>i.serialize(),ti=i=>i.length===1?i[0]:i,ni=(i,e)=>e[i]?e[i]:e[i]={};function tn(i,e){let t,n=[];if(!i)return n;for(;(t=e.exec(i))!==null;)n.push(t);return n}function nn(i){if(function(n){return n==null||n==="null"||n==="undefined"||n===""||n.trim()===""}(i))return;let e=Number(i);if(!Number.isNaN(e))return e;let t=i.toLowerCase();return t==="true"||t!=="false"&&i.trim()}const rn=["rdf:li","rdf:Seq","rdf:Bag","rdf:Alt","rdf:Description"],ii=new RegExp(`(<|\\/)(${rn.join("|")})`,"g");var ri=Object.freeze({__proto__:null,default:Qn,Exifr:Z,fileParsers:B,segmentParsers:S,fileReaders:V,tagKeys:P,tagValues:N,tagRevivers:Q,createDictionary:x,extendDictionary:ce,fetchUrlAsArrayBuffer:de,readBlobAsArrayBuffer:he,chunkedProps:q,otherSegments:me,segments:ue,tiffBlocks:w,segmentsAndBlocks:$,tiffExtractables:Y,inheritables:_e,allFormatters:J,Options:pe,parse:Ve,gpsOnlyOptions:ct,gps:qt,thumbnailOnlyOptions:ut,thumbnail:$t,thumbnailUrl:Yt,orientationOnlyOptions:pt,orientation:ft,rotations:gt,get rotateCanvas(){return oe},get rotateCss(){return le},rotation:Jt});let Et=De("fs",i=>i.promises);V.set("fs",class extends He{async readWhole(){this.chunked=!1,this.fs=await Et;let i=await this.fs.readFile(this.input);this._swapBuffer(i)}async readChunked(){this.chunked=!0,this.fs=await Et,await this.open(),await this.readChunk(0,this.options.firstChunkSize)}async open(){this.fh===void 0&&(this.fh=await this.fs.open(this.input,"r"),this.size=(await this.fh.stat(this.input)).size)}async _readChunk(i,e){this.fh===void 0&&await this.open(),i+e>this.size&&(e=this.size-i);var t=this.subarray(i,e,!0);return await this.fh.read(t.dataView,0,e,i),t}async close(){if(this.fh){let i=this.fh;this.fh=void 0,await i.close()}}});V.set("base64",class extends He{constructor(...i){super(...i),this.input=this.input.replace(/^data:([^;]+);base64,/gim,""),this.size=this.input.length/4*3,this.input.endsWith("==")?this.size-=2:this.input.endsWith("=")&&(this.size-=1)}async _readChunk(i,e){let t,n,r=this.input;i===void 0?(i=0,t=0,n=0):(t=4*Math.floor(i/3),n=i-t/4*3),e===void 0&&(e=this.size);let s=i+e,a=t+4*Math.ceil(s/3);r=r.slice(t,a);let o=Math.min(e,this.size-i);if(Be){let l=Ue.from(r,"base64").slice(n,n+o);return this.set(l,i,!0)}{let l=this.subarray(i,o,!0),c=atob(r),d=l.toUint8();for(let u=0;u<o;u++)d[u]=c.charCodeAt(n+u);return l}}});class Ft extends ze{static canHandle(e,t){return t===18761||t===19789}extendOptions(e){let{ifd0:t,xmp:n,iptc:r,icc:s}=e;n.enabled&&t.deps.add(700),r.enabled&&t.deps.add(33723),s.enabled&&t.deps.add(34675),t.finalizeFilters()}async parse(){let{tiff:e,xmp:t,iptc:n,icc:r}=this.options;if(e.enabled||t.enabled||n.enabled||r.enabled){let s=Math.max(it(this.options),this.options.chunkSize);await this.file.ensureChunk(0,s),this.createParser("tiff",this.file),this.parsers.tiff.parseHeader(),await this.parsers.tiff.parseIfd0Block(),this.adaptTiffPropAsSegment("xmp"),this.adaptTiffPropAsSegment("iptc"),this.adaptTiffPropAsSegment("icc")}}adaptTiffPropAsSegment(e){if(this.parsers.tiff[e]){let t=this.parsers.tiff[e];this.injectSegment(e,t)}}}g(Ft,"type","tiff"),B.set("tiff",Ft);let si=De("zlib");const ai=["ihdr","iccp","text","itxt","exif"];class Nt extends ze{constructor(...e){super(...e),g(this,"catchError",t=>this.errors.push(t)),g(this,"metaChunks",[]),g(this,"unknownChunks",[])}static canHandle(e,t){return t===35152&&e.getUint32(0)===2303741511&&e.getUint32(4)===218765834}async parse(){let{file:e}=this;await this.findPngChunksInRange(8,e.byteLength),await this.readSegments(this.metaChunks),this.findIhdr(),this.parseTextChunks(),await this.findExif().catch(this.catchError),await this.findXmp().catch(this.catchError),await this.findIcc().catch(this.catchError)}async findPngChunksInRange(e,t){let{file:n}=this;for(;e<t;){let r=n.getUint32(e),s=n.getUint32(e+4),a=n.getString(e+4,4).toLowerCase(),o=r+4+4+4,l={type:a,offset:e,length:o,start:e+4+4,size:r,marker:s};ai.includes(a)?this.metaChunks.push(l):this.unknownChunks.push(l),e+=o}}parseTextChunks(){let e=this.metaChunks.filter(t=>t.type==="text");for(let t of e){let[n,r]=this.file.getString(t.start,t.size).split("\0");this.injectKeyValToIhdr(n,r)}}injectKeyValToIhdr(e,t){let n=this.parsers.ihdr;n&&n.raw.set(e,t)}findIhdr(){let e=this.metaChunks.find(t=>t.type==="ihdr");e&&this.options.ihdr.enabled!==!1&&this.createParser("ihdr",e.chunk)}async findExif(){let e=this.metaChunks.find(t=>t.type==="exif");e&&this.injectSegment("tiff",e.chunk)}async findXmp(){let e=this.metaChunks.filter(t=>t.type==="itxt");for(let t of e)t.chunk.getString(0,17)==="XML:com.adobe.xmp"&&this.injectSegment("xmp",t.chunk)}async findIcc(){let e=this.metaChunks.find(o=>o.type==="iccp");if(!e)return;let{chunk:t}=e,n=t.getUint8Array(0,81),r=0;for(;r<80&&n[r]!==0;)r++;let s=r+2,a=t.getString(0,r);if(this.injectKeyValToIhdr("ProfileName",a),Oe){let o=await si,l=t.getUint8Array(s);l=o.inflateSync(l),this.injectSegment("icc",l)}}}g(Nt,"type","png"),B.set("png",Nt),x(P,"interop",[[1,"InteropIndex"],[2,"InteropVersion"],[4096,"RelatedImageFileFormat"],[4097,"RelatedImageWidth"],[4098,"RelatedImageHeight"]]),ce(P,"ifd0",[[11,"ProcessingSoftware"],[254,"SubfileType"],[255,"OldSubfileType"],[263,"Thresholding"],[264,"CellWidth"],[265,"CellLength"],[266,"FillOrder"],[269,"DocumentName"],[280,"MinSampleValue"],[281,"MaxSampleValue"],[285,"PageName"],[286,"XPosition"],[287,"YPosition"],[290,"GrayResponseUnit"],[297,"PageNumber"],[321,"HalftoneHints"],[322,"TileWidth"],[323,"TileLength"],[332,"InkSet"],[337,"TargetPrinter"],[18246,"Rating"],[18249,"RatingPercent"],[33550,"PixelScale"],[34264,"ModelTransform"],[34377,"PhotoshopSettings"],[50706,"DNGVersion"],[50707,"DNGBackwardVersion"],[50708,"UniqueCameraModel"],[50709,"LocalizedCameraModel"],[50736,"DNGLensInfo"],[50739,"ShadowScale"],[50740,"DNGPrivateData"],[33920,"IntergraphMatrix"],[33922,"ModelTiePoint"],[34118,"SEMInfo"],[34735,"GeoTiffDirectory"],[34736,"GeoTiffDoubleParams"],[34737,"GeoTiffAsciiParams"],[50341,"PrintIM"],[50721,"ColorMatrix1"],[50722,"ColorMatrix2"],[50723,"CameraCalibration1"],[50724,"CameraCalibration2"],[50725,"ReductionMatrix1"],[50726,"ReductionMatrix2"],[50727,"AnalogBalance"],[50728,"AsShotNeutral"],[50729,"AsShotWhiteXY"],[50730,"BaselineExposure"],[50731,"BaselineNoise"],[50732,"BaselineSharpness"],[50734,"LinearResponseLimit"],[50735,"CameraSerialNumber"],[50741,"MakerNoteSafety"],[50778,"CalibrationIlluminant1"],[50779,"CalibrationIlluminant2"],[50781,"RawDataUniqueID"],[50827,"OriginalRawFileName"],[50828,"OriginalRawFileData"],[50831,"AsShotICCProfile"],[50832,"AsShotPreProfileMatrix"],[50833,"CurrentICCProfile"],[50834,"CurrentPreProfileMatrix"],[50879,"ColorimetricReference"],[50885,"SRawType"],[50898,"PanasonicTitle"],[50899,"PanasonicTitle2"],[50931,"CameraCalibrationSig"],[50932,"ProfileCalibrationSig"],[50933,"ProfileIFD"],[50934,"AsShotProfileName"],[50936,"ProfileName"],[50937,"ProfileHueSatMapDims"],[50938,"ProfileHueSatMapData1"],[50939,"ProfileHueSatMapData2"],[50940,"ProfileToneCurve"],[50941,"ProfileEmbedPolicy"],[50942,"ProfileCopyright"],[50964,"ForwardMatrix1"],[50965,"ForwardMatrix2"],[50966,"PreviewApplicationName"],[50967,"PreviewApplicationVersion"],[50968,"PreviewSettingsName"],[50969,"PreviewSettingsDigest"],[50970,"PreviewColorSpace"],[50971,"PreviewDateTime"],[50972,"RawImageDigest"],[50973,"OriginalRawFileDigest"],[50981,"ProfileLookTableDims"],[50982,"ProfileLookTableData"],[51043,"TimeCodes"],[51044,"FrameRate"],[51058,"TStop"],[51081,"ReelName"],[51089,"OriginalDefaultFinalSize"],[51090,"OriginalBestQualitySize"],[51091,"OriginalDefaultCropSize"],[51105,"CameraLabel"],[51107,"ProfileHueSatMapEncoding"],[51108,"ProfileLookTableEncoding"],[51109,"BaselineExposureOffset"],[51110,"DefaultBlackRender"],[51111,"NewRawImageDigest"],[51112,"RawToPreviewGain"]]);let Ut=[[273,"StripOffsets"],[279,"StripByteCounts"],[288,"FreeOffsets"],[289,"FreeByteCounts"],[291,"GrayResponseCurve"],[292,"T4Options"],[293,"T6Options"],[300,"ColorResponseUnit"],[320,"ColorMap"],[324,"TileOffsets"],[325,"TileByteCounts"],[326,"BadFaxLines"],[327,"CleanFaxData"],[328,"ConsecutiveBadFaxLines"],[330,"SubIFD"],[333,"InkNames"],[334,"NumberofInks"],[336,"DotRange"],[338,"ExtraSamples"],[339,"SampleFormat"],[340,"SMinSampleValue"],[341,"SMaxSampleValue"],[342,"TransferRange"],[343,"ClipPath"],[344,"XClipPathUnits"],[345,"YClipPathUnits"],[346,"Indexed"],[347,"JPEGTables"],[351,"OPIProxy"],[400,"GlobalParametersIFD"],[401,"ProfileType"],[402,"FaxProfile"],[403,"CodingMethods"],[404,"VersionYear"],[405,"ModeNumber"],[433,"Decode"],[434,"DefaultImageColor"],[435,"T82Options"],[437,"JPEGTables"],[512,"JPEGProc"],[515,"JPEGRestartInterval"],[517,"JPEGLosslessPredictors"],[518,"JPEGPointTransforms"],[519,"JPEGQTables"],[520,"JPEGDCTables"],[521,"JPEGACTables"],[559,"StripRowCounts"],[999,"USPTOMiscellaneous"],[18247,"XP_DIP_XML"],[18248,"StitchInfo"],[28672,"SonyRawFileType"],[28688,"SonyToneCurve"],[28721,"VignettingCorrection"],[28722,"VignettingCorrParams"],[28724,"ChromaticAberrationCorrection"],[28725,"ChromaticAberrationCorrParams"],[28726,"DistortionCorrection"],[28727,"DistortionCorrParams"],[29895,"SonyCropTopLeft"],[29896,"SonyCropSize"],[32781,"ImageID"],[32931,"WangTag1"],[32932,"WangAnnotation"],[32933,"WangTag3"],[32934,"WangTag4"],[32953,"ImageReferencePoints"],[32954,"RegionXformTackPoint"],[32955,"WarpQuadrilateral"],[32956,"AffineTransformMat"],[32995,"Matteing"],[32996,"DataType"],[32997,"ImageDepth"],[32998,"TileDepth"],[33300,"ImageFullWidth"],[33301,"ImageFullHeight"],[33302,"TextureFormat"],[33303,"WrapModes"],[33304,"FovCot"],[33305,"MatrixWorldToScreen"],[33306,"MatrixWorldToCamera"],[33405,"Model2"],[33421,"CFARepeatPatternDim"],[33422,"CFAPattern2"],[33423,"BatteryLevel"],[33424,"KodakIFD"],[33445,"MDFileTag"],[33446,"MDScalePixel"],[33447,"MDColorTable"],[33448,"MDLabName"],[33449,"MDSampleInfo"],[33450,"MDPrepDate"],[33451,"MDPrepTime"],[33452,"MDFileUnits"],[33589,"AdventScale"],[33590,"AdventRevision"],[33628,"UIC1Tag"],[33629,"UIC2Tag"],[33630,"UIC3Tag"],[33631,"UIC4Tag"],[33918,"IntergraphPacketData"],[33919,"IntergraphFlagRegisters"],[33921,"INGRReserved"],[34016,"Site"],[34017,"ColorSequence"],[34018,"IT8Header"],[34019,"RasterPadding"],[34020,"BitsPerRunLength"],[34021,"BitsPerExtendedRunLength"],[34022,"ColorTable"],[34023,"ImageColorIndicator"],[34024,"BackgroundColorIndicator"],[34025,"ImageColorValue"],[34026,"BackgroundColorValue"],[34027,"PixelIntensityRange"],[34028,"TransparencyIndicator"],[34029,"ColorCharacterization"],[34030,"HCUsage"],[34031,"TrapIndicator"],[34032,"CMYKEquivalent"],[34152,"AFCP_IPTC"],[34232,"PixelMagicJBIGOptions"],[34263,"JPLCartoIFD"],[34306,"WB_GRGBLevels"],[34310,"LeafData"],[34687,"TIFF_FXExtensions"],[34688,"MultiProfiles"],[34689,"SharedData"],[34690,"T88Options"],[34732,"ImageLayer"],[34750,"JBIGOptions"],[34856,"Opto-ElectricConvFactor"],[34857,"Interlace"],[34908,"FaxRecvParams"],[34909,"FaxSubAddress"],[34910,"FaxRecvTime"],[34929,"FedexEDR"],[34954,"LeafSubIFD"],[37387,"FlashEnergy"],[37388,"SpatialFrequencyResponse"],[37389,"Noise"],[37390,"FocalPlaneXResolution"],[37391,"FocalPlaneYResolution"],[37392,"FocalPlaneResolutionUnit"],[37397,"ExposureIndex"],[37398,"TIFF-EPStandardID"],[37399,"SensingMethod"],[37434,"CIP3DataFile"],[37435,"CIP3Sheet"],[37436,"CIP3Side"],[37439,"StoNits"],[37679,"MSDocumentText"],[37680,"MSPropertySetStorage"],[37681,"MSDocumentTextPosition"],[37724,"ImageSourceData"],[40965,"InteropIFD"],[40976,"SamsungRawPointersOffset"],[40977,"SamsungRawPointersLength"],[41217,"SamsungRawByteOrder"],[41218,"SamsungRawUnknown"],[41484,"SpatialFrequencyResponse"],[41485,"Noise"],[41489,"ImageNumber"],[41490,"SecurityClassification"],[41491,"ImageHistory"],[41494,"TIFF-EPStandardID"],[41995,"DeviceSettingDescription"],[42112,"GDALMetadata"],[42113,"GDALNoData"],[44992,"ExpandSoftware"],[44993,"ExpandLens"],[44994,"ExpandFilm"],[44995,"ExpandFilterLens"],[44996,"ExpandScanner"],[44997,"ExpandFlashLamp"],[46275,"HasselbladRawImage"],[48129,"PixelFormat"],[48130,"Transformation"],[48131,"Uncompressed"],[48132,"ImageType"],[48256,"ImageWidth"],[48257,"ImageHeight"],[48258,"WidthResolution"],[48259,"HeightResolution"],[48320,"ImageOffset"],[48321,"ImageByteCount"],[48322,"AlphaOffset"],[48323,"AlphaByteCount"],[48324,"ImageDataDiscard"],[48325,"AlphaDataDiscard"],[50215,"OceScanjobDesc"],[50216,"OceApplicationSelector"],[50217,"OceIDNumber"],[50218,"OceImageLogic"],[50255,"Annotations"],[50459,"HasselbladExif"],[50547,"OriginalFileName"],[50560,"USPTOOriginalContentType"],[50656,"CR2CFAPattern"],[50710,"CFAPlaneColor"],[50711,"CFALayout"],[50712,"LinearizationTable"],[50713,"BlackLevelRepeatDim"],[50714,"BlackLevel"],[50715,"BlackLevelDeltaH"],[50716,"BlackLevelDeltaV"],[50717,"WhiteLevel"],[50718,"DefaultScale"],[50719,"DefaultCropOrigin"],[50720,"DefaultCropSize"],[50733,"BayerGreenSplit"],[50737,"ChromaBlurRadius"],[50738,"AntiAliasStrength"],[50752,"RawImageSegmentation"],[50780,"BestQualityScale"],[50784,"AliasLayerMetadata"],[50829,"ActiveArea"],[50830,"MaskedAreas"],[50935,"NoiseReductionApplied"],[50974,"SubTileBlockSize"],[50975,"RowInterleaveFactor"],[51008,"OpcodeList1"],[51009,"OpcodeList2"],[51022,"OpcodeList3"],[51041,"NoiseProfile"],[51114,"CacheVersion"],[51125,"DefaultUserCrop"],[51157,"NikonNEFInfo"],[65024,"KdcIFD"]];ce(P,"ifd0",Ut),ce(P,"exif",Ut),x(N,"gps",[[23,{M:"Magnetic North",T:"True North"}],[25,{K:"Kilometers",M:"Miles",N:"Nautical Miles"}]]);class et extends F{static canHandle(e,t){return e.getUint8(t+1)===224&&e.getUint32(t+4)===1246120262&&e.getUint8(t+8)===0}parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint16(0)],[2,this.chunk.getUint8(2)],[3,this.chunk.getUint16(3)],[5,this.chunk.getUint16(5)],[7,this.chunk.getUint8(7)],[8,this.chunk.getUint8(8)]])}}g(et,"type","jfif"),g(et,"headerLength",9),S.set("jfif",et),x(P,"jfif",[[0,"JFIFVersion"],[2,"ResolutionUnit"],[3,"XResolution"],[5,"YResolution"],[7,"ThumbnailWidth"],[8,"ThumbnailHeight"]]);class Bt extends F{parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint32(0)],[4,this.chunk.getUint32(4)],[8,this.chunk.getUint8(8)],[9,this.chunk.getUint8(9)],[10,this.chunk.getUint8(10)],[11,this.chunk.getUint8(11)],[12,this.chunk.getUint8(12)],...Array.from(this.raw)])}}g(Bt,"type","ihdr"),S.set("ihdr",Bt),x(P,"ihdr",[[0,"ImageWidth"],[4,"ImageHeight"],[8,"BitDepth"],[9,"ColorType"],[10,"Compression"],[11,"Filter"],[12,"Interlace"]]),x(N,"ihdr",[[9,{0:"Grayscale",2:"RGB",3:"Palette",4:"Grayscale with Alpha",6:"RGB with Alpha",DEFAULT:"Unknown"}],[10,{0:"Deflate/Inflate",DEFAULT:"Unknown"}],[11,{0:"Adaptive",DEFAULT:"Unknown"}],[12,{0:"Noninterlaced",1:"Adam7 Interlace",DEFAULT:"Unknown"}]]);class Re extends F{static canHandle(e,t){return e.getUint8(t+1)===226&&e.getUint32(t+4)===1229144927}static findPosition(e,t){let n=super.findPosition(e,t);return n.chunkNumber=e.getUint8(t+16),n.chunkCount=e.getUint8(t+17),n.multiSegment=n.chunkCount>1,n}static handleMultiSegments(e){return function(t){let n=function(r){let s=r[0].constructor,a=0;for(let c of r)a+=c.length;let o=new s(a),l=0;for(let c of r)o.set(c,l),l+=c.length;return o}(t.map(r=>r.chunk.toUint8()));return new O(n)}(e)}parse(){return this.raw=new Map,this.parseHeader(),this.parseTags(),this.translate(),this.output}parseHeader(){let{raw:e}=this;this.chunk.byteLength<84&&C("ICC header is too short");for(let[t,n]of Object.entries(oi)){t=parseInt(t,10);let r=n(this.chunk,t);r!=="\0\0\0\0"&&e.set(t,r)}}parseTags(){let e,t,n,r,s,{raw:a}=this,o=this.chunk.getUint32(128),l=132,c=this.chunk.byteLength;for(;o--;){if(e=this.chunk.getString(l,4),t=this.chunk.getUint32(l+4),n=this.chunk.getUint32(l+8),r=this.chunk.getString(t,4),t+n>c)return void console.warn("reached the end of the first ICC chunk. Enable options.tiff.multiSegment to read all ICC segments.");s=this.parseTag(r,t,n),s!==void 0&&s!=="\0\0\0\0"&&a.set(e,s),l+=12}}parseTag(e,t,n){switch(e){case"desc":return this.parseDesc(t);case"mluc":return this.parseMluc(t);case"text":return this.parseText(t,n);case"sig ":return this.parseSig(t)}if(!(t+n>this.chunk.byteLength))return this.chunk.getUint8Array(t,n)}parseDesc(e){let t=this.chunk.getUint32(e+8)-1;return ae(this.chunk.getString(e+12,t))}parseText(e,t){return ae(this.chunk.getString(e+8,t-8))}parseSig(e){return ae(this.chunk.getString(e+8,4))}parseMluc(e){let{chunk:t}=this,n=t.getUint32(e+8),r=t.getUint32(e+12),s=e+16,a=[];for(let o=0;o<n;o++){let l=t.getString(s+0,2),c=t.getString(s+2,2),d=t.getUint32(s+4),u=t.getUint32(s+8)+e,p=ae(t.getUnicodeString(u,d));a.push({lang:l,country:c,text:p}),s+=r}return n===1?a[0].text:a}translateValue(e,t){return typeof e=="string"?t[e]||t[e.toLowerCase()]||e:t[e]||e}}g(Re,"type","icc"),g(Re,"multiSegment",!0),g(Re,"headerLength",18);const oi={4:z,8:function(i,e){return[i.getUint8(e),i.getUint8(e+1)>>4,i.getUint8(e+1)%16].map(t=>t.toString(10)).join(".")},12:z,16:z,20:z,24:function(i,e){const t=i.getUint16(e),n=i.getUint16(e+2)-1,r=i.getUint16(e+4),s=i.getUint16(e+6),a=i.getUint16(e+8),o=i.getUint16(e+10);return new Date(Date.UTC(t,n,r,s,a,o))},36:z,40:z,48:z,52:z,64:(i,e)=>i.getUint32(e),80:z};function z(i,e){return ae(i.getString(e,4))}S.set("icc",Re),x(P,"icc",[[4,"ProfileCMMType"],[8,"ProfileVersion"],[12,"ProfileClass"],[16,"ColorSpaceData"],[20,"ProfileConnectionSpace"],[24,"ProfileDateTime"],[36,"ProfileFileSignature"],[40,"PrimaryPlatform"],[44,"CMMFlags"],[48,"DeviceManufacturer"],[52,"DeviceModel"],[56,"DeviceAttributes"],[64,"RenderingIntent"],[68,"ConnectionSpaceIlluminant"],[80,"ProfileCreator"],[84,"ProfileID"],["Header","ProfileHeader"],["MS00","WCSProfiles"],["bTRC","BlueTRC"],["bXYZ","BlueMatrixColumn"],["bfd","UCRBG"],["bkpt","MediaBlackPoint"],["calt","CalibrationDateTime"],["chad","ChromaticAdaptation"],["chrm","Chromaticity"],["ciis","ColorimetricIntentImageState"],["clot","ColorantTableOut"],["clro","ColorantOrder"],["clrt","ColorantTable"],["cprt","ProfileCopyright"],["crdi","CRDInfo"],["desc","ProfileDescription"],["devs","DeviceSettings"],["dmdd","DeviceModelDesc"],["dmnd","DeviceMfgDesc"],["dscm","ProfileDescriptionML"],["fpce","FocalPlaneColorimetryEstimates"],["gTRC","GreenTRC"],["gXYZ","GreenMatrixColumn"],["gamt","Gamut"],["kTRC","GrayTRC"],["lumi","Luminance"],["meas","Measurement"],["meta","Metadata"],["mmod","MakeAndModel"],["ncl2","NamedColor2"],["ncol","NamedColor"],["ndin","NativeDisplayInfo"],["pre0","Preview0"],["pre1","Preview1"],["pre2","Preview2"],["ps2i","PS2RenderingIntent"],["ps2s","PostScript2CSA"],["psd0","PostScript2CRD0"],["psd1","PostScript2CRD1"],["psd2","PostScript2CRD2"],["psd3","PostScript2CRD3"],["pseq","ProfileSequenceDesc"],["psid","ProfileSequenceIdentifier"],["psvm","PS2CRDVMSize"],["rTRC","RedTRC"],["rXYZ","RedMatrixColumn"],["resp","OutputResponse"],["rhoc","ReflectionHardcopyOrigColorimetry"],["rig0","PerceptualRenderingIntentGamut"],["rig2","SaturationRenderingIntentGamut"],["rpoc","ReflectionPrintOutputColorimetry"],["sape","SceneAppearanceEstimates"],["scoe","SceneColorimetryEstimates"],["scrd","ScreeningDesc"],["scrn","Screening"],["targ","CharTarget"],["tech","Technology"],["vcgt","VideoCardGamma"],["view","ViewingConditions"],["vued","ViewingCondDesc"],["wtpt","MediaWhitePoint"]]);const Te={"4d2p":"Erdt Systems",AAMA:"Aamazing Technologies",ACER:"Acer",ACLT:"Acolyte Color Research",ACTI:"Actix Sytems",ADAR:"Adara Technology",ADBE:"Adobe",ADI:"ADI Systems",AGFA:"Agfa Graphics",ALMD:"Alps Electric",ALPS:"Alps Electric",ALWN:"Alwan Color Expertise",AMTI:"Amiable Technologies",AOC:"AOC International",APAG:"Apago",APPL:"Apple Computer",AST:"AST","AT&T":"AT&T",BAEL:"BARBIERI electronic",BRCO:"Barco NV",BRKP:"Breakpoint",BROT:"Brother",BULL:"Bull",BUS:"Bus Computer Systems","C-IT":"C-Itoh",CAMR:"Intel",CANO:"Canon",CARR:"Carroll Touch",CASI:"Casio",CBUS:"Colorbus PL",CEL:"Crossfield",CELx:"Crossfield",CGS:"CGS Publishing Technologies International",CHM:"Rochester Robotics",CIGL:"Colour Imaging Group, London",CITI:"Citizen",CL00:"Candela",CLIQ:"Color IQ",CMCO:"Chromaco",CMiX:"CHROMiX",COLO:"Colorgraphic Communications",COMP:"Compaq",COMp:"Compeq/Focus Technology",CONR:"Conrac Display Products",CORD:"Cordata Technologies",CPQ:"Compaq",CPRO:"ColorPro",CRN:"Cornerstone",CTX:"CTX International",CVIS:"ColorVision",CWC:"Fujitsu Laboratories",DARI:"Darius Technology",DATA:"Dataproducts",DCP:"Dry Creek Photo",DCRC:"Digital Contents Resource Center, Chung-Ang University",DELL:"Dell Computer",DIC:"Dainippon Ink and Chemicals",DICO:"Diconix",DIGI:"Digital","DL&C":"Digital Light & Color",DPLG:"Doppelganger",DS:"Dainippon Screen",DSOL:"DOOSOL",DUPN:"DuPont",EPSO:"Epson",ESKO:"Esko-Graphics",ETRI:"Electronics and Telecommunications Research Institute",EVER:"Everex Systems",EXAC:"ExactCODE",Eizo:"Eizo",FALC:"Falco Data Products",FF:"Fuji Photo Film",FFEI:"FujiFilm Electronic Imaging",FNRD:"Fnord Software",FORA:"Fora",FORE:"Forefront Technology",FP:"Fujitsu",FPA:"WayTech Development",FUJI:"Fujitsu",FX:"Fuji Xerox",GCC:"GCC Technologies",GGSL:"Global Graphics Software",GMB:"Gretagmacbeth",GMG:"GMG",GOLD:"GoldStar Technology",GOOG:"Google",GPRT:"Giantprint",GTMB:"Gretagmacbeth",GVC:"WayTech Development",GW2K:"Sony",HCI:"HCI",HDM:"Heidelberger Druckmaschinen",HERM:"Hermes",HITA:"Hitachi America",HP:"Hewlett-Packard",HTC:"Hitachi",HiTi:"HiTi Digital",IBM:"IBM",IDNT:"Scitex",IEC:"Hewlett-Packard",IIYA:"Iiyama North America",IKEG:"Ikegami Electronics",IMAG:"Image Systems",IMI:"Ingram Micro",INTC:"Intel",INTL:"N/A (INTL)",INTR:"Intra Electronics",IOCO:"Iocomm International Technology",IPS:"InfoPrint Solutions Company",IRIS:"Scitex",ISL:"Ichikawa Soft Laboratory",ITNL:"N/A (ITNL)",IVM:"IVM",IWAT:"Iwatsu Electric",Idnt:"Scitex",Inca:"Inca Digital Printers",Iris:"Scitex",JPEG:"Joint Photographic Experts Group",JSFT:"Jetsoft Development",JVC:"JVC Information Products",KART:"Scitex",KFC:"KFC Computek Components",KLH:"KLH Computers",KMHD:"Konica Minolta",KNCA:"Konica",KODA:"Kodak",KYOC:"Kyocera",Kart:"Scitex",LCAG:"Leica",LCCD:"Leeds Colour",LDAK:"Left Dakota",LEAD:"Leading Technology",LEXM:"Lexmark International",LINK:"Link Computer",LINO:"Linotronic",LITE:"Lite-On",Leaf:"Leaf",Lino:"Linotronic",MAGC:"Mag Computronic",MAGI:"MAG Innovision",MANN:"Mannesmann",MICN:"Micron Technology",MICR:"Microtek",MICV:"Microvitec",MINO:"Minolta",MITS:"Mitsubishi Electronics America",MITs:"Mitsuba",MNLT:"Minolta",MODG:"Modgraph",MONI:"Monitronix",MONS:"Monaco Systems",MORS:"Morse Technology",MOTI:"Motive Systems",MSFT:"Microsoft",MUTO:"MUTOH INDUSTRIES",Mits:"Mitsubishi Electric",NANA:"NANAO",NEC:"NEC",NEXP:"NexPress Solutions",NISS:"Nissei Sangyo America",NKON:"Nikon",NONE:"none",OCE:"Oce Technologies",OCEC:"OceColor",OKI:"Oki",OKID:"Okidata",OKIP:"Okidata",OLIV:"Olivetti",OLYM:"Olympus",ONYX:"Onyx Graphics",OPTI:"Optiquest",PACK:"Packard Bell",PANA:"Matsushita Electric Industrial",PANT:"Pantone",PBN:"Packard Bell",PFU:"PFU",PHIL:"Philips Consumer Electronics",PNTX:"HOYA",POne:"Phase One A/S",PREM:"Premier Computer Innovations",PRIN:"Princeton Graphic Systems",PRIP:"Princeton Publishing Labs",QLUX:"Hong Kong",QMS:"QMS",QPCD:"QPcard AB",QUAD:"QuadLaser",QUME:"Qume",RADI:"Radius",RDDx:"Integrated Color Solutions",RDG:"Roland DG",REDM:"REDMS Group",RELI:"Relisys",RGMS:"Rolf Gierling Multitools",RICO:"Ricoh",RNLD:"Edmund Ronald",ROYA:"Royal",RPC:"Ricoh Printing Systems",RTL:"Royal Information Electronics",SAMP:"Sampo",SAMS:"Samsung",SANT:"Jaime Santana Pomares",SCIT:"Scitex",SCRN:"Dainippon Screen",SDP:"Scitex",SEC:"Samsung",SEIK:"Seiko Instruments",SEIk:"Seikosha",SGUY:"ScanGuy.com",SHAR:"Sharp Laboratories",SICC:"International Color Consortium",SONY:"Sony",SPCL:"SpectraCal",STAR:"Star",STC:"Sampo Technology",Scit:"Scitex",Sdp:"Scitex",Sony:"Sony",TALO:"Talon Technology",TAND:"Tandy",TATU:"Tatung",TAXA:"TAXAN America",TDS:"Tokyo Denshi Sekei",TECO:"TECO Information Systems",TEGR:"Tegra",TEKT:"Tektronix",TI:"Texas Instruments",TMKR:"TypeMaker",TOSB:"Toshiba",TOSH:"Toshiba",TOTK:"TOTOKU ELECTRIC",TRIU:"Triumph",TSBT:"Toshiba",TTX:"TTX Computer Products",TVM:"TVM Professional Monitor",TW:"TW Casper",ULSX:"Ulead Systems",UNIS:"Unisys",UTZF:"Utz Fehlau & Sohn",VARI:"Varityper",VIEW:"Viewsonic",VISL:"Visual communication",VIVO:"Vivo Mobile Communication",WANG:"Wang",WLBR:"Wilbur Imaging",WTG2:"Ware To Go",WYSE:"WYSE Technology",XERX:"Xerox",XRIT:"X-Rite",ZRAN:"Zoran",Zebr:"Zebra Technologies",appl:"Apple Computer",bICC:"basICColor",berg:"bergdesign",ceyd:"Integrated Color Solutions",clsp:"MacDermid ColorSpan",ds:"Dainippon Screen",dupn:"DuPont",ffei:"FujiFilm Electronic Imaging",flux:"FluxData",iris:"Scitex",kart:"Scitex",lcms:"Little CMS",lino:"Linotronic",none:"none",ob4d:"Erdt Systems",obic:"Medigraph",quby:"Qubyx Sarl",scit:"Scitex",scrn:"Dainippon Screen",sdp:"Scitex",siwi:"SIWI GRAFIKA",yxym:"YxyMaster"},Vt={scnr:"Scanner",mntr:"Monitor",prtr:"Printer",link:"Device Link",abst:"Abstract",spac:"Color Space Conversion Profile",nmcl:"Named Color",cenc:"ColorEncodingSpace profile",mid:"MultiplexIdentification profile",mlnk:"MultiplexLink profile",mvis:"MultiplexVisualization profile",nkpf:"Nikon Input Device Profile (NON-STANDARD!)"};x(N,"icc",[[4,Te],[12,Vt],[40,Object.assign({},Te,Vt)],[48,Te],[80,Te],[64,{0:"Perceptual",1:"Relative Colorimetric",2:"Saturation",3:"Absolute Colorimetric"}],["tech",{amd:"Active Matrix Display",crt:"Cathode Ray Tube Display",kpcd:"Photo CD",pmd:"Passive Matrix Display",dcam:"Digital Camera",dcpj:"Digital Cinema Projector",dmpc:"Digital Motion Picture Camera",dsub:"Dye Sublimation Printer",epho:"Electrophotographic Printer",esta:"Electrostatic Printer",flex:"Flexography",fprn:"Film Writer",fscn:"Film Scanner",grav:"Gravure",ijet:"Ink Jet Printer",imgs:"Photo Image Setter",mpfr:"Motion Picture Film Recorder",mpfs:"Motion Picture Film Scanner",offs:"Offset Lithography",pjtv:"Projection Television",rpho:"Photographic Paper Printer",rscn:"Reflective Scanner",silk:"Silkscreen",twax:"Thermal Wax Printer",vidc:"Video Camera",vidm:"Video Monitor"}]]);class Le extends F{static canHandle(e,t,n){return e.getUint8(t+1)===237&&e.getString(t+4,9)==="Photoshop"&&this.containsIptc8bim(e,t,n)!==void 0}static headerLength(e,t,n){let r,s=this.containsIptc8bim(e,t,n);if(s!==void 0)return r=e.getUint8(t+s+7),r%2!=0&&(r+=1),r===0&&(r=4),s+8+r}static containsIptc8bim(e,t,n){for(let r=0;r<n;r++)if(this.isIptcSegmentHead(e,t+r))return r}static isIptcSegmentHead(e,t){return e.getUint8(t)===56&&e.getUint32(t)===943868237&&e.getUint16(t+4)===1028}parse(){let{raw:e}=this,t=this.chunk.byteLength-1,n=!1;for(let r=0;r<t;r++)if(this.chunk.getUint8(r)===28&&this.chunk.getUint8(r+1)===2){n=!0;let s=this.chunk.getUint16(r+3),a=this.chunk.getUint8(r+2),o=this.chunk.getLatin1String(r+5,s);e.set(a,this.pluralizeValue(e.get(a),o)),r+=4+s}else if(n)break;return this.translate(),this.output}pluralizeValue(e,t){return e!==void 0?e instanceof Array?(e.push(t),e):[e,t]:t}}g(Le,"type","iptc"),g(Le,"translateValues",!1),g(Le,"reviveValues",!1),S.set("iptc",Le),x(P,"iptc",[[0,"ApplicationRecordVersion"],[3,"ObjectTypeReference"],[4,"ObjectAttributeReference"],[5,"ObjectName"],[7,"EditStatus"],[8,"EditorialUpdate"],[10,"Urgency"],[12,"SubjectReference"],[15,"Category"],[20,"SupplementalCategories"],[22,"FixtureIdentifier"],[25,"Keywords"],[26,"ContentLocationCode"],[27,"ContentLocationName"],[30,"ReleaseDate"],[35,"ReleaseTime"],[37,"ExpirationDate"],[38,"ExpirationTime"],[40,"SpecialInstructions"],[42,"ActionAdvised"],[45,"ReferenceService"],[47,"ReferenceDate"],[50,"ReferenceNumber"],[55,"DateCreated"],[60,"TimeCreated"],[62,"DigitalCreationDate"],[63,"DigitalCreationTime"],[65,"OriginatingProgram"],[70,"ProgramVersion"],[75,"ObjectCycle"],[80,"Byline"],[85,"BylineTitle"],[90,"City"],[92,"Sublocation"],[95,"State"],[100,"CountryCode"],[101,"Country"],[103,"OriginalTransmissionReference"],[105,"Headline"],[110,"Credit"],[115,"Source"],[116,"CopyrightNotice"],[118,"Contact"],[120,"Caption"],[121,"LocalCaption"],[122,"Writer"],[125,"RasterizedCaption"],[130,"ImageType"],[131,"ImageOrientation"],[135,"LanguageIdentifier"],[150,"AudioType"],[151,"AudioSamplingRate"],[152,"AudioSamplingResolution"],[153,"AudioDuration"],[154,"AudioOutcue"],[184,"JobID"],[185,"MasterDocumentID"],[186,"ShortDocumentID"],[187,"UniqueDocumentID"],[188,"OwnerID"],[200,"ObjectPreviewFileFormat"],[201,"ObjectPreviewFileVersion"],[202,"ObjectPreviewData"],[221,"Prefs"],[225,"ClassifyState"],[228,"SimilarityIndex"],[230,"DocumentNotes"],[231,"DocumentHistory"],[232,"ExifCameraInfo"],[255,"CatalogSets"]]),x(N,"iptc",[[10,{0:"0 (reserved)",1:"1 (most urgent)",2:"2",3:"3",4:"4",5:"5 (normal urgency)",6:"6",7:"7",8:"8 (least urgent)",9:"9 (user-defined priority)"}],[75,{a:"Morning",b:"Both Morning and Evening",p:"Evening"}],[131,{L:"Landscape",P:"Portrait",S:"Square"}]]);let tt=null;async function li(){if(!tt)try{const n=(await import("./joraw-1Lq5hXK7.js")).default;if(typeof n!="function")throw new Error("JoRaw WASM import failed");const r=new URL("/assets/joraw-DraTMNgX.wasm",import.meta.url).href;tt=n({locateFile:(s,a)=>s.endsWith("joraw.wasm")?r:a+s})}catch(t){throw console.error("Failed to load joraw.js:",t),t}const i=await tt,e=i.LibRaw||i.JoRaw;if(!e)throw new Error("JoRaw class not found");return e}const di=async i=>{var n,r,s,a,o,l,c,d,u,p,h,y,m,b;const e=await li(),t=new e;try{if(await t.open(i,{}),typeof t.getRawImage!="function")throw new Error("WASM mismatch");const k=t.getRawImage();let U=new Uint16Array(k.data);const _=await t.metadata(!0);let A={..._};try{const f=await ri.parse(i.buffer);f&&(A={...A,...f})}catch(f){console.warn("exifr parsing failed for RAW buffer",f)}const R=((n=_.idata)==null?void 0:n.filters)||0,D=((r=_.idata)==null?void 0:r.colors)||0,M=R===0&&D===3,H=R===9;let v=[0,0,0,0],T=!1,G=null;if(t.getBlackLevels)try{const f=t.getBlackLevels();G=f,f.dng_cblack&&f.dng_cblack.length===4&&Array.from(f.dng_cblack).some(I=>I>0)?(v=Array.from(f.dng_cblack).map(Number),T=!0):f.cblack&&f.cblack.length===4&&Array.from(f.cblack).some(I=>I>0)?(v=Array.from(f.cblack).map(Number),T=!0):typeof f.black=="number"&&f.black>0&&(v=[f.black,f.black,f.black,f.black],T=!0)}catch(f){console.warn("getBlackLevels binding failed",f)}if(!T){let f=[];if((s=_.color_data)!=null&&s.cblack_rawpy_style)f=_.color_data.cblack_rawpy_style;else if((o=(a=_.color_data)==null?void 0:a.dng_levels)!=null&&o.dng_cblack)f=_.color_data.dng_levels.dng_cblack;else if(((l=_.black_level_per_channel)==null?void 0:l.length)>=4)f=_.black_level_per_channel;else if(((c=_.cblack)==null?void 0:c.length)>=4)f=_.cblack;else if(((u=(d=_.color)==null?void 0:d.cblack)==null?void 0:u.length)>=4)f=_.color.cblack;else{const I=_.black_level||_.color_data&&_.color_data.black||0;f=[I,I,I,I]}v=[Number(f[0])||0,Number(f[1])||0,Number(f[2])||0,Number(f[3])||0]}const W=(...f)=>{for(const I of f){if(Array.isArray(I)||ArrayBuffer.isView(I)){const ye=Math.max(...Array.from(I).map(Number).filter(ve=>Number.isFinite(ve)&&ve>0));if(Number.isFinite(ye)&&ye>0)return ye;continue}const K=Number(I);if(Number.isFinite(K)&&K>0)return K}return null},ee=Number.isFinite(Number(k.bits))&&Number(k.bits)>0?Math.pow(2,Number(k.bits))-1:null,j=W(_.white_level,(h=(p=_.color_data)==null?void 0:p.dng_levels)==null?void 0:h.dng_whitelevel,(y=_.color_data)==null?void 0:y.maximum,G==null?void 0:G.maximum,(m=_.color_data)==null?void 0:m.fmaximum,(b=_.color_data)==null?void 0:b.data_maximum,ee)||16383;return{data:U,width:k.width,height:k.height,bayerPattern:_.color_desc||"RGGB",blackLevels:v,whiteLevel:j,metadata:A,isThreePlane:M,threePlaneTransfer:M?"linear":void 0,isXTrans:H}}finally{t.delete?t.delete():t.close()}};async function hi(i){if(kn(i)){const n=await An(i);if(!n)throw new Error("Sony cRAW HQ decoder did not return image data.");return n.rawImageData}if(En(i)){const n=await Fn(i);if(!n)throw new Error("Nikon HE decoder did not return image data.");return n}const t=new Uint8Array(i);return di(t)}self.onmessage=async i=>{const{id:e,buffer:t,returnBuffer:n}=i.data;try{const r=await hi(t),s=[r.data.buffer];r.floatData&&s.push(r.floatData.buffer),n&&s.push(t),self.postMessage({id:e,success:!0,raw:r,buffer:n?t:void 0},s)}catch(r){self.postMessage({id:e,success:!1,error:(r==null?void 0:r.message)||"Decode failed"})}};
