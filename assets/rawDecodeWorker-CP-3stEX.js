const cn={"Sony ILCE-7RM5":"0.82 -0.2976 -0.0719 -0.4296 1.2053 0.2532 -0.0429 0.1282 0.5774"};let Ze=null;async function pn(i){return Ze||(Ze=(async()=>{if(typeof window.loadPyodide!="function")throw new Error("Pyodide missing: window.loadPyodide not found.");const e=await window.loadPyodide();return await e.loadPackage("numpy"),e})()),Ze}var un=`#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
`,mn="/assets/sony-craw-hq-libraw-BAR7UfD7.js",_n="/assets/sony-craw-hq-libraw-CZg3hVRg.wasm";const kt=512,yn=cn["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let et=null,tt=null;function bn(i){if(i.byteLength<8)return null;const e=i.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function Wt(i,e,t){const n=Math.min(i.length,e+t);let r="";for(let s=e;s<n;s++){const a=i[s];if(a===0)break;r+=String.fromCharCode(a)}return r.trim()}function U(i,e,t,n,r){const s=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!s)return[];const a=s*n,o=a<=4?r:i.getUint32(r,e);if(o<0||o+a>i.byteLength)return[];const l=[];for(let h=0;h<n;h++){const d=o+h*s;t===1||t===2||t===7?l.push(i.getUint8(d)):t===3?l.push(i.getUint16(d,e)):t===8?l.push(i.getInt16(d,e)):t===4?l.push(i.getUint32(d,e)):t===9&&l.push(i.getInt32(d,e))}return l}function Ct(i,e,t,n,r,s){if(n!==2||r<=0)return"";const a=r<=4?s:e.getUint32(s,t);return a<0||a>=i.length?"":Wt(i,a,r)}function Kt(i){const e=new Uint8Array(i),t=new DataView(i),n=bn(t);if(n===null||t.getUint16(2,n)!==42)return null;const s=u=>t.getUint16(u,n),a=u=>t.getUint32(u,n),o=[a(4)],l=new Set;let h="",d="";for(;o.length;){const u=o.pop();if(l.has(u)||u<=0||u+2>t.byteLength)continue;l.add(u);const g=s(u);if(u+2+g*12+4>t.byteLength)continue;const c=new Map;for(let F=0;F<g;F++){const I=u+2+F*12,M=s(I),N=s(I+2),Q=a(I+4),A=I+8;c.set(M,{type:N,count:Q,valueOffset:A})}const y=c.get(271),C=c.get(272);y&&!h&&(h=Ct(e,t,n,y.type,y.count,y.valueOffset)),C&&!d&&(d=Ct(e,t,n,C.type,C.count,C.valueOffset));const P=c.get(330);if(P){const F=U(t,n,P.type,P.count,P.valueOffset);for(const I of F)o.push(I)}const O=c.get(259),m=c.get(262);if(O&&m){const F=U(t,n,O.type,O.count,O.valueOffset)[0],I=U(t,n,m.type,m.count,m.valueOffset)[0];if(F===32766&&I===32803){const M=U(t,n,c.get(256).type,c.get(256).count,c.get(256).valueOffset)[0],N=U(t,n,c.get(257).type,c.get(257).count,c.get(257).valueOffset)[0],Q=U(t,n,c.get(258).type,c.get(258).count,c.get(258).valueOffset)[0],A=U(t,n,c.get(273).type,c.get(273).count,c.get(273).valueOffset)[0],B=U(t,n,c.get(279).type,c.get(279).count,c.get(279).valueOffset)[0],q=c.get(33422)?U(t,n,c.get(33422).type,c.get(33422).count,c.get(33422).valueOffset):[0,1,1,2];c.get(29456)&&U(t,n,c.get(29456).type,c.get(29456).count,c.get(29456).valueOffset);const J=c.get(50717)?U(t,n,c.get(50717).type,c.get(50717).count,c.get(50717).valueOffset)[0]:16383,Z=c.get(50719)?U(t,n,c.get(50719).type,c.get(50719).count,c.get(50719).valueOffset):[],ee=c.get(50720)?U(t,n,c.get(50720).type,c.get(50720).count,c.get(50720).valueOffset):[];if(A+kt+16>e.length||A+B>e.length)return null;const p=A+kt,_=Wt(e,p,4),V=e[p+8]<<8|e[p+9],j=e[p+10]<<8|e[p+11],z=e[p+12]<<8|e[p+13],E=e[p+14]<<8|e[p+15],te=z>>4&63,ce=E>>13,Y=E>>10&3,W=j*2,T=B>=4?(e[A]|e[A+1]<<8|e[A+2]<<16|e[A+3]<<24)>>>0:0,Je=V===M&&W===N;let Se=!1;if(T>=1&&T<=16&&B>=8+T*24){const ne=new Map,ie=new Map;let Pe=!0;for(let Ie=0;Ie<T;Ie++){const re=A+8+Ie*24,pe=t.getUint32(re+8,!0),ue=t.getUint32(re+12,!0),Qe=t.getUint32(re+16,!0),Oe=t.getUint32(re+20,!0);if(!Qe||!Oe||pe+Qe>M||ue+Oe>N){Pe=!1;break}const St=ne.get(ue);if(St!==void 0&&St!==Oe){Pe=!1;break}ne.set(ue,Oe),ie.set(ue,(ie.get(ue)||0)+Qe)}if(Pe){const Ie=Array.from(ne.keys()).sort((pe,ue)=>pe-ue);let re=0;for(const pe of Ie){if(pe!==re||ie.get(pe)!==M){Pe=!1;break}re+=ne.get(pe)}Se=Pe&&re===N}}const De=T>=1&&T<=16&&V>0&&W>0&&M%V===0&&N%W===0&&T===M/V*(N/W);if(_!=="A000"&&_!=="0000"||!Je&&!De&&!Se||te!==16||ce!==3||Y!==3)return null;const Ye=[1024,1024,1024,1024],$e=q.slice(0,4).map(ne=>ne===0?"R":ne===2?"B":"G").join("")||"RGGB";return{width:M,height:N,bitsPerSample:Q,compression:F,photometric:I,blackLevel:Ye,whiteLevel:Number(J||16383),cfaPattern:$e,defaultCropOrigin:Z.length>=2?[Number(Z[0]),Number(Z[1])]:void 0,defaultCropSize:ee.length>=2?[Number(ee[0]),Number(ee[1])]:void 0,make:h||"SONY",model:d||"ILCE-7M5"}}}const v=a(u+2+g*12);v&&o.push(v)}return null}async function wn(i){return et||(et=(async()=>{const e=await pn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",un),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",fn),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",gn),await e.runPythonAsync(`
import sys
...
`),e.__jtrSonyCrawHqDecoderReady=!0),e})()),et}function xn(i){return Kt(i)}async function Sn(){return tt||(tt=import(mn).then(i=>{const e=i.default;if(typeof e!="function")throw new Error("Sony cRAW HQ LibRaw WASM module is missing its initializer");return e({locateFile:(t,n)=>t.endsWith(".wasm")?_n:n+t})})),tt}function kn(i){return i==="ILCE-7M5"?yn:null}function Xt(i,e,t,n){var l;if(i.length!==e.width*e.height)throw new Error(`Sony cRAW HQ decoded size mismatch: got ${i.length}, expected ${e.width*e.height}`);const r=e.model||"ILCE-7M5",s=r.startsWith("Sony ")?r:`Sony ${r}`,a=kn(r),o={...n||{},make:e.make||(n==null?void 0:n.camera_make)||"SONY",model:r,camera_make:e.make||(n==null?void 0:n.camera_make)||"SONY",camera_model:r,UniqueCameraModel:s,sourceFormat:t==="libraw-wasm"?"Sony cRAW HQ / LLVC3 (LibRaw WASM)":"Sony cRAW HQ / LLVC3",sonyCrawHq:{...e,decodeBackend:t},color_desc:e.cfaPattern,black_level_per_channel:e.blackLevel,white_level:e.whiteLevel,color_matrix:a&&a.length===9?a:void 0,idata:{filters:2492765332,colors:3},color_data:{...(n==null?void 0:n.color_data)||{},black:1024,cblack_rawpy_style:e.blackLevel,dng_levels:{...((l=n==null?void 0:n.color_data)==null?void 0:l.dng_levels)||{},dng_cblack:e.blackLevel,dng_whitelevel:e.whiteLevel}}};return{data:i,width:e.width,height:e.height,bayerPattern:e.cfaPattern,blackLevels:e.blackLevel,whiteLevel:e.whiteLevel,metadata:o,isThreePlane:!1,isXTrans:!1}}async function Cn(i,e,t){const n=typeof performance<"u"?performance.now():Date.now(),r=await Sn(),s=typeof performance<"u"?performance.now():Date.now(),a=r.LibRaw||r.JoRaw;if(!a)throw new Error("Sony cRAW HQ LibRaw WASM class not found");const o=new a;try{const l=new Uint8Array(i);o.open(l,{});const h=typeof performance<"u"?performance.now():Date.now();let d=null;try{d=o.metadata(!0)}catch(O){console.warn("[Sony cRAW HQ] fast WASM metadata read failed",O)}const u=typeof performance<"u"?performance.now():Date.now(),g=o.getRawImage(),c=typeof performance<"u"?performance.now():Date.now();if(!g||!g.data)throw new Error("Sony cRAW HQ LibRaw WASM returned no raw image");const y=g.data instanceof Uint16Array?g.data:new Uint16Array(g.data.buffer,g.data.byteOffset||0,g.data.byteLength/2),C=typeof performance<"u"?performance.now():Date.now();if(g.width!==e.width||g.height!==e.height)throw new Error(`Sony cRAW HQ LibRaw WASM dimensions mismatch: got ${g.width}x${g.height}, expected ${e.width}x${e.height}`);const P=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] fast decode timings",{width:e.width,height:e.height,backend:"libraw-wasm",wasmReadyMs:Math.round(s-n),openMs:Math.round(h-s),metadataMs:Math.round(u-h),unpackMs:Math.round(c-u),copyMs:Math.round(C-c),totalMs:Math.round(P-n)}),{rawImageData:Xt(y,e,"libraw-wasm",d),info:e}}finally{typeof o.delete=="function"?o.delete():typeof o.close=="function"&&o.close()}}async function vn(i,e,t){const n=typeof performance<"u"?performance.now():Date.now(),r=await wn(),s=typeof performance<"u"?performance.now():Date.now(),a=new Uint8Array(i),o=await fetch(new URL("/assets/sony_llvc3_static_lut4096_padded_u16-FsVBk-IV.bin",import.meta.url));if(!o.ok)throw new Error(`Failed to load Sony LLVC3 sample LUT: HTTP ${o.status}`);const l=new Uint8Array(await o.arrayBuffer()),h=typeof performance<"u"?performance.now():Date.now();r.globals.set("jtr_sony_arw_bytes",a),r.globals.set("jtr_sony_lut_bytes",l);const d=await r.runPythonAsync("jtr_decode_sony_craw_hq(jtr_sony_arw_bytes.to_py(), jtr_sony_lut_bytes.to_py())"),u=typeof performance<"u"?performance.now():Date.now(),g=d.toJs();typeof d.destroy=="function"&&d.destroy(),r.globals.delete("jtr_sony_arw_bytes"),r.globals.delete("jtr_sony_lut_bytes");const c=new Uint8Array(g.byteLength);c.set(g);const y=new Uint16Array(c.buffer),C=typeof performance<"u"?performance.now():Date.now(),P=typeof performance<"u"?performance.now():Date.now();return console.info("[Sony cRAW HQ] decode timings",{width:e.width,height:e.height,backend:"pyodide",pyodideReadyMs:Math.round(s-n),lutLoadMs:Math.round(h-s),llvc3DecodeMs:Math.round(u-h),copyMs:Math.round(C-u),totalMs:Math.round(P-n)}),{rawImageData:Xt(y,e,"pyodide"),info:e}}async function Pn(i,e){const t=Kt(i);if(!t)return null;try{return await Cn(i,t,e)}catch(n){return console.warn("[Sony cRAW HQ] fast WASM decode failed; falling back to Pyodide",n),vn(i,t)}}async function In(i,e){return Pn(i,e)}var He=typeof self<"u"?self:global;const Re=typeof navigator<"u",An=Re&&typeof HTMLImageElement>"u",Ne=!(typeof global>"u"||typeof process>"u"||!process.versions||!process.versions.node),je=He.Buffer,Fe=He.BigInt,We=!!je,Tn=i=>i;function Be(i,e=Tn){if(Ne)try{return typeof require=="function"?Promise.resolve(e(require(i))):import(i).then(e)}catch{console.warn(`Couldn't load ${i}`)}}let ft=He.fetch;const Ln=i=>ft=i;if(!He.fetch){const i=Be("http",n=>n),e=Be("https",n=>n),t=(n,{headers:r}={})=>new Promise(async(s,a)=>{let{port:o,hostname:l,pathname:h,protocol:d,search:u}=new URL(n);const g={method:"GET",hostname:l,path:encodeURI(h)+u,headers:r};o!==""&&(g.port=Number(o));const c=(d==="https:"?await e:await i).request(g,y=>{if(y.statusCode===301||y.statusCode===302){let C=new URL(y.headers.location,n).toString();return t(C,{headers:r}).then(s).catch(a)}s({status:y.statusCode,arrayBuffer:()=>new Promise(C=>{let P=[];y.on("data",O=>P.push(O)),y.on("end",()=>C(Buffer.concat(P)))})})});c.on("error",a),c.end()});Ln(t)}function f(i,e,t){return e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}const Ve=i=>qt(i)?void 0:i,Rn=i=>i!==void 0;function qt(i){return i===void 0||(i instanceof Map?i.size===0:Object.values(i).filter(Rn).length===0)}function S(i){let e=new Error(i);throw delete e.stack,e}function fe(i){return(i=function(e){for(;e.endsWith("\0");)e=e.slice(0,-1);return e}(i).trim())===""?void 0:i}function dt(i){let e=function(t){let n=0;return t.ifd0.enabled&&(n+=1024),t.exif.enabled&&(n+=2048),t.makerNote&&(n+=2048),t.userComment&&(n+=1024),t.gps.enabled&&(n+=512),t.interop.enabled&&(n+=100),t.ifd1.enabled&&(n+=1024),n+2048}(i);return i.jfif.enabled&&(e+=50),i.xmp.enabled&&(e+=2e4),i.iptc.enabled&&(e+=14e3),i.icc.enabled&&(e+=6e3),e}const ht=i=>String.fromCharCode.apply(null,i),vt=typeof TextDecoder<"u"?new TextDecoder("utf-8"):void 0;function Jt(i){return vt?vt.decode(i):We?Buffer.from(i).toString("utf8"):decodeURIComponent(escape(ht(i)))}class D{static from(e,t){return e instanceof this&&e.le===t?e:new D(e,void 0,void 0,t)}constructor(e,t=0,n,r){if(typeof r=="boolean"&&(this.le=r),Array.isArray(e)&&(e=new Uint8Array(e)),e===0)this.byteOffset=0,this.byteLength=0;else if(e instanceof ArrayBuffer){n===void 0&&(n=e.byteLength-t);let s=new DataView(e,t,n);this._swapDataView(s)}else if(e instanceof Uint8Array||e instanceof DataView||e instanceof D){n===void 0&&(n=e.byteLength-t),(t+=e.byteOffset)+n>e.byteOffset+e.byteLength&&S("Creating view outside of available memory in ArrayBuffer");let s=new DataView(e.buffer,t,n);this._swapDataView(s)}else if(typeof e=="number"){let s=new DataView(new ArrayBuffer(e));this._swapDataView(s)}else S("Invalid input argument for BufferView: "+e)}_swapArrayBuffer(e){this._swapDataView(new DataView(e))}_swapBuffer(e){this._swapDataView(new DataView(e.buffer,e.byteOffset,e.byteLength))}_swapDataView(e){this.dataView=e,this.buffer=e.buffer,this.byteOffset=e.byteOffset,this.byteLength=e.byteLength}_lengthToEnd(e){return this.byteLength-e}set(e,t,n=D){return e instanceof DataView||e instanceof D?e=new Uint8Array(e.buffer,e.byteOffset,e.byteLength):e instanceof ArrayBuffer&&(e=new Uint8Array(e)),e instanceof Uint8Array||S("BufferView.set(): Invalid data argument."),this.toUint8().set(e,t),new n(this,t,e.byteLength)}subarray(e,t){return t=t||this._lengthToEnd(e),new D(this,e,t)}toUint8(){return new Uint8Array(this.buffer,this.byteOffset,this.byteLength)}getUint8Array(e,t){return new Uint8Array(this.buffer,this.byteOffset+e,t)}getString(e=0,t=this.byteLength){return Jt(this.getUint8Array(e,t))}getLatin1String(e=0,t=this.byteLength){let n=this.getUint8Array(e,t);return ht(n)}getUnicodeString(e=0,t=this.byteLength){const n=[];for(let r=0;r<t&&e+r<this.byteLength;r+=2)n.push(this.getUint16(e+r));return ht(n)}getInt8(e){return this.dataView.getInt8(e)}getUint8(e){return this.dataView.getUint8(e)}getInt16(e,t=this.le){return this.dataView.getInt16(e,t)}getInt32(e,t=this.le){return this.dataView.getInt32(e,t)}getUint16(e,t=this.le){return this.dataView.getUint16(e,t)}getUint32(e,t=this.le){return this.dataView.getUint32(e,t)}getFloat32(e,t=this.le){return this.dataView.getFloat32(e,t)}getFloat64(e,t=this.le){return this.dataView.getFloat64(e,t)}getFloat(e,t=this.le){return this.dataView.getFloat32(e,t)}getDouble(e,t=this.le){return this.dataView.getFloat64(e,t)}getUintBytes(e,t,n){switch(t){case 1:return this.getUint8(e,n);case 2:return this.getUint16(e,n);case 4:return this.getUint32(e,n);case 8:return this.getUint64&&this.getUint64(e,n)}}getUint(e,t,n){switch(t){case 8:return this.getUint8(e,n);case 16:return this.getUint16(e,n);case 32:return this.getUint32(e,n);case 64:return this.getUint64&&this.getUint64(e,n)}}toString(e){return this.dataView.toString(e,this.constructor.name)}ensureChunk(){}}function ct(i,e){S(`${i} '${e}' was not loaded, try using full build of exifr.`)}class gt extends Map{constructor(e){super(),this.kind=e}get(e,t){return this.has(e)||ct(this.kind,e),t&&(e in t||function(n,r){S(`Unknown ${n} '${r}'.`)}(this.kind,e),t[e].enabled||ct(this.kind,e)),super.get(e)}keyList(){return Array.from(this.keys())}}var K=new gt("file parser"),x=new gt("segment parser"),X=new gt("file reader");function Dn(i,e){return typeof i=="string"?Pt(i,e):Re&&!An&&i instanceof HTMLImageElement?Pt(i.src,e):i instanceof Uint8Array||i instanceof ArrayBuffer||i instanceof DataView?new D(i):Re&&i instanceof Blob?pt(i,e,"blob",ye):void S("Invalid input argument")}function Pt(i,e){return(t=i).startsWith("data:")||t.length>1e4?ut(i,e,"base64"):Ne&&i.includes("://")?pt(i,e,"url",_e):Ne?ut(i,e,"fs"):Re?pt(i,e,"url",_e):void S("Invalid input argument");var t}async function pt(i,e,t,n){return X.has(t)?ut(i,e,t):n?async function(r,s){let a=await s(r);return new D(a)}(i,n):void S(`Parser ${t} is not loaded`)}async function ut(i,e,t){let n=new(X.get(t))(i,e);return await n.read(),n}const _e=i=>ft(i).then(e=>e.arrayBuffer()),ye=i=>new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result||new ArrayBuffer),n.onerror=t,n.readAsArrayBuffer(i)});class On extends Map{get tagKeys(){return this.allKeys||(this.allKeys=Array.from(this.keys())),this.allKeys}get tagValues(){return this.allValues||(this.allValues=Array.from(this.values())),this.allValues}}function w(i,e,t){let n=new On;for(let[r,s]of t)n.set(r,s);if(Array.isArray(e))for(let r of e)i.set(r,n);else i.set(e,n);return n}function be(i,e,t){let n,r=i.get(e);for(n of t)r.set(n[0],n[1])}const k=new Map,H=new Map,de=new Map,se=["chunked","firstChunkSize","firstChunkSizeNode","firstChunkSizeBrowser","chunkSize","chunkLimit"],Ce=["jfif","xmp","icc","iptc","ihdr"],we=["tiff",...Ce],b=["ifd0","ifd1","exif","gps","interop"],ae=[...we,...b],oe=["makerNote","userComment"],ve=["translateKeys","translateValues","reviveValues","multiSegment"],le=[...ve,"sanitize","mergeOutput","silentErrors"];class Yt{get translate(){return this.translateKeys||this.translateValues||this.reviveValues}}class Ae extends Yt{get needed(){return this.enabled||this.deps.size>0}constructor(e,t,n,r){if(super(),f(this,"enabled",!1),f(this,"skip",new Set),f(this,"pick",new Set),f(this,"deps",new Set),f(this,"translateKeys",!1),f(this,"translateValues",!1),f(this,"reviveValues",!1),this.key=e,this.enabled=t,this.parse=this.enabled,this.applyInheritables(r),this.canBeFiltered=b.includes(e),this.canBeFiltered&&(this.dict=k.get(e)),n!==void 0)if(Array.isArray(n))this.parse=this.enabled=!0,this.canBeFiltered&&n.length>0&&this.translateTagSet(n,this.pick);else if(typeof n=="object"){if(this.enabled=!0,this.parse=n.parse!==!1,this.canBeFiltered){let{pick:s,skip:a}=n;s&&s.length>0&&this.translateTagSet(s,this.pick),a&&a.length>0&&this.translateTagSet(a,this.skip)}this.applyInheritables(n)}else n===!0||n===!1?this.parse=this.enabled=n:S(`Invalid options argument: ${n}`)}applyInheritables(e){let t,n;for(t of ve)n=e[t],n!==void 0&&(this[t]=n)}translateTagSet(e,t){if(this.dict){let n,r,{tagKeys:s,tagValues:a}=this.dict;for(n of e)typeof n=="string"?(r=a.indexOf(n),r===-1&&(r=s.indexOf(Number(n))),r!==-1&&t.add(Number(s[r]))):t.add(n)}else for(let n of e)t.add(n)}finalizeFilters(){!this.enabled&&this.deps.size>0?(this.enabled=!0,ze(this.pick,this.deps)):this.enabled&&this.pick.size>0&&ze(this.pick,this.deps)}}var L={jfif:!1,tiff:!0,xmp:!1,icc:!1,iptc:!1,ifd0:!0,ifd1:!1,exif:!0,gps:!0,interop:!1,ihdr:void 0,makerNote:!1,userComment:!1,multiSegment:!1,skip:[],pick:[],translateKeys:!0,translateValues:!0,reviveValues:!0,sanitize:!0,mergeOutput:!0,silentErrors:!0,chunked:!0,firstChunkSize:void 0,firstChunkSizeNode:512,firstChunkSizeBrowser:65536,chunkSize:65536,chunkLimit:5},It=new Map;class xe extends Yt{static useCached(e){let t=It.get(e);return t!==void 0||(t=new this(e),It.set(e,t)),t}constructor(e){super(),e===!0?this.setupFromTrue():e===void 0?this.setupFromUndefined():Array.isArray(e)?this.setupFromArray(e):typeof e=="object"?this.setupFromObject(e):S(`Invalid options argument ${e}`),this.firstChunkSize===void 0&&(this.firstChunkSize=Re?this.firstChunkSizeBrowser:this.firstChunkSizeNode),this.mergeOutput&&(this.ifd1.enabled=!1),this.filterNestedSegmentTags(),this.traverseTiffDependencyTree(),this.checkLoadedPlugins()}setupFromUndefined(){let e;for(e of se)this[e]=L[e];for(e of le)this[e]=L[e];for(e of oe)this[e]=L[e];for(e of ae)this[e]=new Ae(e,L[e],void 0,this)}setupFromTrue(){let e;for(e of se)this[e]=L[e];for(e of le)this[e]=L[e];for(e of oe)this[e]=!0;for(e of ae)this[e]=new Ae(e,!0,void 0,this)}setupFromArray(e){let t;for(t of se)this[t]=L[t];for(t of le)this[t]=L[t];for(t of oe)this[t]=L[t];for(t of ae)this[t]=new Ae(t,!1,void 0,this);this.setupGlobalFilters(e,void 0,b)}setupFromObject(e){let t;for(t of(b.ifd0=b.ifd0||b.image,b.ifd1=b.ifd1||b.thumbnail,Object.assign(this,e),se))this[t]=nt(e[t],L[t]);for(t of le)this[t]=nt(e[t],L[t]);for(t of oe)this[t]=nt(e[t],L[t]);for(t of we)this[t]=new Ae(t,L[t],e[t],this);for(t of b)this[t]=new Ae(t,L[t],e[t],this.tiff);this.setupGlobalFilters(e.pick,e.skip,b,ae),e.tiff===!0?this.batchEnableWithBool(b,!0):e.tiff===!1?this.batchEnableWithUserValue(b,e):Array.isArray(e.tiff)?this.setupGlobalFilters(e.tiff,void 0,b):typeof e.tiff=="object"&&this.setupGlobalFilters(e.tiff.pick,e.tiff.skip,b)}batchEnableWithBool(e,t){for(let n of e)this[n].enabled=t}batchEnableWithUserValue(e,t){for(let n of e){let r=t[n];this[n].enabled=r!==!1&&r!==void 0}}setupGlobalFilters(e,t,n,r=n){if(e&&e.length){for(let a of r)this[a].enabled=!1;let s=At(e,n);for(let[a,o]of s)ze(this[a].pick,o),this[a].enabled=!0}else if(t&&t.length){let s=At(t,n);for(let[a,o]of s)ze(this[a].skip,o)}}filterNestedSegmentTags(){let{ifd0:e,exif:t,xmp:n,iptc:r,icc:s}=this;this.makerNote?t.deps.add(37500):t.skip.add(37500),this.userComment?t.deps.add(37510):t.skip.add(37510),n.enabled||e.skip.add(700),r.enabled||e.skip.add(33723),s.enabled||e.skip.add(34675)}traverseTiffDependencyTree(){let{ifd0:e,exif:t,gps:n,interop:r}=this;r.needed&&(t.deps.add(40965),e.deps.add(40965)),t.needed&&e.deps.add(34665),n.needed&&e.deps.add(34853),this.tiff.enabled=b.some(s=>this[s].enabled===!0)||this.makerNote||this.userComment;for(let s of b)this[s].finalizeFilters()}get onlyTiff(){return!Ce.map(e=>this[e].enabled).some(e=>e===!0)&&this.tiff.enabled}checkLoadedPlugins(){for(let e of we)this[e].enabled&&!x.has(e)&&ct("segment parser",e)}}function At(i,e){let t,n,r,s,a=[];for(r of e){for(s of(t=k.get(r),n=[],t))(i.includes(s[0])||i.includes(s[1]))&&n.push(s[0]);n.length&&a.push([r,n])}return a}function nt(i,e){return i!==void 0?i:e!==void 0?e:void 0}function ze(i,e){for(let t of e)i.add(t)}f(xe,"default",L);class he{constructor(e){f(this,"parsers",{}),f(this,"output",{}),f(this,"errors",[]),f(this,"pushToErrors",t=>this.errors.push(t)),this.options=xe.useCached(e)}async read(e){this.file=await Dn(e,this.options)}setup(){if(this.fileParser)return;let{file:e}=this,t=e.getUint16(0);for(let[n,r]of K)if(r.canHandle(e,t))return this.fileParser=new r(this.options,this.file,this.parsers),e[n]=!0;this.file.close&&this.file.close(),S("Unknown file format")}async parse(){let{output:e,errors:t}=this;return this.setup(),this.options.silentErrors?(await this.executeParsers().catch(this.pushToErrors),t.push(...this.fileParser.errors)):await this.executeParsers(),this.file.close&&this.file.close(),this.options.silentErrors&&t.length>0&&(e.errors=t),Ve(e)}async executeParsers(){let{output:e}=this;await this.fileParser.parse();let t=Object.values(this.parsers).map(async n=>{let r=await n.parse();n.assignToOutput(e,r)});this.options.silentErrors&&(t=t.map(n=>n.catch(this.pushToErrors))),await Promise.all(t)}async extractThumbnail(){this.setup();let{options:e,file:t}=this,n=x.get("tiff",e);var r;if(t.tiff?r={start:0,type:"tiff"}:t.jpeg&&(r=await this.fileParser.getOrFindSegment("tiff")),r===void 0)return;let s=await this.fileParser.ensureSegmentChunk(r),a=this.parsers.tiff=new n(s,e,t),o=await a.extractThumbnail();return t.close&&t.close(),o}}async function Ke(i,e){let t=new he(e);return await t.read(i),t.parse()}var Fn=Object.freeze({__proto__:null,parse:Ke,Exifr:he,fileParsers:K,segmentParsers:x,fileReaders:X,tagKeys:k,tagValues:H,tagRevivers:de,createDictionary:w,extendDictionary:be,fetchUrlAsArrayBuffer:_e,readBlobAsArrayBuffer:ye,chunkedProps:se,otherSegments:Ce,segments:we,tiffBlocks:b,segmentsAndBlocks:ae,tiffExtractables:oe,inheritables:ve,allFormatters:le,Options:xe});class Xe{constructor(e,t,n){f(this,"errors",[]),f(this,"ensureSegmentChunk",async r=>{let s=r.start,a=r.size||65536;if(this.file.chunked)if(this.file.available(s,a))r.chunk=this.file.subarray(s,a);else try{r.chunk=await this.file.readChunk(s,a)}catch(o){S(`Couldn't read segment: ${JSON.stringify(r)}. ${o.message}`)}else this.file.byteLength>s+a?r.chunk=this.file.subarray(s,a):r.size===void 0?r.chunk=this.file.subarray(s):S("Segment unreachable: "+JSON.stringify(r));return r.chunk}),this.extendOptions&&this.extendOptions(e),this.options=e,this.file=t,this.parsers=n}injectSegment(e,t){this.options[e].enabled&&this.createParser(e,t)}createParser(e,t){let n=new(x.get(e))(t,this.options,this.file);return this.parsers[e]=n}createParsers(e){for(let t of e){let{type:n,chunk:r}=t,s=this.options[n];if(s&&s.enabled){let a=this.parsers[n];a&&a.append||a||this.createParser(n,r)}}}async readSegments(e){let t=e.map(this.ensureSegmentChunk);await Promise.all(t)}}class G{static findPosition(e,t){let n=e.getUint16(t+2)+2,r=typeof this.headerLength=="function"?this.headerLength(e,t,n):this.headerLength,s=t+r,a=n-r;return{offset:t,length:n,headerLength:r,start:s,size:a,end:s+a}}static parse(e,t={}){return new this(e,new xe({[this.type]:t}),e).parse()}normalizeInput(e){return e instanceof D?e:new D(e)}constructor(e,t={},n){f(this,"errors",[]),f(this,"raw",new Map),f(this,"handleError",r=>{if(!this.options.silentErrors)throw r;this.errors.push(r.message)}),this.chunk=this.normalizeInput(e),this.file=n,this.type=this.constructor.type,this.globalOptions=this.options=t,this.localOptions=t[this.type],this.canTranslate=this.localOptions&&this.localOptions.translate}translate(){this.canTranslate&&(this.translated=this.translateBlock(this.raw,this.type))}get output(){return this.translated?this.translated:this.raw?Object.fromEntries(this.raw):void 0}translateBlock(e,t){let n=de.get(t),r=H.get(t),s=k.get(t),a=this.options[t],o=a.reviveValues&&!!n,l=a.translateValues&&!!r,h=a.translateKeys&&!!s,d={};for(let[u,g]of e)o&&n.has(u)?g=n.get(u)(g):l&&r.has(u)&&(g=this.translateValue(g,r.get(u))),h&&s.has(u)&&(u=s.get(u)||u),d[u]=g;return d}translateValue(e,t){return t[e]||t.DEFAULT||e}assignToOutput(e,t){this.assignObjectToOutput(e,this.constructor.type,t)}assignObjectToOutput(e,t,n){if(this.globalOptions.mergeOutput)return Object.assign(e,n);e[t]?Object.assign(e[t],n):e[t]=n}}f(G,"headerLength",4),f(G,"type",void 0),f(G,"multiSegment",!1),f(G,"canHandle",()=>!1);function Mn(i){return i===192||i===194||i===196||i===219||i===221||i===218||i===254}function En(i){return i>=224&&i<=239}function Un(i,e,t){for(let[n,r]of x)if(r.canHandle(i,e,t))return n}class Tt extends Xe{constructor(...e){super(...e),f(this,"appSegments",[]),f(this,"jpegSegments",[]),f(this,"unknownSegments",[])}static canHandle(e,t){return t===65496}async parse(){await this.findAppSegments(),await this.readSegments(this.appSegments),this.mergeMultiSegments(),this.createParsers(this.mergedAppSegments||this.appSegments)}setupSegmentFinderArgs(e){e===!0?(this.findAll=!0,this.wanted=new Set(x.keyList())):(e=e===void 0?x.keyList().filter(t=>this.options[t].enabled):e.filter(t=>this.options[t].enabled&&x.has(t)),this.findAll=!1,this.remaining=new Set(e),this.wanted=new Set(e)),this.unfinishedMultiSegment=!1}async findAppSegments(e=0,t){this.setupSegmentFinderArgs(t);let{file:n,findAll:r,wanted:s,remaining:a}=this;if(!r&&this.file.chunked&&(r=Array.from(s).some(o=>{let l=x.get(o),h=this.options[o];return l.multiSegment&&h.multiSegment}),r&&await this.file.readWhole()),e=this.findAppSegmentsInRange(e,n.byteLength),!this.options.onlyTiff&&n.chunked){let o=!1;for(;a.size>0&&!o&&(n.canReadNextChunk||this.unfinishedMultiSegment);){let{nextChunkOffset:l}=n,h=this.appSegments.some(d=>!this.file.available(d.offset||d.start,d.length||d.size));if(o=e>l&&!h?!await n.readNextChunk(e):!await n.readNextChunk(l),(e=this.findAppSegmentsInRange(e,n.byteLength))===void 0)return}}}findAppSegmentsInRange(e,t){t-=2;let n,r,s,a,o,l,{file:h,findAll:d,wanted:u,remaining:g,options:c}=this;for(;e<t;e++)if(h.getUint8(e)===255){if(n=h.getUint8(e+1),En(n)){if(r=h.getUint16(e+2),s=Un(h,e,r),s&&u.has(s)&&(a=x.get(s),o=a.findPosition(h,e),l=c[s],o.type=s,this.appSegments.push(o),!d&&(a.multiSegment&&l.multiSegment?(this.unfinishedMultiSegment=o.chunkNumber<o.chunkCount,this.unfinishedMultiSegment||g.delete(s)):g.delete(s),g.size===0)))break;c.recordUnknownSegments&&(o=G.findPosition(h,e),o.marker=n,this.unknownSegments.push(o)),e+=r+1}else if(Mn(n)){if(r=h.getUint16(e+2),n===218&&c.stopAfterSos!==!1)return;c.recordJpegSegments&&this.jpegSegments.push({offset:e,length:r,marker:n}),e+=r+1}}return e}mergeMultiSegments(){if(!this.appSegments.some(t=>t.multiSegment))return;let e=function(t,n){let r,s,a,o=new Map;for(let l=0;l<t.length;l++)r=t[l],s=r[n],o.has(s)?a=o.get(s):o.set(s,a=[]),a.push(r);return Array.from(o)}(this.appSegments,"type");this.mergedAppSegments=e.map(([t,n])=>{let r=x.get(t,this.options);return r.handleMultiSegments?{type:t,chunk:r.handleMultiSegments(n)}:n[0]})}getSegment(e){return this.appSegments.find(t=>t.type===e)}async getOrFindSegment(e){let t=this.getSegment(e);return t===void 0&&(await this.findAppSegments(0,[e]),t=this.getSegment(e)),t}}f(Tt,"type","jpeg"),K.set("jpeg",Tt);const Nn=[void 0,1,1,2,4,8,1,1,2,4,8,4,8,4];class Bn extends G{parseHeader(){var e=this.chunk.getUint16();e===18761?this.le=!0:e===19789&&(this.le=!1),this.chunk.le=this.le,this.headerParsed=!0}parseTags(e,t,n=new Map){let{pick:r,skip:s}=this.options[t];r=new Set(r);let a=r.size>0,o=s.size===0,l=this.chunk.getUint16(e);e+=2;for(let h=0;h<l;h++){let d=this.chunk.getUint16(e);if(a){if(r.has(d)&&(n.set(d,this.parseTag(e,d,t)),r.delete(d),r.size===0))break}else!o&&s.has(d)||n.set(d,this.parseTag(e,d,t));e+=12}return n}parseTag(e,t,n){let{chunk:r}=this,s=r.getUint16(e+2),a=r.getUint32(e+4),o=Nn[s];if(o*a<=4?e+=8:e=r.getUint32(e+8),(s<1||s>13)&&S(`Invalid TIFF value type. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e}`),e>r.byteLength&&S(`Invalid TIFF value offset. block: ${n.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${r.byteLength}`),s===1)return r.getUint8Array(e,a);if(s===2)return fe(r.getString(e,a));if(s===7)return r.getUint8Array(e,a);if(a===1)return this.parseTagValue(s,e);{let l=new(function(d){switch(d){case 1:return Uint8Array;case 3:return Uint16Array;case 4:return Uint32Array;case 5:return Array;case 6:return Int8Array;case 8:return Int16Array;case 9:return Int32Array;case 10:return Array;case 11:return Float32Array;case 12:return Float64Array;default:return Array}}(s))(a),h=o;for(let d=0;d<a;d++)l[d]=this.parseTagValue(s,e),e+=h;return l}}parseTagValue(e,t){let{chunk:n}=this;switch(e){case 1:return n.getUint8(t);case 3:return n.getUint16(t);case 4:return n.getUint32(t);case 5:return n.getUint32(t)/n.getUint32(t+4);case 6:return n.getInt8(t);case 8:return n.getInt16(t);case 9:return n.getInt32(t);case 10:return n.getInt32(t)/n.getInt32(t+4);case 11:return n.getFloat(t);case 12:return n.getDouble(t);case 13:return n.getUint32(t);default:S(`Invalid tiff type ${e}`)}}}class it extends Bn{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1165519206&&e.getUint16(t+8)===0}async parse(){this.parseHeader();let{options:e}=this;return e.ifd0.enabled&&await this.parseIfd0Block(),e.exif.enabled&&await this.safeParse("parseExifBlock"),e.gps.enabled&&await this.safeParse("parseGpsBlock"),e.interop.enabled&&await this.safeParse("parseInteropBlock"),e.ifd1.enabled&&await this.safeParse("parseThumbnailBlock"),this.createOutput()}safeParse(e){let t=this[e]();return t.catch!==void 0&&(t=t.catch(this.handleError)),t}findIfd0Offset(){this.ifd0Offset===void 0&&(this.ifd0Offset=this.chunk.getUint32(4))}findIfd1Offset(){if(this.ifd1Offset===void 0){this.findIfd0Offset();let e=this.chunk.getUint16(this.ifd0Offset),t=this.ifd0Offset+2+12*e;this.ifd1Offset=this.chunk.getUint32(t)}}parseBlock(e,t){let n=new Map;return this[t]=n,this.parseTags(e,t,n),n}async parseIfd0Block(){if(this.ifd0)return;let{file:e}=this;this.findIfd0Offset(),this.ifd0Offset<8&&S("Malformed EXIF data"),!e.chunked&&this.ifd0Offset>e.byteLength&&S(`IFD0 offset points to outside of file.
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`),e.tiff&&await e.ensureChunk(this.ifd0Offset,dt(this.options));let t=this.parseBlock(this.ifd0Offset,"ifd0");return t.size!==0?(this.exifOffset=t.get(34665),this.interopOffset=t.get(40965),this.gpsOffset=t.get(34853),this.xmp=t.get(700),this.iptc=t.get(33723),this.icc=t.get(34675),this.options.sanitize&&(t.delete(34665),t.delete(40965),t.delete(34853),t.delete(700),t.delete(33723),t.delete(34675)),t):void 0}async parseExifBlock(){if(this.exif||(this.ifd0||await this.parseIfd0Block(),this.exifOffset===void 0))return;this.file.tiff&&await this.file.ensureChunk(this.exifOffset,dt(this.options));let e=this.parseBlock(this.exifOffset,"exif");return this.interopOffset||(this.interopOffset=e.get(40965)),this.makerNote=e.get(37500),this.userComment=e.get(37510),this.options.sanitize&&(e.delete(40965),e.delete(37500),e.delete(37510)),this.unpack(e,41728),this.unpack(e,41729),e}unpack(e,t){let n=e.get(t);n&&n.length===1&&e.set(t,n[0])}async parseGpsBlock(){if(this.gps||(this.ifd0||await this.parseIfd0Block(),this.gpsOffset===void 0))return;let e=this.parseBlock(this.gpsOffset,"gps");return e&&e.has(2)&&e.has(4)&&(e.set("latitude",Lt(...e.get(2),e.get(1))),e.set("longitude",Lt(...e.get(4),e.get(3)))),e}async parseInteropBlock(){if(!this.interop&&(this.ifd0||await this.parseIfd0Block(),this.interopOffset!==void 0||this.exif||await this.parseExifBlock(),this.interopOffset!==void 0))return this.parseBlock(this.interopOffset,"interop")}async parseThumbnailBlock(e=!1){if(!this.ifd1&&!this.ifd1Parsed&&(!this.options.mergeOutput||e))return this.findIfd1Offset(),this.ifd1Offset>0&&(this.parseBlock(this.ifd1Offset,"ifd1"),this.ifd1Parsed=!0),this.ifd1}async extractThumbnail(){if(this.headerParsed||this.parseHeader(),this.ifd1Parsed||await this.parseThumbnailBlock(!0),this.ifd1===void 0)return;let e=this.ifd1.get(513),t=this.ifd1.get(514);return this.chunk.getUint8Array(e,t)}get image(){return this.ifd0}get thumbnail(){return this.ifd1}createOutput(){let e,t,n,r={};for(t of b)if(e=this[t],!qt(e))if(n=this.canTranslate?this.translateBlock(e,t):Object.fromEntries(e),this.options.mergeOutput){if(t==="ifd1")continue;Object.assign(r,n)}else r[t]=n;return this.makerNote&&(r.makerNote=this.makerNote),this.userComment&&(r.userComment=this.userComment),r}assignToOutput(e,t){if(this.globalOptions.mergeOutput)Object.assign(e,t);else for(let[n,r]of Object.entries(t))this.assignObjectToOutput(e,n,r)}}function Lt(i,e,t,n){var r=i+e/60+t/3600;return n!=="S"&&n!=="W"||(r*=-1),r}f(it,"type","tiff"),f(it,"headerLength",10),x.set("tiff",it);var Vn=Object.freeze({__proto__:null,default:Fn,Exifr:he,fileParsers:K,segmentParsers:x,fileReaders:X,tagKeys:k,tagValues:H,tagRevivers:de,createDictionary:w,extendDictionary:be,fetchUrlAsArrayBuffer:_e,readBlobAsArrayBuffer:ye,chunkedProps:se,otherSegments:Ce,segments:we,tiffBlocks:b,segmentsAndBlocks:ae,tiffExtractables:oe,inheritables:ve,allFormatters:le,Options:xe,parse:Ke});const mt={ifd0:!1,ifd1:!1,exif:!1,gps:!1,interop:!1,sanitize:!1,reviveValues:!0,translateKeys:!1,translateValues:!1,mergeOutput:!1},_t=Object.assign({},mt,{firstChunkSize:4e4,gps:[1,2,3,4]});async function $t(i){let e=new he(_t);await e.read(i);let t=await e.parse();if(t&&t.gps){let{latitude:n,longitude:r}=t.gps;return{latitude:n,longitude:r}}}const yt=Object.assign({},mt,{tiff:!1,ifd1:!0,mergeOutput:!1});async function Qt(i){let e=new he(yt);await e.read(i);let t=await e.extractThumbnail();return t&&We?je.from(t):t}async function Zt(i){let e=await this.thumbnail(i);if(e!==void 0){let t=new Blob([e]);return URL.createObjectURL(t)}}const bt=Object.assign({},mt,{firstChunkSize:4e4,ifd0:[274]});async function wt(i){let e=new he(bt);await e.read(i);let t=await e.parse();if(t&&t.ifd0)return t.ifd0[274]}const xt=Object.freeze({1:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:0,rad:0},2:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:0,rad:0},3:{dimensionSwapped:!1,scaleX:1,scaleY:1,deg:180,rad:180*Math.PI/180},4:{dimensionSwapped:!1,scaleX:-1,scaleY:1,deg:180,rad:180*Math.PI/180},5:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:90,rad:90*Math.PI/180},6:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:90,rad:90*Math.PI/180},7:{dimensionSwapped:!0,scaleX:1,scaleY:-1,deg:270,rad:270*Math.PI/180},8:{dimensionSwapped:!0,scaleX:1,scaleY:1,deg:270,rad:270*Math.PI/180}});let ge=!0,me=!0;if(typeof navigator=="object"){let i=navigator.userAgent;if(i.includes("iPad")||i.includes("iPhone")){let e=i.match(/OS (\d+)_(\d+)/);if(e){let[,t,n]=e;ge=Number(t)+.1*Number(n)<13.4,me=!1}}else if(i.includes("OS X 10")){let[,e]=i.match(/OS X 10[_.](\d+)/);ge=me=Number(e)<15}if(i.includes("Chrome/")){let[,e]=i.match(/Chrome\/(\d+)/);ge=me=Number(e)<81}else if(i.includes("Firefox/")){let[,e]=i.match(/Firefox\/(\d+)/);ge=me=Number(e)<77}}async function en(i){let e=await wt(i);return Object.assign({canvas:ge,css:me},xt[e])}class zn extends D{constructor(...e){super(...e),f(this,"ranges",new Gn),this.byteLength!==0&&this.ranges.add(0,this.byteLength)}_tryExtend(e,t,n){if(e===0&&this.byteLength===0&&n){let r=new DataView(n.buffer||n,n.byteOffset,n.byteLength);this._swapDataView(r)}else{let r=e+t;if(r>this.byteLength){let{dataView:s}=this._extend(r);this._swapDataView(s)}}}_extend(e){let t;t=We?je.allocUnsafe(e):new Uint8Array(e);let n=new DataView(t.buffer,t.byteOffset,t.byteLength);return t.set(new Uint8Array(this.buffer,this.byteOffset,this.byteLength),0),{uintView:t,dataView:n}}subarray(e,t,n=!1){return t=t||this._lengthToEnd(e),n&&this._tryExtend(e,t),this.ranges.add(e,t),super.subarray(e,t)}set(e,t,n=!1){n&&this._tryExtend(t,e.byteLength,e);let r=super.set(e,t);return this.ranges.add(t,r.byteLength),r}async ensureChunk(e,t){this.chunked&&(this.ranges.available(e,t)||await this.readChunk(e,t))}available(e,t){return this.ranges.available(e,t)}}class Gn{constructor(){f(this,"list",[])}get length(){return this.list.length}add(e,t,n=0){let r=e+t,s=this.list.filter(a=>Rt(e,a.offset,r)||Rt(e,a.end,r));if(s.length>0){e=Math.min(e,...s.map(o=>o.offset)),r=Math.max(r,...s.map(o=>o.end)),t=r-e;let a=s.shift();a.offset=e,a.length=t,a.end=r,this.list=this.list.filter(o=>!s.includes(o))}else this.list.push({offset:e,length:t,end:r})}available(e,t){let n=e+t;return this.list.some(r=>r.offset<=e&&n<=r.end)}}function Rt(i,e,t){return i<=e&&e<=t}class qe extends zn{constructor(e,t){super(0),f(this,"chunksRead",0),this.input=e,this.options=t}async readWhole(){this.chunked=!1,await this.readChunk(this.nextChunkOffset)}async readChunked(){this.chunked=!0,await this.readChunk(0,this.options.firstChunkSize)}async readNextChunk(e=this.nextChunkOffset){if(this.fullyRead)return this.chunksRead++,!1;let t=this.options.chunkSize,n=await this.readChunk(e,t);return!!n&&n.byteLength===t}async readChunk(e,t){if(this.chunksRead++,(t=this.safeWrapAddress(e,t))!==0)return this._readChunk(e,t)}safeWrapAddress(e,t){return this.size!==void 0&&e+t>this.size?Math.max(0,this.size-e):t}get nextChunkOffset(){if(this.ranges.list.length!==0)return this.ranges.list[0].length}get canReadNextChunk(){return this.chunksRead<this.options.chunkLimit}get fullyRead(){return this.size!==void 0&&this.nextChunkOffset===this.size}read(){return this.options.chunked?this.readChunked():this.readWhole()}close(){}}X.set("blob",class extends qe{async readWhole(){this.chunked=!1;let i=await ye(this.input);this._swapArrayBuffer(i)}readChunked(){return this.chunked=!0,this.size=this.input.size,super.readChunked()}async _readChunk(i,e){let t=e?i+e:void 0,n=this.input.slice(i,t),r=await ye(n);return this.set(r,i,!0)}});var Hn=Object.freeze({__proto__:null,default:Vn,Exifr:he,fileParsers:K,segmentParsers:x,fileReaders:X,tagKeys:k,tagValues:H,tagRevivers:de,createDictionary:w,extendDictionary:be,fetchUrlAsArrayBuffer:_e,readBlobAsArrayBuffer:ye,chunkedProps:se,otherSegments:Ce,segments:we,tiffBlocks:b,segmentsAndBlocks:ae,tiffExtractables:oe,inheritables:ve,allFormatters:le,Options:xe,parse:Ke,gpsOnlyOptions:_t,gps:$t,thumbnailOnlyOptions:yt,thumbnail:Qt,thumbnailUrl:Zt,orientationOnlyOptions:bt,orientation:wt,rotations:xt,get rotateCanvas(){return ge},get rotateCss(){return me},rotation:en});X.set("url",class extends qe{async readWhole(){this.chunked=!1;let i=await _e(this.input);i instanceof ArrayBuffer?this._swapArrayBuffer(i):i instanceof Uint8Array&&this._swapBuffer(i)}async _readChunk(i,e){let t=e?i+e-1:void 0,n=this.options.httpHeaders||{};(i||t)&&(n.range=`bytes=${[i,t].join("-")}`);let r=await ft(this.input,{headers:n}),s=await r.arrayBuffer(),a=s.byteLength;if(r.status!==416)return a!==e&&(this.size=i+a),this.set(s,i,!0)}});D.prototype.getUint64=function(i){let e=this.getUint32(i),t=this.getUint32(i+4);return e<1048575?e<<32|t:typeof Fe!==void 0?(console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."),Fe(e)<<Fe(32)|Fe(t)):void S("Trying to read 64b value but JS can only handle 53b numbers.")};class jn extends Xe{parseBoxes(e=0){let t=[];for(;e<this.file.byteLength-4;){let n=this.parseBoxHead(e);if(t.push(n),n.length===0)break;e+=n.length}return t}parseSubBoxes(e){e.boxes=this.parseBoxes(e.start)}findBox(e,t){return e.boxes===void 0&&this.parseSubBoxes(e),e.boxes.find(n=>n.kind===t)}parseBoxHead(e){let t=this.file.getUint32(e),n=this.file.getString(e+4,4),r=e+8;return t===1&&(t=this.file.getUint64(e+8),r+=8),{offset:e,length:t,kind:n,start:r}}parseBoxFullHead(e){if(e.version!==void 0)return;let t=this.file.getUint32(e.start);e.version=t>>24,e.start+=4}}class tn extends jn{static canHandle(e,t){if(t!==0)return!1;let n=e.getUint16(2);if(n>50)return!1;let r=16,s=[];for(;r<n;)s.push(e.getString(r,4)),r+=4;return s.includes(this.type)}async parse(){let e=this.file.getUint32(0),t=this.parseBoxHead(e);for(;t.kind!=="meta";)e+=t.length,await this.file.ensureChunk(e,16),t=this.parseBoxHead(e);await this.file.ensureChunk(t.offset,t.length),this.parseBoxFullHead(t),this.parseSubBoxes(t),this.options.icc.enabled&&await this.findIcc(t),this.options.tiff.enabled&&await this.findExif(t)}async registerSegment(e,t,n){await this.file.ensureChunk(t,n);let r=this.file.subarray(t,n);this.createParser(e,r)}async findIcc(e){let t=this.findBox(e,"iprp");if(t===void 0)return;let n=this.findBox(t,"ipco");if(n===void 0)return;let r=this.findBox(n,"colr");r!==void 0&&await this.registerSegment("icc",r.offset+12,r.length)}async findExif(e){let t=this.findBox(e,"iinf");if(t===void 0)return;let n=this.findBox(e,"iloc");if(n===void 0)return;let r=this.findExifLocIdInIinf(t),s=this.findExtentInIloc(n,r);if(s===void 0)return;let[a,o]=s;await this.file.ensureChunk(a,o);let l=4+this.file.getUint32(a);a+=l,o-=l,await this.registerSegment("tiff",a,o)}findExifLocIdInIinf(e){this.parseBoxFullHead(e);let t,n,r,s,a=e.start,o=this.file.getUint16(a);for(a+=2;o--;){if(t=this.parseBoxHead(a),this.parseBoxFullHead(t),n=t.start,t.version>=2&&(r=t.version===3?4:2,s=this.file.getString(n+r+2,4),s==="Exif"))return this.file.getUintBytes(n,r);a+=t.length}}get8bits(e){let t=this.file.getUint8(e);return[t>>4,15&t]}findExtentInIloc(e,t){this.parseBoxFullHead(e);let n=e.start,[r,s]=this.get8bits(n++),[a,o]=this.get8bits(n++),l=e.version===2?4:2,h=e.version===1||e.version===2?2:0,d=o+r+s,u=e.version===2?4:2,g=this.file.getUintBytes(n,u);for(n+=u;g--;){let c=this.file.getUintBytes(n,l);n+=l+h+2+a;let y=this.file.getUint16(n);if(n+=2,c===t)return y>1&&console.warn(`ILOC box has more than one extent but we're only processing one
Please create an issue at https://github.com/MikeKovarik/exifr with this file`),[this.file.getUintBytes(n+o,r),this.file.getUintBytes(n+o+r,s)];n+=y*d}}}class nn extends tn{}f(nn,"type","heic");class Dt extends tn{}f(Dt,"type","avif"),K.set("heic",nn),K.set("avif",Dt),w(k,["ifd0","ifd1"],[[256,"ImageWidth"],[257,"ImageHeight"],[258,"BitsPerSample"],[259,"Compression"],[262,"PhotometricInterpretation"],[270,"ImageDescription"],[271,"Make"],[272,"Model"],[273,"StripOffsets"],[274,"Orientation"],[277,"SamplesPerPixel"],[278,"RowsPerStrip"],[279,"StripByteCounts"],[282,"XResolution"],[283,"YResolution"],[284,"PlanarConfiguration"],[296,"ResolutionUnit"],[301,"TransferFunction"],[305,"Software"],[306,"ModifyDate"],[315,"Artist"],[316,"HostComputer"],[317,"Predictor"],[318,"WhitePoint"],[319,"PrimaryChromaticities"],[513,"ThumbnailOffset"],[514,"ThumbnailLength"],[529,"YCbCrCoefficients"],[530,"YCbCrSubSampling"],[531,"YCbCrPositioning"],[532,"ReferenceBlackWhite"],[700,"ApplicationNotes"],[33432,"Copyright"],[33723,"IPTC"],[34665,"ExifIFD"],[34675,"ICC"],[34853,"GpsIFD"],[330,"SubIFD"],[40965,"InteropIFD"],[40091,"XPTitle"],[40092,"XPComment"],[40093,"XPAuthor"],[40094,"XPKeywords"],[40095,"XPSubject"]]),w(k,"exif",[[33434,"ExposureTime"],[33437,"FNumber"],[34850,"ExposureProgram"],[34852,"SpectralSensitivity"],[34855,"ISO"],[34858,"TimeZoneOffset"],[34859,"SelfTimerMode"],[34864,"SensitivityType"],[34865,"StandardOutputSensitivity"],[34866,"RecommendedExposureIndex"],[34867,"ISOSpeed"],[34868,"ISOSpeedLatitudeyyy"],[34869,"ISOSpeedLatitudezzz"],[36864,"ExifVersion"],[36867,"DateTimeOriginal"],[36868,"CreateDate"],[36873,"GooglePlusUploadCode"],[36880,"OffsetTime"],[36881,"OffsetTimeOriginal"],[36882,"OffsetTimeDigitized"],[37121,"ComponentsConfiguration"],[37122,"CompressedBitsPerPixel"],[37377,"ShutterSpeedValue"],[37378,"ApertureValue"],[37379,"BrightnessValue"],[37380,"ExposureCompensation"],[37381,"MaxApertureValue"],[37382,"SubjectDistance"],[37383,"MeteringMode"],[37384,"LightSource"],[37385,"Flash"],[37386,"FocalLength"],[37393,"ImageNumber"],[37394,"SecurityClassification"],[37395,"ImageHistory"],[37396,"SubjectArea"],[37500,"MakerNote"],[37510,"UserComment"],[37520,"SubSecTime"],[37521,"SubSecTimeOriginal"],[37522,"SubSecTimeDigitized"],[37888,"AmbientTemperature"],[37889,"Humidity"],[37890,"Pressure"],[37891,"WaterDepth"],[37892,"Acceleration"],[37893,"CameraElevationAngle"],[40960,"FlashpixVersion"],[40961,"ColorSpace"],[40962,"ExifImageWidth"],[40963,"ExifImageHeight"],[40964,"RelatedSoundFile"],[41483,"FlashEnergy"],[41486,"FocalPlaneXResolution"],[41487,"FocalPlaneYResolution"],[41488,"FocalPlaneResolutionUnit"],[41492,"SubjectLocation"],[41493,"ExposureIndex"],[41495,"SensingMethod"],[41728,"FileSource"],[41729,"SceneType"],[41730,"CFAPattern"],[41985,"CustomRendered"],[41986,"ExposureMode"],[41987,"WhiteBalance"],[41988,"DigitalZoomRatio"],[41989,"FocalLengthIn35mmFormat"],[41990,"SceneCaptureType"],[41991,"GainControl"],[41992,"Contrast"],[41993,"Saturation"],[41994,"Sharpness"],[41996,"SubjectDistanceRange"],[42016,"ImageUniqueID"],[42032,"OwnerName"],[42033,"SerialNumber"],[42034,"LensInfo"],[42035,"LensMake"],[42036,"LensModel"],[42037,"LensSerialNumber"],[42080,"CompositeImage"],[42081,"CompositeImageCount"],[42082,"CompositeImageExposureTimes"],[42240,"Gamma"],[59932,"Padding"],[59933,"OffsetSchema"],[65e3,"OwnerName"],[65001,"SerialNumber"],[65002,"Lens"],[65100,"RawFile"],[65101,"Converter"],[65102,"WhiteBalance"],[65105,"Exposure"],[65106,"Shadows"],[65107,"Brightness"],[65108,"Contrast"],[65109,"Saturation"],[65110,"Sharpness"],[65111,"Smoothness"],[65112,"MoireFilter"],[40965,"InteropIFD"]]),w(k,"gps",[[0,"GPSVersionID"],[1,"GPSLatitudeRef"],[2,"GPSLatitude"],[3,"GPSLongitudeRef"],[4,"GPSLongitude"],[5,"GPSAltitudeRef"],[6,"GPSAltitude"],[7,"GPSTimeStamp"],[8,"GPSSatellites"],[9,"GPSStatus"],[10,"GPSMeasureMode"],[11,"GPSDOP"],[12,"GPSSpeedRef"],[13,"GPSSpeed"],[14,"GPSTrackRef"],[15,"GPSTrack"],[16,"GPSImgDirectionRef"],[17,"GPSImgDirection"],[18,"GPSMapDatum"],[19,"GPSDestLatitudeRef"],[20,"GPSDestLatitude"],[21,"GPSDestLongitudeRef"],[22,"GPSDestLongitude"],[23,"GPSDestBearingRef"],[24,"GPSDestBearing"],[25,"GPSDestDistanceRef"],[26,"GPSDestDistance"],[27,"GPSProcessingMethod"],[28,"GPSAreaInformation"],[29,"GPSDateStamp"],[30,"GPSDifferential"],[31,"GPSHPositioningError"]]),w(H,["ifd0","ifd1"],[[274,{1:"Horizontal (normal)",2:"Mirror horizontal",3:"Rotate 180",4:"Mirror vertical",5:"Mirror horizontal and rotate 270 CW",6:"Rotate 90 CW",7:"Mirror horizontal and rotate 90 CW",8:"Rotate 270 CW"}],[296,{1:"None",2:"inches",3:"cm"}]]);let Le=w(H,"exif",[[34850,{0:"Not defined",1:"Manual",2:"Normal program",3:"Aperture priority",4:"Shutter priority",5:"Creative program",6:"Action program",7:"Portrait mode",8:"Landscape mode"}],[37121,{0:"-",1:"Y",2:"Cb",3:"Cr",4:"R",5:"G",6:"B"}],[37383,{0:"Unknown",1:"Average",2:"CenterWeightedAverage",3:"Spot",4:"MultiSpot",5:"Pattern",6:"Partial",255:"Other"}],[37384,{0:"Unknown",1:"Daylight",2:"Fluorescent",3:"Tungsten (incandescent light)",4:"Flash",9:"Fine weather",10:"Cloudy weather",11:"Shade",12:"Daylight fluorescent (D 5700 - 7100K)",13:"Day white fluorescent (N 4600 - 5400K)",14:"Cool white fluorescent (W 3900 - 4500K)",15:"White fluorescent (WW 3200 - 3700K)",17:"Standard light A",18:"Standard light B",19:"Standard light C",20:"D55",21:"D65",22:"D75",23:"D50",24:"ISO studio tungsten",255:"Other"}],[37385,{0:"Flash did not fire",1:"Flash fired",5:"Strobe return light not detected",7:"Strobe return light detected",9:"Flash fired, compulsory flash mode",13:"Flash fired, compulsory flash mode, return light not detected",15:"Flash fired, compulsory flash mode, return light detected",16:"Flash did not fire, compulsory flash mode",24:"Flash did not fire, auto mode",25:"Flash fired, auto mode",29:"Flash fired, auto mode, return light not detected",31:"Flash fired, auto mode, return light detected",32:"No flash function",65:"Flash fired, red-eye reduction mode",69:"Flash fired, red-eye reduction mode, return light not detected",71:"Flash fired, red-eye reduction mode, return light detected",73:"Flash fired, compulsory flash mode, red-eye reduction mode",77:"Flash fired, compulsory flash mode, red-eye reduction mode, return light not detected",79:"Flash fired, compulsory flash mode, red-eye reduction mode, return light detected",89:"Flash fired, auto mode, red-eye reduction mode",93:"Flash fired, auto mode, return light not detected, red-eye reduction mode",95:"Flash fired, auto mode, return light detected, red-eye reduction mode"}],[41495,{1:"Not defined",2:"One-chip color area sensor",3:"Two-chip color area sensor",4:"Three-chip color area sensor",5:"Color sequential area sensor",7:"Trilinear sensor",8:"Color sequential linear sensor"}],[41728,{1:"Film Scanner",2:"Reflection Print Scanner",3:"Digital Camera"}],[41729,{1:"Directly photographed"}],[41985,{0:"Normal",1:"Custom",2:"HDR (no original saved)",3:"HDR (original saved)",4:"Original (for HDR)",6:"Panorama",7:"Portrait HDR",8:"Portrait"}],[41986,{0:"Auto",1:"Manual",2:"Auto bracket"}],[41987,{0:"Auto",1:"Manual"}],[41990,{0:"Standard",1:"Landscape",2:"Portrait",3:"Night",4:"Other"}],[41991,{0:"None",1:"Low gain up",2:"High gain up",3:"Low gain down",4:"High gain down"}],[41996,{0:"Unknown",1:"Macro",2:"Close",3:"Distant"}],[42080,{0:"Unknown",1:"Not a Composite Image",2:"General Composite Image",3:"Composite Image Captured While Shooting"}]]);const Ot={1:"No absolute unit of measurement",2:"Inch",3:"Centimeter"};Le.set(37392,Ot),Le.set(41488,Ot);const rt={0:"Normal",1:"Low",2:"High"};function Ft(i){return typeof i=="object"&&i.length!==void 0?i[0]:i}function Mt(i){let e=Array.from(i).slice(1);return e[1]>15&&(e=e.map(t=>String.fromCharCode(t))),e[2]!=="0"&&e[2]!==0||e.pop(),e.join(".")}function st(i){if(typeof i=="string"){var[e,t,n,r,s,a]=i.trim().split(/[-: ]/g).map(Number),o=new Date(e,t-1,n);return Number.isNaN(r)||Number.isNaN(s)||Number.isNaN(a)||(o.setHours(r),o.setMinutes(s),o.setSeconds(a)),Number.isNaN(+o)?i:o}}function Te(i){if(typeof i=="string")return i;let e=[];if(i[1]===0&&i[i.length-1]===0)for(let t=0;t<i.length;t+=2)e.push(Et(i[t+1],i[t]));else for(let t=0;t<i.length;t+=2)e.push(Et(i[t],i[t+1]));return fe(String.fromCodePoint(...e))}function Et(i,e){return i<<8|e}Le.set(41992,rt),Le.set(41993,rt),Le.set(41994,rt),w(de,["ifd0","ifd1"],[[50827,function(i){return typeof i!="string"?Jt(i):i}],[306,st],[40091,Te],[40092,Te],[40093,Te],[40094,Te],[40095,Te]]),w(de,"exif",[[40960,Mt],[36864,Mt],[36867,st],[36868,st],[40962,Ft],[40963,Ft]]),w(de,"gps",[[0,i=>Array.from(i).join(".")],[7,i=>Array.from(i).join(":")]]);class at extends G{static canHandle(e,t){return e.getUint8(t+1)===225&&e.getUint32(t+4)===1752462448&&e.getString(t+4,20)==="http://ns.adobe.com/"}static headerLength(e,t){return e.getString(t+4,34)==="http://ns.adobe.com/xmp/extension/"?79:33}static findPosition(e,t){let n=super.findPosition(e,t);return n.multiSegment=n.extended=n.headerLength===79,n.multiSegment?(n.chunkCount=e.getUint8(t+72),n.chunkNumber=e.getUint8(t+76),e.getUint8(t+77)!==0&&n.chunkNumber++):(n.chunkCount=1/0,n.chunkNumber=-1),n}static handleMultiSegments(e){return e.map(t=>t.chunk.getString()).join("")}normalizeInput(e){return typeof e=="string"?e:D.from(e).getString()}parse(e=this.chunk){if(!this.localOptions.parse)return e;e=function(s){let a={},o={};for(let l of on)a[l]=[],o[l]=0;return s.replace(qn,(l,h,d)=>{if(h==="<"){let u=++o[d];return a[d].push(u),`${l}#${u}`}return`${l}#${a[d].pop()}`})}(e);let t=ke.findAll(e,"rdf","Description");t.length===0&&t.push(new ke("rdf","Description",void 0,e));let n,r={};for(let s of t)for(let a of s.properties)n=Xn(a.ns,r),rn(a,n);return function(s){let a;for(let o in s)a=s[o]=Ve(s[o]),a===void 0&&delete s[o];return Ve(s)}(r)}assignToOutput(e,t){if(this.localOptions.parse)for(let[n,r]of Object.entries(t))switch(n){case"tiff":this.assignObjectToOutput(e,"ifd0",r);break;case"exif":this.assignObjectToOutput(e,"exif",r);break;case"xmlns":break;default:this.assignObjectToOutput(e,n,r)}else e.xmp=t}}f(at,"type","xmp"),f(at,"multiSegment",!0),x.set("xmp",at);class Ge{static findAll(e){return sn(e,/([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(Ge.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],r=e[3].slice(1,-1);return r=an(r),new Ge(t,n,r)}constructor(e,t,n){this.ns=e,this.name=t,this.value=n}serialize(){return this.value}}class ke{static findAll(e,t,n){if(t!==void 0||n!==void 0){t=t||"[\\w\\d-]+",n=n||"[\\w\\d-]+";var r=new RegExp(`<(${t}):(${n})(#\\d+)?((\\s+?[\\w\\d-:]+=("[^"]*"|'[^']*'))*\\s*)(\\/>|>([\\s\\S]*?)<\\/\\1:\\2\\3>)`,"gm")}else r=/<([\w\d-]+):([\w\d-]+)(#\d+)?((\s+?[\w\d-:]+=("[^"]*"|'[^']*'))*\s*)(\/>|>([\s\S]*?)<\/\1:\2\3>)/gm;return sn(e,r).map(ke.unpackMatch)}static unpackMatch(e){let t=e[1],n=e[2],r=e[4],s=e[8];return new ke(t,n,r,s)}constructor(e,t,n,r){this.ns=e,this.name=t,this.attrString=n,this.innerXml=r,this.attrs=Ge.findAll(n),this.children=ke.findAll(r),this.value=this.children.length===0?an(r):void 0,this.properties=[...this.attrs,...this.children]}get isPrimitive(){return this.value!==void 0&&this.attrs.length===0&&this.children.length===0}get isListContainer(){return this.children.length===1&&this.children[0].isList}get isList(){let{ns:e,name:t}=this;return e==="rdf"&&(t==="Seq"||t==="Bag"||t==="Alt")}get isListItem(){return this.ns==="rdf"&&this.name==="li"}serialize(){if(this.properties.length===0&&this.value===void 0)return;if(this.isPrimitive)return this.value;if(this.isListContainer)return this.children[0].serialize();if(this.isList)return Kn(this.children.map(Wn));if(this.isListItem&&this.children.length===1&&this.attrs.length===0)return this.children[0].serialize();let e={};for(let t of this.properties)rn(t,e);return this.value!==void 0&&(e.value=this.value),Ve(e)}}function rn(i,e){let t=i.serialize();t!==void 0&&(e[i.name]=t)}var Wn=i=>i.serialize(),Kn=i=>i.length===1?i[0]:i,Xn=(i,e)=>e[i]?e[i]:e[i]={};function sn(i,e){let t,n=[];if(!i)return n;for(;(t=e.exec(i))!==null;)n.push(t);return n}function an(i){if(function(n){return n==null||n==="null"||n==="undefined"||n===""||n.trim()===""}(i))return;let e=Number(i);if(!Number.isNaN(e))return e;let t=i.toLowerCase();return t==="true"||t!=="false"&&i.trim()}const on=["rdf:li","rdf:Seq","rdf:Bag","rdf:Alt","rdf:Description"],qn=new RegExp(`(<|\\/)(${on.join("|")})`,"g");var ln=Object.freeze({__proto__:null,default:Hn,Exifr:he,fileParsers:K,segmentParsers:x,fileReaders:X,tagKeys:k,tagValues:H,tagRevivers:de,createDictionary:w,extendDictionary:be,fetchUrlAsArrayBuffer:_e,readBlobAsArrayBuffer:ye,chunkedProps:se,otherSegments:Ce,segments:we,tiffBlocks:b,segmentsAndBlocks:ae,tiffExtractables:oe,inheritables:ve,allFormatters:le,Options:xe,parse:Ke,gpsOnlyOptions:_t,gps:$t,thumbnailOnlyOptions:yt,thumbnail:Qt,thumbnailUrl:Zt,orientationOnlyOptions:bt,orientation:wt,rotations:xt,get rotateCanvas(){return ge},get rotateCss(){return me},rotation:en});let Ut=Be("fs",i=>i.promises);X.set("fs",class extends qe{async readWhole(){this.chunked=!1,this.fs=await Ut;let i=await this.fs.readFile(this.input);this._swapBuffer(i)}async readChunked(){this.chunked=!0,this.fs=await Ut,await this.open(),await this.readChunk(0,this.options.firstChunkSize)}async open(){this.fh===void 0&&(this.fh=await this.fs.open(this.input,"r"),this.size=(await this.fh.stat(this.input)).size)}async _readChunk(i,e){this.fh===void 0&&await this.open(),i+e>this.size&&(e=this.size-i);var t=this.subarray(i,e,!0);return await this.fh.read(t.dataView,0,e,i),t}async close(){if(this.fh){let i=this.fh;this.fh=void 0,await i.close()}}});X.set("base64",class extends qe{constructor(...i){super(...i),this.input=this.input.replace(/^data:([^;]+);base64,/gim,""),this.size=this.input.length/4*3,this.input.endsWith("==")?this.size-=2:this.input.endsWith("=")&&(this.size-=1)}async _readChunk(i,e){let t,n,r=this.input;i===void 0?(i=0,t=0,n=0):(t=4*Math.floor(i/3),n=i-t/4*3),e===void 0&&(e=this.size);let s=i+e,a=t+4*Math.ceil(s/3);r=r.slice(t,a);let o=Math.min(e,this.size-i);if(We){let l=je.from(r,"base64").slice(n,n+o);return this.set(l,i,!0)}{let l=this.subarray(i,o,!0),h=atob(r),d=l.toUint8();for(let u=0;u<o;u++)d[u]=h.charCodeAt(n+u);return l}}});class Nt extends Xe{static canHandle(e,t){return t===18761||t===19789}extendOptions(e){let{ifd0:t,xmp:n,iptc:r,icc:s}=e;n.enabled&&t.deps.add(700),r.enabled&&t.deps.add(33723),s.enabled&&t.deps.add(34675),t.finalizeFilters()}async parse(){let{tiff:e,xmp:t,iptc:n,icc:r}=this.options;if(e.enabled||t.enabled||n.enabled||r.enabled){let s=Math.max(dt(this.options),this.options.chunkSize);await this.file.ensureChunk(0,s),this.createParser("tiff",this.file),this.parsers.tiff.parseHeader(),await this.parsers.tiff.parseIfd0Block(),this.adaptTiffPropAsSegment("xmp"),this.adaptTiffPropAsSegment("iptc"),this.adaptTiffPropAsSegment("icc")}}adaptTiffPropAsSegment(e){if(this.parsers.tiff[e]){let t=this.parsers.tiff[e];this.injectSegment(e,t)}}}f(Nt,"type","tiff"),K.set("tiff",Nt);let Jn=Be("zlib");const Yn=["ihdr","iccp","text","itxt","exif"];class Bt extends Xe{constructor(...e){super(...e),f(this,"catchError",t=>this.errors.push(t)),f(this,"metaChunks",[]),f(this,"unknownChunks",[])}static canHandle(e,t){return t===35152&&e.getUint32(0)===2303741511&&e.getUint32(4)===218765834}async parse(){let{file:e}=this;await this.findPngChunksInRange(8,e.byteLength),await this.readSegments(this.metaChunks),this.findIhdr(),this.parseTextChunks(),await this.findExif().catch(this.catchError),await this.findXmp().catch(this.catchError),await this.findIcc().catch(this.catchError)}async findPngChunksInRange(e,t){let{file:n}=this;for(;e<t;){let r=n.getUint32(e),s=n.getUint32(e+4),a=n.getString(e+4,4).toLowerCase(),o=r+4+4+4,l={type:a,offset:e,length:o,start:e+4+4,size:r,marker:s};Yn.includes(a)?this.metaChunks.push(l):this.unknownChunks.push(l),e+=o}}parseTextChunks(){let e=this.metaChunks.filter(t=>t.type==="text");for(let t of e){let[n,r]=this.file.getString(t.start,t.size).split("\0");this.injectKeyValToIhdr(n,r)}}injectKeyValToIhdr(e,t){let n=this.parsers.ihdr;n&&n.raw.set(e,t)}findIhdr(){let e=this.metaChunks.find(t=>t.type==="ihdr");e&&this.options.ihdr.enabled!==!1&&this.createParser("ihdr",e.chunk)}async findExif(){let e=this.metaChunks.find(t=>t.type==="exif");e&&this.injectSegment("tiff",e.chunk)}async findXmp(){let e=this.metaChunks.filter(t=>t.type==="itxt");for(let t of e)t.chunk.getString(0,17)==="XML:com.adobe.xmp"&&this.injectSegment("xmp",t.chunk)}async findIcc(){let e=this.metaChunks.find(o=>o.type==="iccp");if(!e)return;let{chunk:t}=e,n=t.getUint8Array(0,81),r=0;for(;r<80&&n[r]!==0;)r++;let s=r+2,a=t.getString(0,r);if(this.injectKeyValToIhdr("ProfileName",a),Ne){let o=await Jn,l=t.getUint8Array(s);l=o.inflateSync(l),this.injectSegment("icc",l)}}}f(Bt,"type","png"),K.set("png",Bt),w(k,"interop",[[1,"InteropIndex"],[2,"InteropVersion"],[4096,"RelatedImageFileFormat"],[4097,"RelatedImageWidth"],[4098,"RelatedImageHeight"]]),be(k,"ifd0",[[11,"ProcessingSoftware"],[254,"SubfileType"],[255,"OldSubfileType"],[263,"Thresholding"],[264,"CellWidth"],[265,"CellLength"],[266,"FillOrder"],[269,"DocumentName"],[280,"MinSampleValue"],[281,"MaxSampleValue"],[285,"PageName"],[286,"XPosition"],[287,"YPosition"],[290,"GrayResponseUnit"],[297,"PageNumber"],[321,"HalftoneHints"],[322,"TileWidth"],[323,"TileLength"],[332,"InkSet"],[337,"TargetPrinter"],[18246,"Rating"],[18249,"RatingPercent"],[33550,"PixelScale"],[34264,"ModelTransform"],[34377,"PhotoshopSettings"],[50706,"DNGVersion"],[50707,"DNGBackwardVersion"],[50708,"UniqueCameraModel"],[50709,"LocalizedCameraModel"],[50736,"DNGLensInfo"],[50739,"ShadowScale"],[50740,"DNGPrivateData"],[33920,"IntergraphMatrix"],[33922,"ModelTiePoint"],[34118,"SEMInfo"],[34735,"GeoTiffDirectory"],[34736,"GeoTiffDoubleParams"],[34737,"GeoTiffAsciiParams"],[50341,"PrintIM"],[50721,"ColorMatrix1"],[50722,"ColorMatrix2"],[50723,"CameraCalibration1"],[50724,"CameraCalibration2"],[50725,"ReductionMatrix1"],[50726,"ReductionMatrix2"],[50727,"AnalogBalance"],[50728,"AsShotNeutral"],[50729,"AsShotWhiteXY"],[50730,"BaselineExposure"],[50731,"BaselineNoise"],[50732,"BaselineSharpness"],[50734,"LinearResponseLimit"],[50735,"CameraSerialNumber"],[50741,"MakerNoteSafety"],[50778,"CalibrationIlluminant1"],[50779,"CalibrationIlluminant2"],[50781,"RawDataUniqueID"],[50827,"OriginalRawFileName"],[50828,"OriginalRawFileData"],[50831,"AsShotICCProfile"],[50832,"AsShotPreProfileMatrix"],[50833,"CurrentICCProfile"],[50834,"CurrentPreProfileMatrix"],[50879,"ColorimetricReference"],[50885,"SRawType"],[50898,"PanasonicTitle"],[50899,"PanasonicTitle2"],[50931,"CameraCalibrationSig"],[50932,"ProfileCalibrationSig"],[50933,"ProfileIFD"],[50934,"AsShotProfileName"],[50936,"ProfileName"],[50937,"ProfileHueSatMapDims"],[50938,"ProfileHueSatMapData1"],[50939,"ProfileHueSatMapData2"],[50940,"ProfileToneCurve"],[50941,"ProfileEmbedPolicy"],[50942,"ProfileCopyright"],[50964,"ForwardMatrix1"],[50965,"ForwardMatrix2"],[50966,"PreviewApplicationName"],[50967,"PreviewApplicationVersion"],[50968,"PreviewSettingsName"],[50969,"PreviewSettingsDigest"],[50970,"PreviewColorSpace"],[50971,"PreviewDateTime"],[50972,"RawImageDigest"],[50973,"OriginalRawFileDigest"],[50981,"ProfileLookTableDims"],[50982,"ProfileLookTableData"],[51043,"TimeCodes"],[51044,"FrameRate"],[51058,"TStop"],[51081,"ReelName"],[51089,"OriginalDefaultFinalSize"],[51090,"OriginalBestQualitySize"],[51091,"OriginalDefaultCropSize"],[51105,"CameraLabel"],[51107,"ProfileHueSatMapEncoding"],[51108,"ProfileLookTableEncoding"],[51109,"BaselineExposureOffset"],[51110,"DefaultBlackRender"],[51111,"NewRawImageDigest"],[51112,"RawToPreviewGain"]]);let Vt=[[273,"StripOffsets"],[279,"StripByteCounts"],[288,"FreeOffsets"],[289,"FreeByteCounts"],[291,"GrayResponseCurve"],[292,"T4Options"],[293,"T6Options"],[300,"ColorResponseUnit"],[320,"ColorMap"],[324,"TileOffsets"],[325,"TileByteCounts"],[326,"BadFaxLines"],[327,"CleanFaxData"],[328,"ConsecutiveBadFaxLines"],[330,"SubIFD"],[333,"InkNames"],[334,"NumberofInks"],[336,"DotRange"],[338,"ExtraSamples"],[339,"SampleFormat"],[340,"SMinSampleValue"],[341,"SMaxSampleValue"],[342,"TransferRange"],[343,"ClipPath"],[344,"XClipPathUnits"],[345,"YClipPathUnits"],[346,"Indexed"],[347,"JPEGTables"],[351,"OPIProxy"],[400,"GlobalParametersIFD"],[401,"ProfileType"],[402,"FaxProfile"],[403,"CodingMethods"],[404,"VersionYear"],[405,"ModeNumber"],[433,"Decode"],[434,"DefaultImageColor"],[435,"T82Options"],[437,"JPEGTables"],[512,"JPEGProc"],[515,"JPEGRestartInterval"],[517,"JPEGLosslessPredictors"],[518,"JPEGPointTransforms"],[519,"JPEGQTables"],[520,"JPEGDCTables"],[521,"JPEGACTables"],[559,"StripRowCounts"],[999,"USPTOMiscellaneous"],[18247,"XP_DIP_XML"],[18248,"StitchInfo"],[28672,"SonyRawFileType"],[28688,"SonyToneCurve"],[28721,"VignettingCorrection"],[28722,"VignettingCorrParams"],[28724,"ChromaticAberrationCorrection"],[28725,"ChromaticAberrationCorrParams"],[28726,"DistortionCorrection"],[28727,"DistortionCorrParams"],[29895,"SonyCropTopLeft"],[29896,"SonyCropSize"],[32781,"ImageID"],[32931,"WangTag1"],[32932,"WangAnnotation"],[32933,"WangTag3"],[32934,"WangTag4"],[32953,"ImageReferencePoints"],[32954,"RegionXformTackPoint"],[32955,"WarpQuadrilateral"],[32956,"AffineTransformMat"],[32995,"Matteing"],[32996,"DataType"],[32997,"ImageDepth"],[32998,"TileDepth"],[33300,"ImageFullWidth"],[33301,"ImageFullHeight"],[33302,"TextureFormat"],[33303,"WrapModes"],[33304,"FovCot"],[33305,"MatrixWorldToScreen"],[33306,"MatrixWorldToCamera"],[33405,"Model2"],[33421,"CFARepeatPatternDim"],[33422,"CFAPattern2"],[33423,"BatteryLevel"],[33424,"KodakIFD"],[33445,"MDFileTag"],[33446,"MDScalePixel"],[33447,"MDColorTable"],[33448,"MDLabName"],[33449,"MDSampleInfo"],[33450,"MDPrepDate"],[33451,"MDPrepTime"],[33452,"MDFileUnits"],[33589,"AdventScale"],[33590,"AdventRevision"],[33628,"UIC1Tag"],[33629,"UIC2Tag"],[33630,"UIC3Tag"],[33631,"UIC4Tag"],[33918,"IntergraphPacketData"],[33919,"IntergraphFlagRegisters"],[33921,"INGRReserved"],[34016,"Site"],[34017,"ColorSequence"],[34018,"IT8Header"],[34019,"RasterPadding"],[34020,"BitsPerRunLength"],[34021,"BitsPerExtendedRunLength"],[34022,"ColorTable"],[34023,"ImageColorIndicator"],[34024,"BackgroundColorIndicator"],[34025,"ImageColorValue"],[34026,"BackgroundColorValue"],[34027,"PixelIntensityRange"],[34028,"TransparencyIndicator"],[34029,"ColorCharacterization"],[34030,"HCUsage"],[34031,"TrapIndicator"],[34032,"CMYKEquivalent"],[34152,"AFCP_IPTC"],[34232,"PixelMagicJBIGOptions"],[34263,"JPLCartoIFD"],[34306,"WB_GRGBLevels"],[34310,"LeafData"],[34687,"TIFF_FXExtensions"],[34688,"MultiProfiles"],[34689,"SharedData"],[34690,"T88Options"],[34732,"ImageLayer"],[34750,"JBIGOptions"],[34856,"Opto-ElectricConvFactor"],[34857,"Interlace"],[34908,"FaxRecvParams"],[34909,"FaxSubAddress"],[34910,"FaxRecvTime"],[34929,"FedexEDR"],[34954,"LeafSubIFD"],[37387,"FlashEnergy"],[37388,"SpatialFrequencyResponse"],[37389,"Noise"],[37390,"FocalPlaneXResolution"],[37391,"FocalPlaneYResolution"],[37392,"FocalPlaneResolutionUnit"],[37397,"ExposureIndex"],[37398,"TIFF-EPStandardID"],[37399,"SensingMethod"],[37434,"CIP3DataFile"],[37435,"CIP3Sheet"],[37436,"CIP3Side"],[37439,"StoNits"],[37679,"MSDocumentText"],[37680,"MSPropertySetStorage"],[37681,"MSDocumentTextPosition"],[37724,"ImageSourceData"],[40965,"InteropIFD"],[40976,"SamsungRawPointersOffset"],[40977,"SamsungRawPointersLength"],[41217,"SamsungRawByteOrder"],[41218,"SamsungRawUnknown"],[41484,"SpatialFrequencyResponse"],[41485,"Noise"],[41489,"ImageNumber"],[41490,"SecurityClassification"],[41491,"ImageHistory"],[41494,"TIFF-EPStandardID"],[41995,"DeviceSettingDescription"],[42112,"GDALMetadata"],[42113,"GDALNoData"],[44992,"ExpandSoftware"],[44993,"ExpandLens"],[44994,"ExpandFilm"],[44995,"ExpandFilterLens"],[44996,"ExpandScanner"],[44997,"ExpandFlashLamp"],[46275,"HasselbladRawImage"],[48129,"PixelFormat"],[48130,"Transformation"],[48131,"Uncompressed"],[48132,"ImageType"],[48256,"ImageWidth"],[48257,"ImageHeight"],[48258,"WidthResolution"],[48259,"HeightResolution"],[48320,"ImageOffset"],[48321,"ImageByteCount"],[48322,"AlphaOffset"],[48323,"AlphaByteCount"],[48324,"ImageDataDiscard"],[48325,"AlphaDataDiscard"],[50215,"OceScanjobDesc"],[50216,"OceApplicationSelector"],[50217,"OceIDNumber"],[50218,"OceImageLogic"],[50255,"Annotations"],[50459,"HasselbladExif"],[50547,"OriginalFileName"],[50560,"USPTOOriginalContentType"],[50656,"CR2CFAPattern"],[50710,"CFAPlaneColor"],[50711,"CFALayout"],[50712,"LinearizationTable"],[50713,"BlackLevelRepeatDim"],[50714,"BlackLevel"],[50715,"BlackLevelDeltaH"],[50716,"BlackLevelDeltaV"],[50717,"WhiteLevel"],[50718,"DefaultScale"],[50719,"DefaultCropOrigin"],[50720,"DefaultCropSize"],[50733,"BayerGreenSplit"],[50737,"ChromaBlurRadius"],[50738,"AntiAliasStrength"],[50752,"RawImageSegmentation"],[50780,"BestQualityScale"],[50784,"AliasLayerMetadata"],[50829,"ActiveArea"],[50830,"MaskedAreas"],[50935,"NoiseReductionApplied"],[50974,"SubTileBlockSize"],[50975,"RowInterleaveFactor"],[51008,"OpcodeList1"],[51009,"OpcodeList2"],[51022,"OpcodeList3"],[51041,"NoiseProfile"],[51114,"CacheVersion"],[51125,"DefaultUserCrop"],[51157,"NikonNEFInfo"],[65024,"KdcIFD"]];be(k,"ifd0",Vt),be(k,"exif",Vt),w(H,"gps",[[23,{M:"Magnetic North",T:"True North"}],[25,{K:"Kilometers",M:"Miles",N:"Nautical Miles"}]]);class ot extends G{static canHandle(e,t){return e.getUint8(t+1)===224&&e.getUint32(t+4)===1246120262&&e.getUint8(t+8)===0}parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint16(0)],[2,this.chunk.getUint8(2)],[3,this.chunk.getUint16(3)],[5,this.chunk.getUint16(5)],[7,this.chunk.getUint8(7)],[8,this.chunk.getUint8(8)]])}}f(ot,"type","jfif"),f(ot,"headerLength",9),x.set("jfif",ot),w(k,"jfif",[[0,"JFIFVersion"],[2,"ResolutionUnit"],[3,"XResolution"],[5,"YResolution"],[7,"ThumbnailWidth"],[8,"ThumbnailHeight"]]);class zt extends G{parse(){return this.parseTags(),this.translate(),this.output}parseTags(){this.raw=new Map([[0,this.chunk.getUint32(0)],[4,this.chunk.getUint32(4)],[8,this.chunk.getUint8(8)],[9,this.chunk.getUint8(9)],[10,this.chunk.getUint8(10)],[11,this.chunk.getUint8(11)],[12,this.chunk.getUint8(12)],...Array.from(this.raw)])}}f(zt,"type","ihdr"),x.set("ihdr",zt),w(k,"ihdr",[[0,"ImageWidth"],[4,"ImageHeight"],[8,"BitDepth"],[9,"ColorType"],[10,"Compression"],[11,"Filter"],[12,"Interlace"]]),w(H,"ihdr",[[9,{0:"Grayscale",2:"RGB",3:"Palette",4:"Grayscale with Alpha",6:"RGB with Alpha",DEFAULT:"Unknown"}],[10,{0:"Deflate/Inflate",DEFAULT:"Unknown"}],[11,{0:"Adaptive",DEFAULT:"Unknown"}],[12,{0:"Noninterlaced",1:"Adam7 Interlace",DEFAULT:"Unknown"}]]);class Ue extends G{static canHandle(e,t){return e.getUint8(t+1)===226&&e.getUint32(t+4)===1229144927}static findPosition(e,t){let n=super.findPosition(e,t);return n.chunkNumber=e.getUint8(t+16),n.chunkCount=e.getUint8(t+17),n.multiSegment=n.chunkCount>1,n}static handleMultiSegments(e){return function(t){let n=function(r){let s=r[0].constructor,a=0;for(let h of r)a+=h.length;let o=new s(a),l=0;for(let h of r)o.set(h,l),l+=h.length;return o}(t.map(r=>r.chunk.toUint8()));return new D(n)}(e)}parse(){return this.raw=new Map,this.parseHeader(),this.parseTags(),this.translate(),this.output}parseHeader(){let{raw:e}=this;this.chunk.byteLength<84&&S("ICC header is too short");for(let[t,n]of Object.entries($n)){t=parseInt(t,10);let r=n(this.chunk,t);r!=="\0\0\0\0"&&e.set(t,r)}}parseTags(){let e,t,n,r,s,{raw:a}=this,o=this.chunk.getUint32(128),l=132,h=this.chunk.byteLength;for(;o--;){if(e=this.chunk.getString(l,4),t=this.chunk.getUint32(l+4),n=this.chunk.getUint32(l+8),r=this.chunk.getString(t,4),t+n>h)return void console.warn("reached the end of the first ICC chunk. Enable options.tiff.multiSegment to read all ICC segments.");s=this.parseTag(r,t,n),s!==void 0&&s!=="\0\0\0\0"&&a.set(e,s),l+=12}}parseTag(e,t,n){switch(e){case"desc":return this.parseDesc(t);case"mluc":return this.parseMluc(t);case"text":return this.parseText(t,n);case"sig ":return this.parseSig(t)}if(!(t+n>this.chunk.byteLength))return this.chunk.getUint8Array(t,n)}parseDesc(e){let t=this.chunk.getUint32(e+8)-1;return fe(this.chunk.getString(e+12,t))}parseText(e,t){return fe(this.chunk.getString(e+8,t-8))}parseSig(e){return fe(this.chunk.getString(e+8,4))}parseMluc(e){let{chunk:t}=this,n=t.getUint32(e+8),r=t.getUint32(e+12),s=e+16,a=[];for(let o=0;o<n;o++){let l=t.getString(s+0,2),h=t.getString(s+2,2),d=t.getUint32(s+4),u=t.getUint32(s+8)+e,g=fe(t.getUnicodeString(u,d));a.push({lang:l,country:h,text:g}),s+=r}return n===1?a[0].text:a}translateValue(e,t){return typeof e=="string"?t[e]||t[e.toLowerCase()]||e:t[e]||e}}f(Ue,"type","icc"),f(Ue,"multiSegment",!0),f(Ue,"headerLength",18);const $n={4:$,8:function(i,e){return[i.getUint8(e),i.getUint8(e+1)>>4,i.getUint8(e+1)%16].map(t=>t.toString(10)).join(".")},12:$,16:$,20:$,24:function(i,e){const t=i.getUint16(e),n=i.getUint16(e+2)-1,r=i.getUint16(e+4),s=i.getUint16(e+6),a=i.getUint16(e+8),o=i.getUint16(e+10);return new Date(Date.UTC(t,n,r,s,a,o))},36:$,40:$,48:$,52:$,64:(i,e)=>i.getUint32(e),80:$};function $(i,e){return fe(i.getString(e,4))}x.set("icc",Ue),w(k,"icc",[[4,"ProfileCMMType"],[8,"ProfileVersion"],[12,"ProfileClass"],[16,"ColorSpaceData"],[20,"ProfileConnectionSpace"],[24,"ProfileDateTime"],[36,"ProfileFileSignature"],[40,"PrimaryPlatform"],[44,"CMMFlags"],[48,"DeviceManufacturer"],[52,"DeviceModel"],[56,"DeviceAttributes"],[64,"RenderingIntent"],[68,"ConnectionSpaceIlluminant"],[80,"ProfileCreator"],[84,"ProfileID"],["Header","ProfileHeader"],["MS00","WCSProfiles"],["bTRC","BlueTRC"],["bXYZ","BlueMatrixColumn"],["bfd","UCRBG"],["bkpt","MediaBlackPoint"],["calt","CalibrationDateTime"],["chad","ChromaticAdaptation"],["chrm","Chromaticity"],["ciis","ColorimetricIntentImageState"],["clot","ColorantTableOut"],["clro","ColorantOrder"],["clrt","ColorantTable"],["cprt","ProfileCopyright"],["crdi","CRDInfo"],["desc","ProfileDescription"],["devs","DeviceSettings"],["dmdd","DeviceModelDesc"],["dmnd","DeviceMfgDesc"],["dscm","ProfileDescriptionML"],["fpce","FocalPlaneColorimetryEstimates"],["gTRC","GreenTRC"],["gXYZ","GreenMatrixColumn"],["gamt","Gamut"],["kTRC","GrayTRC"],["lumi","Luminance"],["meas","Measurement"],["meta","Metadata"],["mmod","MakeAndModel"],["ncl2","NamedColor2"],["ncol","NamedColor"],["ndin","NativeDisplayInfo"],["pre0","Preview0"],["pre1","Preview1"],["pre2","Preview2"],["ps2i","PS2RenderingIntent"],["ps2s","PostScript2CSA"],["psd0","PostScript2CRD0"],["psd1","PostScript2CRD1"],["psd2","PostScript2CRD2"],["psd3","PostScript2CRD3"],["pseq","ProfileSequenceDesc"],["psid","ProfileSequenceIdentifier"],["psvm","PS2CRDVMSize"],["rTRC","RedTRC"],["rXYZ","RedMatrixColumn"],["resp","OutputResponse"],["rhoc","ReflectionHardcopyOrigColorimetry"],["rig0","PerceptualRenderingIntentGamut"],["rig2","SaturationRenderingIntentGamut"],["rpoc","ReflectionPrintOutputColorimetry"],["sape","SceneAppearanceEstimates"],["scoe","SceneColorimetryEstimates"],["scrd","ScreeningDesc"],["scrn","Screening"],["targ","CharTarget"],["tech","Technology"],["vcgt","VideoCardGamma"],["view","ViewingConditions"],["vued","ViewingCondDesc"],["wtpt","MediaWhitePoint"]]);const Me={"4d2p":"Erdt Systems",AAMA:"Aamazing Technologies",ACER:"Acer",ACLT:"Acolyte Color Research",ACTI:"Actix Sytems",ADAR:"Adara Technology",ADBE:"Adobe",ADI:"ADI Systems",AGFA:"Agfa Graphics",ALMD:"Alps Electric",ALPS:"Alps Electric",ALWN:"Alwan Color Expertise",AMTI:"Amiable Technologies",AOC:"AOC International",APAG:"Apago",APPL:"Apple Computer",AST:"AST","AT&T":"AT&T",BAEL:"BARBIERI electronic",BRCO:"Barco NV",BRKP:"Breakpoint",BROT:"Brother",BULL:"Bull",BUS:"Bus Computer Systems","C-IT":"C-Itoh",CAMR:"Intel",CANO:"Canon",CARR:"Carroll Touch",CASI:"Casio",CBUS:"Colorbus PL",CEL:"Crossfield",CELx:"Crossfield",CGS:"CGS Publishing Technologies International",CHM:"Rochester Robotics",CIGL:"Colour Imaging Group, London",CITI:"Citizen",CL00:"Candela",CLIQ:"Color IQ",CMCO:"Chromaco",CMiX:"CHROMiX",COLO:"Colorgraphic Communications",COMP:"Compaq",COMp:"Compeq/Focus Technology",CONR:"Conrac Display Products",CORD:"Cordata Technologies",CPQ:"Compaq",CPRO:"ColorPro",CRN:"Cornerstone",CTX:"CTX International",CVIS:"ColorVision",CWC:"Fujitsu Laboratories",DARI:"Darius Technology",DATA:"Dataproducts",DCP:"Dry Creek Photo",DCRC:"Digital Contents Resource Center, Chung-Ang University",DELL:"Dell Computer",DIC:"Dainippon Ink and Chemicals",DICO:"Diconix",DIGI:"Digital","DL&C":"Digital Light & Color",DPLG:"Doppelganger",DS:"Dainippon Screen",DSOL:"DOOSOL",DUPN:"DuPont",EPSO:"Epson",ESKO:"Esko-Graphics",ETRI:"Electronics and Telecommunications Research Institute",EVER:"Everex Systems",EXAC:"ExactCODE",Eizo:"Eizo",FALC:"Falco Data Products",FF:"Fuji Photo Film",FFEI:"FujiFilm Electronic Imaging",FNRD:"Fnord Software",FORA:"Fora",FORE:"Forefront Technology",FP:"Fujitsu",FPA:"WayTech Development",FUJI:"Fujitsu",FX:"Fuji Xerox",GCC:"GCC Technologies",GGSL:"Global Graphics Software",GMB:"Gretagmacbeth",GMG:"GMG",GOLD:"GoldStar Technology",GOOG:"Google",GPRT:"Giantprint",GTMB:"Gretagmacbeth",GVC:"WayTech Development",GW2K:"Sony",HCI:"HCI",HDM:"Heidelberger Druckmaschinen",HERM:"Hermes",HITA:"Hitachi America",HP:"Hewlett-Packard",HTC:"Hitachi",HiTi:"HiTi Digital",IBM:"IBM",IDNT:"Scitex",IEC:"Hewlett-Packard",IIYA:"Iiyama North America",IKEG:"Ikegami Electronics",IMAG:"Image Systems",IMI:"Ingram Micro",INTC:"Intel",INTL:"N/A (INTL)",INTR:"Intra Electronics",IOCO:"Iocomm International Technology",IPS:"InfoPrint Solutions Company",IRIS:"Scitex",ISL:"Ichikawa Soft Laboratory",ITNL:"N/A (ITNL)",IVM:"IVM",IWAT:"Iwatsu Electric",Idnt:"Scitex",Inca:"Inca Digital Printers",Iris:"Scitex",JPEG:"Joint Photographic Experts Group",JSFT:"Jetsoft Development",JVC:"JVC Information Products",KART:"Scitex",KFC:"KFC Computek Components",KLH:"KLH Computers",KMHD:"Konica Minolta",KNCA:"Konica",KODA:"Kodak",KYOC:"Kyocera",Kart:"Scitex",LCAG:"Leica",LCCD:"Leeds Colour",LDAK:"Left Dakota",LEAD:"Leading Technology",LEXM:"Lexmark International",LINK:"Link Computer",LINO:"Linotronic",LITE:"Lite-On",Leaf:"Leaf",Lino:"Linotronic",MAGC:"Mag Computronic",MAGI:"MAG Innovision",MANN:"Mannesmann",MICN:"Micron Technology",MICR:"Microtek",MICV:"Microvitec",MINO:"Minolta",MITS:"Mitsubishi Electronics America",MITs:"Mitsuba",MNLT:"Minolta",MODG:"Modgraph",MONI:"Monitronix",MONS:"Monaco Systems",MORS:"Morse Technology",MOTI:"Motive Systems",MSFT:"Microsoft",MUTO:"MUTOH INDUSTRIES",Mits:"Mitsubishi Electric",NANA:"NANAO",NEC:"NEC",NEXP:"NexPress Solutions",NISS:"Nissei Sangyo America",NKON:"Nikon",NONE:"none",OCE:"Oce Technologies",OCEC:"OceColor",OKI:"Oki",OKID:"Okidata",OKIP:"Okidata",OLIV:"Olivetti",OLYM:"Olympus",ONYX:"Onyx Graphics",OPTI:"Optiquest",PACK:"Packard Bell",PANA:"Matsushita Electric Industrial",PANT:"Pantone",PBN:"Packard Bell",PFU:"PFU",PHIL:"Philips Consumer Electronics",PNTX:"HOYA",POne:"Phase One A/S",PREM:"Premier Computer Innovations",PRIN:"Princeton Graphic Systems",PRIP:"Princeton Publishing Labs",QLUX:"Hong Kong",QMS:"QMS",QPCD:"QPcard AB",QUAD:"QuadLaser",QUME:"Qume",RADI:"Radius",RDDx:"Integrated Color Solutions",RDG:"Roland DG",REDM:"REDMS Group",RELI:"Relisys",RGMS:"Rolf Gierling Multitools",RICO:"Ricoh",RNLD:"Edmund Ronald",ROYA:"Royal",RPC:"Ricoh Printing Systems",RTL:"Royal Information Electronics",SAMP:"Sampo",SAMS:"Samsung",SANT:"Jaime Santana Pomares",SCIT:"Scitex",SCRN:"Dainippon Screen",SDP:"Scitex",SEC:"Samsung",SEIK:"Seiko Instruments",SEIk:"Seikosha",SGUY:"ScanGuy.com",SHAR:"Sharp Laboratories",SICC:"International Color Consortium",SONY:"Sony",SPCL:"SpectraCal",STAR:"Star",STC:"Sampo Technology",Scit:"Scitex",Sdp:"Scitex",Sony:"Sony",TALO:"Talon Technology",TAND:"Tandy",TATU:"Tatung",TAXA:"TAXAN America",TDS:"Tokyo Denshi Sekei",TECO:"TECO Information Systems",TEGR:"Tegra",TEKT:"Tektronix",TI:"Texas Instruments",TMKR:"TypeMaker",TOSB:"Toshiba",TOSH:"Toshiba",TOTK:"TOTOKU ELECTRIC",TRIU:"Triumph",TSBT:"Toshiba",TTX:"TTX Computer Products",TVM:"TVM Professional Monitor",TW:"TW Casper",ULSX:"Ulead Systems",UNIS:"Unisys",UTZF:"Utz Fehlau & Sohn",VARI:"Varityper",VIEW:"Viewsonic",VISL:"Visual communication",VIVO:"Vivo Mobile Communication",WANG:"Wang",WLBR:"Wilbur Imaging",WTG2:"Ware To Go",WYSE:"WYSE Technology",XERX:"Xerox",XRIT:"X-Rite",ZRAN:"Zoran",Zebr:"Zebra Technologies",appl:"Apple Computer",bICC:"basICColor",berg:"bergdesign",ceyd:"Integrated Color Solutions",clsp:"MacDermid ColorSpan",ds:"Dainippon Screen",dupn:"DuPont",ffei:"FujiFilm Electronic Imaging",flux:"FluxData",iris:"Scitex",kart:"Scitex",lcms:"Little CMS",lino:"Linotronic",none:"none",ob4d:"Erdt Systems",obic:"Medigraph",quby:"Qubyx Sarl",scit:"Scitex",scrn:"Dainippon Screen",sdp:"Scitex",siwi:"SIWI GRAFIKA",yxym:"YxyMaster"},Gt={scnr:"Scanner",mntr:"Monitor",prtr:"Printer",link:"Device Link",abst:"Abstract",spac:"Color Space Conversion Profile",nmcl:"Named Color",cenc:"ColorEncodingSpace profile",mid:"MultiplexIdentification profile",mlnk:"MultiplexLink profile",mvis:"MultiplexVisualization profile",nkpf:"Nikon Input Device Profile (NON-STANDARD!)"};w(H,"icc",[[4,Me],[12,Gt],[40,Object.assign({},Me,Gt)],[48,Me],[80,Me],[64,{0:"Perceptual",1:"Relative Colorimetric",2:"Saturation",3:"Absolute Colorimetric"}],["tech",{amd:"Active Matrix Display",crt:"Cathode Ray Tube Display",kpcd:"Photo CD",pmd:"Passive Matrix Display",dcam:"Digital Camera",dcpj:"Digital Cinema Projector",dmpc:"Digital Motion Picture Camera",dsub:"Dye Sublimation Printer",epho:"Electrophotographic Printer",esta:"Electrostatic Printer",flex:"Flexography",fprn:"Film Writer",fscn:"Film Scanner",grav:"Gravure",ijet:"Ink Jet Printer",imgs:"Photo Image Setter",mpfr:"Motion Picture Film Recorder",mpfs:"Motion Picture Film Scanner",offs:"Offset Lithography",pjtv:"Projection Television",rpho:"Photographic Paper Printer",rscn:"Reflective Scanner",silk:"Silkscreen",twax:"Thermal Wax Printer",vidc:"Video Camera",vidm:"Video Monitor"}]]);class Ee extends G{static canHandle(e,t,n){return e.getUint8(t+1)===237&&e.getString(t+4,9)==="Photoshop"&&this.containsIptc8bim(e,t,n)!==void 0}static headerLength(e,t,n){let r,s=this.containsIptc8bim(e,t,n);if(s!==void 0)return r=e.getUint8(t+s+7),r%2!=0&&(r+=1),r===0&&(r=4),s+8+r}static containsIptc8bim(e,t,n){for(let r=0;r<n;r++)if(this.isIptcSegmentHead(e,t+r))return r}static isIptcSegmentHead(e,t){return e.getUint8(t)===56&&e.getUint32(t)===943868237&&e.getUint16(t+4)===1028}parse(){let{raw:e}=this,t=this.chunk.byteLength-1,n=!1;for(let r=0;r<t;r++)if(this.chunk.getUint8(r)===28&&this.chunk.getUint8(r+1)===2){n=!0;let s=this.chunk.getUint16(r+3),a=this.chunk.getUint8(r+2),o=this.chunk.getLatin1String(r+5,s);e.set(a,this.pluralizeValue(e.get(a),o)),r+=4+s}else if(n)break;return this.translate(),this.output}pluralizeValue(e,t){return e!==void 0?e instanceof Array?(e.push(t),e):[e,t]:t}}f(Ee,"type","iptc"),f(Ee,"translateValues",!1),f(Ee,"reviveValues",!1),x.set("iptc",Ee),w(k,"iptc",[[0,"ApplicationRecordVersion"],[3,"ObjectTypeReference"],[4,"ObjectAttributeReference"],[5,"ObjectName"],[7,"EditStatus"],[8,"EditorialUpdate"],[10,"Urgency"],[12,"SubjectReference"],[15,"Category"],[20,"SupplementalCategories"],[22,"FixtureIdentifier"],[25,"Keywords"],[26,"ContentLocationCode"],[27,"ContentLocationName"],[30,"ReleaseDate"],[35,"ReleaseTime"],[37,"ExpirationDate"],[38,"ExpirationTime"],[40,"SpecialInstructions"],[42,"ActionAdvised"],[45,"ReferenceService"],[47,"ReferenceDate"],[50,"ReferenceNumber"],[55,"DateCreated"],[60,"TimeCreated"],[62,"DigitalCreationDate"],[63,"DigitalCreationTime"],[65,"OriginatingProgram"],[70,"ProgramVersion"],[75,"ObjectCycle"],[80,"Byline"],[85,"BylineTitle"],[90,"City"],[92,"Sublocation"],[95,"State"],[100,"CountryCode"],[101,"Country"],[103,"OriginalTransmissionReference"],[105,"Headline"],[110,"Credit"],[115,"Source"],[116,"CopyrightNotice"],[118,"Contact"],[120,"Caption"],[121,"LocalCaption"],[122,"Writer"],[125,"RasterizedCaption"],[130,"ImageType"],[131,"ImageOrientation"],[135,"LanguageIdentifier"],[150,"AudioType"],[151,"AudioSamplingRate"],[152,"AudioSamplingResolution"],[153,"AudioDuration"],[154,"AudioOutcue"],[184,"JobID"],[185,"MasterDocumentID"],[186,"ShortDocumentID"],[187,"UniqueDocumentID"],[188,"OwnerID"],[200,"ObjectPreviewFileFormat"],[201,"ObjectPreviewFileVersion"],[202,"ObjectPreviewData"],[221,"Prefs"],[225,"ClassifyState"],[228,"SimilarityIndex"],[230,"DocumentNotes"],[231,"DocumentHistory"],[232,"ExifCameraInfo"],[255,"CatalogSets"]]),w(H,"iptc",[[10,{0:"0 (reserved)",1:"1 (most urgent)",2:"2",3:"3",4:"4",5:"5 (normal urgency)",6:"6",7:"7",8:"8 (least urgent)",9:"9 (user-defined priority)"}],[75,{a:"Morning",b:"Both Morning and Evening",p:"Evening"}],[131,{L:"Landscape",P:"Portrait",S:"Square"}]]);let lt=null,Ht=!1;async function dn(){if(!lt)try{const n=(await import("./joraw2-QjkmqCku.js")).default;if(typeof n!="function")throw new Error("JoRaw2 WASM import failed");const r=new URL("/assets/joraw2-mksGsjyD.wasm",import.meta.url).href;lt=n({locateFile:(s,a)=>s.endsWith("joraw2.wasm")?r:a+s})}catch(t){throw console.error("Failed to load joraw2.js:",t),t}const e=(await lt).LibRaw;if(!e)throw new Error("JoRaw2 class not found");if(!Ht){const t=new e;try{if(typeof t.runtimeInfo!="function")throw new Error("JoRaw2 runtime identity is missing");const n=t.runtimeInfo();if((n==null?void 0:n.wrapper)!=="joraw2"||!String((n==null?void 0:n.librawVersion)||"").startsWith("0.22.2")||!(n!=null&&n.nikonHe)||!(n!=null&&n.nikonHeStar))throw new Error(`Unexpected JoRaw2 runtime: ${JSON.stringify(n)}`);Ht=!0}finally{t.delete&&t.delete()}}return e}function Qn(i,e,t){const n=t.type===1||t.type===2||t.type===7?1:t.type===3?2:t.type===4||t.type===9||t.type===11||t.type===13?4:t.type===5||t.type===10||t.type===12?8:0;if(n===0)throw new Error(`Unsupported TIFF field type: ${t.type}`);const s=t.count*n<=4?t.valueFieldOffset:i.getUint32(t.valueFieldOffset,e),a=[];for(let o=0;o<t.count;o++){const l=s+o*n;if(l<0||l+n>i.byteLength)throw new Error("Invalid TIFF field offset");if(t.type===1)a.push(i.getUint8(l));else if(t.type===2||t.type===7)a.push(i.getUint8(l));else if(t.type===3)a.push(i.getUint16(l,e));else if(t.type===5){const h=i.getUint32(l+4,e);a.push(h?i.getUint32(l,e)/h:0)}else if(t.type===13)a.push(i.getUint32(l,e));else if(t.type===9)a.push(i.getInt32(l,e));else if(t.type===10){const h=i.getInt32(l+4,e);a.push(h?i.getInt32(l,e)/h:0)}else t.type===11?a.push(i.getFloat32(l,e)):t.type===12?a.push(i.getFloat64(l,e)):a.push(i.getUint32(l,e))}return a}function jt(i,e,t){if(!Number.isFinite(t)||t<=0||t+2>i.byteLength)throw new Error("Invalid TIFF IFD offset");const n=i.getUint16(t,e);if(t+2+n*12+4>i.byteLength)throw new Error("Corrupt TIFF IFD");const s=new Map;for(let a=0;a<n;a++){const o=t+2+a*12,l=i.getUint16(o,e),h=i.getUint16(o+2,e),d=i.getUint32(o+4,e);s.set(l,{type:h,count:d,valueFieldOffset:o+8})}return s}function R(i,e,t,n){const r=t.get(n);return r?Qn(i,e,r):[]}const hn=(...i)=>{for(const e of i){if(Array.isArray(e)||ArrayBuffer.isView(e)){const n=Array.from(e).map(Number).filter(r=>Number.isFinite(r)&&r>0);if(n.length)return Math.max(...n);continue}const t=Number(e);if(Number.isFinite(t)&&t>0)return t}return null},Zn=i=>{const t=(Array.isArray(i)||ArrayBuffer.isView(i)?Array.from(i).map(Number):[Number(i)]).map(n=>Number.isFinite(n)?n:0);return t.length>=3?[t[0]||0,t[1]||0,t[1]||0,t[2]||0]:t.length===1?[t[0]||0,t[0]||0,t[0]||0,t[0]||0]:[0,0,0,0]};function ei(i,e={}){var A,B,q,J,Z,ee;if(i.byteLength<8)return null;const t=new DataView(i.buffer,i.byteOffset,i.byteLength),n=t.getUint16(0,!1),r=n===18761;if(!r&&n!==19789||t.getUint16(2,r)!==42)return null;const s=t.getUint32(4,r);let a;try{a=jt(t,r,s)}catch{return null}const o=new Set([s]);for(const p of R(t,r,a,330))p>0&&o.add(p);let l=null;for(const p of o)try{const _=p===s?a:jt(t,r,p),V=R(t,r,_,256)[0]||0,j=R(t,r,_,257)[0]||0,z=R(t,r,_,258),E=R(t,r,_,277)[0]||z.length||1,te=z.length===1?new Array(E).fill(z[0]):z,ce=R(t,r,_,259)[0]||1,Y=R(t,r,_,262)[0]||0,W=R(t,r,_,284)[0]||1,T=R(t,r,_,339),Je=T.length===0?new Array(E).fill(1):T.length===1?new Array(E).fill(T[0]):T,Se=R(t,r,_,273),De=R(t,r,_,279),Ye=R(t,r,_,278)[0]||j,$e=Je.slice(0,E).every(ie=>ie===0||ie===1);if(!(Y===34892&&ce===1&&W===1&&V>0&&j>0&&E>=3&&te.length>=E&&te.slice(0,E).every(ie=>ie===16)&&$e&&Se.length>0&&Se.length===De.length))continue;(!l||V*j>l.width*l.height)&&(l={entries:_,width:V,height:j,samplesPerPixel:E,rowsPerStrip:Ye,stripOffsets:Se,stripByteCounts:De,bitsPerSample:te,photometric:Y})}catch{continue}if(!l)return null;const{entries:h,width:d,height:u,samplesPerPixel:g,rowsPerStrip:c,stripOffsets:y,stripByteCounts:C,bitsPerSample:P,photometric:O}=l,m=d*u;if(!Number.isSafeInteger(m)||m<=0)return null;const v=new Uint16Array(m*3);for(let p=0;p<y.length;p++){const _=p*c;if(_>=u)break;const V=Math.min(c,u-_),j=V*d*g*2,z=y[p],E=C[p];if(z<0||E<j||z+j>i.byteLength)throw new Error("Invalid LinearRaw DNG strip bounds");const te=_*d*3;if(g===3&&r&&!(i.byteOffset+z&1)){v.set(new Uint16Array(i.buffer,i.byteOffset+z,V*d*3),te);continue}const ce=new DataView(i.buffer,i.byteOffset+z,j);let Y=0,W=te;for(let T=0;T<V*d;T++)v[W++]=ce.getUint16(Y,r),v[W++]=ce.getUint16(Y+2,r),v[W++]=ce.getUint16(Y+4,r),Y+=g*2}const F=R(t,r,h,50714),I=((B=(A=e==null?void 0:e.color_data)==null?void 0:A.dng_levels)==null?void 0:B.dng_cblack)||((q=e==null?void 0:e.color_data)==null?void 0:q.cblack_rawpy_style)||(e==null?void 0:e.black_level_per_channel)||(e==null?void 0:e.cblack),M=Zn(F.length?F:I),N=R(t,r,h,50717),Q=hn(N,(Z=(J=e==null?void 0:e.color_data)==null?void 0:J.dng_levels)==null?void 0:Z.dng_whitelevel,(ee=e==null?void 0:e.color_data)==null?void 0:ee.maximum,e==null?void 0:e.white_level)||65535;return{data:v,width:d,height:u,bayerPattern:"RGBG",blackLevels:M,whiteLevel:Q,metadata:{...e,format:"DNG_LINEAR_RAW_RGB",description:"Uncompressed DNG LinearRaw RGB",linearRawDngDecoder:!0,bitsPerSample:P.slice(0,g),samplesPerPixel:g,photometric:O},isThreePlane:!0,threePlaneTransfer:"linear"}}async function ti(i){const e=ei(i);if(!e)return null;let t={};const n=await dn(),r=new n;try{await r.open(i,{}),t=await r.metadata(!0)}catch(s){console.warn("LinearRaw DNG metadata enrichment failed",s)}finally{try{r.delete?r.delete():r.close()}catch{}}try{const s=await ln.parse(i.buffer);s&&(t={...t,...s})}catch(s){console.warn("exifr parsing failed for LinearRaw DNG",s)}return e.metadata={...t,...e.metadata},e}const ni=async i=>{var r,s,a,o,l,h,d,u,g,c,y,C,P,O;const e=await ti(i);if(e)return e;const t=await dn(),n=new t;try{if(await n.open(i,{}),typeof n.getRawImage!="function")throw new Error("WASM mismatch");let m={};try{m=await n.metadata(!0)}catch(p){console.warn("Metadata error before raw extraction",p)}const v=n.getRawImage(),F=v.data instanceof Uint16Array?v.data:new Uint16Array(v.data);let I={...m};try{const p=await ln.parse(i.buffer);p&&(I={...I,...p})}catch(p){console.warn("exifr parsing failed for RAW buffer",p)}const M=((r=m.idata)==null?void 0:r.filters)||0,N=((s=m.idata)==null?void 0:s.colors)||0,Q=M===0&&N===3,A=M===9;let B=[0,0,0,0],q=!1,J=null;if(n.getBlackLevels)try{const p=n.getBlackLevels();J=p,p.dng_cblack&&p.dng_cblack.length===4&&Array.from(p.dng_cblack).some(_=>_>0)?(B=Array.from(p.dng_cblack).map(Number),q=!0):p.cblack&&p.cblack.length===4&&Array.from(p.cblack).some(_=>_>0)?(B=Array.from(p.cblack).map(Number),q=!0):typeof p.black=="number"&&p.black>0&&(B=[p.black,p.black,p.black,p.black],q=!0)}catch(p){console.warn("getBlackLevels binding failed",p)}if(!q){let p=[];if((a=m.color_data)!=null&&a.cblack_rawpy_style)p=m.color_data.cblack_rawpy_style;else if((l=(o=m.color_data)==null?void 0:o.dng_levels)!=null&&l.dng_cblack)p=m.color_data.dng_levels.dng_cblack;else if(((h=m.black_level_per_channel)==null?void 0:h.length)>=4)p=m.black_level_per_channel;else if(((d=m.cblack)==null?void 0:d.length)>=4)p=m.cblack;else if(((g=(u=m.color)==null?void 0:u.cblack)==null?void 0:g.length)>=4)p=m.color.cblack;else{const _=m.black_level||m.color_data&&m.color_data.black||0;p=[_,_,_,_]}B=[Number(p[0])||0,Number(p[1])||0,Number(p[2])||0,Number(p[3])||0]}const Z=Number.isFinite(Number(v.bits))&&Number(v.bits)>0?Math.pow(2,Number(v.bits))-1:null,ee=hn(m.white_level,(y=(c=m.color_data)==null?void 0:c.dng_levels)==null?void 0:y.dng_whitelevel,(C=m.color_data)==null?void 0:C.maximum,J==null?void 0:J.maximum,(P=m.color_data)==null?void 0:P.fmaximum,(O=m.color_data)==null?void 0:O.data_maximum,Z)||16383;return{data:F,width:v.width,height:v.height,bayerPattern:m.color_desc||"RGGB",blackLevels:B,whiteLevel:ee,metadata:I,isThreePlane:Q,threePlaneTransfer:Q?"linear":void 0,isXTrans:A}}finally{n.delete?n.delete():n.close()}};async function ii(i){if(xn(i)){const n=await In(i);if(!n)throw new Error("Sony cRAW HQ decoder did not return image data.");return n.rawImageData}const t=new Uint8Array(i);return ni(t)}self.onmessage=async i=>{const{id:e,buffer:t,returnBuffer:n}=i.data;try{const r=await ii(t),s=[r.data.buffer];r.floatData&&s.push(r.floatData.buffer),n&&s.push(t),self.postMessage({id:e,success:!0,raw:r,buffer:n?t:void 0},s)}catch(r){self.postMessage({id:e,success:!1,error:(r==null?void 0:r.message)||"Decode failed"})}};
