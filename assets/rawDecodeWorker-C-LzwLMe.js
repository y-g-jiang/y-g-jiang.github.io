const hn={"Sony ILCE-7RM5":"0.82 -0.2976 -0.0719 -0.4296 1.2053 0.2532 -0.0429 0.1282 0.5774"};let Ze=null;async function cn(i){return Ze||(Ze=(async()=>{if(typeof window.loadPyodide!="function")throw new Error("Pyodide missing: window.loadPyodide not found.");const e=await window.loadPyodide();return await e.loadPackage("numpy"),e})()),Ze}var pn=`#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
`,gn="/assets/joraw-BAR7UfD7.js",mn="/assets/joraw-CZg3hVRg.wasm";const kt=512,_n=hn["Sony ILCE-7RM5"].split(/\s+/).map(Number).filter(Number.isFinite);let et=null,tt=null;function yn(i){if(i.byteLength<8)return null;const e=i.getUint16(0,!1);return e===18761?!0:e===19789?!1:null}function jt(i,e,t){const n=Math.min(i.length,e+t);let r="";for(let s=e;s<n;s++){const a=i[s];if(a===0)break;r+=String.fromCharCode(a)}return r.trim()}function U(i,e,t,n,r){const s=t===1||t===2||t===7?1:t===3||t===8?2:t===4||t===9?4:0;if(!s)return[];const a=s*n,o=a<=4?r:i.getUint32(r,e);if(o<0||o+a>i.byteLength)return[];const l=[];for(let h=0;h<n;h++){const d=o+h*s;t===1||t===2||t===7?l.push(i.getUint8(d)):t===3?l.push(i.getUint16(d,e)):t===8?l.push(i.getInt16(d,e)):t===4?l.push(i.getUint32(d,e)):t===9&&l.push(i.getInt32(d,e))}return l}function Ct(i,e,t,n,r,s){if(n!==2||r<=0)return"";const a=r<=4?s:e.getUint32(s,t);return a<0||a>=i.length?"":jt(i,a,r)}function Wt(i){const e=new Uint8Array(i),t=new DataView(i),n=yn(t);if(n===null||t.getUint16(2,n)!==42)return null;const s=u=>t.getUint16(u,n),a=u=>t.getUint32(u,n),o=[a(4)],l=new Set;let h="",d="";for(;o.length;){const u=o.pop();if(l.has(u)||u<=0||u+2>t.byteLength)continue;l.add(u);const g=s(u);if(u+2+g*12+4>t.byteLength)continue;const c=new Map;for(let F=0;F<g;F++){const I=u+2+F*12,M=s(I),N=s(I+2),Q=a(I+4),A=I+8;c.set(M,{type:N,count:Q,valueOffset:A})}const y=c.get(271),C=c.get(272);y&&!h&&(h=Ct(e,t,n,y.type,y.count,y.valueOffset)),C&&!d&&(d=Ct(e,t,n,C.type,C.count,C.valueOffset));const v=c.get(330);if(v){const F=U(t,n,v.type,v.count,v.valueOffset);for(const I of F)o.push(I)}const O=c.get(259),m=c.get(262);if(O&&m){const F=U(t,n,O.type,O.count,O.valueOffset)[0],I=U(t,n,m.type,m.count,m.valueOffset)[0];if(F===32766&&I===32803){const M=U(t,n,c.get(256).type,c.get(256).count,c.get(256).valueOffset)[0],N=U(t,n,c.get(257).type,c.get(257).count,c.get(257).valueOffset)[0],Q=U(t,n,c.get(258).type,c.get(258).count,c.get(258).valueOffset)[0],A=U(t,n,c.get(273).type,c.get(273).count,c.get(273).valueOffset)[0],B=U(t,n,c.get(279).type,c.get(279).count,c.get(279).valueOffset)[0],q=c.get(33422)?U(t,n,c.get(33422).type,c.get(33422).count,c.get(33422).valueOffset):[0,1,1,2];c.get(29456)&&U(t,n,c.get(29456).type,c.get(29456).count,c.get(29456).valueOffset);const Y=c.get(50717)?U(t,n,c.get(50717).type,c.get(50717).count,c.get(50717).valueOffset)[0]:16383,Z=c.get(50719)?U(t,n,c.get(50719).type,c.get(50719).count,c.get(50719).valueOffset):[],ee=c.get(50720)?U(t,n,c.get(50720).type,c.get(50720).count,c.get(50720).valueOffset):[];if(A+kt+16>e.length||A+B>e.length)return null;const p=A+kt,_=jt(e,p,4),V=e[p+8]<<8|e[p+9],j=e[p+10]<<8|e[p+11],z=e[p+12]<<8|e[p+13],E=e[p+14]<<8|e[p+15],te=z>>4&63,ce=E>>13,J=E>>10&3,W=j*2,T=B>=4?(e[A]|e[A+1]<<8|e[A+2]<<16|e[A+3]<<24)>>>0:0,Ye=V===M&&W===N;let Se=!1;if(T>=1&&T<=16&&B>=8+T*24){const ne=new Map,ie=new Map;let Pe=!0;for(let Ie=0;Ie<T;Ie++){const re=A+8+Ie*24,pe=t.getUint32(re+8,!0),ue=t.getUint32(re+12,!0),Qe=t.getUint32(re+16,!0),Oe=t.getUint32(re+20,!0);if(!Qe||!Oe||pe+Qe>M||ue+Oe>N){Pe=!1;break}const St=ne.get(ue);if(St!==void 0&&St!==Oe){Pe=!1;break}ne.set(ue,Oe),ie.set(ue,(ie.get(ue)||0)+Qe)}if(Pe){const Ie=Array.from(ne.keys()).sort((pe,ue)=>pe-ue);let re=0;for(const pe of Ie){if(pe!==re||ie.get(pe)!==M){Pe=!1;break}re+=ne.get(pe)}Se=Pe&&re===N}}const De=T>=1&&T<=16&&V>0&&W>0&&M%V===0&&N%W===0&&T===M/V*(N/W);if(_!=="A000"&&_!=="0000"||!Ye&&!De&&!Se||te!==16||ce!==3||J!==3)return null;const Je=[1024,1024,1024,1024],$e=q.slice(0,4).map(ne=>ne===0?"R":ne===2?"B":"G").join("")||"RGGB";return{width:M,height:N,bitsPerSample:Q,compression:F,photometric:I,blackLevel:Je,whiteLevel:Number(Y||16383),cfaPattern:$e,defaultCropOrigin:Z.length>=2?[Number(Z[0]),Number(Z[1])]:void 0,defaultCropSize:ee.length>=2?[Number(ee[0]),Number(ee[1])]:void 0,make:h||"SONY",model:d||"ILCE-7M5"}}}const P=a(u+2+g*12);P&&o.push(P)}return null}async function bn(i){return et||(et=(async()=>{const e=await cn();return e.__jtrSonyCrawHqDecoderReady||(await e.FS.mkdirTree("/sony_craw_hq"),await e.FS.writeFile("/sony_craw_hq/llvc3_bitstream_probe.py",pn),await e.FS.writeFile("/sony_craw_hq/llvc3_entropy.py",un),await e.FS.writeFile("/sony_craw_hq/llvc3_math.py",fn),await e.runPythonAsync(`
import sys
