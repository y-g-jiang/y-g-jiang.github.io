...
<lensdatabase version="2">
    ...
    <lens>
        <maker>Sigma</maker>
        <model>Sigma 12-24mm f/4.5-5.6 EX DG Aspherical HSM</model>
        <mount>Sigma SA</mount>
        <mount>Canon EF</mount>
        <mount>Nikon F AF</mount>
    ...
    <lens>
        <maker>Sigma</maker>
        <model>Sigma 17-35mm F2.8-4 EX DG  Aspherical HSM</model>
        <mount>Nikon F AF</mount>
        <mount>Sigma SA</mount>
        <mount>Canon EF</mount>
        <mount>Minolta AF</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="17" a="0.0246095" b="-0.0657287" c="0.0213482"/>
            <distortion model="ptlens" focal="20" a="0.0073341" b="-0.01581" c="-0.0154961"/>
            <distortion model="ptlens" focal="24" a="0.0045182" b="-0.0096269" c="-0.0134071"/>
            <distortion model="ptlens" focal="29" a="0.0031857" b="-0.006667" c="-0.0103352"/>
            <distortion model="ptlens" focal="35" a="-0.0129047" b="0.0410401" c="-0.0495888"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <cropfactor>1.53</cropfactor>
        <calibration>
            <distortion model="ptlens" focal="18" a="0.02501" b="-0.05722" c="-0.00866"/>
            <distortion model="ptlens" focal="20" a="-0.00556" b="0.04704" c="-0.10382"/>
            <distortion model="ptlens" focal="24" a="-0.01524" b="0.06135" c="-0.08128"/>
            <distortion model="ptlens" focal="26" a="-0.00911" b="0.04929" c="-0.07925"/>
            <distortion model="ptlens" focal="29" a="-0.03263" b="0.12747" c="-0.15716"/>
            <distortion model="ptlens" focal="31" a="0.00399" b="-0.0064" c="0"/>
            <distortion model="ptlens" focal="33" a="0.0003" b="0.00446" c="-0.00061"/>
            <distortion model="ptlens" focal="35" a="-0.00198" b="0.00955" c="-0.0003"/>
            <distortion model="ptlens" focal="38" a="-0.00382" b="0.01199" c="0.00307"/>
            <distortion model="ptlens" focal="40" a="-0.00847" b="0.03148" c="-0.02089"/>
            <distortion model="ptlens" focal="43" a="0.00545" b="-0.01275" c="0.01729"/>
            <distortion model="ptlens" focal="50" a="-0.00638" b="0.0245" c="-0.01351"/>
            <tca model="poly3" focal="18" vr="1.0003468" vb="1.0001876"/>
            <tca model="poly3" focal="20" vr="1.0003318" vb="1.0001727"/>
            <tca model="poly3" focal="24" vr="1.0002696" vb="1.0001007"/>
            <tca model="poly3" focal="26" vr="1.0002319" vb="1.0000824"/>
            <tca model="poly3" focal="29" vr="1.0002176" vb="1.0000613"/>
            <tca model="poly3" focal="31" vr="1.0001903" vb="1.0000537"/>
            <tca model="poly3" focal="33" vr="1.0001556" vb="1.0000418"/>
            <tca model="poly3" focal="35" vr="1.0001378" vb="1.0000252"/>
            <tca model="poly3" focal="38" vr="1.0001160" vb="1.0000139"/>
            <tca model="poly3" focal="40" vr="1.0001015" vb="1.0000149"/>
            <tca model="poly3" focal="43" vr="1.0000337" vb="1.0000047"/>
            <tca model="poly3" focal="50" vr="0.9999761" vb="0.9999972"/>
         </calibration>
    </lens>
	...
	<lens>
        ...
        <cropfactor>1.0</cropfactor>
        <calibration>
            <!-- Taken with Canon R6MII -->
            <distortion model="ptlens" focal="24" a="0.0285134" b="-0.0799396" c="0.0402303"/>
            <distortion model="ptlens" focal="30" a="0.0163787" b="-0.0422842" c="0.0223784"/>
            <distortion model="ptlens" focal="37" a="0.0069019" b="-0.0126487" c="0.0053124"/>
            <distortion model="ptlens" focal="46" a="0.0002932" b="0.0105908" c="-0.0118432"/>
            <distortion model="ptlens" focal="52" a="0.0244922" b="-0.0712196" c="0.0779712"/>
            <distortion model="ptlens" focal="60" a="-0.0002835" b="0.0126778" c="-0.0094704"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <calibration>
            ...
            <vignetting model="pa" focal="24" aperture="1.4" distance="10" k1="-2.0477" k2="2.3104" k3="-1.0912"/>
            <vignetting model="pa" focal="24" aperture="1.4" distance="1000" k1="-2.0477" k2="2.3104" k3="-1.0912"/>
            <vignetting model="pa" focal="24" aperture="2" distance="10" k1="-0.5784" k2="-0.2396" k3="0.1281"/>
            <vignetting model="pa" focal="24" aperture="2" distance="1000" k1="-0.5784" k2="-0.2396" k3="0.1281"/>
            <vignetting model="pa" focal="24" aperture="2.8" distance="10" k1="-0.7911" k2="0.9866" k3="-0.7268"/>
            <vignetting model="pa" focal="24" aperture="2.8" distance="1000" k1="-0.7911" k2="0.9866" k3="-0.7268"/>
            <vignetting model="pa" focal="24" aperture="4" distance="10" k1="-0.8309" k2="0.9091" k3="-0.4407"/>
            <vignetting model="pa" focal="24" aperture="4" distance="1000" k1="-0.8309" k2="0.9091" k3="-0.4407"/>
            <vignetting model="pa" focal="24" aperture="16" distance="10" k1="-0.8466" k2="0.9030" k3="-0.4477"/>
            <vignetting model="pa" focal="24" aperture="16" distance="1000" k1="-0.8466" k2="0.9030" k3="-0.4477"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <model lang="en">Sigma 17-70mm f/2.8-4 DC Macro OS HSM | Contemporary 013</model>
        <mount>Nikon F AF</mount>
        <mount>Sigma SA</mount>
        <mount>Canon EF</mount>
        <mount>Sony Alpha</mount>
    ...
    <lens>
        <maker>Sigma</maker>
        <model>Sigma 70-200mm f/2.8 APO EX HSM</model>
        <model lang="en">Sigma 70-200mm f/2.8 EX DG HSM</model>
        <mount>Canon EF</mount>
        <mount>Sigma SA</mount>
        <mount>Nikon F AF</mount>
        <mount>Pentax KAF2</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="70" a="0.0003215" b="-0.0058231" c="0.0034852"/>
            <distortion model="ptlens" focal="88" a="0.0143317" b="-0.0531857" c="0.0589158"/>
            <distortion model="ptlens" focal="103" a="0.0053835" b="-0.0189868" c="0.0203402"/>
            <distortion model="ptlens" focal="135" a="0.0019456" b="0.0027474" c="-0.0098426"/>
            <distortion model="ptlens" focal="200" a="0.00781062" b="-0.0325498" c="0.051551"/>
            <vignetting model="pa" focal="70" aperture="2.8" distance="10" k1="-0.0256" k2="-0.2683" k3="0.1513"/>
            <vignetting model="pa" focal="70" aperture="2.8" distance="1000" k1="-0.0256" k2="-0.2683" k3="0.1513"/>
            <vignetting model="pa" focal="70" aperture="4" distance="10" k1="0.0303" k2="-0.1114" k3="0.0359"/>
            <vignetting model="pa" focal="70" aperture="4" distance="1000" k1="0.0303" k2="-0.1114" k3="0.0359"/>
            <vignetting model="pa" focal="70" aperture="5.6" distance="10" k1="0.0264" k2="-0.0966" k3="0.0262"/>
            <vignetting model="pa" focal="70" aperture="5.6" distance="1000" k1="0.0264" k2="-0.0966" k3="0.0262"/>
            <vignetting model="pa" focal="70" aperture="8" distance="10" k1="0.0442" k2="-0.1495" k3="0.0624"/>
            <vignetting model="pa" focal="70" aperture="8" distance="1000" k1="0.0442" k2="-0.1495" k3="0.0624"/>
            <vignetting model="pa" focal="70" aperture="32" distance="10" k1="0.0026" k2="-0.0982" k3="0.0487"/>
            <vignetting model="pa" focal="70" aperture="32" distance="1000" k1="0.0026" k2="-0.0982" k3="0.0487"/>
            <vignetting model="pa" focal="83" aperture="2.8" distance="10" k1="-0.0913" k2="-0.0876" k3="0.0488"/>
            <vignetting model="pa" focal="83" aperture="2.8" distance="1000" k1="-0.0913" k2="-0.0876" k3="0.0488"/>
            <vignetting model="pa" focal="83" aperture="4" distance="10" k1="0.0185" k2="-0.0690" k3="0.0097"/>
            <vignetting model="pa" focal="83" aperture="4" distance="1000" k1="0.0185" k2="-0.0690" k3="0.0097"/>
            <vignetting model="pa" focal="83" aperture="5.6" distance="10" k1="0.0172" k2="-0.0699" k3="0.0138"/>
            <vignetting model="pa" focal="83" aperture="5.6" distance="1000" k1="0.0172" k2="-0.0699" k3="0.0138"/>
            <vignetting model="pa" focal="83" aperture="8" distance="10" k1="0.0277" k2="-0.0981" k3="0.0311"/>
            <vignetting model="pa" focal="83" aperture="8" distance="1000" k1="0.0277" k2="-0.0981" k3="0.0311"/>
            <vignetting model="pa" focal="83" aperture="32" distance="10" k1="-0.0050" k2="-0.0536" k3="0.0166"/>
            <vignetting model="pa" focal="83" aperture="32" distance="1000" k1="-0.0050" k2="-0.0536" k3="0.0166"/>
            <vignetting model="pa" focal="103" aperture="2.8" distance="10" k1="-0.0706" k2="-0.0849" k3="0.0430"/>
            <vignetting model="pa" focal="103" aperture="2.8" distance="1000" k1="-0.0706" k2="-0.0849" k3="0.0430"/>
            <vignetting model="pa" focal="103" aperture="4" distance="10" k1="0.0197" k2="-0.0705" k3="0.0124"/>
            <vignetting model="pa" focal="103" aperture="4" distance="1000" k1="0.0197" k2="-0.0705" k3="0.0124"/>
            <vignetting model="pa" focal="103" aperture="5.6" distance="10" k1="0.0054" k2="-0.0332" k3="-0.0081"/>
            <vignetting model="pa" focal="103" aperture="5.6" distance="1000" k1="0.0054" k2="-0.0332" k3="-0.0081"/>
            <vignetting model="pa" focal="103" aperture="8" distance="10" k1="0.0230" k2="-0.0776" k3="0.0189"/>
            <vignetting model="pa" focal="103" aperture="8" distance="1000" k1="0.0230" k2="-0.0776" k3="0.0189"/>
            <vignetting model="pa" focal="103" aperture="32" distance="10" k1="-0.0044" k2="-0.0483" k3="0.0126"/>
            <vignetting model="pa" focal="103" aperture="32" distance="1000" k1="-0.0044" k2="-0.0483" k3="0.0126"/>
            <vignetting model="pa" focal="135" aperture="2.8" distance="10" k1="-0.0446" k2="-0.1340" k3="0.0038"/>
            <vignetting model="pa" focal="135" aperture="2.8" distance="1000" k1="-0.0446" k2="-0.1340" k3="0.0038"/>
            <vignetting model="pa" focal="135" aperture="4" distance="10" k1="-0.0303" k2="0.1154" k3="-0.1531"/>
            <vignetting model="pa" focal="135" aperture="4" distance="1000" k1="-0.0303" k2="0.1154" k3="-0.1531"/>
            <vignetting model="pa" focal="135" aperture="5.6" distance="10" k1="-0.0061" k2="-0.0015" k3="-0.0216"/>
            <vignetting model="pa" focal="135" aperture="5.6" distance="1000" k1="-0.0061" k2="-0.0015" k3="-0.0216"/>
            <vignetting model="pa" focal="135" aperture="8" distance="10" k1="0.0033" k2="-0.0265" k3="-0.0059"/>
            <vignetting model="pa" focal="135" aperture="8" distance="1000" k1="0.0033" k2="-0.0265" k3="-0.0059"/>
            <vignetting model="pa" focal="135" aperture="32" distance="10" k1="-0.0222" k2="0.0050" k3="-0.0161"/>
            <vignetting model="pa" focal="135" aperture="32" distance="1000" k1="-0.0222" k2="0.0050" k3="-0.0161"/>
            <vignetting model="pa" focal="200" aperture="2.8" distance="10" k1="-0.6117" k2="0.5099" k3="-0.2109"/>
            <vignetting model="pa" focal="200" aperture="2.8" distance="1000" k1="-0.6117" k2="0.5099" k3="-0.2109"/>
            <vignetting model="pa" focal="200" aperture="4" distance="10" k1="0.0663" k2="-0.6477" k3="0.3739"/>
            <vignetting model="pa" focal="200" aperture="4" distance="1000" k1="0.0663" k2="-0.6477" k3="0.3739"/>
            <vignetting model="pa" focal="200" aperture="5.6" distance="10" k1="-0.0427" k2="0.1348" k3="-0.1533"/>
            <vignetting model="pa" focal="200" aperture="5.6" distance="1000" k1="-0.0427" k2="0.1348" k3="-0.1533"/>
            <vignetting model="pa" focal="200" aperture="8" distance="10" k1="-0.0084" k2="-0.0014" k3="-0.0146"/>
            <vignetting model="pa" focal="200" aperture="8" distance="1000" k1="-0.0084" k2="-0.0014" k3="-0.0146"/>
            <vignetting model="pa" focal="200" aperture="32" distance="10" k1="-0.0317" k2="0.0259" k3="-0.0236"/>
            <vignetting model="pa" focal="200" aperture="32" distance="1000" k1="-0.0317" k2="0.0259" k3="-0.0236"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <calibration>
            ...
            <distortion model="poly3" focal="105" k1="-0.00055"/>
             <!-- Taken with Nikon D600 -->
            <vignetting model="pa" focal="105" aperture="2.8" distance="10" k1="-1.5417" k2="1.5900" k3="-0.7238"/>
            <vignetting model="pa" focal="105" aperture="2.8" distance="1000" k1="-1.5417" k2="1.5900" k3="-0.7238"/>
            <vignetting model="pa" focal="105" aperture="4" distance="10" k1="0.1735" k2="-0.9904" k3="0.4253"/>
            <vignetting model="pa" focal="105" aperture="4" distance="1000" k1="0.1735" k2="-0.9904" k3="0.4253"/>
            <vignetting model="pa" focal="105" aperture="5.6" distance="10" k1="-0.1780" k2="0.3993" k3="-0.3474"/>
            <vignetting model="pa" focal="105" aperture="5.6" distance="1000" k1="-0.1780" k2="0.3993" k3="-0.3474"/>
            <vignetting model="pa" focal="105" aperture="8" distance="10" k1="-0.0881" k2="0.0546" k3="-0.0259"/>
            <vignetting model="pa" focal="105" aperture="8" distance="1000" k1="-0.0881" k2="0.0546" k3="-0.0259"/>
            <vignetting model="pa" focal="105" aperture="22" distance="10" k1="-0.1401" k2="0.1292" k3="-0.0540"/>
            <vignetting model="pa" focal="105" aperture="22" distance="1000" k1="-0.1401" k2="0.1292" k3="-0.0540"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <calibration>
            ...
            <!-- Taken with CanonEOS 5DS R -->
            <vignetting model="pa" focal="20" aperture="1.4" distance="0.276" k1="-1.7357" k2="1.5419" k3="-0.6319"/>
            <vignetting model="pa" focal="20" aperture="1.4" distance="0.5" k1="-1.7566" k2="1.7472" k3="-0.8031"/>
            <vignetting model="pa" focal="20" aperture="1.4" distance="1.6" k1="-1.7470" k2="1.7744" k3="-0.8381"/>
            <vignetting model="pa" focal="20" aperture="1.4" distance="1000" k1="-1.7410" k2="1.7755" k3="-0.8473"/>
            <vignetting model="pa" focal="20" aperture="2" distance="0.276" k1="-0.0046" k2="-1.6103" k3="0.9289"/>
            <vignetting model="pa" focal="20" aperture="2" distance="0.5" k1="-0.0981" k2="-1.1272" k3="0.5654"/>
            <vignetting model="pa" focal="20" aperture="2" distance="1.6" k1="-0.1585" k2="-0.8932" k3="0.3937"/>
            <vignetting model="pa" focal="20" aperture="2" distance="1000" k1="-0.1747" k2="-0.8430" k3="0.3539"/>
            <vignetting model="pa" focal="20" aperture="2.8" distance="0.276" k1="-0.2093" k2="0.1386" k3="-0.3844"/>
            <vignetting model="pa" focal="20" aperture="2.8" distance="0.5" k1="-0.3635" k2="0.6001" k3="-0.6831"/>
            <vignetting model="pa" focal="20" aperture="2.8" distance="1.6" k1="-0.3792" k2="0.6087" k3="-0.6852"/>
            <vignetting model="pa" focal="20" aperture="2.8" distance="1000" k1="-0.3645" k2="0.5511" k3="-0.6448"/>
            <vignetting model="pa" focal="20" aperture="4" distance="0.276" k1="-0.3453" k2="0.4743" k3="-0.3294"/>
            <vignetting model="pa" focal="20" aperture="4" distance="0.5" k1="-0.4423" k2="0.7908" k3="-0.6093"/>
            <vignetting model="pa" focal="20" aperture="4" distance="1.6" k1="-0.4808" k2="0.9521" k3="-0.7929"/>
            <vignetting model="pa" focal="20" aperture="4" distance="1000" k1="-0.4665" k2="0.9079" k3="-0.7732"/>
            <vignetting model="pa" focal="20" aperture="16" distance="0.276" k1="-0.2916" k2="0.1724" k3="-0.0238"/>
            <vignetting model="pa" focal="20" aperture="16" distance="0.5" k1="-0.3208" k2="0.2142" k3="-0.0411"/>
            <vignetting model="pa" focal="20" aperture="16" distance="1.6" k1="-0.3321" k2="0.2279" k3="-0.0454"/>
            <vignetting model="pa" focal="20" aperture="16" distance="1000" k1="-0.3290" k2="0.2077" k3="-0.0287"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <model lang="en">70-200mm F2.8 DG OS HSM | S</model>
        <mount>Canon EF</mount>
        <mount>Sigma SA</mount>
        <mount>Nikon F</mount>
    ...
    <lens>
        <maker>Sigma</maker>
        <model>Sigma 60-600mm f/4.5-6.3 DG OS HSM | S</model>
        <model lang="en">Sigma 60-600mm F4.5-6.3 DG OS HSM | Sports 018</model>
        <mount>Canon EF-S</mount>
        <mount>Nikon F AF</mount>
        <mount>Sigma SA</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="60" a="-0.00118" b="0.00033" c="-0.00282"/>
            <distortion model="ptlens" focal="71" a="0.00084" b="-0.00932" c="0.00178"/>
            <distortion model="ptlens" focal="79" a="0.00047" b="-0.00407" c="0.00641"/>
            <distortion model="ptlens" focal="100" a="0.0007" b="-0.00260" c="0.00338"/>
            <distortion model="ptlens" focal="117" a="-0.00055" b="0.00174" c="-0.00164"/>
            <distortion model="ptlens" focal="151" a="-0.00273" b="0.00993" c="-0.01029"/>
            <distortion model="ptlens" focal="204" a="0.00091" b="-0.00150" c="0.00043"/>
            <distortion model="ptlens" focal="244" a="0.00415" b="-0.01555" c="0.0203"/>
            <distortion model="ptlens" focal="295" a="-0.00079" b="0.00605" c="-0.00778"/>
            <distortion model="ptlens" focal="388" a="0.00048" b="0.0008" c="-0.00107"/>
            <distortion model="ptlens" focal="600" a="-0.01249" b="0.04203" c="-0.04085"/>
            <tca model="poly3" focal="60" vr="1.0001298" vb="1.0001669"/>
            <tca model="poly3" focal="71" vr="1.0001976" vb="1.0001156"/>
            <tca model="poly3" focal="79" vr="1.0002182" vb="1.0000929"/>
            <tca model="poly3" focal="100" vr="1.0002940" vb="1.0000243"/>
            <tca model="poly3" focal="117" vr="1.0002873" vb="1.0000007"/>
            <tca model="poly3" focal="151" vr="1.0002527" vb="0.9999815"/>
            <tca model="poly3" focal="204" vr="1.0001179" vb="1.0000086"/>
            <tca model="poly3" focal="256" vr="0.9999895" vb="1.0000680"/>
            <tca model="poly3" focal="295" vr="0.9998870" vb="1.0001103"/>
            <tca model="poly3" focal="413" vr="0.9996795" vb="1.0001509"/>
            <tca model="poly3" focal="600" vr="0.9995804" vb="1.0000425"/>
            <vignetting model="pa" focal="60" aperture="4.5" distance="10" k1="-0.1050" k2="-0.0760" k3="0.0247"/>
            <vignetting model="pa" focal="60" aperture="4.5" distance="1000" k1="-0.1050" k2="-0.0760" k3="0.0247"/>
            <vignetting model="pa" focal="60" aperture="5" distance="10" k1="-0.0515" k2="0.0175" k3="-0.0385"/>
            <vignetting model="pa" focal="60" aperture="5" distance="1000" k1="-0.0515" k2="0.0175" k3="-0.0385"/>
            <vignetting model="pa" focal="60" aperture="5.6" distance="10" k1="-0.0477" k2="-0.0309" k3="0.0359"/>
            <vignetting model="pa" focal="60" aperture="5.6" distance="1000" k1="-0.0477" k2="-0.0309" k3="0.0359"/>
            <vignetting model="pa" focal="60" aperture="6.3" distance="10" k1="-0.0486" k2="-0.0271" k3="0.0324"/>
            <vignetting model="pa" focal="60" aperture="6.3" distance="1000" k1="-0.0486" k2="-0.0271" k3="0.0324"/>
            <vignetting model="pa" focal="60" aperture="7.1" distance="10" k1="-0.0502" k2="-0.0219" k3="0.0287"/>
            <vignetting model="pa" focal="60" aperture="7.1" distance="1000" k1="-0.0502" k2="-0.0219" k3="0.0287"/>
            <vignetting model="pa" focal="60" aperture="8" distance="10" k1="-0.0500" k2="-0.0205" k3="0.0264"/>
            <vignetting model="pa" focal="60" aperture="8" distance="1000" k1="-0.0500" k2="-0.0205" k3="0.0264"/>
            <vignetting model="pa" focal="60" aperture="9" distance="10" k1="-0.0497" k2="-0.0191" k3="0.0249"/>
            <vignetting model="pa" focal="60" aperture="9" distance="1000" k1="-0.0497" k2="-0.0191" k3="0.0249"/>
            <vignetting model="pa" focal="60" aperture="10" distance="10" k1="-0.0499" k2="-0.0171" k3="0.0232"/>
            <vignetting model="pa" focal="60" aperture="10" distance="1000" k1="-0.0499" k2="-0.0171" k3="0.0232"/>
            <vignetting model="pa" focal="60" aperture="11" distance="10" k1="-0.0484" k2="-0.0187" k3="0.0245"/>
            <vignetting model="pa" focal="60" aperture="11" distance="1000" k1="-0.0484" k2="-0.0187" k3="0.0245"/>
            <vignetting model="pa" focal="60" aperture="13" distance="10" k1="-0.0487" k2="-0.0223" k3="0.0286"/>
            <vignetting model="pa" focal="60" aperture="13" distance="1000" k1="-0.0487" k2="-0.0223" k3="0.0286"/>
            <vignetting model="pa" focal="60" aperture="14" distance="10" k1="-0.0485" k2="-0.0225" k3="0.0293"/>
            <vignetting model="pa" focal="60" aperture="14" distance="1000" k1="-0.0485" k2="-0.0225" k3="0.0293"/>
            <vignetting model="pa" focal="60" aperture="16" distance="10" k1="-0.0474" k2="-0.0256" k3="0.0316"/>
            <vignetting model="pa" focal="60" aperture="16" distance="1000" k1="-0.0474" k2="-0.0256" k3="0.0316"/>
            <vignetting model="pa" focal="60" aperture="22" distance="10" k1="-0.0518" k2="-0.0167" k3="0.0279"/>
            <vignetting model="pa" focal="60" aperture="22" distance="1000" k1="-0.0518" k2="-0.0167" k3="0.0279"/>
            <vignetting model="pa" focal="71" aperture="4.5" distance="10" k1="-0.0648" k2="-0.1802" k3="0.1018"/>
            <vignetting model="pa" focal="71" aperture="4.5" distance="1000" k1="-0.0648" k2="-0.1802" k3="0.1018"/>
            <vignetting model="pa" focal="71" aperture="5" distance="10" k1="-0.0444" k2="-0.0005" k3="-0.0220"/>
            <vignetting model="pa" focal="71" aperture="5" distance="1000" k1="-0.0444" k2="-0.0005" k3="-0.0220"/>
            <vignetting model="pa" focal="71" aperture="5.6" distance="10" k1="-0.0435" k2="-0.0289" k3="0.0325"/>
            <vignetting model="pa" focal="71" aperture="5.6" distance="1000" k1="-0.0435" k2="-0.0289" k3="0.0325"/>
            <vignetting model="pa" focal="71" aperture="6.3" distance="10" k1="-0.0421" k2="-0.0323" k3="0.0359"/>
            <vignetting model="pa" focal="71" aperture="6.3" distance="1000" k1="-0.0421" k2="-0.0323" k3="0.0359"/>
            <vignetting model="pa" focal="71" aperture="7.1" distance="10" k1="-0.0433" k2="-0.0281" k3="0.0324"/>
            <vignetting model="pa" focal="71" aperture="7.1" distance="1000" k1="-0.0433" k2="-0.0281" k3="0.0324"/>
            <vignetting model="pa" focal="71" aperture="8" distance="10" k1="-0.0432" k2="-0.0271" k3="0.0315"/>
            <vignetting model="pa" focal="71" aperture="8" distance="1000" k1="-0.0432" k2="-0.0271" k3="0.0315"/>
            <vignetting model="pa" focal="71" aperture="9" distance="10" k1="-0.0422" k2="-0.0301" k3="0.0346"/>
            <vignetting model="pa" focal="71" aperture="9" distance="1000" k1="-0.0422" k2="-0.0301" k3="0.0346"/>
            <vignetting model="pa" focal="71" aperture="10" distance="10" k1="-0.0423" k2="-0.0280" k3="0.0323"/>
            <vignetting model="pa" focal="71" aperture="10" distance="1000" k1="-0.0423" k2="-0.0280" k3="0.0323"/>
            <vignetting model="pa" focal="71" aperture="11" distance="10" k1="-0.0415" k2="-0.0280" k3="0.0317"/>
            <vignetting model="pa" focal="71" aperture="11" distance="1000" k1="-0.0415" k2="-0.0280" k3="0.0317"/>
            <vignetting model="pa" focal="71" aperture="13" distance="10" k1="-0.0426" k2="-0.0272" k3="0.0327"/>
            <vignetting model="pa" focal="71" aperture="13" distance="1000" k1="-0.0426" k2="-0.0272" k3="0.0327"/>
            <vignetting model="pa" focal="71" aperture="14" distance="10" k1="-0.0447" k2="-0.0213" k3="0.0283"/>
            <vignetting model="pa" focal="71" aperture="14" distance="1000" k1="-0.0447" k2="-0.0213" k3="0.0283"/>
            <vignetting model="pa" focal="71" aperture="16" distance="10" k1="-0.0408" k2="-0.0307" k3="0.0348"/>
            <vignetting model="pa" focal="71" aperture="16" distance="1000" k1="-0.0408" k2="-0.0307" k3="0.0348"/>
            <vignetting model="pa" focal="71" aperture="22" distance="10" k1="-0.0451" k2="-0.0203" k3="0.0296"/>
            <vignetting model="pa" focal="71" aperture="22" distance="1000" k1="-0.0451" k2="-0.0203" k3="0.0296"/>
            <vignetting model="pa" focal="79" aperture="5" distance="10" k1="-0.0696" k2="-0.1446" k3="0.0766"/>
            <vignetting model="pa" focal="79" aperture="5" distance="1000" k1="-0.0696" k2="-0.1446" k3="0.0766"/>
            <vignetting model="pa" focal="79" aperture="5.6" distance="10" k1="-0.0621" k2="0.0226" k3="0.0042"/>
            <vignetting model="pa" focal="79" aperture="5.6" distance="1000" k1="-0.0621" k2="0.0226" k3="0.0042"/>
            <vignetting model="pa" focal="79" aperture="6.3" distance="10" k1="-0.0662" k2="0.0268" k3="0.0050"/>
            <vignetting model="pa" focal="79" aperture="6.3" distance="1000" k1="-0.0662" k2="0.0268" k3="0.0050"/>
            <vignetting model="pa" focal="79" aperture="7.1" distance="10" k1="-0.0643" k2="0.0223" k3="0.0078"/>
            <vignetting model="pa" focal="79" aperture="7.1" distance="1000" k1="-0.0643" k2="0.0223" k3="0.0078"/>
            <vignetting model="pa" focal="79" aperture="8" distance="10" k1="-0.0662" k2="0.0282" k3="0.0024"/>
            <vignetting model="pa" focal="79" aperture="8" distance="1000" k1="-0.0662" k2="0.0282" k3="0.0024"/>
            <vignetting model="pa" focal="79" aperture="9" distance="10" k1="-0.0672" k2="0.0325" k3="-0.0011"/>
            <vignetting model="pa" focal="79" aperture="9" distance="1000" k1="-0.0672" k2="0.0325" k3="-0.0011"/>
            <vignetting model="pa" focal="79" aperture="10" distance="10" k1="-0.0642" k2="0.0240" k3="0.0047"/>
            <vignetting model="pa" focal="79" aperture="10" distance="1000" k1="-0.0642" k2="0.0240" k3="0.0047"/>
            <vignetting model="pa" focal="79" aperture="11" distance="10" k1="-0.0646" k2="0.0236" k3="0.0058"/>
            <vignetting model="pa" focal="79" aperture="11" distance="1000" k1="-0.0646" k2="0.0236" k3="0.0058"/>
            <vignetting model="pa" focal="79" aperture="13" distance="10" k1="-0.0620" k2="0.0169" k3="0.0101"/>
            <vignetting model="pa" focal="79" aperture="13" distance="1000" k1="-0.0620" k2="0.0169" k3="0.0101"/>
            <vignetting model="pa" focal="79" aperture="14" distance="10" k1="-0.0636" k2="0.0213" k3="0.0064"/>
            <vignetting model="pa" focal="79" aperture="14" distance="1000" k1="-0.0636" k2="0.0213" k3="0.0064"/>
            <vignetting model="pa" focal="79" aperture="16" distance="10" k1="-0.0607" k2="0.0114" k3="0.0143"/>
            <vignetting model="pa" focal="79" aperture="16" distance="1000" k1="-0.0607" k2="0.0114" k3="0.0143"/>
            <vignetting model="pa" focal="79" aperture="18" distance="10" k1="-0.0539" k2="-0.0042" k3="0.0236"/>
            <vignetting model="pa" focal="79" aperture="18" distance="1000" k1="-0.0539" k2="-0.0042" k3="0.0236"/>
            <vignetting model="pa" focal="79" aperture="20" distance="10" k1="-0.0607" k2="0.0099" k3="0.0159"/>
            <vignetting model="pa" focal="79" aperture="20" distance="1000" k1="-0.0607" k2="0.0099" k3="0.0159"/>
            <vignetting model="pa" focal="79" aperture="22" distance="10" k1="-0.0650" k2="0.0191" k3="0.0109"/>
            <vignetting model="pa" focal="79" aperture="22" distance="1000" k1="-0.0650" k2="0.0191" k3="0.0109"/>
            <vignetting model="pa" focal="100" aperture="5" distance="10" k1="-0.0345" k2="-0.1964" k3="0.1103"/>
            <vignetting model="pa" focal="100" aperture="5" distance="1000" k1="-0.0345" k2="-0.1964" k3="0.1103"/>
            <vignetting model="pa" focal="100" aperture="5.6" distance="10" k1="-0.0741" k2="0.0731" k3="-0.0394"/>
            <vignetting model="pa" focal="100" aperture="5.6" distance="1000" k1="-0.0741" k2="0.0731" k3="-0.0394"/>
            <vignetting model="pa" focal="100" aperture="6.3" distance="10" k1="-0.0653" k2="0.0354" k3="-0.0016"/>
            <vignetting model="pa" focal="100" aperture="6.3" distance="1000" k1="-0.0653" k2="0.0354" k3="-0.0016"/>
            <vignetting model="pa" focal="100" aperture="7.1" distance="10" k1="-0.0643" k2="0.0329" k3="0.0002"/>
            <vignetting model="pa" focal="100" aperture="7.1" distance="1000" k1="-0.0643" k2="0.0329" k3="0.0002"/>
            <vignetting model="pa" focal="100" aperture="8" distance="10" k1="-0.0642" k2="0.0328" k3="-0.0003"/>
            <vignetting model="pa" focal="100" aperture="8" distance="1000" k1="-0.0642" k2="0.0328" k3="-0.0003"/>
            <vignetting model="pa" focal="100" aperture="9" distance="10" k1="-0.0641" k2="0.0332" k3="-0.0015"/>
            <vignetting model="pa" focal="100" aperture="9" distance="1000" k1="-0.0641" k2="0.0332" k3="-0.0015"/>
            <vignetting model="pa" focal="100" aperture="10" distance="10" k1="-0.0570" k2="0.0167" k3="0.0085"/>
            <vignetting model="pa" focal="100" aperture="10" distance="1000" k1="-0.0570" k2="0.0167" k3="0.0085"/>
            <vignetting model="pa" focal="100" aperture="11" distance="10" k1="-0.0637" k2="0.0334" k3="-0.0026"/>
            <vignetting model="pa" focal="100" aperture="11" distance="1000" k1="-0.0637" k2="0.0334" k3="-0.0026"/>
            <vignetting model="pa" focal="100" aperture="13" distance="10" k1="-0.0589" k2="0.0182" k3="0.0099"/>
            <vignetting model="pa" focal="100" aperture="13" distance="1000" k1="-0.0589" k2="0.0182" k3="0.0099"/>
            <vignetting model="pa" focal="100" aperture="14" distance="10" k1="-0.0603" k2="0.0199" k3="0.0093"/>
            <vignetting model="pa" focal="100" aperture="14" distance="1000" k1="-0.0603" k2="0.0199" k3="0.0093"/>
            <vignetting model="pa" focal="100" aperture="16" distance="10" k1="-0.0616" k2="0.0253" k3="0.0042"/>
            <vignetting model="pa" focal="100" aperture="16" distance="1000" k1="-0.0616" k2="0.0253" k3="0.0042"/>
            <vignetting model="pa" focal="100" aperture="25" distance="10" k1="-0.0643" k2="0.0294" k3="0.0023"/>
            <vignetting model="pa" focal="100" aperture="25" distance="1000" k1="-0.0643" k2="0.0294" k3="0.0023"/>
            <vignetting model="pa" focal="117" aperture="5" distance="10" k1="-0.0154" k2="-0.2090" k3="0.1151"/>
            <vignetting model="pa" focal="117" aperture="5" distance="1000" k1="-0.0154" k2="-0.2090" k3="0.1151"/>
            <vignetting model="pa" focal="117" aperture="5.6" distance="10" k1="-0.0729" k2="0.0860" k3="-0.0604"/>
            <vignetting model="pa" focal="117" aperture="5.6" distance="1000" k1="-0.0729" k2="0.0860" k3="-0.0604"/>
            <vignetting model="pa" focal="117" aperture="6.3" distance="10" k1="-0.0634" k2="0.0350" k3="-0.0001"/>
            <vignetting model="pa" focal="117" aperture="6.3" distance="1000" k1="-0.0634" k2="0.0350" k3="-0.0001"/>
            <vignetting model="pa" focal="117" aperture="7.1" distance="10" k1="-0.0665" k2="0.0459" k3="-0.0090"/>
            <vignetting model="pa" focal="117" aperture="7.1" distance="1000" k1="-0.0665" k2="0.0459" k3="-0.0090"/>
            <vignetting model="pa" focal="117" aperture="8" distance="10" k1="-0.0658" k2="0.0435" k3="-0.0073"/>
            <vignetting model="pa" focal="117" aperture="8" distance="1000" k1="-0.0658" k2="0.0435" k3="-0.0073"/>
            <vignetting model="pa" focal="117" aperture="9" distance="10" k1="-0.0657" k2="0.0426" k3="-0.0069"/>
            <vignetting model="pa" focal="117" aperture="9" distance="1000" k1="-0.0657" k2="0.0426" k3="-0.0069"/>
            <vignetting model="pa" focal="117" aperture="10" distance="10" k1="-0.0664" k2="0.0467" k3="-0.0107"/>
            <vignetting model="pa" focal="117" aperture="10" distance="1000" k1="-0.0664" k2="0.0467" k3="-0.0107"/>
            <vignetting model="pa" focal="117" aperture="11" distance="10" k1="-0.0641" k2="0.0398" k3="-0.0056"/>
            <vignetting model="pa" focal="117" aperture="11" distance="1000" k1="-0.0641" k2="0.0398" k3="-0.0056"/>
            <vignetting model="pa" focal="117" aperture="13" distance="10" k1="-0.0603" k2="0.0285" k3="0.0020"/>
            <vignetting model="pa" focal="117" aperture="13" distance="1000" k1="-0.0603" k2="0.0285" k3="0.0020"/>
            <vignetting model="pa" focal="117" aperture="14" distance="10" k1="-0.0608" k2="0.0284" k3="0.0032"/>
            <vignetting model="pa" focal="117" aperture="14" distance="1000" k1="-0.0608" k2="0.0284" k3="0.0032"/>
            <vignetting model="pa" focal="117" aperture="16" distance="10" k1="-0.0587" k2="0.0204" k3="0.0089"/>
            <vignetting model="pa" focal="117" aperture="16" distance="1000" k1="-0.0587" k2="0.0204" k3="0.0089"/>
            <vignetting model="pa" focal="117" aperture="25" distance="10" k1="-0.0601" k2="0.0204" k3="0.0092"/>
            <vignetting model="pa" focal="117" aperture="25" distance="1000" k1="-0.0601" k2="0.0204" k3="0.0092"/>
            <vignetting model="pa" focal="151" aperture="5.6" distance="10" k1="-0.0064" k2="-0.2099" k3="0.1178"/>
            <vignetting model="pa" focal="151" aperture="5.6" distance="1000" k1="-0.0064" k2="-0.2099" k3="0.1178"/>
            <vignetting model="pa" focal="151" aperture="6.3" distance="10" k1="-0.0560" k2="0.0247" k3="0.0045"/>
            <vignetting model="pa" focal="151" aperture="6.3" distance="1000" k1="-0.0560" k2="0.0247" k3="0.0045"/>
            <vignetting model="pa" focal="151" aperture="7.1" distance="10" k1="-0.0573" k2="0.0272" k3="0.0028"/>
            <vignetting model="pa" focal="151" aperture="7.1" distance="1000" k1="-0.0573" k2="0.0272" k3="0.0028"/>
            <vignetting model="pa" focal="151" aperture="8" distance="10" k1="-0.0577" k2="0.0291" k3="0.0013"/>
            <vignetting model="pa" focal="151" aperture="8" distance="1000" k1="-0.0577" k2="0.0291" k3="0.0013"/>
            <vignetting model="pa" focal="151" aperture="9" distance="10" k1="-0.0585" k2="0.0293" k3="0.0017"/>
            <vignetting model="pa" focal="151" aperture="9" distance="1000" k1="-0.0585" k2="0.0293" k3="0.0017"/>
            <vignetting model="pa" focal="151" aperture="10" distance="10" k1="-0.0580" k2="0.0297" k3="0.0005"/>
            <vignetting model="pa" focal="151" aperture="10" distance="1000" k1="-0.0580" k2="0.0297" k3="0.0005"/>
            <vignetting model="pa" focal="151" aperture="11" distance="10" k1="-0.0568" k2="0.0262" k3="0.0032"/>
            <vignetting model="pa" focal="151" aperture="11" distance="1000" k1="-0.0568" k2="0.0262" k3="0.0032"/>
            <vignetting model="pa" focal="151" aperture="13" distance="10" k1="-0.0466" k2="0.0002" k3="0.0197"/>
            <vignetting model="pa" focal="151" aperture="13" distance="1000" k1="-0.0466" k2="0.0002" k3="0.0197"/>
            <vignetting model="pa" focal="151" aperture="14" distance="10" k1="-0.0554" k2="0.0239" k3="0.0031"/>
            <vignetting model="pa" focal="151" aperture="14" distance="1000" k1="-0.0554" k2="0.0239" k3="0.0031"/>
            <vignetting model="pa" focal="151" aperture="16" distance="10" k1="-0.0512" k2="0.0093" k3="0.0152"/>
            <vignetting model="pa" focal="151" aperture="16" distance="1000" k1="-0.0512" k2="0.0093" k3="0.0152"/>
            <vignetting model="pa" focal="151" aperture="18" distance="10" k1="-0.0531" k2="0.0160" k3="0.0089"/>
            <vignetting model="pa" focal="151" aperture="18" distance="1000" k1="-0.0531" k2="0.0160" k3="0.0089"/>
            <vignetting model="pa" focal="151" aperture="20" distance="10" k1="-0.0539" k2="0.0167" k3="0.0089"/>
            <vignetting model="pa" focal="151" aperture="20" distance="1000" k1="-0.0539" k2="0.0167" k3="0.0089"/>
            <vignetting model="pa" focal="151" aperture="22" distance="10" k1="-0.0529" k2="0.0127" k3="0.0124"/>
            <vignetting model="pa" focal="151" aperture="22" distance="1000" k1="-0.0529" k2="0.0127" k3="0.0124"/>
            <vignetting model="pa" focal="151" aperture="29" distance="10" k1="-0.0532" k2="0.0112" k3="0.0133"/>
            <vignetting model="pa" focal="151" aperture="29" distance="1000" k1="-0.0532" k2="0.0112" k3="0.0133"/>
            <vignetting model="pa" focal="204" aperture="5.6" distance="10" k1="-0.0134" k2="-0.2106" k3="0.1340"/>
            <vignetting model="pa" focal="204" aperture="5.6" distance="1000" k1="-0.0134" k2="-0.2106" k3="0.1340"/>
            <vignetting model="pa" focal="204" aperture="6.3" distance="10" k1="-0.0497" k2="0.0189" k3="0.0050"/>
            <vignetting model="pa" focal="204" aperture="6.3" distance="1000" k1="-0.0497" k2="0.0189" k3="0.0050"/>
            <vignetting model="pa" focal="204" aperture="7.1" distance="10" k1="-0.0467" k2="0.0067" k3="0.0158"/>
            <vignetting model="pa" focal="204" aperture="7.1" distance="1000" k1="-0.0467" k2="0.0067" k3="0.0158"/>
            <vignetting model="pa" focal="204" aperture="8" distance="10" k1="-0.0486" k2="0.0117" k3="0.0115"/>
            <vignetting model="pa" focal="204" aperture="8" distance="1000" k1="-0.0486" k2="0.0117" k3="0.0115"/>
            <vignetting model="pa" focal="204" aperture="9" distance="10" k1="-0.0474" k2="0.0081" k3="0.0141"/>
            <vignetting model="pa" focal="204" aperture="9" distance="1000" k1="-0.0474" k2="0.0081" k3="0.0141"/>
            <vignetting model="pa" focal="204" aperture="10" distance="10" k1="-0.0462" k2="0.0057" k3="0.0151"/>
            <vignetting model="pa" focal="204" aperture="10" distance="1000" k1="-0.0462" k2="0.0057" k3="0.0151"/>
            <vignetting model="pa" focal="204" aperture="11" distance="10" k1="-0.0472" k2="0.0064" k3="0.0153"/>
            <vignetting model="pa" focal="204" aperture="11" distance="1000" k1="-0.0472" k2="0.0064" k3="0.0153"/>
            <vignetting model="pa" focal="204" aperture="13" distance="10" k1="-0.0469" k2="0.0078" k3="0.0135"/>
            <vignetting model="pa" focal="204" aperture="13" distance="1000" k1="-0.0469" k2="0.0078" k3="0.0135"/>
            <vignetting model="pa" focal="204" aperture="14" distance="10" k1="-0.0447" k2="0.0011" k3="0.0186"/>
            <vignetting model="pa" focal="204" aperture="14" distance="1000" k1="-0.0447" k2="0.0011" k3="0.0186"/>
            <vignetting model="pa" focal="204" aperture="16" distance="10" k1="-0.0391" k2="-0.0136" k3="0.0283"/>
            <vignetting model="pa" focal="204" aperture="16" distance="1000" k1="-0.0391" k2="-0.0136" k3="0.0283"/>
            <vignetting model="pa" focal="204" aperture="29" distance="10" k1="-0.0427" k2="-0.0068" k3="0.0233"/>
            <vignetting model="pa" focal="204" aperture="29" distance="1000" k1="-0.0427" k2="-0.0068" k3="0.0233"/>
            <vignetting model="pa" focal="244" aperture="5.6" distance="10" k1="-0.0223" k2="-0.1985" k3="0.1337"/>
            <vignetting model="pa" focal="244" aperture="5.6" distance="1000" k1="-0.0223" k2="-0.1985" k3="0.1337"/>
            <vignetting model="pa" focal="244" aperture="6.3" distance="10" k1="-0.0478" k2="0.0320" k3="-0.0171"/>
            <vignetting model="pa" focal="244" aperture="6.3" distance="1000" k1="-0.0478" k2="0.0320" k3="-0.0171"/>
            <vignetting model="pa" focal="244" aperture="7.1" distance="10" k1="-0.0422" k2="-0.0004" k3="0.0199"/>
            <vignetting model="pa" focal="244" aperture="7.1" distance="1000" k1="-0.0422" k2="-0.0004" k3="0.0199"/>
            <vignetting model="pa" focal="244" aperture="8" distance="10" k1="-0.0432" k2="0.0017" k3="0.0179"/>
            <vignetting model="pa" focal="244" aperture="8" distance="1000" k1="-0.0432" k2="0.0017" k3="0.0179"/>
            <vignetting model="pa" focal="244" aperture="9" distance="10" k1="-0.0430" k2="0.0021" k3="0.0169"/>
            <vignetting model="pa" focal="244" aperture="9" distance="1000" k1="-0.0430" k2="0.0021" k3="0.0169"/>
            <vignetting model="pa" focal="244" aperture="10" distance="10" k1="-0.0428" k2="0.0018" k3="0.0170"/>
            <vignetting model="pa" focal="244" aperture="10" distance="1000" k1="-0.0428" k2="0.0018" k3="0.0170"/>
            <vignetting model="pa" focal="244" aperture="11" distance="10" k1="-0.0445" k2="0.0050" k3="0.0153"/>
            <vignetting model="pa" focal="244" aperture="11" distance="1000" k1="-0.0445" k2="0.0050" k3="0.0153"/>
            <vignetting model="pa" focal="244" aperture="13" distance="10" k1="-0.0458" k2="0.0087" k3="0.0130"/>
            <vignetting model="pa" focal="244" aperture="13" distance="1000" k1="-0.0458" k2="0.0087" k3="0.0130"/>
            <vignetting model="pa" focal="244" aperture="14" distance="10" k1="-0.0423" k2="-0.0019" k3="0.0204"/>
            <vignetting model="pa" focal="244" aperture="14" distance="1000" k1="-0.0423" k2="-0.0019" k3="0.0204"/>
            <vignetting model="pa" focal="244" aperture="16" distance="10" k1="-0.0391" k2="-0.0066" k3="0.0218"/>
            <vignetting model="pa" focal="244" aperture="16" distance="1000" k1="-0.0391" k2="-0.0066" k3="0.0218"/>
            <vignetting model="pa" focal="244" aperture="18" distance="10" k1="-0.0387" k2="-0.0082" k3="0.0227"/>
            <vignetting model="pa" focal="244" aperture="18" distance="1000" k1="-0.0387" k2="-0.0082" k3="0.0227"/>
            <vignetting model="pa" focal="244" aperture="20" distance="10" k1="-0.0389" k2="-0.0095" k3="0.0241"/>
            <vignetting model="pa" focal="244" aperture="20" distance="1000" k1="-0.0389" k2="-0.0095" k3="0.0241"/>
            <vignetting model="pa" focal="244" aperture="22" distance="10" k1="-0.0392" k2="-0.0096" k3="0.0242"/>
            <vignetting model="pa" focal="244" aperture="22" distance="1000" k1="-0.0392" k2="-0.0096" k3="0.0242"/>
            <vignetting model="pa" focal="244" aperture="29" distance="10" k1="-0.0439" k2="-0.0030" k3="0.0224"/>
            <vignetting model="pa" focal="244" aperture="29" distance="1000" k1="-0.0439" k2="-0.0030" k3="0.0224"/>
            <vignetting model="pa" focal="295" aperture="5.6" distance="10" k1="-0.0403" k2="-0.1390" k3="0.0851"/>
            <vignetting model="pa" focal="295" aperture="5.6" distance="1000" k1="-0.0403" k2="-0.1390" k3="0.0851"/>
            <vignetting model="pa" focal="295" aperture="6.3" distance="10" k1="-0.0484" k2="0.0432" k3="-0.0316"/>
            <vignetting model="pa" focal="295" aperture="6.3" distance="1000" k1="-0.0484" k2="0.0432" k3="-0.0316"/>
            <vignetting model="pa" focal="295" aperture="7.1" distance="10" k1="-0.0405" k2="0.0006" k3="0.0171"/>
            <vignetting model="pa" focal="295" aperture="7.1" distance="1000" k1="-0.0405" k2="0.0006" k3="0.0171"/>
            <vignetting model="pa" focal="295" aperture="8" distance="10" k1="-0.0433" k2="0.0062" k3="0.0142"/>
            <vignetting model="pa" focal="295" aperture="8" distance="1000" k1="-0.0433" k2="0.0062" k3="0.0142"/>
            <vignetting model="pa" focal="295" aperture="9" distance="10" k1="-0.0426" k2="0.0024" k3="0.0178"/>
            <vignetting model="pa" focal="295" aperture="9" distance="1000" k1="-0.0426" k2="0.0024" k3="0.0178"/>
            <vignetting model="pa" focal="295" aperture="10" distance="10" k1="-0.0439" k2="0.0056" k3="0.0151"/>
            <vignetting model="pa" focal="295" aperture="10" distance="1000" k1="-0.0439" k2="0.0056" k3="0.0151"/>
            <vignetting model="pa" focal="295" aperture="11" distance="10" k1="-0.0415" k2="0.0009" k3="0.0170"/>
            <vignetting model="pa" focal="295" aperture="11" distance="1000" k1="-0.0415" k2="0.0009" k3="0.0170"/>
            <vignetting model="pa" focal="295" aperture="13" distance="10" k1="-0.0408" k2="-0.0022" k3="0.0200"/>
            <vignetting model="pa" focal="295" aperture="13" distance="1000" k1="-0.0408" k2="-0.0022" k3="0.0200"/>
            <vignetting model="pa" focal="295" aperture="14" distance="10" k1="-0.0392" k2="-0.0045" k3="0.0203"/>
            <vignetting model="pa" focal="295" aperture="14" distance="1000" k1="-0.0392" k2="-0.0045" k3="0.0203"/>
            <vignetting model="pa" focal="295" aperture="16" distance="10" k1="-0.0414" k2="0.0020" k3="0.0150"/>
            <vignetting model="pa" focal="295" aperture="16" distance="1000" k1="-0.0414" k2="0.0020" k3="0.0150"/>
            <vignetting model="pa" focal="295" aperture="18" distance="10" k1="-0.0368" k2="-0.0093" k3="0.0224"/>
            <vignetting model="pa" focal="295" aperture="18" distance="1000" k1="-0.0368" k2="-0.0093" k3="0.0224"/>
            <vignetting model="pa" focal="295" aperture="20" distance="10" k1="-0.0392" k2="-0.0060" k3="0.0215"/>
            <vignetting model="pa" focal="295" aperture="20" distance="1000" k1="-0.0392" k2="-0.0060" k3="0.0215"/>
            <vignetting model="pa" focal="295" aperture="22" distance="10" k1="-0.0388" k2="-0.0061" k3="0.0208"/>
            <vignetting model="pa" focal="295" aperture="22" distance="1000" k1="-0.0388" k2="-0.0061" k3="0.0208"/>
            <vignetting model="pa" focal="295" aperture="25" distance="10" k1="-0.0393" k2="-0.0073" k3="0.0233"/>
            <vignetting model="pa" focal="295" aperture="25" distance="1000" k1="-0.0393" k2="-0.0073" k3="0.0233"/>
            <vignetting model="pa" focal="295" aperture="29" distance="10" k1="-0.0429" k2="-0.0011" k3="0.0198"/>
            <vignetting model="pa" focal="295" aperture="29" distance="1000" k1="-0.0429" k2="-0.0011" k3="0.0198"/>
            <vignetting model="pa" focal="388" aperture="6.3" distance="10" k1="0.0338" k2="-0.3409" k3="0.1367"/>
            <vignetting model="pa" focal="388" aperture="6.3" distance="1000" k1="0.0338" k2="-0.3409" k3="0.1367"/>
            <vignetting model="pa" focal="388" aperture="7.1" distance="10" k1="-0.0408" k2="0.0411" k3="-0.0584"/>
            <vignetting model="pa" focal="388" aperture="7.1" distance="1000" k1="-0.0408" k2="0.0411" k3="-0.0584"/>
            <vignetting model="pa" focal="388" aperture="8" distance="10" k1="-0.0530" k2="0.0721" k3="-0.0601"/>
            <vignetting model="pa" focal="388" aperture="8" distance="1000" k1="-0.0530" k2="0.0721" k3="-0.0601"/>
            <vignetting model="pa" focal="388" aperture="9" distance="10" k1="-0.0312" k2="-0.0205" k3="0.0293"/>
            <vignetting model="pa" focal="388" aperture="9" distance="1000" k1="-0.0312" k2="-0.0205" k3="0.0293"/>
            <vignetting model="pa" focal="388" aperture="10" distance="10" k1="-0.0328" k2="-0.0180" k3="0.0290"/>
            <vignetting model="pa" focal="388" aperture="10" distance="1000" k1="-0.0328" k2="-0.0180" k3="0.0290"/>
            <vignetting model="pa" focal="388" aperture="11" distance="10" k1="-0.0344" k2="-0.0140" k3="0.0260"/>
            <vignetting model="pa" focal="388" aperture="11" distance="1000" k1="-0.0344" k2="-0.0140" k3="0.0260"/>
            <vignetting model="pa" focal="388" aperture="13" distance="10" k1="-0.0335" k2="-0.0172" k3="0.0278"/>
            <vignetting model="pa" focal="388" aperture="13" distance="1000" k1="-0.0335" k2="-0.0172" k3="0.0278"/>
            <vignetting model="pa" focal="388" aperture="14" distance="10" k1="-0.0333" k2="-0.0176" k3="0.0280"/>
            <vignetting model="pa" focal="388" aperture="14" distance="1000" k1="-0.0333" k2="-0.0176" k3="0.0280"/>
            <vignetting model="pa" focal="388" aperture="16" distance="10" k1="-0.0355" k2="-0.0108" k3="0.0231"/>
            <vignetting model="pa" focal="388" aperture="16" distance="1000" k1="-0.0355" k2="-0.0108" k3="0.0231"/>
            <vignetting model="pa" focal="388" aperture="18" distance="10" k1="-0.0275" k2="-0.0301" k3="0.0350"/>
            <vignetting model="pa" focal="388" aperture="18" distance="1000" k1="-0.0275" k2="-0.0301" k3="0.0350"/>
            <vignetting model="pa" focal="388" aperture="20" distance="10" k1="-0.0298" k2="-0.0245" k3="0.0313"/>
            <vignetting model="pa" focal="388" aperture="20" distance="1000" k1="-0.0298" k2="-0.0245" k3="0.0313"/>
            <vignetting model="pa" focal="388" aperture="22" distance="10" k1="-0.0308" k2="-0.0218" k3="0.0290"/>
            <vignetting model="pa" focal="388" aperture="22" distance="1000" k1="-0.0308" k2="-0.0218" k3="0.0290"/>
            <vignetting model="pa" focal="388" aperture="32" distance="10" k1="-0.0350" k2="-0.0173" k3="0.0289"/>
            <vignetting model="pa" focal="388" aperture="32" distance="1000" k1="-0.0350" k2="-0.0173" k3="0.0289"/>
            <vignetting model="pa" focal="600" aperture="6.3" distance="10" k1="-0.3405" k2="-0.0066" k3="0.0700"/>
            <vignetting model="pa" focal="600" aperture="6.3" distance="1000" k1="-0.3405" k2="-0.0066" k3="0.0700"/>
            <vignetting model="pa" focal="600" aperture="7.1" distance="10" k1="0.0344" k2="-0.4734" k3="0.2853"/>
            <vignetting model="pa" focal="600" aperture="7.1" distance="1000" k1="0.0344" k2="-0.4734" k3="0.2853"/>
            <vignetting model="pa" focal="600" aperture="8" distance="10" k1="0.0121" k2="-0.1156" k3="-0.0047"/>
            <vignetting model="pa" focal="600" aperture="8" distance="1000" k1="0.0121" k2="-0.1156" k3="-0.0047"/>
            <vignetting model="pa" focal="600" aperture="9" distance="10" k1="-0.0414" k2="0.0378" k3="-0.0402"/>
            <vignetting model="pa" focal="600" aperture="9" distance="1000" k1="-0.0414" k2="0.0378" k3="-0.0402"/>
            <vignetting model="pa" focal="600" aperture="10" distance="10" k1="-0.0284" k2="-0.0204" k3="0.0238"/>
            <vignetting model="pa" focal="600" aperture="10" distance="1000" k1="-0.0284" k2="-0.0204" k3="0.0238"/>
            <vignetting model="pa" focal="600" aperture="11" distance="10" k1="-0.0260" k2="-0.0308" k3="0.0342"/>
            <vignetting model="pa" focal="600" aperture="11" distance="1000" k1="-0.0260" k2="-0.0308" k3="0.0342"/>
            <vignetting model="pa" focal="600" aperture="13" distance="10" k1="-0.0279" k2="-0.0296" k3="0.0351"/>
            <vignetting model="pa" focal="600" aperture="13" distance="1000" k1="-0.0279" k2="-0.0296" k3="0.0351"/>
            <vignetting model="pa" focal="600" aperture="14" distance="10" k1="-0.0257" k2="-0.0332" k3="0.0364"/>
            <vignetting model="pa" focal="600" aperture="14" distance="1000" k1="-0.0257" k2="-0.0332" k3="0.0364"/>
            <vignetting model="pa" focal="600" aperture="16" distance="10" k1="-0.0219" k2="-0.0429" k3="0.0425"/>
            <vignetting model="pa" focal="600" aperture="16" distance="1000" k1="-0.0219" k2="-0.0429" k3="0.0425"/>
            <vignetting model="pa" focal="600" aperture="18" distance="10" k1="-0.0237" k2="-0.0366" k3="0.0375"/>
            <vignetting model="pa" focal="600" aperture="18" distance="1000" k1="-0.0237" k2="-0.0366" k3="0.0375"/>
            <vignetting model="pa" focal="600" aperture="20" distance="10" k1="-0.0230" k2="-0.0383" k3="0.0384"/>
            <vignetting model="pa" focal="600" aperture="20" distance="1000" k1="-0.0230" k2="-0.0383" k3="0.0384"/>
            <vignetting model="pa" focal="600" aperture="22" distance="10" k1="-0.0259" k2="-0.0324" k3="0.0349"/>
            <vignetting model="pa" focal="600" aperture="22" distance="1000" k1="-0.0259" k2="-0.0324" k3="0.0349"/>
            <vignetting model="pa" focal="600" aperture="25" distance="10" k1="-0.0256" k2="-0.0341" k3="0.0361"/>
            <vignetting model="pa" focal="600" aperture="25" distance="1000" k1="-0.0256" k2="-0.0341" k3="0.0361"/>
            <vignetting model="pa" focal="600" aperture="29" distance="10" k1="-0.0252" k2="-0.0373" k3="0.0390"/>
            <vignetting model="pa" focal="600" aperture="29" distance="1000" k1="-0.0252" k2="-0.0373" k3="0.0390"/>
            <vignetting model="pa" focal="600" aperture="32" distance="10" k1="-0.0284" k2="-0.0312" k3="0.0354"/>
            <vignetting model="pa" focal="600" aperture="32" distance="1000" k1="-0.0284" k2="-0.0312" k3="0.0354"/>
        </calibration>
    </lens>
    ...
    <lens>
        ...
        <calibration>
             <!-- Taken with Canon EOS 7D Mark II -->
            <vignetting model="pa" focal="84" aperture="6.3" distance="10" k1="-0.1135" k2="0.1384" k3="-0.0805"/>
            <vignetting model="pa" focal="84" aperture="6.3" distance="1000" k1="-0.1135" k2="0.1384" k3="-0.0805"/>
            <vignetting model="pa" focal="84" aperture="7.1" distance="10" k1="-0.0556" k2="0.0589" k3="-0.0180"/>
            <vignetting model="pa" focal="84" aperture="7.1" distance="1000" k1="-0.0556" k2="0.0589" k3="-0.0180"/>
            <vignetting model="pa" focal="84" aperture="8" distance="10" k1="-0.0617" k2="0.0723" k3="-0.0267"/>
            <vignetting model="pa" focal="84" aperture="8" distance="1000" k1="-0.0617" k2="0.0723" k3="-0.0267"/>
            <vignetting model="pa" focal="84" aperture="11" distance="10" k1="-0.0671" k2="0.0856" k3="-0.0346"/>
            <vignetting model="pa" focal="84" aperture="11" distance="1000" k1="-0.0671" k2="0.0856" k3="-0.0346"/>
            <vignetting model="pa" focal="84" aperture="16" distance="10" k1="-0.0779" k2="0.1117" k3="-0.0518"/>
            <vignetting model="pa" focal="84" aperture="16" distance="1000" k1="-0.0779" k2="0.1117" k3="-0.0518"/>
            <vignetting model="pa" focal="84" aperture="22" distance="10" k1="-0.0902" k2="0.1383" k3="-0.0680"/>
            <vignetting model="pa" focal="84" aperture="22" distance="1000" k1="-0.0902" k2="0.1383" k3="-0.0680"/>
            <vignetting model="pa" focal="84" aperture="32" distance="10" k1="-0.1011" k2="0.1611" k3="-0.0822"/>
            <vignetting model="pa" focal="84" aperture="32" distance="1000" k1="-0.1011" k2="0.1611" k3="-0.0822"/>
            <vignetting model="pa" focal="100" aperture="6.3" distance="10" k1="-0.0899" k2="0.0898" k3="-0.0507"/>
            <vignetting model="pa" focal="100" aperture="6.3" distance="1000" k1="-0.0899" k2="0.0898" k3="-0.0507"/>
            <vignetting model="pa" focal="100" aperture="7.1" distance="10" k1="-0.0476" k2="0.0436" k3="-0.0093"/>
            <vignetting model="pa" focal="100" aperture="7.1" distance="1000" k1="-0.0476" k2="0.0436" k3="-0.0093"/>
            <vignetting model="pa" focal="100" aperture="8" distance="10" k1="-0.0517" k2="0.0505" k3="-0.0124"/>
            <vignetting model="pa" focal="100" aperture="8" distance="1000" k1="-0.0517" k2="0.0505" k3="-0.0124"/>
            <vignetting model="pa" focal="100" aperture="11" distance="10" k1="-0.0618" k2="0.0756" k3="-0.0287"/>
            <vignetting model="pa" focal="100" aperture="11" distance="1000" k1="-0.0618" k2="0.0756" k3="-0.0287"/>
            <vignetting model="pa" focal="100" aperture="16" distance="10" k1="-0.0659" k2="0.0866" k3="-0.0369"/>
            <vignetting model="pa" focal="100" aperture="16" distance="1000" k1="-0.0659" k2="0.0866" k3="-0.0369"/>
            <vignetting model="pa" focal="100" aperture="22" distance="10" k1="-0.0800" k2="0.1178" k3="-0.0562"/>
            <vignetting model="pa" focal="100" aperture="22" distance="1000" k1="-0.0800" k2="0.1178" k3="-0.0562"/>
            <vignetting model="pa" focal="100" aperture="32" distance="10" k1="-0.0972" k2="0.1533" k3="-0.0780"/>
            <vignetting model="pa" focal="100" aperture="32" distance="1000" k1="-0.0972" k2="0.1533" k3="-0.0780"/>
            <vignetting model="pa" focal="111" aperture="7.1" distance="10" k1="-0.0752" k2="0.0672" k3="-0.0387"/>
            <vignetting model="pa" focal="111" aperture="7.1" distance="1000" k1="-0.0752" k2="0.0672" k3="-0.0387"/>
            <vignetting model="pa" focal="111" aperture="8" distance="10" k1="-0.0463" k2="0.0428" k3="-0.0087"/>
            <vignetting model="pa" focal="111" aperture="8" distance="1000" k1="-0.0463" k2="0.0428" k3="-0.0087"/>
            <vignetting model="pa" focal="111" aperture="11" distance="10" k1="-0.0590" k2="0.0695" k3="-0.0242"/>
            <vignetting model="pa" focal="111" aperture="11" distance="1000" k1="-0.0590" k2="0.0695" k3="-0.0242"/>
            <vignetting model="pa" focal="111" aperture="16" distance="10" k1="-0.0610" k2="0.0736" k3="-0.0263"/>
            <vignetting model="pa" focal="111" aperture="16" distance="1000" k1="-0.0610" k2="0.0736" k3="-0.0263"/>
            <vignetting model="pa" focal="111" aperture="22" distance="10" k1="-0.0759" k2="0.1086" k3="-0.0491"/>
            <vignetting model="pa" focal="111" aperture="22" distance="1000" k1="-0.0759" k2="0.1086" k3="-0.0491"/>
            <vignetting model="pa" focal="111" aperture="32" distance="10" k1="-0.0974" k2="0.1562" k3="-0.0798"/>
            <vignetting model="pa" focal="111" aperture="32" distance="1000" k1="-0.0974" k2="0.1562" k3="-0.0798"/>
            <vignetting model="pa" focal="141" aperture="7.1" distance="10" k1="-0.0478" k2="0.0247" k3="-0.0151"/>
            <vignetting model="pa" focal="141" aperture="7.1" distance="1000" k1="-0.0478" k2="0.0247" k3="-0.0151"/>
            <vignetting model="pa" focal="141" aperture="8" distance="10" k1="-0.0484" k2="0.0509" k3="-0.0140"/>
            <vignetting model="pa" focal="141" aperture="8" distance="1000" k1="-0.0484" k2="0.0509" k3="-0.0140"/>
            <vignetting model="pa" focal="141" aperture="11" distance="10" k1="-0.0533" k2="0.0608" k3="-0.0193"/>
            <vignetting model="pa" focal="141" aperture="11" distance="1000" k1="-0.0533" k2="0.0608" k3="-0.0193"/>
            <vignetting model="pa" focal="141" aperture="16" distance="10" k1="-0.0562" k2="0.0682" k3="-0.0242"/>
            <vignetting model="pa" focal="141" aperture="16" distance="1000" k1="-0.0562" k2="0.0682" k3="-0.0242"/>
            <vignetting model="pa" focal="141" aperture="22" distance="10" k1="-0.0626" k2="0.0833" k3="-0.0344"/>
            <vignetting model="pa" focal="141" aperture="22" distance="1000" k1="-0.0626" k2="0.0833" k3="-0.0344"/>
            <vignetting model="pa" focal="141" aperture="36" distance="10" k1="-0.0837" k2="0.1298" k3="-0.0646"/>
            <vignetting model="pa" focal="141" aperture="36" distance="1000" k1="-0.0837" k2="0.1298" k3="-0.0646"/>
            <vignetting model="pa" focal="165" aperture="7.1" distance="10" k1="-0.0336" k2="0.0104" k3="-0.0082"/>
            <vignetting model="pa" focal="165" aperture="7.1" distance="1000" k1="-0.0336" k2="0.0104" k3="-0.0082"/>
            <vignetting model="pa" focal="165" aperture="8" distance="10" k1="-0.0456" k2="0.0461" k3="-0.0102"/>
            <vignetting model="pa" focal="165" aperture="8" distance="1000" k1="-0.0456" k2="0.0461" k3="-0.0102"/>
            <vignetting model="pa" focal="165" aperture="11" distance="10" k1="-0.0481" k2="0.0495" k3="-0.0119"/>
            <vignetting model="pa" focal="165" aperture="11" distance="1000" k1="-0.0481" k2="0.0495" k3="-0.0119"/>
            <vignetting model="pa" focal="165" aperture="16" distance="10" k1="-0.0526" k2="0.0623" k3="-0.0207"/>
            <vignetting model="pa" focal="165" aperture="16" distance="1000" k1="-0.0526" k2="0.0623" k3="-0.0207"/>
            <vignetting model="pa" focal="165" aperture="22" distance="10" k1="-0.0611" k2="0.0815" k3="-0.0336"/>
            <vignetting model="pa" focal="165" aperture="22" distance="1000" k1="-0.0611" k2="0.0815" k3="-0.0336"/>
            <vignetting model="pa" focal="165" aperture="36" distance="10" k1="-0.0847" k2="0.1348" k3="-0.0680"/>
            <vignetting model="pa" focal="165" aperture="36" distance="1000" k1="-0.0847" k2="0.1348" k3="-0.0680"/>
            <vignetting model="pa" focal="213" aperture="8" distance="10" k1="-0.0262" k2="0.0079" k3="-0.0091"/>
            <vignetting model="pa" focal="213" aperture="8" distance="1000" k1="-0.0262" k2="0.0079" k3="-0.0091"/>
            <vignetting model="pa" focal="213" aperture="11" distance="10" k1="-0.0473" k2="0.0515" k3="-0.0132"/>
            <vignetting model="pa" focal="213" aperture="11" distance="1000" k1="-0.0473" k2="0.0515" k3="-0.0132"/>
            <vignetting model="pa" focal="213" aperture="16" distance="10" k1="-0.0480" k2="0.0542" k3="-0.0156"/>
            <vignetting model="pa" focal="213" aperture="16" distance="1000" k1="-0.0480" k2="0.0542" k3="-0.0156"/>
            <vignetting model="pa" focal="213" aperture="22" distance="10" k1="-0.0570" k2="0.0753" k3="-0.0295"/>
            <vignetting model="pa" focal="213" aperture="22" distance="1000" k1="-0.0570" k2="0.0753" k3="-0.0295"/>
            <vignetting model="pa" focal="213" aperture="32" distance="10" k1="-0.0705" k2="0.1050" k3="-0.0485"/>
            <vignetting model="pa" focal="213" aperture="32" distance="1000" k1="-0.0705" k2="0.1050" k3="-0.0485"/>
            <vignetting model="pa" focal="213" aperture="40" distance="10" k1="-0.0821" k2="0.1309" k3="-0.0652"/>
            <vignetting model="pa" focal="213" aperture="40" distance="1000" k1="-0.0821" k2="0.1309" k3="-0.0652"/>
            <vignetting model="pa" focal="287" aperture="8" distance="10" k1="-0.0158" k2="-0.0297" k3="0.0157"/>
            <vignetting model="pa" focal="287" aperture="8" distance="1000" k1="-0.0158" k2="-0.0297" k3="0.0157"/>
            <vignetting model="pa" focal="287" aperture="9" distance="10" k1="-0.0414" k2="0.0402" k3="-0.0064"/>
            <vignetting model="pa" focal="287" aperture="9" distance="1000" k1="-0.0414" k2="0.0402" k3="-0.0064"/>
            <vignetting model="pa" focal="287" aperture="10" distance="10" k1="-0.0414" k2="0.0400" k3="-0.0066"/>
            <vignetting model="pa" focal="287" aperture="10" distance="1000" k1="-0.0414" k2="0.0400" k3="-0.0066"/>
            <vignetting model="pa" focal="287" aperture="11" distance="10" k1="-0.0476" k2="0.0555" k3="-0.0168"/>
            <vignetting model="pa" focal="287" aperture="11" distance="1000" k1="-0.0476" k2="0.0555" k3="-0.0168"/>
            <vignetting model="pa" focal="287" aperture="13" distance="10" k1="-0.0480" k2="0.0546" k3="-0.0151"/>
            <vignetting model="pa" focal="287" aperture="13" distance="1000" k1="-0.0480" k2="0.0546" k3="-0.0151"/>
            <vignetting model="pa" focal="287" aperture="14" distance="10" k1="-0.0501" k2="0.0618" k3="-0.0208"/>
            <vignetting model="pa" focal="287" aperture="14" distance="1000" k1="-0.0501" k2="0.0618" k3="-0.0208"/>
            <vignetting model="pa" focal="287" aperture="16" distance="10" k1="-0.0522" k2="0.0673" k3="-0.0242"/>
            <vignetting model="pa" focal="287" aperture="16" distance="1000" k1="-0.0522" k2="0.0673" k3="-0.0242"/>
            <vignetting model="pa" focal="287" aperture="22" distance="10" k1="-0.0550" k2="0.0743" k3="-0.0297"/>
            <vignetting model="pa" focal="287" aperture="22" distance="1000" k1="-0.0550" k2="0.0743" k3="-0.0297"/>
            <vignetting model="pa" focal="287" aperture="32" distance="10" k1="-0.0663" k2="0.0985" k3="-0.0447"/>
            <vignetting model="pa" focal="287" aperture="32" distance="1000" k1="-0.0663" k2="0.0985" k3="-0.0447"/>
            <vignetting model="pa" focal="287" aperture="40" distance="10" k1="-0.0782" k2="0.1257" k3="-0.0621"/>
            <vignetting model="pa" focal="287" aperture="40" distance="1000" k1="-0.0782" k2="0.1257" k3="-0.0621"/>
            <vignetting model="pa" focal="344" aperture="8" distance="10" k1="-0.0228" k2="-0.0222" k3="0.0142"/>
            <vignetting model="pa" focal="344" aperture="8" distance="1000" k1="-0.0228" k2="-0.0222" k3="0.0142"/>
            <vignetting model="pa" focal="344" aperture="11" distance="10" k1="-0.0481" k2="0.0578" k3="-0.0172"/>
            <vignetting model="pa" focal="344" aperture="11" distance="1000" k1="-0.0481" k2="0.0578" k3="-0.0172"/>
            <vignetting model="pa" focal="344" aperture="16" distance="10" k1="-0.0507" k2="0.0636" k3="-0.0206"/>
            <vignetting model="pa" focal="344" aperture="16" distance="1000" k1="-0.0507" k2="0.0636" k3="-0.0206"/>
            <vignetting model="pa" focal="344" aperture="22" distance="10" k1="-0.0557" k2="0.0754" k3="-0.0286"/>
            <vignetting model="pa" focal="344" aperture="22" distance="1000" k1="-0.0557" k2="0.0754" k3="-0.0286"/>
            <vignetting model="pa" focal="344" aperture="32" distance="10" k1="-0.0663" k2="0.1005" k3="-0.0460"/>
            <vignetting model="pa" focal="344" aperture="32" distance="1000" k1="-0.0663" k2="0.1005" k3="-0.0460"/>
            <vignetting model="pa" focal="344" aperture="40" distance="10" k1="-0.0690" k2="0.1091" k3="-0.0529"/>
            <vignetting model="pa" focal="344" aperture="40" distance="1000" k1="-0.0690" k2="0.1091" k3="-0.0529"/>
            <vignetting model="pa" focal="415" aperture="8" distance="10" k1="-0.0219" k2="-0.0277" k3="0.0187"/>
            <vignetting model="pa" focal="415" aperture="8" distance="1000" k1="-0.0219" k2="-0.0277" k3="0.0187"/>
            <vignetting model="pa" focal="415" aperture="11" distance="10" k1="-0.0427" k2="0.0458" k3="-0.0099"/>
            <vignetting model="pa" focal="415" aperture="11" distance="1000" k1="-0.0427" k2="0.0458" k3="-0.0099"/>
            <vignetting model="pa" focal="415" aperture="16" distance="10" k1="-0.0484" k2="0.0607" k3="-0.0205"/>
            <vignetting model="pa" focal="415" aperture="16" distance="1000" k1="-0.0484" k2="0.0607" k3="-0.0205"/>
            <vignetting model="pa" focal="415" aperture="22" distance="10" k1="-0.0539" k2="0.0721" k3="-0.0280"/>
            <vignetting model="pa" focal="415" aperture="22" distance="1000" k1="-0.0539" k2="0.0721" k3="-0.0280"/>
            <vignetting model="pa" focal="415" aperture="32" distance="10" k1="-0.0647" k2="0.0968" k3="-0.0436"/>
            <vignetting model="pa" focal="415" aperture="32" distance="1000" k1="-0.0647" k2="0.0968" k3="-0.0436"/>
            <vignetting model="pa" focal="415" aperture="40" distance="10" k1="-0.0781" k2="0.1259" k3="-0.0606"/>
            <vignetting model="pa" focal="415" aperture="40" distance="1000" k1="-0.0781" k2="0.1259" k3="-0.0606"/>
            <vignetting model="pa" focal="546" aperture="9" distance="10" k1="-0.0247" k2="0.0046" k3="-0.0152"/>
            <vignetting model="pa" focal="546" aperture="9" distance="1000" k1="-0.0247" k2="0.0046" k3="-0.0152"/>
            <vignetting model="pa" focal="546" aperture="10" distance="10" k1="-0.0351" k2="0.0312" k3="-0.0024"/>
            <vignetting model="pa" focal="546" aperture="10" distance="1000" k1="-0.0351" k2="0.0312" k3="-0.0024"/>
            <vignetting model="pa" focal="546" aperture="11" distance="10" k1="-0.0357" k2="0.0307" k3="-0.0011"/>
            <vignetting model="pa" focal="546" aperture="11" distance="1000" k1="-0.0357" k2="0.0307" k3="-0.0011"/>
            <vignetting model="pa" focal="546" aperture="16" distance="10" k1="-0.0436" k2="0.0495" k3="-0.0136"/>
            <vignetting model="pa" focal="546" aperture="16" distance="1000" k1="-0.0436" k2="0.0495" k3="-0.0136"/>
            <vignetting model="pa" focal="546" aperture="22" distance="10" k1="-0.0533" k2="0.0698" k3="-0.0253"/>
            <vignetting model="pa" focal="546" aperture="22" distance="1000" k1="-0.0533" k2="0.0698" k3="-0.0253"/>
            <vignetting model="pa" focal="546" aperture="32" distance="10" k1="-0.0629" k2="0.0923" k3="-0.0402"/>
            <vignetting model="pa" focal="546" aperture="32" distance="1000" k1="-0.0629" k2="0.0923" k3="-0.0402"/>
            <vignetting model="pa" focal="546" aperture="45" distance="10" k1="-0.0726" k2="0.1130" k3="-0.0526"/>
            <vignetting model="pa" focal="546" aperture="45" distance="1000" k1="-0.0726" k2="0.1130" k3="-0.0526"/>
            <vignetting model="pa" focal="840" aperture="9" distance="10" k1="-0.1981" k2="0.0444" k3="-0.0183"/>
            <vignetting model="pa" focal="840" aperture="9" distance="1000" k1="-0.1981" k2="0.0444" k3="-0.0183"/>
            <vignetting model="pa" focal="840" aperture="10" distance="10" k1="0.0256" k2="-0.2020" k3="0.1068"/>
            <vignetting model="pa" focal="840" aperture="10" distance="1000" k1="0.0256" k2="-0.2020" k3="0.1068"/>
            <vignetting model="pa" focal="840" aperture="11" distance="10" k1="-0.0379" k2="0.0494" k3="-0.0248"/>
            <vignetting model="pa" focal="840" aperture="11" distance="1000" k1="-0.0379" k2="0.0494" k3="-0.0248"/>
            <vignetting model="pa" focal="840" aperture="16" distance="10" k1="-0.0379" k2="0.0375" k3="-0.0072"/>
            <vignetting model="pa" focal="840" aperture="16" distance="1000" k1="-0.0379" k2="0.0375" k3="-0.0072"/>
            <vignetting model="pa" focal="840" aperture="22" distance="10" k1="-0.0483" k2="0.0577" k3="-0.0189"/>
            <vignetting model="pa" focal="840" aperture="22" distance="1000" k1="-0.0483" k2="0.0577" k3="-0.0189"/>
            <vignetting model="pa" focal="840" aperture="32" distance="10" k1="-0.0583" k2="0.0794" k3="-0.0321"/>
            <vignetting model="pa" focal="840" aperture="32" distance="1000" k1="-0.0583" k2="0.0794" k3="-0.0321"/>
            <vignetting model="pa" focal="840" aperture="45" distance="10" k1="-0.0685" k2="0.1045" k3="-0.0484"/>
            <vignetting model="pa" focal="840" aperture="45" distance="1000" k1="-0.0685" k2="0.1045" k3="-0.0484"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 14mm f/2.8 EX Aspherical HSM</model>
        <mount>Canon EF</mount>
        <mount>Nikon F</mount>
        <mount>Sigma SA</mount>
        <mount>Sony Alpha</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="14" a="0.00935997" b="-0.025667" c="0.00245276"/>
            <tca model="poly3" focal="14" vr="1.0006568" vb="0.9998735"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 15mm f/2.8 EX DG Diagonal Fisheye</model>
        <mount>Canon EF</mount>
        <mount>Sigma SA</mount>
        <mount>Nikon F</mount>
        <mount>Sony Alpha</mount>
        ...
        <calibration>
            <!-- Taken with Canon EOS 80D -->
            <distortion model="ptlens" focal="15" a="0.0186949" b="-0.0906375" c="-0.0319767"/>
            <tca model="poly3" focal="15" vr="1.0002505" vb="1.0001911"/>
            <vignetting model="pa" focal="15" aperture="2.8" distance="10" k1="-0.4951" k2="0.0250" k3="0.1059"/>
            <vignetting model="pa" focal="15" aperture="2.8" distance="1000" k1="-0.4951" k2="0.0250" k3="0.1059"/>
            <vignetting model="pa" focal="15" aperture="4" distance="10" k1="-0.1250" k2="0.1120" k3="-0.1090"/>
            <vignetting model="pa" focal="15" aperture="4" distance="1000" k1="-0.1250" k2="0.1120" k3="-0.1090"/>
            <vignetting model="pa" focal="15" aperture="5.6" distance="10" k1="-0.1447" k2="0.1509" k3="-0.0658"/>
            <vignetting model="pa" focal="15" aperture="5.6" distance="1000" k1="-0.1447" k2="0.1509" k3="-0.0658"/>
            <vignetting model="pa" focal="15" aperture="8" distance="10" k1="-0.1481" k2="0.1409" k3="-0.0603"/>
            <vignetting model="pa" focal="15" aperture="8" distance="1000" k1="-0.1481" k2="0.1409" k3="-0.0603"/>
            <vignetting model="pa" focal="15" aperture="11" distance="10" k1="-0.1477" k2="0.1326" k3="-0.0572"/>
            <vignetting model="pa" focal="15" aperture="11" distance="1000" k1="-0.1477" k2="0.1326" k3="-0.0572"/>
            <vignetting model="pa" focal="15" aperture="16" distance="10" k1="-0.1548" k2="0.1457" k3="-0.0634"/>
            <vignetting model="pa" focal="15" aperture="16" distance="1000" k1="-0.1548" k2="0.1457" k3="-0.0634"/>
            <vignetting model="pa" focal="15" aperture="22" distance="10" k1="-0.1558" k2="0.1503" k3="-0.0621"/>
            <vignetting model="pa" focal="15" aperture="22" distance="1000" k1="-0.1558" k2="0.1503" k3="-0.0621"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 24-70mm F2.8 DG OS HSM | Art 017</model>
        <mount>Sigma SA</mount>
        <mount>Canon EF</mount>
        <mount>Nikon F</mount>
        <cropfactor>1.0</cropfactor>
        <calibration>
            ...
            <distortion model="ptlens" focal="24" a="0.0242559" b="-0.0662983" c="0.0245867"/>
            <distortion model="ptlens" focal="27" a="0.0201362" b="-0.0545548" c="0.0247158"/>
            <distortion model="ptlens" focal="28" a="0.0153596" b="-0.0381425" c="0.0111283"/>
            <distortion model="ptlens" focal="35" a="0.0071352" b="-0.010377" c="-0.0038095"/>
            <distortion model="ptlens" focal="44" a="0.0062708" b="-0.0101241" c="0.0063449"/>
            <distortion model="ptlens" focal="53" a="0.0015572" b="0.0049598" c="-0.0040844"/>
            <distortion model="ptlens" focal="58" a="0.0153281" b="-0.0412909" c="0.0476226"/>
            <distortion model="ptlens" focal="70" a="0.0013453" b="0.0066491" c="-0.0011936"/>
            <tca model="poly3" focal="24" vr="1.0001580" vb="1.0001595"/>
            <tca model="poly3" focal="27" vr="1.0001072" vb="1.0001607"/>
            <tca model="poly3" focal="31" vr="1.0000810" vb="1.0001445"/>
            <tca model="poly3" focal="35" vr="1.0000359" vb="1.0001212"/>
            <tca model="poly3" focal="41" vr="0.9999926" vb="1.0000987"/>
            <tca model="poly3" focal="50" vr="0.9999516" vb="1.0000188"/>
            <tca model="poly3" focal="57" vr="0.9998924" vb="1.0000074"/>
            <tca model="poly3" focal="59" vr="0.9998432" vb="1.0000424"/>
            <tca model="poly3" focal="70" vr="0.9996800" vb="1.0000726"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 30mm F1.4 DC HSM | Art 013</model>
        <mount>Canon EF</mount>
        <mount>Nikon F</mount>
        <mount>Sigma SA</mount>
        <mount>Sony Alpha</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="30" a="0.0016474" b="-0.0113428" c="0.0010198"/>
            <tca model="poly3" focal="30" vr="1.0003821" vb="1.0000143"/>
            <vignetting model="pa" focal="30" aperture="1.4" distance="10" k1="-0.8683" k2="0.4198" k3="-0.0719"/>
            <vignetting model="pa" focal="30" aperture="1.4" distance="1000" k1="-0.8683" k2="0.4198" k3="-0.0719"/>
            <vignetting model="pa" focal="30" aperture="2" distance="10" k1="-0.0722" k2="-0.4033" k3="0.1554"/>
            <vignetting model="pa" focal="30" aperture="2" distance="1000" k1="-0.0722" k2="-0.4033" k3="0.1554"/>
            <vignetting model="pa" focal="30" aperture="2.8" distance="10" k1="-0.1318" k2="-0.0711" k3="0.0274"/>
            <vignetting model="pa" focal="30" aperture="2.8" distance="1000" k1="-0.1318" k2="-0.0711" k3="0.0274"/>
            <vignetting model="pa" focal="30" aperture="4" distance="10" k1="-0.1141" k2="-0.1125" k3="0.0692"/>
            <vignetting model="pa" focal="30" aperture="4" distance="1000" k1="-0.1141" k2="-0.1125" k3="0.0692"/>
            <vignetting model="pa" focal="30" aperture="16" distance="10" k1="-0.1074" k2="-0.1896" k3="0.1597"/>
            <vignetting model="pa" focal="30" aperture="16" distance="1000" k1="-0.1074" k2="-0.1896" k3="0.1597"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 12-24mm F4.5-5.6 II DG HSM</model>
        <mount>Nikon F AF</mount>
        <mount>Canon EF</mount>
        <mount>Pentax KAF</mount>
        <mount>Sigma SA</mount>
        ...
        <calibration>
            ...
            <distortion model="ptlens" focal="12" a="0.0343662" b="-0.1420169" c="0.1377181"/>
            <distortion model="ptlens" focal="14" a="0.0262195" b="-0.1198236" c="0.1251479"/>
            <distortion model="ptlens" focal="15" a="0.013384" b="-0.0731224" c="0.0842325"/>
            <distortion model="ptlens" focal="17" a="0.0143309" b="-0.0786334" c="0.10093"/>
            <distortion model="ptlens" focal="19" a="-0.0042103" b="-0.0078835" c="0.0346072"/>
            <distortion model="ptlens" focal="21" a="-0.0119742" b="0.0263903" c="-0.000161"/>
            <distortion model="ptlens" focal="22" a="-0.0125026" b="0.030839" c="-0.0063702"/>
            <distortion model="ptlens" focal="24" a="-0.0089305" b="0.0247241" c="-0.0005789"/>
        </calibration>
    </lens>

    <lens>
        <maker>Sigma</maker>
        <model>Sigma 35–80mm f/4–5.6 DL-II AF</model>
        <mount>Sony Alpha</mount>
        <mount>Canon EF</mount>
        <mount>Nikon F</mount>
    ...
    <lens>
        <maker>Sigma</maker>
        <model>Sigma 90mm f/2.8 Macro AF</model>
        <mount>Sony Alpha</mount>
        <mount>Sigma SA</mount>
        <mount>Nikon F AF</mount>
        <mount>Canon EF-S</mount>
	    ...
	    <!-- Taken with Sony A700 -->
            <distortion model="ptlens" focal="90" a="0.00844" b="-0.02592" c="0.02708"/>
        </calibration>
    </lens>
